  ...
  const result = one(
    {
      ...
      ignore: options.ignore
        ...
        : defaultIgnore,
      source: options.source ? defaultSource.concat(options.source)
      : defaultSource,
    },
    tree,
  );
...
function patch(config, nodes, offset) {
  ...
  while (++index < nodes.length) {
    ...
    const end = typeof start === "number"
      ? start + toString(node).length
      : undefined;

    node.position = start !== undefined && end !== undefined
      ? {
