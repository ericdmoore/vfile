...
const remarkLintListItemBulletIndent = lintRule(
  {
    ...
    url:
      "https://github.com/remarkjs/remark-lint/tree/main/packages/remark-lint-list-item-bullet-indent#readme",
  },
    ...
    visit(tree, "list", (list, _, grandparent) => {
      ...
      while (++index < list.children.length) {
        ...
        if (
          ...
          const indent = item.position.start.column -
            grandparent.position.start.column;
