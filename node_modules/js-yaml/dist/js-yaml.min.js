...
!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], t)
    : t(
      (e = "undefined" != typeof globalThis ? globalThis : e || self).jsyaml =
        {},
    );
}(this, function (e) {
  "use strict";
  ...
  var n = {
    ...
    extend: function (e, t) {
      ...
      if (t) {
        for (
          n = 0, i = (o = Object.keys(t)).length; n < i; n += 1
        ) {
          e[r = o[n]] = t[r];
        }
      }
  ...
  var c = function (e, t) {
      ...
      for (u = 1; u <= t.linesBefore && !(s - u < 0); u++) {
        p = a(e.buffer, o[s - u], c[s - u], e.position - (o[s] - o[s - u]), h),
          f = n.repeat(" ", t.indent) + l((e.line - u + 1).toString(), d) +
            " | " + p.str + "\n" + f;
      }
      for (
        p = a(e.buffer, o[s], c[s], e.position, h),
          f += n.repeat(" ", t.indent) + l((e.line + 1).toString(), d) + " | " +
            p.str + "\n",
    ...
    if (
      t = t || {},
        Object.keys(t).forEach(function (t) {
          if (-1 === s.indexOf(t)) {
            throw new o(
              'Unknown option "' + t + '" is met in definition of "' + e +
                '" YAML type.',
            );
          }
        }),
      ...
      throw new o(
        'Unknown kind "' + this.kind + '" is specified for "' + e +
          '" YAML type.',
      );
    }
  };
  ...
  var v = new p("tag:yaml.org,2002:bool", {
    ...
    resolve: function (e) {
      if (null === e) return !1;
      var t = e.length;
      return 4 === t && ("true" === e || "True" === e || "TRUE" === e) ||
    ...
    if (t < n) {
      if (l = e.input.slice(t, n), i) {
        for (r = 0, o = l.length; r < o; r += 1) {
          9 === (a = l.charCodeAt(r)) || 32 <= a && a <= 1114111 ||
  ...
  function de(e, t, n, i, r, o, a, l, c) {
    ...
    if (Array.isArray(r)) {
      for (
        s = 0, u = (r = Array.prototype.slice.call(r)).length; s < u; s += 1
      ) {
        Array.isArray(r[s]) &&
        ce(e, "nested arrays are not supported inside keys"),
          "object" == typeof r && "[object Object]" === Z(r[s]) &&
          (r[s] = "[object Object]");
      }
    }
    if (
      "object" == typeof r && "[object Object]" === Z(r) &&
      (r = "[object Object]"),
        r = String(r),
        null === t && (t = {}),
  ...
  function me(e) {
    ...
    return !(45 !== (t = e.input.charCodeAt(n)) && 46 !== t ||
      t !== e.input.charCodeAt(n + 1) || t !== e.input.charCodeAt(n + 2) ||
      ...
      for (; 0 !== r && !z(r);) {
        ...
        (a
          ...
          : (n = e.input.slice(t - 1, e.position + 1),
            ...
            a = !0,
            t = e.position + 1)), r = e.input.charCodeAt(++e.position);
      }
      i = e.input.slice(t, e.position),
        $.test(i) &&
  ...
  function we(e, t, i, r, o) {
    ...
    if (
      ...
      for (; Ae(e) || ve(e);) {
        ge(e, !0, -1)
          ? (m = !0,
            c = a,
            e.lineIndent > t ? g = 1 : e.lineIndent === t
              ? g = 0
              : e.lineIndent < t && (g = -1))
          : c = !1;
      }
    ...
    if (
          ...
          1 === g
            ? c && (be(e, h) || function (e, t, n) {
                ...
                for (
                  ...
                  if (
                    ge(e, !0, t), (d = e.input.charCodeAt(e.position)) === a
                  ) {
                    return e.position++,
                      e.tag = g,
                      e.anchor = m,
                  ...
                  h
                    ...
                    f = null,
                    l = c = !1,
                    63 === d && z(e.input.charCodeAt(e.position + 1)) &&
              ...
              : (l && function (e, t) {
                      ...
                      for (; 0 !== a;) {
                        ...
                        if (
                          !u && e.lineIndent > p && (p = e.lineIndent), J(a)
                        ) {
                          f++;
                        } else {
                          if (e.lineIndent < p) {
                ...
                ? function (e, t, n) {
                  ...
                  if (
                    z(u = e.input.charCodeAt(e.position)) || X(u) || 35 === u ||
                    38 === u || 42 === u || 33 === u || 124 === u || 62 === u ||
                    39 === u || 34 === u || 37 === u || 64 === u || 96 === u
                  ) {
                    return !1;
                  }
                  if (
                    (63 === u || 45 === u) &&
                    (z(i = e.input.charCodeAt(e.position + 1)) || n && X(i))
                  ) {
                    return !1;
                  }
                  for (
      ...
      f || ce(e, "unknown tag !<" + e.tag + ">"),
        null !== e.result && f.kind !== e.kind &&
        ce(
          e,
          "unacceptable node kind for !<" + e.tag + '> tag; it should be "' +
            f.kind + '", not "' + e.kind + '"',
        ),
  ...
  function ke(e) {
    ...
    ge(e, !0, -1),
      ...
      ge(e, !0, -1),
      e.checkLineBreaks && H.test(e.input.slice(o, e.position)) &&
  ...
  function Ce(e, t) {
    t = t || {},
      0 !== (e = String(e)).length &&
      (10 !== e.charCodeAt(e.length - 1) && 13 !== e.charCodeAt(e.length - 1) &&
        (e += "\n"),
        65279 === e.charCodeAt(0) && (e = e.slice(1)));
    var n = new ae(e, t), i = e.indexOf("\0");
    for (
      ...
      this.styleMap = function (e, t) {
        ...
        for (n = {}, r = 0, o = (i = Object.keys(t)).length; r < o; r += 1) {
          a = i[r],
            ...
            (c = e.compiledTypeMap.fallback[a]) && Se.call(c.styleAliases, l) &&
            (l = c.styleAliases[l]),
            n[a] = l;
        }
        return n;
  ...
  function Me(e, t) {
    for (
      var i, r = n.repeat(" ", t), o = 0, a = -1, l = "", c = e.length; o < c;
    ) {
      -1 === (a = e.indexOf("\n", o))
        ? (i = e.slice(o), o = c)
  ...
  function De(e) {
    return 32 <= e && e <= 126 ||
      ...
      57344 <= e && e <= 65533 && e !== Oe || 65536 <= e && e <= 1114111;
  }
  function Ue(e) {
  ...
  function qe(e, t, n) {
    ...
    return (n
        ...
        35 !== e && !(58 === t && !r) ||
      Ue(t) && !_e(t) && 35 === e || 58 === t && r;
  }
  function Ye(e, t) {
    var n, i = e.charCodeAt(t);
    return i >= 55296 && i <= 56319 && t + 1 < e.length &&
        (n = e.charCodeAt(t + 1)) >= 56320 && n <= 57343
  ...
  function Be(e, t, n, i, r, o, a, l) {
    var c,
      ...
      h = -1 !== i,
      g = -1,
      m = De(s = Ye(e, 0)) && s !== Oe && !_e(s) && 45 !== s && 63 !== s &&
        58 !== s && 44 !== s && 91 !== s && 93 !== s && 123 !== s &&
        125 !== s && 35 !== s && 38 !== s && 42 !== s && 33 !== s &&
        124 !== s && 61 !== s && 62 !== s && 39 !== s && 34 !== s && 37 !== s &&
        64 !== s && 96 !== s && function (e) {
        return !_e(e) && 58 !== e;
      }(Ye(e, e.length - 1));
    if (t || a) {
