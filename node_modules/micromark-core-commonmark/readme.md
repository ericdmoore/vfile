...
The core CommonMark constructs needed to tokenize markdown. Some of these can be
[turned off][disable], but they are often essential to markdown and weird things
might happen.
