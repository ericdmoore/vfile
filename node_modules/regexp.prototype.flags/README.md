...
An ES6 spec-compliant `RegExp.prototype.flags` shim. Invoke its "shim" method to
shim RegExp.prototype.flags if it is unavailable. _Note_: `RegExp#flags`
...
[spec](http://www.ecma-international.org/ecma-262/6.0/#sec-get-regexp.prototype.flags).
