...
[`remark-lint`][mono] rule to warn when initial or final dashes appear in file
names.
...
You can use this package to check that no initial or final dashes appear in file
names.
