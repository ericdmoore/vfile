...
exports
  .getContextPackagePath = getContextPackagePath;
exports
  .getFilePackagePath = getFilePackagePath;
exports
  .getFilePackageName = getFilePackageName;
...
function getFilePackageName(filePath) {
  ...
  if (pkg) {
    ...
    return pkg.name ||
      getFilePackageName((0, _path.dirname)((0, _path.dirname)(path)));
  }
  return null;
}
