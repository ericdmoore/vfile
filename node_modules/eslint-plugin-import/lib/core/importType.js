...
exports
  .isExternalModuleMain = isExternalModuleMain;
exports
  .isScoped = isScoped;
exports
  .isScopedMain = isScopedMain;
...
function isExternalPath(path, context) {
  ...
  if ((0, _path.relative)(packagePath, path).startsWith("..")) return true;
  var folders = settings && settings["import/external-module-folders"] ||
    ["node_modules"];
