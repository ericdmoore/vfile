  ...
  create: function () {
    function create(context) {
      ...
      var _ref = config || {},
        ...
        importFunctions = _ref$importFunctions === undefined
          ? []
          : _ref$importFunctions;
      var _ref2 = config || {},
        _ref2$webpackChunknam = _ref2.webpackChunknameFormat,
        webpackChunknameFormat = _ref2$webpackChunknam === undefined
          ? "[0-9a-zA-Z-_/.]+"
          : _ref2$webpackChunknam;

      var paddedCommentRegex = /^ (\S[\s\S]+\S) $/;
      var commentStyleRegex = /^( \w+: (["'][^"']*["']|\d+|false|true),?)+ $/;
      var chunkSubstrFormat = " webpackChunkName: [\"']" +
        String(webpackChunknameFormat) + "[\"'],? ";
      ...
      function run(node, arg) {
        ...
        try {
          for (
            var _iterator = leadingComments[Symbol.iterator](), _step;
            ...
            try {
              ...
              _vm2["default"].runInNewContext(
                "(function() {return {" + String(comment.value) + "}})()",
              );
            } catch (error) {
              context.report({
                node: node,
            ...
            if (!commentStyleRegex.test(comment.value)) {
              context.report({
                node: node,
                message:
                  "dynamic imports require a leading comment in the form /*" +
                  chunkSubstrFormat + "*/",
              });
