  ...
  create: function () {
    function create(context) {
      ...
      function isResolvableWithoutExtension(file) {
        ...
        return resolvedFileWithoutExtension ===
          (0, _resolve2["default"])(file, context);
      }
      ...
      function checkFileExtension(source, node) {
        ...
        var extension = _path2["default"].extname(resolvedPath || importPath)
          .substring(1);
        ...
        if (!extension || !importPath.endsWith("." + String(extension))) {
          ...
          if (extensionRequired && !extensionForbidden) {
            context.report({
              ...
              ) + 'for "' + String(importPathWithQueryString) + '"',
            });
          }
        } else if (extension) {
          if (
            ...
            context.report({
              node: source,
              message: 'Unexpected use of file extension "' +
                String(extension) + '" for "' +
                String(importPathWithQueryString) + '"',
            });
          }
        }
      }
