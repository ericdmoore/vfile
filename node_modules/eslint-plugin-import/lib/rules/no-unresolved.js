  ...
  create: function () {
    function create(context) {
      ...
      function checkSourceValue(source, node) {
        ...
        var caseSensitive = !_resolve.CASE_SENSITIVE_FS &&
          options.caseSensitive !== false;
        var caseSensitiveStrict = !_resolve.CASE_SENSITIVE_FS &&
          options.caseSensitiveStrict;
        ...
        if (resolvedPath === undefined) {
          ...
          var cacheSettings = _ModuleCache2["default"].getSettings(
            context.settings,
          );
          if (
            !(0, _resolve.fileExistsWithCaseSync)(
              resolvedPath,
              cacheSettings,
              caseSensitiveStrict,
            )
