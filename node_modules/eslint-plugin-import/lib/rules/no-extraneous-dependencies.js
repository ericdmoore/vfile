...
function hasKeys() {
  var obj = arguments.length > 0 && arguments[0] !== undefined
    ? arguments[0]
    : {};
...
function checkDependencyDeclaration(deps, packageName, declarationStatus) {
  ...
  return packageHierarchy.reduce(function (result, ancestorName) {
    return {
      isInDeps: result.isInDeps ||
        deps.dependencies[ancestorName] !== undefined,
      isInDevDeps: result.isInDevDeps ||
        deps.devDependencies[ancestorName] !== undefined,
  ...
  return config.some(function (c) {
    return (
      ...
      (0, _minimatch2["default"])(
        filename,
        _path2["default"].join(process.cwd(), c),
      )
    );
  });
}
  ...
  create: function () {
    function create(context) {
      ...
      var filename = context.getPhysicalFilename
        ? context.getPhysicalFilename()
        : context.getFilename();
      var deps = getDependencies(context, options.packageDir) ||
        extractDepFields({});
