  ...
  create: function () {
    function noReachingInside(context) {
      ...
      function isAllowViolation(importPath) {
        ...
        if (
          reachingAllowed(justSteps) || reachingAllowed("/" + String(justSteps))
        ) {
          return false;
        }
      ...
      function isForbidViolation(importPath) {
        ...
        if (
          ...
          reachingForbidden("/" + String(justSteps))
        ) {
          return true;
        }
      ...
      var isReachViolation = options.forbid
        ? isForbidViolation
        : isAllowViolation;

      function checkImportForReaching(importPath, node) {
        var potentialViolationTypes = [
          "parent",
          "index",
          "sibling",
          "external",
