  ...
  try {
    ...
    try {
      ...
      var _require3 = require("eslint/lib/util/glob-utils"),
        originalListFilesToProcess = _require3.listFilesToProcess;
...
if (FileEnumerator) {
  listFilesToProcess = function listFilesToProcess(src, extensions) {
    ...
    return Array.from(e.iterateFiles(src), function (_ref) {
      var filePath = _ref.filePath, ignored = _ref.ignored;
      return {
        ignored: ignored,
        filename: filePath,
      };
 ...
 */
var prepareImportsAndExports = function prepareImportsAndExports(
  srcFiles,
  context,
) {
    ...
    if (currentExports) {
      ...
      reexports.forEach(function (value, key) {
        ...
        if (typeof localImport !== "undefined") {
          localImport = new Set(
            [].concat(_toConsumableArray(localImport), [currentValue]),
          );
        } else {
...
var doPreparation = function doPreparation(src, ignoreExports, context) {
  var prepareKey = JSON.stringify({
    ...
    extensions: Array.from((0, _ignore.getFileExtensions)(context.settings))
      .sort(),
  });
...
var newNamespaceImportExists = function newNamespaceImportExists(specifiers) {
  return (
    specifiers.some(function (_ref7) {
      var type = _ref7.type;
...
var newDefaultImportExists = function newDefaultImportExists(specifiers) {
  return (
    specifiers.some(function (_ref8) {
      var type = _ref8.type;
...
var fileIsInPkg = function fileIsInPkg(file) {
  var _readPkgUp = (0, _readPkgUp3["default"])({ cwd: file }),
  ...
  var checkPkgFieldObject = function checkPkgFieldObject(pkgField) {
    var pkgFieldFiles = (0, _object2["default"])(pkgField).map(
      function (value) {
  ...
  var checkPkgField = function checkPkgField(pkgField) {
    ...
    if (
      (typeof pkgField === "undefined" ? "undefined" : _typeof(pkgField)) ===
        "object"
    ) {
  ...
  create: function () {
    function create(context) {
      var _ref9 = context.options[0] || {},
        ...
        ignoreExports = _ref9$ignoreExports === undefined
          ? []
          : _ref9$ignoreExports,
      ...
      var file = context.getPhysicalFilename
      ...
      var checkUsage = function () {
        function checkUsage(node, exportedValue) {
          ...
          var exportsKey = exportedValue === DEFAULT
            ? IMPORT_DEFAULT_SPECIFIER
            : exportedValue;

          var exportStatement = exports.get(exportsKey);

          var value = exportsKey === IMPORT_DEFAULT_SPECIFIER
            ? DEFAULT
            : exportsKey;
        ...
        function updateImportUsage(node) {
          ...
          node.body.forEach(function (astNode) {
            ...
            if (astNode.type === EXPORT_NAMED_DECLARATION) {
              if (astNode.source) {
                resolvedPath = (0, _resolve2["default"])(
