      ...
      return {
        "ExportDefaultDeclaration": function () {
          function ExportDefaultDeclaration(node) {
            return addNamed("default", node, getParent(node));
          }
        ...
        "ExportNamedDeclaration": function () {
          function ExportNamedDeclaration(node) {
            ...
            if (node.declaration.declarations != null) {
              ...
              try {
                for (
                  var _iterator = node.declaration.declarations
                      [Symbol.iterator](),
                    _step;
        ...
        "ExportAllDeclaration": function () {
          function ExportAllDeclaration(node) {
            ...
            var remoteExports = _ExportMap2["default"].get(
              node.source.value,
              context,
            );
        ...
        "Program:exit": function () {
          function ProgramExit() {
            ...
            try {
              for (
                var _iterator2 = namespace[Symbol.iterator](), _step2;
                ...
                try {
                  for (
                    var _iterator3 = named[Symbol.iterator](), _step3;
                    ...
                    try {
                      for (
                        var _iterator4 = nodes[Symbol.iterator](), _step4;
                        !(_iteratorNormalCompletion4 =
                          (_step4 = _iterator4.next()).done);
                      ...
                      try {
                        if (
                          !_iteratorNormalCompletion4 && _iterator4["return"]
                        ) {
                          _iterator4["return"]();
                        }
                      } finally {
