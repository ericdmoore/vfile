  ...
  create: function () {
    function create(context) {
      ...
      function captureDeclaration(identifierOrPattern) {
        if (
          identifierOrPattern && identifierOrPattern.type === "ObjectPattern"
        ) {
          // recursively capture
          ...
          identifierOrPattern && identifierOrPattern.type === "ArrayPattern"
        ) {
      ...
      return {
        ...
        "Program:exit": function () {
          function ProgramExit() {
            if (
              specifierExportCount === 1 && !hasDefaultExport &&
              !hasStarExport && !hasTypeExport
            ) {
