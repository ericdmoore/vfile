...
var log = (0, _debug2["default"])(
  "eslint-plugin-import:rules:newline-after-import",
);
...
function isClassWithDecorator(node) {
  return node.type === "ClassDeclaration" && node.decorators &&
  ...
  create: function () {
    function create(context) {
      ...
      function checkForNewLine(node, nextNode, type) {
        ...
        if (lineDifference < EXPECTED_LINE_DIFFERENCE) {
          ...
          context.report({
            ...
            message: "Expected " + String(options.count) + " empty line" +
              (options.count > 1 ? "s" : "") + " after " + String(
                type,
              ) + " statement not followed by another " + String(type) + ".",
            fix: function () {
              function fix(fixer) {
      ...
      function checkImport(node) {
        ...
        if (
          nextNode && nextNode.type !== "ImportDeclaration" &&
