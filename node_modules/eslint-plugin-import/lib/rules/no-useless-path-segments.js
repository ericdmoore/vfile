...
module.exports = {
  ...
  create: function () {
    function create(context) {
      var currentDir = _path2["default"].dirname(
      ...
      function checkSourceValue(source) {
        ...
        function reportWithProposedPath(proposedPath) {
          context.report({
            ...
            message: 'Useless path segments for "' + String(importPath) +
              '", should be "' + String(proposedPath) + '"',
            fix: function () {
              function fix(fixer) {
                return proposedPath &&
        ...
        var regexUnnecessaryIndex = new RegExp(
          ".*\\/index(\\" + String(
        ...
        if (
          options && options.noUselessIndex &&
          ...
          if (parentDirectory !== "." && parentDirectory !== "..") {
            ...
            try {
              for (
                var _iterator = fileExtensions[Symbol.iterator](), _step;
                ...
                if (
                  (0, _resolve2["default"])(
                    "" + String(parentDirectory) + String(fileExtension),
                    context,
                  )
                ) {
        ...
        var countImportPathRelativeParents = countRelativeParents(
          importPathSplit,
        );
        var countExpectedRelativeParents = countRelativeParents(expectedSplit);
        var diff = countImportPathRelativeParents -
          countExpectedRelativeParents;
