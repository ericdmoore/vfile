            ...
            body.forEach(function (node, index) {
              ...
              if (
                ...
                if (nonImportCount > 0) {
                  ...
                  try {
                    for (
                      var _iterator = context.getDeclaredVariables(node)
                          [Symbol.iterator](),
                        _step;
                      ...
                      if (references.length) {
                        ...
                        try {
                          for (
                            var _iterator2 = references[Symbol.iterator](),
                              _step2;
            ...
            errorInfos.forEach(function (errorInfo, index) {
              ...
              if (index < lastSortNodesIndex) {
                ...
                infos.fix = function (fixer) {
                  ...
                  if (!lastLegalImp) {
                    insertSourceCode = insertSourceCode.trim() +
                      insertSourceCode.match(/^(\s+)/)[0];
                  }
