  ...
  create: function () {
    function noRelativePackages(context) {
      ...
      function checkSourceValue(sourceNode) {
        ...
        var relDepPath = (0, _path.relative)(
          (0, _path.dirname)(myPath),
          absDepPath,
        );
        ...
        if ((0, _importType2["default"])(relDepPath, context) === "parent") {
          context.report({
            ...
            message:
              ...
              ("(dependency injection), move `" + String(
                (0, _path.basename)(myPath),
              ) + "` to same ") + ("directory as `" + String(
                depPath,
              ) + "` or consider making `" + String(depPath) + "` a package."),
          });
        }
      }
