    ...
    function create(context) {
      function checkDeclaration(node) {
        ...
        if (kind === "var" || kind === "let") {
          context.report(
            node,
            "Exporting mutable '" + String(kind) +
              "' binding, use 'const' instead.",
          );
        }
      }
        ...
        try {
          for (
            ...
            if (variable.name === name) {
              ...
              try {
                for (
                  var _iterator2 = variable.defs[Symbol.iterator](), _step2;
      ...
      function handleExportNamed(node) {
        ...
        if (node.declaration) {
          ...
          try {
            for (
              var _iterator3 = node.specifiers[Symbol.iterator](), _step3;
