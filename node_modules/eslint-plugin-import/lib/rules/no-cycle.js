...
module.exports = {
  ...
  create: function () {
    function create(context) {
      var myPath = context.getPhysicalFilename
        ? context.getPhysicalFilename()
        : context.getFilename();
      if (myPath === "<text>") return {}; // can't cycle-check a non-file

      var options = context.options[0] || {};
      var maxDepth = typeof options.maxDepth === "number"
        ? options.maxDepth
        : Infinity;
      ...
      function checkSourceValue(sourceNode, importer) {
        ...
        function detectCycle(_ref2) {
          ...
          try {
            for (
              var _iterator = m.imports[Symbol.iterator](), _step;
              ...
              var toTraverse = [].concat(_toConsumableArray(declarations))
              ...
              if (route.length + 1 < maxDepth) {
                ...
                try {
                  for (
                    var _iterator2 = toTraverse[Symbol.iterator](), _step2;
        ...
        while (untraversed.length > 0) {
          ...
          if (detectCycle(next)) {
            var message = next.route.length > 0
              ? "Dependency cycle via " + String(
