...
var countDependencies = function countDependencies(
  dependencies,
  lastNode,
  context,
) {
  ...
  if (dependencies.size > max) {
    context.report(
      lastNode,
      "Maximum number of dependencies (" + String(max) + ") exceeded.",
    );
  }
};
  ...
  create: function () {
    function create(context) {
      var _ref2 = context.options[0] || {},
        ...
        ignoreTypeImports = _ref2$ignoreTypeImpor === undefined
          ? DEFAULT_IGNORE_TYPE_IMPORTS
          : _ref2$ignoreTypeImpor;
