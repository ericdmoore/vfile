  ...
  return {
    ...
    AssignmentExpression: function () {
      function AssignmentExpression(node) {
        ...
        if (
          chain[0] === "module" && chain[1] === "exports" && chain.length <= 3
        ) {
    ...
    "Program:exit": function () {
      function onExit() {
        ...
        (0, _arrayPrototype2["default"])(
          (0, _object2["default"])(nodes.modules.sources)
            .filter(function (nodesWithSource) {
              return Array.isArray(nodesWithSource) &&
                nodesWithSource.length > 1;
            }),
        )
        ...
        (0, _arrayPrototype2["default"])(
          (0, _object2["default"])(nodes.types.sources)
            .filter(function (nodesWithSource) {
              return Array.isArray(nodesWithSource) &&
                nodesWithSource.length > 1;
            }),
