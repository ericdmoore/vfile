  ...
  create: function () {
    function namespaceRule(context) {
      ...
      var _ref = context.options[0] || {},
        ...
        allowComputed = _ref$allowComputed === undefined
          ? false
          : _ref$allowComputed;
      ...
      function makeMessage(last, namepath) {
        return "'" + String(last.name) + "' not found in " +
          (namepath.length > 1 ? "deeply " : "") + "imported namespace '" +
          String(namepath.join(".")) + "'.";
      }
      ...
      return {
        ...
        Program: function () {
          function Program(_ref2) {
            ...
            function processBodyStatement(declaration) {
              ...
              var imports = _ExportMap2["default"].get(
              ...
              try {
                for (
                  var _iterator = declaration.specifiers[Symbol.iterator](),
                    _step;
        ...
        VariableDeclarator: function () {
          function VariableDeclarator(_ref3) {
            ...
            if (
              (0, _declaredScope2["default"])(context, init.name) !== "module"
            ) {
              return;
            }
            ...
            function testKey(pattern, namespace) {
              ...
              try {
                for (
                  var _iterator2 = pattern.properties[Symbol.iterator](),
                    _step2;
