...
SublimeLinter-eslint introduced a change to support `.eslintignore` files which
...
I also found that I needed to set `rc_search_limit` to `null`, which removes the
