...
(function () {
  ...
  function isAllowedName(title) {
    return isNameParameterRequired(title) || title === "const" ||
      title === "constant";
  }
  ...
  function isAllowedType(title) {
    return isTypeParameterRequired(title) || title === "throws" ||
      title === "const" || title === "constant" ||
      title === "namespace" || title === "member" || title === "var" ||
      title === "module" ||
      title === "constructor" || title === "class" || title === "extends" ||
      title === "augments" ||
  ...
  function convertUnwrappedCommentIndex(originalSource, unwrappedIndex) {
    ...
    while ((match = matcher.exec(replacedSource))) {
      ...
      if (match.index + match[0].length > unwrappedIndex + numSkippedChars) {
        return unwrappedIndex + numSkippedChars + originalSource.length -
  ...
  (function (exports) {
    ...
    TagParser.prototype.parseName = function () {
      ...
      if (isAllowedName(this._title)) {
        ...
        if (!this._tag.name) {
          ...
          // fixed at the end
          if (
            isParamTitle(this._title) && this._tag.type && this._tag.type.name
          ) {
    ...
    TagParser.prototype.parseCaption = function parseDescription() {
      ...
      if (captionStart >= 0 && captionEnd >= 0) {
        ...
        this._tag.description = description.substring(
          captionEnd + captionEndTag.length,
        ).trim();
      } else {
        this._tag.description = description;
      }
    ...
    TagParser.prototype.parseThis = function parseThis() {
      ...
      if (value && value.charAt(0) === "{") {
        ...
        if (
          gotType && this._tag.type.type === "NameExpression" ||
    ...
    TagParser.prototype.epilogue = function epilogue() {
      ...
      if (
        isAllowedOptional(this._title) && !this._tag.type && description &&
