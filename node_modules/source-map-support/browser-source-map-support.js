...
(this.define || function (R, U) {
  ...
  (function e(C, J, A) {
    ...
    for (
      var t = "function" == typeof require && require, m = 0; m < A.length; m++
    ) {
      p(A[m]);
    }
    return p;
  })(
    {
      ...
      2: [function (C, J, A) {
        (function (e) {
          ...
          e.toByteArray = function (m) {
            ...
            var k = 0;
            for (c = 0; c < r; c += 4) {
              var u = p(m.charAt(c)) << 18 | p(m.charAt(c + 1)) << 12 |
                p(m.charAt(c + 2)) << 6 | p(m.charAt(c + 3));
              f((u & 16711680) >> 16);
              f((u & 65280) >> 8);
              f(u & 255);
            }
            2 === l
              ? (u = p(m.charAt(c)) << 2 | p(m.charAt(c + 1)) >> 4, f(u & 255))
              : 1 === l &&
                (u = p(m.charAt(c)) << 10 | p(m.charAt(c + 1)) << 4 |
                  p(m.charAt(c + 2)) >> 2,
                  f(u >> 8 & 255),
                  f(u & 255));
            return q;
      ...
      4: [function (C, J, A) {
        (function (e) {
          var p = Object.prototype.toString,
            t = "function" === typeof e.alloc &&
              "function" === typeof e.allocUnsafe && "function" ===
                typeof e.from;
      ...
      5: [function (C, J, A) {
        ...
        function f(a, b, h, w) {
          ...
          for (var y = 0, I = Math.min(a.length - h, 2); y < I; y++) {
            a[h + y] = (b & 255 << 8 * (w ? y : 1 - y)) >>> 8 * (w ? y : 1 - y);
          }
        }
        function c(a, b, h, w) {
        ...
        function k(a) {
          for (var b = [], h = 0; h < a.length; h++) {
            ...
            if (127 >= w) b.push(w);
              ...
              var y = h;
              55296 <= w && 57343 >= w && h++;
              w = encodeURIComponent(a.slice(y, h + 1)).substr(1).split("%");
        ...
        var n = C("base64-js"), v = C("ieee754"), z = C("is-array");
        A.Buffer = e;
        A.SlowBuffer = e;
        ...
        e.concat = function (a, b) {
          ...
          var h;
          if (void 0 === b) for (h = b = 0; h < a.length; h++) b += a[h].length;
          var w = new e(b), y = 0;
        ...
        e.prototype.readInt32BE = function (a, b) {
          b || t(a, 4, this.length);
          return this[a] << 24 | this[a + 1] << 16 | this[a + 2] << 8 |
            this[a + 3];
        };
        ...
        e.prototype.writeInt16LE = function (a, b, h) {
          ...
          e.TYPED_ARRAY_SUPPORT ? (this[b] = a, this[b + 1] = a >>> 8)
          : f(this, a, b, !0);
          return b + 2;
        };
        e.prototype.writeInt16BE = function (a, b, h) {
          ...
          b >>>= 0;
          h || m(this, a, b, 2, 32767, -32768);
          e.TYPED_ARRAY_SUPPORT ? (this[b] = a >>> 8, this[b + 1] = a)
          : f(this, a, b, !1);
          return b + 2;
        };
        ...
        e.prototype.copy = function (a, b, h, w) {
          ...
          if (w !== h && 0 !== a.length && 0 !== this.length) {
            ...
            if (0 > b || b >= a.length) {throw new TypeError(
                "targetStart out of bounds",
              );}
            if (0 > h || h >= this.length) {throw new TypeError(
                "sourceStart out of bounds",
              );}
            if (0 > w || w > this.length) {throw new TypeError(
                "sourceEnd out of bounds",
              );}
            w > this.length && (w = this.length);
            a.length - b < w - h && (w = a.length - b + h);
            w -= h;
            if (1E3 > w || !e.TYPED_ARRAY_SUPPORT) {for (
                var y = 0; y < w; y++
              ) {
                a[y + b] = this[y + h];
      ...
      6: [function (C, J, A) {
        ...
        A.write = function (e, p, t, m, f, c) {
          ...
          c = m ? 0 : c - 1;
          var d = m ? 1 : -1, g = 0 > p || 0 === p && 0 > 1 / p ? 1 : 0;
          p = Math.abs(p);
          isNaN(p) || Infinity === p
            ? (p = isNaN(p) ? 1 : 0, m = r)
      ...
      7: [function (C, J, A) {
        ...
        J.exports = Array.isArray || function (p) {
      ...
      8: [function (C, J, A) {
        (function (e) {
          ...
          A.resolve = function () {
            for (
              var c = "", l = !1, q = arguments.length - 1; -1 <= q && !l; q--
            ) {
      ...
      10: [function (C, J, A) {
        ...
        e.fromArray = function (f, c) {
          for (var l = new e(), q = 0, r = f.length; q < r; q++) l.add(f[q], c);
          return l;
        };
      ...
      11: [function (C, J, A) {
        var e = C("./base64");
        A.encode = function (p) {
          var t = "", m = 0 > p ? (-p << 1) + 1 : p << 1;
          do p = m & 31, m >>>= 5, 0 < m && (p |= 32), t += e.encode(p); while (
            0 < m
          );
          return t;
        };
        A.decode = function (p, t, m) {
          var f = p.length, c = 0, l = 0;
          do {
            if (t >= f) {
      ...
      12: [function (C, J, A) {
        ...
        A.decode = function (p) {
          return 65 <= p && 90 >= p ? p - 65 : 97 <= p && 122 >= p
            ? p - 97 + 26
            : 48 <= p && 57 >= p
            ? p - 48 + 52
            : 43 == p
      ...
      13: [function (C, J, A) {
        function e(p, t, m, f, c, l) {
          var q = Math.floor((t - p) / 2) + p, r = c(m, f[q], !0);
          return 0 === r
            ? q
            : 0 < r
            ? 1 < t - q
      ...
      16: [function (C, J, A) {
        ...
        function p(k, u) {
          ...
          z && (z = f.normalize(z));
          n = n.map(String).map(f.normalize).map(function (L) {
        ...
        function t() {
          ...
          this.name = this.originalColumn = this.originalLine = this.source =
            null;
        }
        function m(k, u) {
          var d = k;
          ...
          this._sections = d.map(function (v) {
            ...
            n = z;
            return {
              generatedOffset: { generatedLine: G + 1, generatedColumn: D + 1 },
        ...
        Object.defineProperty(p.prototype, "sources", {
          get: function () {
            return this._sources.toArray().map(function (k) {
              return f.computeSourceURL(this.sourceRoot, k, this._sourceMapURL);
            }, this);
          },
        });
          ...
          if (
            ...
            null !== u &&
              (u = this._sources.at(u),
                u = f.computeSourceURL(this.sourceRoot, u, this._sourceMapURL));
        ...
        Object.defineProperty(m.prototype, "sources", {
          get: function () {
            for (var k = [], u = 0; u < this._sections.length; u++) {
              for (
                var d = 0; d < this._sections[u].consumer.sources.length; d++
              ) {
        ...
        m.prototype.generatedPositionFor = function (k) {
          for (var u = 0; u < this._sections.length; u++) {
            ...
            if (
              -1 !==
                d.consumer.sources.indexOf(f.getArg(k, "source"))
            ) {
              var g = d.consumer.generatedPositionFor(k);
              if (g) {
                return {
                  line: g.line + (d.generatedOffset.generatedLine - 1),
                  column: g.column + (d.generatedOffset.generatedLine === g.line
                    ? d.generatedOffset.generatedColumn - 1
                    : 0),
                };
              }
        ...
        m.prototype._parseMappings = function (k, u) {
          ...
          for (var d = 0; d < this._sections.length; d++) {
            for (
              ...
              var z = n[v], G = g.consumer._sources.at(z.source);
              ...
              z = {
                source: G,
                generatedLine: z.generatedLine +
                  (g.generatedOffset.generatedLine - 1),
                generatedColumn: z.generatedColumn +
      ...
      17: [function (C, J, A) {
        ...
        e.fromSourceMap = function (c) {
          var l = c.sourceRoot, q = new e({ file: c.file, sourceRoot: l });
          c.eachMapping(function (r) {
            ...
            null != r.source &&
              (k.source = r.source,
                ...
                k.original = { line: r.originalLine, column: r.originalColumn },
        ...
        e.prototype._validateMapping = function (c, l, q, r) {
          ...
          if (
            !(c && "line" in c && "column" in c && 0 < c.line &&
                0 <= c.column && !l && !q && !r ||
              c && "line" in c && "column" in c && l && "line" in l &&
                "column" in l && 0 < c.line && 0 <= c.column && 0 < l.line &&
                0 <= l.column &&
                q)
          ) {
            throw Error(
        ...
        e.prototype._serializeMappings = function () {
          for (
            ...
            if (n.generatedLine !== l) {
              ...
              if (!t.compareByGeneratedPositionsInflated(n, z[G - 1])) continue;
              g += ",";
            }
            ...
            null != n.source &&
              (v = this._sources.indexOf(n.source),
                ...
                q = n.originalColumn,
                null != n.name &&
                (n = this._names.indexOf(n.name), g += p.encode(n - k), k = n));
            d += g;
          }
          return d;
        };
          ...
          c.eachMapping(function (z) {
            if (null !== v) {
              if (g < z.generatedLine) q(v, d()), g++, n = 0;
                ...
                var G = k[u] || "", D = G.substr(0, z.generatedColumn - n);
        ...
        e.prototype.toStringWithSourceMap = function (f) {
          ...
          this.walk(function (v, z) {
            ...
            null !== z.source && null !== z.line && null !== z.column
              ? (u === z.source && d === z.line && g === z.column &&
                  n === z.name ||
                r.addMapping({
                  source: z.source,
      ...
      19: [function (C, J, A) {
        ...
        function q(d) {
          ...
          if (
            9 >
              g ||
            95 !== d.charCodeAt(g - 1) || 95 !== d.charCodeAt(g - 2) ||
            111 !== d.charCodeAt(g - 3) || 116 !== d.charCodeAt(g - 4) ||
            111 !== d.charCodeAt(g - 5) || 114 !== d.charCodeAt(g - 6) ||
            112 !== d.charCodeAt(g - 7) || 95 !== d.charCodeAt(g - 8) ||
            95 !== d.charCodeAt(g - 9)
          ) {
            return !1;
          }
      ...
      20: [function (C, J, A) {
        A.SourceMapGenerator =
          C("./lib/source-map-generator").SourceMapGenerator;
        ...
        (function (e) {
          ...
          function l() {
            ...
            if (this.isNative()) x = "native";
              ...
              null != B &&
                (x += ":" + B, (B = this.getColumnNumber()) && (x += ":" + B));
            }
            B = "";
            var F = this.getFunctionName(), E = !0, H = this.isConstructor();
            if (this.isToplevel() || H) {
              ...
              F
                ? (H && 0 != F.indexOf(H) && (B += H + "."),
                  B += F,
                  M && F.indexOf("." + M) != F.length - M.length - 1 &&
                  (B += " [as " + M + "]"))
                : B += H + "." + (M || "<anonymous>");
            }
            E && (B += " (" + x + ")");
          ...
          function k(x, B) {
            ...
            for (
              ...
              H.push("\n    at " + r(B[M], E)), E.nextPosition = E.curPosition;
            }
            ...
            e.emit = function (B) {
              if ("uncaughtException" === B) {
                ...
                if (F && !E) {
                  F = arguments[1];
                  E = u(F);
                  var H = "object" === typeof e && null !== e ? e.stderr
                  : void 0;
                  H && H._handle && H._handle.setBlocking &&
                    H._handle.setBlocking(!0);
                  E && (console.error(), console.error(E));
                  console.error(F.stack);
                  "object" === typeof e && null !== e &&
                    "function" === typeof e.exit && e.exit(1);
                  return;
                }
              }
            ...
            a: {
              if (p()) {
                try {
                  ...
                  B.open("GET", x, !1);
                  B.send(null);
                  var F = B.getResponseHeader("SourceMap") ||
          ...
          A.install = function (x) {
            ...
            if (
              x.environment &&
              (a = x.environment, -1 === ["node", "browser", "auto"].indexOf(a))
            ) {
              throw Error(
                "environment " + a +
            ...
            if (
              ...
              var B = J.require("module"), F = B.prototype._compile;
              F.__sourceMapSupport || (B.prototype._compile = function (E, H) {
                b[H] = E;
                h[H] = void 0;
            ...
            L ||
              (L = "emptyCacheBetweenOperations" in x
                ? x.emptyCacheBetweenOperations
                : !1);
            G || (G = !0, Error.prepareStackTrace = k);
            if (!D) {
              x = "handleUncaughtExceptions" in x ? x.handleUncaughtExceptions
              : !0;
              try {
                !1 === J.require("worker_threads").isMainThread && (x = !1);
              } catch (E) {}
              x && "object" === typeof e && null !== e &&
