  ...
  return function (t) {
    ...
    function e(t, i) {
      ...
      return i
        ? (t >>>= 0,
          (e = 0 <= t && t < 256) && (h = l[t])
            ? h
            : (n = r(t, (0 | t) < 0 ? -1 : 0, !0), e && (l[t] = n), n))
        : (t |= 0,
          (e = -128 <= t && t < 128) && (h = f[t])
            ? h
            : (n = r(t, t < 0 ? -1 : 0, !1), e && (f[t] = n), n));
    }
    function s(t, i) {
    ...
    function u(t, i) {
      return "number" == typeof t
        ...
        : "string" == typeof t
        ? o(t, i)
        : r(t.low, t.high, "boolean" == typeof i ? i : t.unsigned);
    }
    t.exports = n;
    var g = null;
    try {
    ...
    var d = 4294967296, c = d * d, w = c / 2, v = e(1 << 24), m = e(0);
    n.ZERO = m;
    var p = e(0, !0);
    n.UZERO = p;
    var y = e(1);
    ...
    B.toInt = function () {
      ...
      B.toString = function (t) {
        ...
        if (this.isNegative()) {
          if (this.eq(_)) {
            var i = s(t), n = this.div(i), h = n.mul(i).sub(this);
      ...
      B.equals = function (t) {
        return h(t) || (t = u(t)),
          (this.unsigned === t.unsigned || this.high >>> 31 != 1 ||
            t.high >>> 31 != 1) && (this.high === t.high && this.low === t.low);
      },
      B.eq = B.equals,
      ...
      B.divide = function (t) {
        ...
        if (g) {
          if (
            !this.unsigned && -2147483648 === this.high && -1 === t.low &&
            -1 === t.high
          ) {
            return this;
          }
        ...
        if (this.unsigned) {
          ...
          if (this.eq(_)) {
            ...
            return i = this.shr(1).div(t).shl(1),
              i.eq(m)
                ? t.isNegative() ? y : N
                : (n = this.sub(t.mul(i)), e = i.add(n.div(t)));
          }
          if (t.eq(_)) return this.unsigned ? p : m;
          if (this.isNegative()) {return t.isNegative()
              ? this.neg().div(t.neg()) : this.neg().div(t).neg();}
      ...
      B.and = function (t) {
        return h(t) || (t = u(t)),
          r(this.low & t.low, this.high & t.high, this.unsigned);
      },
      B.or = function (t) {
        return h(t) || (t = u(t)),
          r(this.low | t.low, this.high | t.high, this.unsigned);
