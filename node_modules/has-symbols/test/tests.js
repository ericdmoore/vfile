...
module.exports = function runSymbolTests(t) {
  ...
  t.equal(
    ...
    "function",
    "Object.getOwnPropertySymbols is a function",
  );
  ...
  t.equal(
    ...
    "[object Symbol]",
    "symbol primitive Object#toStrings properly",
  );
  t.equal(
  ...
  t.deepEqual(
    Object.keys(obj),
    [],
    "no enumerable own keys on symbol-valued object",
  );
  t.deepEqual(
    Object.getOwnPropertyNames(obj),
    [],
    "no own names on symbol-valued object",
  );
  t.deepEqual(
    Object.getOwnPropertySymbols(obj),
    [sym],
    "one own symbol on symbol-valued object",
  );
  t.equal(
