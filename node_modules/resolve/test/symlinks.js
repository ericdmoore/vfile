...
test("sync symlink when preserveSymlinks = true", function (t) {
  ...
  resolve(
    "foo",
    { basedir: symlinkDir, preserveSymlinks: true },
...
test(
  "sync symlink from node_modules to other dir when preserveSymlinks = false",
  function (t) {
...
test(
  "async symlink from node_modules to other dir when preserveSymlinks = false",
  function (t) {
    t.plan(2);
    var basedir = path.join(__dirname, "resolver", "symlinked", "_");
    resolve(
