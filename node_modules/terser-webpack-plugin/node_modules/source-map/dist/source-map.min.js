  ...
  return function (e) {
    ...
    t.prototype._version = 3,
      ...
      t.prototype._validateMapping = function (e, n, r, t) {
        ...
        if (
          (!(e && "line" in e && "column" in e && e.line > 0 &&
            e.column >= 0) || n || r || t) &&
          !(e && "line" in e && "column" in e && n && "line" in n &&
            "column" in n && e.line > 0 && e.column >= 0 && n.line > 0 &&
            n.column >= 0 && r)
        ) {
          throw new Error(
            "Invalid mapping: " +
              JSON.stringify({ generated: e, source: r, original: n, name: t }),
          );
        }
      },
        ...
        for (
          ...
          e += o.encode(n.generatedColumn - s),
            ...
            (t = this._sources.indexOf(n.source),
              ...
              u = n.originalColumn,
              null != n.name &&
              (r = this._names.indexOf(n.name), e += o.encode(r - c), c = r)),
            p += e;
        }
        return p;
      },
    ...
    n.encode = function (e) {
      var n, r = "", o = t(e);
      do n = o & u, o >>>= s, o > 0 && (n |= l), r += i.encode(n); while (
        o > 0
      );
      return r;
    },
    ...
    function i(e) {
      ...
      for (
        var s, a = n.isAbsolute(r), u = r.split(/\/+/), l = 0, c = u.length - 1;
        c >= 0;
        c--
      ) {
        s = u[c],
          "." === s
            ...
            ? l++
            : l > 0 &&
              ("" === s ? (u.splice(c + 1, l), l = 0) : (u.splice(c, 2), l--));
      }
      return r = u.join("/"),
        "" === r && (r = a ? "/" : "."),
        i ? (i.path = r, o(i)) : r;
    ...
    function g(e) {
      ...
      if (n < 9) return !1;
      if (
        95 !== e.charCodeAt(n - 1) || 95 !== e.charCodeAt(n - 2) ||
        111 !== e.charCodeAt(n - 3) || 116 !== e.charCodeAt(n - 4) ||
        111 !== e.charCodeAt(n - 5) || 114 !== e.charCodeAt(n - 6) ||
        112 !== e.charCodeAt(n - 7) || 95 !== e.charCodeAt(n - 8) ||
        95 !== e.charCodeAt(n - 9)
      ) {
        return !1;
      }
    ...
    function t(e, n) {
      var r = e;
      return "string" == typeof e && (r = a.parseSourceMapInput(e)),
    ...
    function o(e, n) {
      ...
      s && (s = a.normalize(s)),
        o = o.map(String).map(a.normalize).map(function (e) {
    ...
    function s(e, n) {
      var r = e;
      "string" == typeof e && (r = a.parseSourceMapInput(e));
      var o = a.getArg(r, "version"), i = a.getArg(r, "sections");
    ...
    t.fromSourceMap = function (e, n) {
      ...
      t.prototype.allGeneratedPositionsFor = function (e) {
        ...
        if (o >= 0) {
          ...
          if (void 0 === e.column) {
            for (
              var s = i.originalLine; i && i.originalLine === s;
            ) {
              t.push({
      ...
      Object.defineProperty(s.prototype, "sources", {
        get: function () {
          for (var e = [], n = 0; n < this._sections.length; n++) {
            for (
              var r = 0; r < this._sections[n].consumer.sources.length; r++
            ) {
          ...
          if (r.consumer._findSourceIndex(a.getArg(e, "source")) !== -1) {
            ...
            if (t) {
              var o = {
                ...
                column: t.column + (r.generatedOffset.generatedLine === t.line
      ...
      return n.eachMapping(function (e) {
        if (null !== h) {
          if (!(g < e.generatedLine)) {
            var n = u[l] || "", r = n.substr(0, e.generatedColumn - p);
            return u[l] = n.substr(e.generatedColumn - p),
              p = e.generatedColumn,
              o(h, r),
              void (h = e);
          }
        ...
        return this.walk(function (e, o) {
          n.code += e,
            null !== o.source && null !== o.line && null !== o.column
              ? (i === o.source && s === o.line && u === o.column &&
                  l === o.name ||
                r.addMapping({
                  source: o.source,
