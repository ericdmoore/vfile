...
exports.getNameOfRootNodeObject = (node) =>
  exports.getRootNode(node).object.name;

exports.isPropertyUnderContext = (node) =>
  exports.getRootNode(node).property.name === "context";

exports.isFunctionExpression = (node) =>
  node && functionExpressions.has(node.type);
...
exports.getTestModifier = (node, mod) =>
  getTestModifiers(node).find((property) => property.name === mod);
...
exports.executionMethods = new Set([
  ...assertionMethodNames,
  "end",
  "plan",
  "log",
  "teardown",
