...
const { getStaticValue, isOpeningParenToken, isCommaToken, findVariable } =
...
function sourceOfBinaryExpressionComponents(sourceCode, node) {
  ...
  const leftRange = [
    ...
    sourceCode.getTokenBefore(operatorToken, { includeComments: true })
      .range[1],
  ];
...
const create = (context) => {
  ...
  return ava.merge({
    CallExpression: visitIf([
      ...
      const firstNonSkipMember = util.getMembers(callee).find((name) =>
        name !== "skip"
      );
