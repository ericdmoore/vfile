...
const knownBooleanSignatures = [
  ...
  espurify(espree.parse(signature).body[0].expression.callee)
);
...
function matchesKnownBooleanExpression(argument) {
  ...
  return knownBooleanSignatures.some((signature) =>
    isDeepStrictEqual(callee, signature)
  );
}
  ...
  return ava.merge({
    CallExpression: visitIf([
      ...
      if (
        ...
        (node.callee.property.name === "truthy" ||
          node.callee.property.name === "falsy") &&
        ...
        if (
          ...
          ((argument.type === "BinaryExpression" &&
            booleanBinaryOperators.has(argument.operator)) ||
            (argument.type === "UnaryExpression" &&
              argument.operator === "!") ||
            (argument.type === "Literal" &&
              argument.value === Boolean(argument.value)) ||
