...
const create = (context) => {
  ...
  const checks = [
    {
      selector:
        'CallExpression[callee.object.name="test"][callee.property.name="before"]',
      name: "before",
    },
    {
      selector:
        'CallExpression[callee.object.name="test"][callee.property.name="after"]',
      name: "after",
    },
    {
      selector:
        'CallExpression[callee.object.object.name="test"][callee.object.property.name="after"][callee.property.name="always"]',
      name: "after.always",
    },
    {
      selector:
        'CallExpression[callee.object.name="test"][callee.property.name="beforeEach"]',
      name: "beforeEach",
    },
    {
      selector:
        'CallExpression[callee.object.name="test"][callee.property.name="afterEach"]',
      name: "afterEach",
    },
    {
      selector:
        'CallExpression[callee.object.object.name="test"][callee.object.property.name="afterEach"][callee.property.name="always"]',
