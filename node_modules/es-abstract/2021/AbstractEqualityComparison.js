...
module.exports = function AbstractEqualityComparison(x, y) {
  ...
  if (
    (xType === "String" || xType === "Number" || xType === "BigInt" ||
      xType === "Symbol") && yType === "Object"
  ) {
    return AbstractEqualityComparison(x, ToPrimitive(y));
  }
  if (
    xType === "Object" &&
    (yType === "String" || yType === "Number" || yType === "BigInt" ||
      yType === "Symbol")
  ) {
    return AbstractEqualityComparison(ToPrimitive(x), y);
  }
  if (
    (xType === "BigInt" && yType === "Number") ||
    (xType === "Number" && yType === "BigInt")
  ) {
    if (
      isNaN(x) || isNaN(y) || x === Infinity || y === Infinity ||
