...
test("shimmed", function (t) {
  ...
  t.test(
    ...
    function (et) {
      et.equal(
        false,
        isEnumerable.call(String.prototype, "trim"),
        "String#trim is not enumerable",
      );
      et.end();
    },
  );
  ...
  t.test("bad string/this value", { skip: !supportsStrictMode }, function (st) {
    st["throws"](
      function () {
        return String.prototype.trim.call(undefined, "a");
      },
      TypeError,
    ...
    st["throws"](
      function () {
        return String.prototype.trim.call(null, "a");
      },
      TypeError,
