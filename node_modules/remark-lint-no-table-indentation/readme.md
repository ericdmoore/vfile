...
You can use this package to check that tables are not indented. Tables are a GFM
feature enabled with [`remark-gfm`](https://github.com/remarkjs/remark-gfm).
...
There is no specific handling of indented tables (or anything else) in markdown.
Hence, it’s recommended to not indent tables and to turn this rule on.

## Fix

[`remark-gfm`](https://github.com/remarkjs/remark-gfm) formats all tables
without indent.
