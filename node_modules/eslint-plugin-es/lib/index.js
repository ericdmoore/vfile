...
module.exports = {
  ...
  rules: {
    ...
    "no-malformed-template-literals": require(
      "./rules/no-malformed-template-literals",
    ),
    ...
    "no-object-getownpropertydescriptor": require(
      "./rules/no-object-getownpropertydescriptor",
    ),
    "no-object-getownpropertydescriptors": require(
      "./rules/no-object-getownpropertydescriptors",
    ),
    "no-object-getownpropertynames": require(
      "./rules/no-object-getownpropertynames",
    ),
    "no-object-getownpropertysymbols": require(
      "./rules/no-object-getownpropertysymbols",
    ),
    ...
    "no-object-preventextensions": require(
      "./rules/no-object-preventextensions",
    ),
    ...
    "no-regexp-lookbehind-assertions": require(
      "./rules/no-regexp-lookbehind-assertions",
    ),
    "no-regexp-named-capture-groups": require(
      "./rules/no-regexp-named-capture-groups",
    ),
    "no-regexp-s-flag": require("./rules/no-regexp-s-flag"),
    "no-regexp-u-flag": require("./rules/no-regexp-u-flag"),
    "no-regexp-unicode-property-escapes-2019": require(
      "./rules/no-regexp-unicode-property-escapes-2019",
    ),
    "no-regexp-unicode-property-escapes": require(
      "./rules/no-regexp-unicode-property-escapes",
    ),
    ...
    "no-trailing-function-commas": require(
      "./rules/no-trailing-function-commas",
    ),
    "no-typed-arrays": require("./rules/no-typed-arrays"),
    "no-unicode-codepoint-escapes": require(
      "./rules/no-unicode-codepoint-escapes",
    ),
