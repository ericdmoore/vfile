...
export declare function isAccessorDeclaration(
  node: ts.Node,
): node is ts.AccessorDeclaration;
export declare function isArrayBindingPattern(
  node: ts.Node,
): node is ts.ArrayBindingPattern;
export declare function isArrayLiteralExpression(
  node: ts.Node,
): node is ts.ArrayLiteralExpression;
export declare function isArrayTypeNode(
  node: ts.Node,
): node is ts.ArrayTypeNode;
export declare function isArrowFunction(
  node: ts.Node,
): node is ts.ArrowFunction;
export declare function isAsExpression(node: ts.Node): node is ts.AsExpression;
export declare function isAssertionExpression(
  node: ts.Node,
): node is ts.AssertionExpression;
export declare function isAwaitExpression(
  node: ts.Node,
): node is ts.AwaitExpression;
export declare function isBinaryExpression(
  node: ts.Node,
): node is ts.BinaryExpression;
export declare function isBindingElement(
  node: ts.Node,
): node is ts.BindingElement;
export declare function isBindingPattern(
  node: ts.Node,
): node is ts.BindingPattern;
...
export declare function isBooleanLiteral(
  node: ts.Node,
): node is ts.BooleanLiteral;
export declare function isBreakOrContinueStatement(
  node: ts.Node,
): node is ts.BreakOrContinueStatement;
export declare function isBreakStatement(
  node: ts.Node,
): node is ts.BreakStatement;
export declare function isCallExpression(
  node: ts.Node,
): node is ts.CallExpression;
export declare function isCallLikeExpression(
  node: ts.Node,
): node is ts.CallLikeExpression;
export declare function isCallSignatureDeclaration(
  node: ts.Node,
...
export declare function isCaseOrDefaultClause(
  node: ts.Node,
...
export declare function isClassExpression(
  node: ts.Node,
): node is ts.ClassExpression;
export declare function isClassLikeDeclaration(
  node: ts.Node,
): node is ts.ClassLikeDeclaration;
export declare function isCommaListExpression(
  node: ts.Node,
): node is ts.CommaListExpression;
export declare function isConditionalExpression(
  node: ts.Node,
): node is ts.ConditionalExpression;
export declare function isConditionalTypeNode(
  node: ts.Node,
): node is ts.ConditionalTypeNode;
export declare function isConstructorDeclaration(
  node: ts.Node,
): node is ts.ConstructorDeclaration;
export declare function isConstructorTypeNode(
  node: ts.Node,
): node is ts.ConstructorTypeNode;
export declare function isConstructSignatureDeclaration(
  node: ts.Node,
...
export declare function isExpressionWithTypeArguments(
  node: ts.Node,
): node is ts.ExpressionWithTypeArguments;
export declare function isExternalModuleReference(
  node: ts.Node,
): node is ts.ExternalModuleReference;
export declare function isForInStatement(
  node: ts.Node,
): node is ts.ForInStatement;
export declare function isForInOrOfStatement(
  node: ts.Node,
): node is ts.ForInOrOfStatement;
export declare function isForOfStatement(
  node: ts.Node,
): node is ts.ForOfStatement;
...
export declare function isFunctionTypeNode(
  node: ts.Node,
): node is ts.FunctionTypeNode;
export declare function isGetAccessorDeclaration(
  node: ts.Node,
...
export declare function isImportEqualsDeclaration(
  node: ts.Node,
): node is ts.ImportEqualsDeclaration;
export declare function isImportSpecifier(
  node: ts.Node,
): node is ts.ImportSpecifier;
export declare function isIndexedAccessTypeNode(
  node: ts.Node,
): node is ts.IndexedAccessTypeNode;
export declare function isIndexSignatureDeclaration(
  node: ts.Node,
): node is ts.IndexSignatureDeclaration;
export declare function isInferTypeNode(
  node: ts.Node,
): node is ts.InferTypeNode;
export declare function isInterfaceDeclaration(
  node: ts.Node,
): node is ts.InterfaceDeclaration;
export declare function isIntersectionTypeNode(
  node: ts.Node,
): node is ts.IntersectionTypeNode;
export declare function isIterationStatement(
  node: ts.Node,
...
export declare function isJsxAttributeLike(
  node: ts.Node,
): node is ts.JsxAttributeLike;
export declare function isJsxAttributes(
  node: ts.Node,
): node is ts.JsxAttributes;
...
export declare function isJsxExpression(
  node: ts.Node,
): node is ts.JsxExpression;
...
export declare function isJsxSelfClosingElement(
  node: ts.Node,
...
export declare function isLabeledStatement(
  node: ts.Node,
): node is ts.LabeledStatement;
export declare function isLiteralExpression(
  node: ts.Node,
): node is ts.LiteralExpression;
export declare function isLiteralTypeNode(
  node: ts.Node,
): node is ts.LiteralTypeNode;
export declare function isMappedTypeNode(
  node: ts.Node,
): node is ts.MappedTypeNode;
export declare function isMetaProperty(node: ts.Node): node is ts.MetaProperty;
export declare function isMethodDeclaration(
  node: ts.Node,
): node is ts.MethodDeclaration;
export declare function isMethodSignature(
  node: ts.Node,
): node is ts.MethodSignature;
...
export declare function isNamespaceDeclaration(
  node: ts.Node,
): node is ts.NamespaceDeclaration;
export declare function isNamespaceImport(
  node: ts.Node,
): node is ts.NamespaceImport;
export declare function isNamespaceExportDeclaration(
  node: ts.Node,
): node is ts.NamespaceExportDeclaration;
export declare function isNewExpression(
  node: ts.Node,
): node is ts.NewExpression;
export declare function isNonNullExpression(
  node: ts.Node,
): node is ts.NonNullExpression;
export declare function isNoSubstitutionTemplateLiteral(
  node: ts.Node,
...
export declare function isNumericLiteral(
  node: ts.Node,
): node is ts.NumericLiteral;
export declare function isNumericOrStringLikeLiteral(
  node: ts.Node,
): node is
  | ts.NumericLiteral
  | ts.StringLiteral
  | ts.NoSubstitutionTemplateLiteral;
export declare function isObjectBindingPattern(
  node: ts.Node,
): node is ts.ObjectBindingPattern;
export declare function isObjectLiteralExpression(
  node: ts.Node,
): node is ts.ObjectLiteralExpression;
export declare function isOmittedExpression(
  node: ts.Node,
): node is ts.OmittedExpression;
export declare function isParameterDeclaration(
  node: ts.Node,
): node is ts.ParameterDeclaration;
export declare function isParenthesizedExpression(
  node: ts.Node,
): node is ts.ParenthesizedExpression;
export declare function isParenthesizedTypeNode(
  node: ts.Node,
): node is ts.ParenthesizedTypeNode;
export declare function isPostfixUnaryExpression(
  node: ts.Node,
): node is ts.PostfixUnaryExpression;
export declare function isPrefixUnaryExpression(
  node: ts.Node,
): node is ts.PrefixUnaryExpression;
export declare function isPropertyAccessExpression(
  node: ts.Node,
): node is ts.PropertyAccessExpression;
export declare function isPropertyAssignment(
  node: ts.Node,
): node is ts.PropertyAssignment;
export declare function isPropertyDeclaration(
  node: ts.Node,
): node is ts.PropertyDeclaration;
export declare function isPropertySignature(
  node: ts.Node,
): node is ts.PropertySignature;
export declare function isQualifiedName(
  node: ts.Node,
): node is ts.QualifiedName;
export declare function isRegularExpressionLiteral(
  node: ts.Node,
): node is ts.RegularExpressionLiteral;
export declare function isReturnStatement(
  node: ts.Node,
): node is ts.ReturnStatement;
export declare function isSetAccessorDeclaration(
  node: ts.Node,
): node is ts.SetAccessorDeclaration;
export declare function isShorthandPropertyAssignment(
  node: ts.Node,
): node is ts.ShorthandPropertyAssignment;
export declare function isSignatureDeclaration(
  node: ts.Node,
): node is ts.SignatureDeclaration;
export declare function isSourceFile(node: ts.Node): node is ts.SourceFile;
export declare function isSpreadAssignment(
  node: ts.Node,
): node is ts.SpreadAssignment;
export declare function isSpreadElement(
  node: ts.Node,
): node is ts.SpreadElement;
export declare function isStringLiteral(
  node: ts.Node,
): node is ts.StringLiteral;
export declare function isSwitchStatement(
  node: ts.Node,
): node is ts.SwitchStatement;
...
export declare function isTemplateExpression(
  node: ts.Node,
): node is ts.TemplateExpression;
export declare function isTemplateLiteral(
  node: ts.Node,
): node is ts.TemplateLiteral;
export declare function isTextualLiteral(
  node: ts.Node,
): node is ts.StringLiteral | ts.NoSubstitutionTemplateLiteral;
export declare function isThrowStatement(
  node: ts.Node,
): node is ts.ThrowStatement;
export declare function isTryStatement(node: ts.Node): node is ts.TryStatement;
export declare function isTupleTypeNode(
  node: ts.Node,
): node is ts.TupleTypeNode;
export declare function isTypeAliasDeclaration(
  node: ts.Node,
): node is ts.TypeAliasDeclaration;
export declare function isTypeAssertion(
  node: ts.Node,
): node is ts.TypeAssertion;
export declare function isTypeLiteralNode(
  node: ts.Node,
): node is ts.TypeLiteralNode;
export declare function isTypeOfExpression(
  node: ts.Node,
): node is ts.TypeOfExpression;
export declare function isTypeOperatorNode(
  node: ts.Node,
): node is ts.TypeOperatorNode;
export declare function isTypeParameterDeclaration(
  node: ts.Node,
): node is ts.TypeParameterDeclaration;
export declare function isTypePredicateNode(
  node: ts.Node,
): node is ts.TypePredicateNode;
export declare function isTypeReferenceNode(
  node: ts.Node,
): node is ts.TypeReferenceNode;
export declare function isTypeQueryNode(
  node: ts.Node,
): node is ts.TypeQueryNode;
export declare function isUnionTypeNode(
  node: ts.Node,
): node is ts.UnionTypeNode;
export declare function isVariableDeclaration(
  node: ts.Node,
): node is ts.VariableDeclaration;
export declare function isVariableStatement(
  node: ts.Node,
): node is ts.VariableStatement;
export declare function isVariableDeclarationList(
  node: ts.Node,
): node is ts.VariableDeclarationList;
export declare function isVoidExpression(
  node: ts.Node,
): node is ts.VoidExpression;
export declare function isWhileStatement(
  node: ts.Node,
): node is ts.WhileStatement;
export declare function isWithStatement(
  node: ts.Node,
): node is ts.WithStatement;
