...
export declare function isConditionalType(
  type: ts.Type,
): type is ts.ConditionalType;
...
export declare function isIndexedAccessType(
  type: ts.Type,
): type is ts.IndexedAccessType;
export declare function isIndexedAccessype(type: ts.Type): type is ts.IndexType;
export declare function isInstantiableType(
  type: ts.Type,
): type is ts.InstantiableType;
export declare function isInterfaceType(
  type: ts.Type,
): type is ts.InterfaceType;
export declare function isIntersectionType(
  type: ts.Type,
): type is ts.IntersectionType;
...
export declare function isSubstitutionType(
  type: ts.Type,
): type is ts.SubstitutionType;
export declare function isTypeParameter(
  type: ts.Type,
): type is ts.TypeParameter;
export declare function isTypeReference(
  type: ts.Type,
): type is ts.TypeReference;
export declare function isTypeVariable(
  type: ts.Type,
): type is ts.TypeParameter | ts.IndexedAccessType;
...
export declare function isUniqueESSymbolType(
  type: ts.Type,
