...
export declare function removeOptionalityFromType(
  checker: ts.TypeChecker,
  type: ts.Type,
): ts.Type;
export declare function removeOptionalChainingUndefinedMarkerType(
  checker: ts.TypeChecker,
  type: ts.Type,
): ts.Type;
export declare function isOptionalChainingUndefinedMarkerType(
  checker: ts.TypeChecker,
  t: ts.Type,
): boolean;
export declare function isTypeAssignableToNumber(
  checker: ts.TypeChecker,
  type: ts.Type,
): boolean;
export declare function isTypeAssignableToString(
  checker: ts.TypeChecker,
  type: ts.Type,
): boolean;
export declare function getCallSignaturesOfType(
  type: ts.Type,
...
export declare function someTypePart(
  type: ts.Type,
...
export declare function isThenableType(
  checker: ts.TypeChecker,
  node: ts.Node,
  type: ts.Type,
): boolean;
...
export declare function isBooleanLiteralType(
  type: ts.Type,
  literal: boolean,
): boolean;
export declare function getPropertyOfType(
  type: ts.Type,
  name: ts.__String,
): ts.Symbol | undefined;
export declare function getWellKnownSymbolPropertyOfType(
  type: ts.Type,
  wellKnownSymbolName: string,
  checker: ts.TypeChecker,
): ts.Symbol | undefined;
/** Determines if writing to a certain property of a given type is allowed. */
export declare function isPropertyReadonlyInType(
  type: ts.Type,
  name: ts.__String,
  checker: ts.TypeChecker,
): boolean;
export declare function symbolHasReadonlyDeclaration(
  symbol: ts.Symbol,
  checker: ts.TypeChecker,
): boolean;
/** Returns the the literal name or unique symbol name from a given type. Doesn't unwrap union types. */
export declare function getPropertyNameFromType(
  type: ts.Type,
): PropertyName | undefined;
export declare function getSymbolOfClassLikeDeclaration(
  node: ts.ClassLikeDeclaration,
  checker: ts.TypeChecker,
): ts.Symbol;
export declare function getConstructorTypeOfClassLikeDeclaration(
  node: ts.ClassLikeDeclaration,
  checker: ts.TypeChecker,
): ts.Type;
export declare function getInstanceTypeOfClassLikeDeclaration(
  node: ts.ClassLikeDeclaration,
  checker: ts.TypeChecker,
): ts.Type;
export declare function getIteratorYieldResultFromIteratorResult(
  type: ts.Type,
  node: ts.Node,
  checker: ts.TypeChecker,
): ts.Type;
/** Lookup the declaration of a class member in the super class. */
export declare function getBaseClassMemberOfClassElement(
