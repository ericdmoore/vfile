...
export declare function endsControlFlow(
  statement: ts.Statement | ts.BlockLike,
  checker?: ts.TypeChecker,
): boolean;
export declare type ControlFlowStatement =
  | ts.BreakStatement
...
export declare function getControlFlowEnd(
  statement: ts.Statement | ts.BlockLike,
  checker?: ts.TypeChecker,
): ControlFlowEnd;
 ...
 */
export declare function callExpressionAffectsControlFlow(
