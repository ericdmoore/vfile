...
export declare function getChildOfKind<T extends ts.SyntaxKind>(
  node: ts.Node,
  kind: T,
...
export declare function isThisParameter(
  parameter: ts.ParameterDeclaration,
): boolean;
export declare function getModifier(
  node: ts.Node,
  kind: ts.Modifier["kind"],
): ts.Modifier | undefined;
export declare function hasModifier(
  modifiers: ts.ModifiersArray | undefined,
  ...kinds: Array<ts.Modifier["kind"]>
): boolean;
export declare function isParameterProperty(
...
export declare const isTypeFlagSet: (
  type: ts.Type,
  flag: ts.TypeFlags,
) => boolean;
export declare const isSymbolFlagSet: (
  symbol: ts.Symbol,
  flag: ts.SymbolFlags,
) => boolean;
export declare function isObjectFlagSet(
  objectType: ts.ObjectType,
  flag: ts.ObjectFlags,
): boolean;
export declare function isModifierFlagSet(
  node: ts.Node,
  flag: ts.ModifierFlags,
): boolean;
export declare function getPreviousStatement(
  statement: ts.Statement,
): ts.Statement | undefined;
export declare function getNextStatement(
  statement: ts.Statement,
): ts.Statement | undefined;
/** Returns the token before the start of `node` or `undefined` if there is none. */
export declare function getPreviousToken(
  node: ts.Node,
  sourceFile?: ts.SourceFile,
): ts.Node | undefined;
/** Returns the next token that begins after the end of `node`. Returns `undefined` for SourceFile and EndOfFileToken */
export declare function getNextToken(
  node: ts.Node,
  sourceFile?: ts.SourceFile,
): ts.Node | undefined;
/** Returns the token at or following the specified position or undefined if none is found inside `parent`. */
export declare function getTokenAtPosition(
  parent: ts.Node,
  pos: number,
  sourceFile?: ts.SourceFile,
  allowJsDoc?: boolean,
 ...
 */
export declare function getCommentAtPosition(
  sourceFile: ts.SourceFile,
  pos: number,
  parent?: ts.Node,
 ...
 * If the `parent` parameter is passed, `pos` must be between `parent.pos` and `parent.end`.
 */
export declare function isPositionInComment(
  sourceFile: ts.SourceFile,
  pos: number,
  parent?: ts.Node,
): boolean;
...
export declare function getAstNodeAtPosition(
  node: ts.Node,
  pos: number,
): ts.Node | undefined;
/**
 ...
 */
export declare function getWrappedNodeAtPosition(
  wrap: NodeWrap,
  pos: number,
): NodeWrap | undefined;
...
export declare function forEachDestructuringIdentifier<T>(
...
export declare function forEachDeclaredVariable<T>(
...
export declare function getVariableDeclarationKind(
  declarationList: ts.VariableDeclarationList,
): VariableDeclarationKind;
export declare function isBlockScopedVariableDeclarationList(
  declarationList: ts.VariableDeclarationList,
): boolean;
export declare function isBlockScopedVariableDeclaration(
  declaration: ts.VariableDeclaration,
): boolean;
export declare function isBlockScopedDeclarationStatement(
  statement: ts.Statement,
): statement is ts.DeclarationStatement;
export declare function isInSingleStatementContext(
  statement: ts.Statement,
): boolean;
...
export declare function isFunctionWithBody(
  node: ts.Node,
 ...
 */
export declare function forEachToken(
  node: ts.Node,
  cb: (node: ts.Node) => void,
  sourceFile?: ts.SourceFile,
): void;
export declare type ForEachTokenCallback = (
  fullText: string,
  kind: ts.SyntaxKind,
  range: ts.TextRange,
  parent: ts.Node,
 ...
 */
export declare function forEachTokenWithTrivia(
  node: ts.Node,
  cb: ForEachTokenCallback,
  sourceFile?: ts.SourceFile,
): void;
export declare type ForEachCommentCallback = (
  fullText: string,
  comment: ts.CommentRange,
) => void;
/** Iterate over all comments owned by `node` or its children */
export declare function forEachComment(
  node: ts.Node,
...
export declare function getLineBreakStyle(
  sourceFile: ts.SourceFile,
): "\n" | "\r\n";
/**
 ...
 */
export declare function isValidIdentifier(
  text: string,
 ...
 */
export declare function isValidPropertyAccess(
  text: string,
  languageVersion?: ts.ScriptTarget,
): boolean;
/**
 ...
 */
export declare function isValidPropertyName(
  text: string,
  languageVersion?: ts.ScriptTarget,
): boolean;
/**
 ...
 */
export declare function isValidNumericLiteral(
  text: string,
  languageVersion?: ts.ScriptTarget,
): boolean;
/**
 ...
 */
export declare function isValidJsxIdentifier(
  text: string,
  languageVersion?: ts.ScriptTarget,
): boolean;
export declare function isNumericPropertyName(
...
export declare function getJsDoc(
  node: ts.Node,
  sourceFile?: ts.SourceFile,
): ts.JSDoc[];
/**
 ...
 */
export declare function parseJsDocOfNode(
  node: ts.Node,
...
export declare type ImportLike =
  ...
  | ts.ImportTypeNode;
export declare function findImportLikeNodes(
  sourceFile: ts.SourceFile,
  kinds: ImportKind,
  ignoreFileName?: boolean,
): ImportLike[];
 ...
 */
export declare function isStatementInAmbientContext(
  node: ts.Statement,
): boolean;
/** Includes `declare namespace`, `declare module` and `declare global` and namespace nested in one of the aforementioned. */
export declare function isAmbientModuleBlock(
  node: ts.Node,
): node is ts.ModuleBlock;
export declare function getIIFE(
  func: ts.FunctionExpression | ts.ArrowFunction,
): ts.CallExpression | undefined;
export declare type StrictCompilerOption =
  | "noImplicitAny"
  | "noImplicitThis"
  | "strictNullChecks"
  | "strictFunctionTypes"
  ...
  | "alwaysStrict"
  | "strictBindCallApply";
export declare function isStrictCompilerOptionEnabled(
  options: ts.CompilerOptions,
  option: StrictCompilerOption,
): boolean;
export declare type BooleanCompilerOptions = {
  [K in keyof ts.CompilerOptions]: NonNullable<ts.CompilerOptions[K]> extends
    boolean ? K : never;
} extends {
 ...
 */
export declare function isCompilerOptionEnabled(
  options: ts.CompilerOptions,
 ...
 */
export declare function getCheckJsDirective(
  source: string,
): ts.CheckJsDirective | undefined;
/** @returns the last `// @ts-check` or `// @ts-nocheck` directive in the given file. */
export declare function getTsCheckDirective(
  source: string,
): ts.CheckJsDirective | undefined;
...
export declare function isReadonlyAssignmentDeclaration(
  node: ts.CallExpression,
  checker: ts.TypeChecker,
): boolean;
/** Determines whether a call to `Object.defineProperty` is statically analyzable. */
export declare function isBindableObjectDefinePropertyCall(
  node: ts.CallExpression,
): boolean;
...
export declare function isWellKnownSymbolLiterally(
  node: ts.Expression,
...
export declare function getPropertyNameOfWellKnownSymbol(
  node: WellKnownSymbolLiteral,
): PropertyName;
...
export declare function getLateBoundPropertyNames(
  node: ts.Expression,
  checker: ts.TypeChecker,
): LateBoundPropertyNames;
export declare function getLateBoundPropertyNamesOfPropertyName(
  node: ts.PropertyName,
  checker: ts.TypeChecker,
): LateBoundPropertyNames;
/** Most declarations demand there to be only one statically known name, e.g. class members with computed name. */
export declare function getSingleLateBoundPropertyNameOfPropertyName(
  node: ts.PropertyName,
  checker: ts.TypeChecker,
): PropertyName | undefined;
export declare function unwrapParentheses(node: ts.Expression): ts.Expression;
export declare function formatPseudoBigInt(
  v: ts.PseudoBigInt,
): `${string}n` | `-${string}n`;
/**
 ...
 */
export declare function hasExhaustiveCaseClauses(
  node: ts.SwitchStatement,
  checker: ts.TypeChecker,
): boolean;
export declare function getBaseOfClassLikeExpression(
