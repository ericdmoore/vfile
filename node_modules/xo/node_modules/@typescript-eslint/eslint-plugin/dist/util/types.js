...
exports.getContextualType = exports.isUnsafeAssignment = exports
  .isAnyOrAnyArrayTypeDiscriminated = exports.isTypeUnknownArrayType = exports
    .isTypeAnyArrayType = exports.isTypeAnyType = exports.isTypeUnknownType =
      exports.getTypeArguments = exports.getEqualsKind = exports
        .getTokenAtPosition = exports.getSourceFileOfNode = exports
          .typeIsOrHasBaseType = exports.isTypeFlagSet = exports.getTypeFlags =
            exports.getDeclaration = exports.isNullableType = exports
              .getConstrainedTypeAtLocation = exports.getTypeName = exports
                .containsAllTypesByName = exports
                  .isTypeArrayTypeOrUnionOfArrayTypes = void 0;
...
function getTypeName(typeChecker, type) {
  ...
  if ((type.flags & ts.TypeFlags.TypeParameter) !== 0) {
    ...
    // via AST.
    const symbol = type.getSymbol();
    const decls = symbol === null || symbol === void 0
      ? void 0
      : symbol.getDeclarations();
    const typeParamDecl = decls === null || decls === void 0
      ? void 0
      : decls[0];
    if (
...
function isNullableType(
  type,
  { isReceiver = false, allowUndefined = true } = {},
) {
...
function getDeclaration(checker, node) {
  ...
  return (_a = declarations === null || declarations === void 0
          ? void 0
          : declarations[0]) !== null && _a !== void 0
    ? _a
    : null;
}
...
function isUnsafeAssignment(type, receiver, checker, senderNode) {
  ...
  if (
    (0, tsutils_1.isTypeReference)(type) &&
    (0, tsutils_1.isTypeReference)(receiver)
  ) {
    ...
    if (
      (senderNode === null || senderNode === void 0
          ? void 0
          : senderNode.type) ===
        experimental_utils_1.AST_NODE_TYPES.NewExpression &&
      senderNode.callee.type ===
    ...
    const typeArguments = (_a = type.typeArguments) !== null && _a !== void 0
      ? _a
      : [];
    const receiverTypeArguments =
      (_b = receiver.typeArguments) !== null && _b !== void 0 ? _b : [];
...
function getContextualType(checker, node) {
  ...
  if (
    (0, tsutils_1.isCallExpression)(parent) ||
    (0, tsutils_1.isNewExpression)(parent)
  ) {
    ...
    (0, tsutils_1.isVariableDeclaration)(parent) ||
    ...
    (0, tsutils_1.isPropertyAssignment)(parent) &&
    (0, tsutils_1.isIdentifier)(node)
  ) {
    return checker.getContextualType(node);
  } else if (
    (0, tsutils_1.isBinaryExpression)(parent) &&
