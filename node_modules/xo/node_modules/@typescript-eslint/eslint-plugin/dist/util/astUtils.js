...
exports.forEachReturnStatement = exports
  .getNameLocationInGlobalDirectiveComment = void 0;
const escapeRegExp_1 = require("./escapeRegExp");
const ts = __importStar(require("typescript"));
// deeply re-export, for convenience
__exportStar(
  require("@typescript-eslint/experimental-utils/dist/ast-utils"),
  exports,
);
...
function getNameLocationInGlobalDirectiveComment(sourceCode, comment, name) {
  const namePattern = new RegExp(
    `[\\s,]${(0, escapeRegExp_1.escapeRegExp)(name)}(?:$|[\\s,:])`,
    "gu",
  );
