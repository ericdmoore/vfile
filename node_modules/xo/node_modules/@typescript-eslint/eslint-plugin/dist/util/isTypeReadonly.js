...
exports.isTypeReadonly = exports.readonlynessOptionsDefaults = exports
  .readonlynessOptionsSchema = void 0;
...
function isTypeReadonlyArrayOrTuple(checker, type, options, seenTypes) {
  function checkTypeArguments(arrayType) {
    ...
    const typeArguments =
      ...
      checker.getTypeArguments
        ...
        : (_a = arrayType.typeArguments) !== null && _a !== void 0
        ? _a
        : [];
  ...
  if (checker.isArrayType(type)) {
    const symbol = (0, nullThrows_1.nullThrows)(
      type.getSymbol(),
      nullThrows_1.NullThrowsReasons.MissingToken("symbol", "array type"),
    );
...
function isTypeReadonlyObject(checker, type, options, seenTypes) {
  function checkIndexSignature(kind) {
    ...
    if (indexInfo) {
      return indexInfo.isReadonly ? 3 /* Readonly */ : 2 /* Mutable */;
    }
    return 1 /* UnknownType */;
  }
  ...
  if (properties.length) {
    ...
    for (const property of properties) {
      if (
        !((0, tsutils_1.isPropertyReadonlyInType)(
          type,
    ...
    for (const property of properties) {
      const propertyType = (0, nullThrows_1.nullThrows)(
        (0, propertyTypes_1.getTypeOfPropertyOfType)(checker, type, property),
        nullThrows_1.NullThrowsReasons.MissingToken(
...
function isTypeReadonlyRecurser(checker, type, options, seenTypes) {
  ...
  if ((0, tsutils_1.isUnionType)(type)) {
    ...
    const result = (0, tsutils_1.unionTypeParts)(type).every((t) =>
      seenTypes.has(t) ||
  ...
  if (
    !(0, tsutils_1.isObjectType)(type) &&
    !(0, tsutils_1.isUnionOrIntersectionType)(type)
  ) {
    return 3 /* Readonly */;
  }
