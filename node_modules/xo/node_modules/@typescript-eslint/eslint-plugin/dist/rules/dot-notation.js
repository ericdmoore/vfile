...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    const { program, esTreeNodeToTSNodeMap } = (0, util_1.getParserServices)(
      context,
    );
    ...
    const allowIndexSignaturePropertyAccess =
      ((_a = options.allowIndexSignaturePropertyAccess) !== null &&
          _a !== void 0
        ? _a
        : false) ||
                  ...
                  (_b =
                        (_a =
                              propertySymbol === null ||
                                ...
                                ? void 0
                                : propertySymbol.getDeclarations()) === null ||
                          _a === void 0
                          ? void 0
                          : _a[0]) === null || _b === void 0
                    ? void 0
                    : _b.modifiers) === null || _c === void 0
              ? void 0
              : _c[0].kind;
          if (
            (allowPrivateClassPropertyAccess &&
