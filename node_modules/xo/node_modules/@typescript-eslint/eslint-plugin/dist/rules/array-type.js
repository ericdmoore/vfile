...
exports.default = util.createRule({
  ...
  create(context, [options]) {
    ...
    const readonlyOption = (_a = options.readonly) !== null && _a !== void 0
      ? _a
      : defaultOption;
    /**
     * @param node the node to be evaluated.
    ...
    return {
      ...
      TSTypeReference(node) {
        ...
        const typeParams = (_a = node.typeParameters) === null || _a === void 0
          ? void 0
          : _a.params;
        ...
        const typeParens = !util.isParenthesized(type, sourceCode) &&
          typeNeedsParentheses(type);
