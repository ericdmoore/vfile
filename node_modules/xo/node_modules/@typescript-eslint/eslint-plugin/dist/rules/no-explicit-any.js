...
exports.default = util.createRule({
  ...
  create(context, [{ ignoreRestArgs, fixToUnknown }]) {
    ...
    function isGreatGrandparentRestElement(node) {
      var _a, _b;
      return (((_b = (_a = node === null || node === void 0
                        ? void 0
                        : node.parent) === null || _a === void 0
                  ? void 0
    ...
    function isGreatGreatGrandparentRestElement(node) {
      var _a, _b, _c;
      return (((_c = (_b = (_a = node.parent) === null || _a === void 0
                        ? void 0
                        : _a.parent) === null || _b === void 0
                  ? void 0
    ...
    return {
      TSAnyKeyword(node) {
        ...
        context.report(
          Object.assign({ node, messageId: "unexpectedAny" }, fixOrSuggest),
        );
      },
    };
  },
