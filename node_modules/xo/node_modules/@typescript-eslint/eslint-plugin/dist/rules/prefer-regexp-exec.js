  ...
  create(context) {
    ...
    function isLikelyToContainGlobalFlag(node) {
      if (
        ...
        return (flags &&
          flags.type === experimental_utils_1.AST_NODE_TYPES.Literal &&
    ...
    return {
      "CallExpression[arguments.length=1] > MemberExpression.callee[property.name='match'][computed=false]"(
        ...
        const argumentValue = (0, util_1.getStaticValue)(
          argumentNode,
          globalScope,
        );
        if (
        ...
        if (
          argumentNode.type === experimental_utils_1.AST_NODE_TYPES.Literal &&
