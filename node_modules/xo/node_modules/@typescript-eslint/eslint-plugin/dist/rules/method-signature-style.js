    ...
    return Object.assign(
      Object.assign(
        ...
        mode === "property" && {
          TSMethodSignature(methodNode) {
            ...
            const members = (parent === null || parent === void 0
                ? void 0
                : parent.type) ===
              ...
              ? parent.members
              : [];
            const duplicatedKeyMethodNodes = members.filter((element) =>
              element.type ===
      ...
      mode === "method" && {
        TSPropertySignature(propertyNode) {
          var _a;
          const typeNode =
            (_a = propertyNode.typeAnnotation) === null || _a === void 0
              ? void 0
              : _a.typeAnnotation;
          if (
            (typeNode === null || typeNode === void 0
              ? void 0
              : typeNode.type) !==
