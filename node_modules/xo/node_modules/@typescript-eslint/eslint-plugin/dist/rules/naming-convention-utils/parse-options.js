...
function normalizeOption(option) {
  ...
  let weight = 0;
  (_a = option.modifiers) === null || _a === void 0
    ? void 0
    : _a.forEach((mod) => {
  ...
  const normalizedOption = {
    ...
    format: option.format
      ? option.format.map((f) => enums_1.PredefinedFormats[f])
      : null,
    ...
    modifiers: (_d = (_c = option.modifiers) === null || _c === void 0
            ? void 0
            : _c.map((m) =>
              enums_1.Modifiers[m]
            )) !== null && _d !== void 0
      ? _d
      : null,
    types: (_f = (_e = option.types) === null || _e === void 0
            ? void 0
            : _e.map((m) => enums_1.TypeModifiers[m])) !== null && _f !== void 0
      ? _f
      : null,
