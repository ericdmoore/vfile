...
function createValidator(type, context, allConfigs) {
  ...
  const configs = allConfigs
    ...
    .sort((a, b) => {
      ...
      const aIsMethodOrProperty = (0, shared_1.isMethodOrPropertySelector)(
        a.selector,
      );
      const bIsMethodOrProperty = (0, shared_1.isMethodOrPropertySelector)(
        b.selector,
      );
  ...
  return (node, modifiers = new Set()) => {
    ...
    const originalName =
      node.type === experimental_utils_1.AST_NODE_TYPES.Identifier ||
        node.type === experimental_utils_1.AST_NODE_TYPES.PrivateIdentifier
        ? node.name
        : `${node.value}`;
    ...
    for (const config of configs) {
      if (
        ((_a = config.filter) === null || _a === void 0
          ? void 0
          : _a.regex.test(originalName)) !==
          ((_b = config.filter) === null || _b === void 0 ? void 0 : _b.match)
      ) {
        // name does not match the filter
        continue;
      }
      if (
        (_c = config.modifiers) === null || _c === void 0
          ? void 0
          : _c.some((modifier) => !modifiers.has(modifier))
      ) {
  ...
  function formatReportData(
    { affixes, formats, originalName, processedName, position, custom, count },
  ) {
    var _a;
    return {
      ...
      position,
      count,
      affixes: affixes === null || affixes === void 0
        ? void 0
        : affixes.join(", "),
      formats: formats === null || formats === void 0 ? void 0
      : formats.map((f) => enums_1.PredefinedFormats[f]).join(", "),
      regex:
        (_a = custom === null || custom === void 0 ? void 0 : custom.regex) ===
            null || _a === void 0
          ? void 0
          : _a.toString(),
      regexMatch:
        (custom === null || custom === void 0 ? void 0 : custom.match) === true
          ? "match"
          : (custom === null || custom === void 0 ? void 0 : custom.match) ===
              false
          ? "not match"
          : null,
    };
