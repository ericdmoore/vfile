...
exports.default = util.createRule({
  ...
  create(context, [options]) {
    ...
    function isGenericOfStaticMethod(variable) {
      ...
      if (
        (typeParameter === null || typeParameter === void 0
          ? void 0
          : typeParameter.type) !==
      ...
      if (
        (typeParameterDecl === null || typeParameterDecl === void 0
          ? void 0
          : typeParameterDecl.type) !==
      ...
      if (
        (methodDefinition === null || methodDefinition === void 0
          ? void 0
    ...
    function isExternalDeclarationMerging(scope, variable, shadowed) {
      ...
      return (isTypeImport(firstDefinition) &&
        ...
        secondDefinition.node.type ===
          experimental_utils_1.AST_NODE_TYPES.TSInterfaceDeclaration &&
        ((_a = secondDefinition.node.parent) === null || _a === void 0
            ? void 0
            : _a.type) ===
    ...
    function isOnInitializer(variable, scopeVar) {
      ...
      const outer = (_a = outerDef === null || outerDef === void 0
              ? void 0
              : outerDef.parent) === null || _a === void 0
        ? void 0
        : _a.range;
      const innerScope = variable.scope;
      const innerDef = variable.defs[0];
      const inner = innerDef === null || innerDef === void 0
        ? void 0
        : innerDef.name.range;
      return !!(outer &&
        inner &&
    ...
    function checkForShadows(scope) {
      ...
      for (const variable of variables) {
        ...
        const shadowed = scope.upper
          ? experimental_utils_1.ASTUtils.findVariable(
            scope.upper,
            variable.name,
          )
          : null;
