...
function normalizeOptions(options) {
  ...
  return {
    enums: (_a = options.enums) !== null && _a !== void 0
      ? _a
      : DEFAULT_OPTION_VALUE,
    generics: (_b = options.generics) !== null && _b !== void 0 ? _b
    : DEFAULT_OPTION_VALUE,
    tuples: (_c = options.tuples) !== null && _c !== void 0 ? _c
    : DEFAULT_OPTION_VALUE,
  };
}
exports.default = util.createRule({
  ...
  create(context, [options]) {
    ...
    function last(nodes) {
      var _a;
      return (_a = nodes[nodes.length - 1]) !== null && _a !== void 0
        ? _a
        : null;
    }
    ...
    function isMultiline(node) {
      ...
      return (last === null || last === void 0 ? void 0 : last.loc.end.line) !==
        (lastToken === null || lastToken === void 0
          ? void 0
