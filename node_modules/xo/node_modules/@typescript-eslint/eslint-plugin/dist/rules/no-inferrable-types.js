...
exports.default = util.createRule({
  ...
  create(context, [{ ignoreParameters, ignoreProperties }]) {
    ...
    function isLiteral(init, typeName) {
      return (init.type === experimental_utils_1.AST_NODE_TYPES.Literal &&
        typeof init.value === typeName);
    }
    function isIdentifier(init, ...names) {
      return (init.type === experimental_utils_1.AST_NODE_TYPES.Identifier &&
        names.includes(init.name));
    }
    ...
    function isInferrable(annotation, init) {
      switch (annotation.type) {
        ...
        case experimental_utils_1.AST_NODE_TYPES.TSUndefinedKeyword:
          return (hasUnaryPrefix(init, "void") ||
            isIdentifier(init, "undefined"));
      }
      return false;
    }
    /**
