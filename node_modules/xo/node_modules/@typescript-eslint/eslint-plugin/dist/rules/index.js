...
const adjacent_overload_signatures_1 = __importDefault(
  require("./adjacent-overload-signatures"),
);
...
const class_literal_property_style_1 = __importDefault(
  require("./class-literal-property-style"),
);
const comma_dangle_1 = __importDefault(require("./comma-dangle"));
const comma_spacing_1 = __importDefault(require("./comma-spacing"));
const consistent_indexed_object_style_1 = __importDefault(
  require("./consistent-indexed-object-style"),
);
const consistent_type_assertions_1 = __importDefault(
  require("./consistent-type-assertions"),
);
const consistent_type_definitions_1 = __importDefault(
  require("./consistent-type-definitions"),
);
const consistent_type_exports_1 = __importDefault(
  require("./consistent-type-exports"),
);
const consistent_type_imports_1 = __importDefault(
...
const explicit_function_return_type_1 = __importDefault(
  require("./explicit-function-return-type"),
);
const explicit_member_accessibility_1 = __importDefault(
  require("./explicit-member-accessibility"),
);
const explicit_module_boundary_types_1 = __importDefault(
...
const lines_between_class_members_1 = __importDefault(
  require("./lines-between-class-members"),
);
const member_delimiter_style_1 = __importDefault(
  require("./member-delimiter-style"),
);
const member_ordering_1 = __importDefault(require("./member-ordering"));
const method_signature_style_1 = __importDefault(
  require("./method-signature-style"),
);
const naming_convention_1 = __importDefault(require("./naming-convention"));
const no_array_constructor_1 = __importDefault(
  require("./no-array-constructor"),
);
const no_base_to_string_1 = __importDefault(require("./no-base-to-string"));
const no_confusing_non_null_assertion_1 = __importDefault(
  require("./no-confusing-non-null-assertion"),
);
const no_confusing_void_expression_1 = __importDefault(
  require("./no-confusing-void-expression"),
);
const no_dupe_class_members_1 = __importDefault(
  require("./no-dupe-class-members"),
);
const no_duplicate_imports_1 = __importDefault(
  require("./no-duplicate-imports"),
);
...
const no_extra_non_null_assertion_1 = __importDefault(
  require("./no-extra-non-null-assertion"),
);
...
const no_floating_promises_1 = __importDefault(
  require("./no-floating-promises"),
);
const no_for_in_array_1 = __importDefault(require("./no-for-in-array"));
const no_implicit_any_catch_1 = __importDefault(
  require("./no-implicit-any-catch"),
);
...
const no_invalid_void_type_1 = __importDefault(
  require("./no-invalid-void-type"),
);
const no_loop_func_1 = __importDefault(require("./no-loop-func"));
const no_loss_of_precision_1 = __importDefault(
  require("./no-loss-of-precision"),
);
const no_magic_numbers_1 = __importDefault(require("./no-magic-numbers"));
const no_meaningless_void_operator_1 = __importDefault(
  require("./no-meaningless-void-operator"),
);
...
const no_non_null_asserted_nullish_coalescing_1 = __importDefault(
  require("./no-non-null-asserted-nullish-coalescing"),
);
const no_non_null_asserted_optional_chain_1 = __importDefault(
  require("./no-non-null-asserted-optional-chain"),
);
const no_non_null_assertion_1 = __importDefault(
  require("./no-non-null-assertion"),
);
const no_parameter_properties_1 = __importDefault(
  require("./no-parameter-properties"),
);
...
const no_restricted_imports_1 = __importDefault(
  require("./no-restricted-imports"),
);
...
const no_unnecessary_boolean_literal_compare_1 = __importDefault(
  require("./no-unnecessary-boolean-literal-compare"),
);
const no_unnecessary_condition_1 = __importDefault(
  require("./no-unnecessary-condition"),
);
const no_unnecessary_qualifier_1 = __importDefault(
  require("./no-unnecessary-qualifier"),
);
const no_unnecessary_type_arguments_1 = __importDefault(
  require("./no-unnecessary-type-arguments"),
);
const no_unnecessary_type_assertion_1 = __importDefault(
  require("./no-unnecessary-type-assertion"),
);
const no_unnecessary_type_constraint_1 = __importDefault(
  require("./no-unnecessary-type-constraint"),
);
const no_unsafe_argument_1 = __importDefault(require("./no-unsafe-argument"));
const no_unsafe_assignment_1 = __importDefault(
  require("./no-unsafe-assignment"),
);
const no_unsafe_call_1 = __importDefault(require("./no-unsafe-call"));
const no_unsafe_member_access_1 = __importDefault(
  require("./no-unsafe-member-access"),
);
const no_unsafe_return_1 = __importDefault(require("./no-unsafe-return"));
const no_unused_expressions_1 = __importDefault(
  require("./no-unused-expressions"),
);
const no_unused_vars_1 = __importDefault(require("./no-unused-vars"));
const no_use_before_define_1 = __importDefault(
  require("./no-use-before-define"),
);
const no_useless_constructor_1 = __importDefault(
  require("./no-useless-constructor"),
);
const no_var_requires_1 = __importDefault(require("./no-var-requires"));
const non_nullable_type_assertion_style_1 = __importDefault(
  require("./non-nullable-type-assertion-style"),
);
const object_curly_spacing_1 = __importDefault(
  require("./object-curly-spacing"),
);
const padding_line_between_statements_1 = __importDefault(
  require("./padding-line-between-statements"),
);
const prefer_as_const_1 = __importDefault(require("./prefer-as-const"));
const prefer_enum_initializers_1 = __importDefault(
  require("./prefer-enum-initializers"),
);
const prefer_for_of_1 = __importDefault(require("./prefer-for-of"));
const prefer_function_type_1 = __importDefault(
  require("./prefer-function-type"),
);
const prefer_includes_1 = __importDefault(require("./prefer-includes"));
const prefer_literal_enum_member_1 = __importDefault(
  require("./prefer-literal-enum-member"),
);
const prefer_namespace_keyword_1 = __importDefault(
  require("./prefer-namespace-keyword"),
);
const prefer_nullish_coalescing_1 = __importDefault(
  require("./prefer-nullish-coalescing"),
);
const prefer_optional_chain_1 = __importDefault(
  require("./prefer-optional-chain"),
);
const prefer_readonly_1 = __importDefault(require("./prefer-readonly"));
const prefer_readonly_parameter_types_1 = __importDefault(
  require("./prefer-readonly-parameter-types"),
);
const prefer_reduce_type_parameter_1 = __importDefault(
  require("./prefer-reduce-type-parameter"),
);
const prefer_regexp_exec_1 = __importDefault(require("./prefer-regexp-exec"));
const prefer_return_this_type_1 = __importDefault(
  require("./prefer-return-this-type"),
);
const prefer_string_starts_ends_with_1 = __importDefault(
  require("./prefer-string-starts-ends-with"),
);
const prefer_ts_expect_error_1 = __importDefault(
  require("./prefer-ts-expect-error"),
);
const promise_function_async_1 = __importDefault(
  require("./promise-function-async"),
);
const quotes_1 = __importDefault(require("./quotes"));
const require_array_sort_compare_1 = __importDefault(
  require("./require-array-sort-compare"),
);
const require_await_1 = __importDefault(require("./require-await"));
const restrict_plus_operands_1 = __importDefault(
  require("./restrict-plus-operands"),
);
const restrict_template_expressions_1 = __importDefault(
  require("./restrict-template-expressions"),
);
const return_await_1 = __importDefault(require("./return-await"));
const semi_1 = __importDefault(require("./semi"));
const sort_type_union_intersection_members_1 = __importDefault(
  require("./sort-type-union-intersection-members"),
);
const space_before_function_paren_1 = __importDefault(
  require("./space-before-function-paren"),
);
const space_infix_ops_1 = __importDefault(require("./space-infix-ops"));
const strict_boolean_expressions_1 = __importDefault(
  require("./strict-boolean-expressions"),
);
const switch_exhaustiveness_check_1 = __importDefault(
  require("./switch-exhaustiveness-check"),
);
const triple_slash_reference_1 = __importDefault(
  require("./triple-slash-reference"),
);
const type_annotation_spacing_1 = __importDefault(
  require("./type-annotation-spacing"),
);
...
exports.default = {
  ...
  "no-non-null-asserted-nullish-coalescing":
    no_non_null_asserted_nullish_coalescing_1.default,
  "no-non-null-asserted-optional-chain":
    no_non_null_asserted_optional_chain_1.default,
  ...
  "no-unnecessary-boolean-literal-compare":
    no_unnecessary_boolean_literal_compare_1.default,
  ...
  "non-nullable-type-assertion-style":
    non_nullable_type_assertion_style_1.default,
  ...
  "sort-type-union-intersection-members":
    sort_type_union_intersection_members_1.default,
