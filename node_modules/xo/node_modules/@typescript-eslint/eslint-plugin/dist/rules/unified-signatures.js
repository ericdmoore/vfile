  ...
  create(context) {
            ...
            context.report({
              ...
              data: {
                ...
                type1: sourceCode.getText(
                  typeAnnotation0 === null || typeAnnotation0 === void 0
                    ? void 0
                    : typeAnnotation0.typeAnnotation,
                ),
                type2: sourceCode.getText(
                  typeAnnotation1 === null || typeAnnotation1 === void 0
                    ? void 0
    ...
    function parameterMayBeMissing(p) {
      const optional = isTSParameterProperty(p)
        ...
        : p.optional;
      return p.type === experimental_utils_1.AST_NODE_TYPES.RestElement ||
        optional;
    }
    ...
    return {
      ...
      TSDeclareFunction(node) {
        ...
        addOverload(
          node,
          (_b = (_a = node.id) === null || _a === void 0 ? void 0 : _a.name) !==
              null && _b !== void 0
            ? _b
            : exportingNode === null || exportingNode === void 0
            ? void 0
            : exportingNode.type,
          exportingNode,
        );
