...
const baseRule = (0, getESLintCoreRule_1.maybeGetESLintCoreRule)(
...
exports.default = util.createRule({
  ...
  meta: {
    ...
    hasSuggestions: baseRule === null || baseRule === void 0
      ? void 0
      : baseRule.meta.hasSuggestions,
    schema: [],
    messages: (_a = baseRule === null || baseRule === void 0
            ? void 0
            : baseRule.meta.messages) !== null && _a !== void 0
      ? _a
      : { noLossOfPrecision: "" },
  },
  defaultOptions: [],
      ...
      Literal(node) {
        rules.Literal(
          Object.assign(Object.assign({}, node), {
            raw: isSeparatedNumeric(node)
              ? node.raw.replace(/_/g, "")
              : node.raw,
          }),
        );
      },
