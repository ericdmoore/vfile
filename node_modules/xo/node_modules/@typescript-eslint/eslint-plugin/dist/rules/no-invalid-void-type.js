    ...
    function checkGenericTypeArgument(node) {
      ...
      if (
        ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) !==
          experimental_utils_1.AST_NODE_TYPES.TSTypeParameterInstantiation ||
        ((_b = node.parent.parent) === null || _b === void 0
            ? void 0
            : _b.type) !== experimental_utils_1.AST_NODE_TYPES.TSTypeReference
      ) {
        return;
      }
      // check whitelist
      ...
      return node.types.every((member) => {
        ...
        return validUnionMembers.includes(member.type) ||
          ...
          (member.type ===
            ...
            ((_a = member.typeParameters) === null || _a === void 0
                ? void 0
                : _a.type) ===
              experimental_utils_1.AST_NODE_TYPES
                .TSTypeParameterInstantiation &&
            ((_b = member.typeParameters) === null || _b === void 0
              ? void 0
              : _b.params.map((param) => param.type).includes(
                experimental_utils_1.AST_NODE_TYPES.TSVoidKeyword,
              )));
      });
    }
