...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [mode]) {
    ...
    function checkMembers(members, node, prefix, postfix, safeFix = true) {
      ...
      if (
        member.type !== experimental_utils_1.AST_NODE_TYPES.TSIndexSignature
      ) {
        return;
      }
    ...
    return Object.assign(
      Object.assign(
        ...
        mode === "index-signature" && {
          TSTypeReference(node) {
            ...
            const params = (_a = node.typeParameters) === null || _a === void 0
              ? void 0
              : _a.params;
            if (
      ...
      mode === "record" && {
        ...
        TSInterfaceDeclaration(node) {
          ...
          let genericTypes = "";
          if (
            ((_b = (_a = node.typeParameters) === null || _a === void 0
                    ? void 0
                    : _a.params) !== null && _b !== void 0
              ? _b
              : []).length > 0
          ) {
            genericTypes = `<${
              (_c = node.typeParameters) === null || _c === void 0
                ? void 0
                : _c.params.map((p) => p.name.name).join(", ")
            }>`;
          }
          checkMembers(
            node.body.body,
            ...
            ";",
            !((_d = node.extends) === null || _d === void 0
              ? void 0
              : _d.length),
          );
        },
