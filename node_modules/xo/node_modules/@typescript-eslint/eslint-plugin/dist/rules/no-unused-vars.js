  ...
  create(context) {
    ...
    const options = (() => {
      ...
      if (firstOption) {
        if (typeof firstOption === "string") {
          ...
          options.vars = (_a = firstOption.vars) !== null && _a !== void 0
            ? _a
            : options.vars;
          options.args = (_b = firstOption.args) !== null && _b !== void 0
            ? _b
            : options.args;
          options.ignoreRestSiblings =
            (_c = firstOption.ignoreRestSiblings) !== null && _c !== void 0
              ? _c
              : options.ignoreRestSiblings;
          options.caughtErrors =
            (_d = firstOption.caughtErrors) !== null && _d !== void 0
              ? _d
              : options.caughtErrors;
    ...
    function collectUnusedVariables() {
      ...
      function isAfterLastUsedArg(variable) {
        ...
        return !posteriorParams.some((v) =>
          v.references.length > 0 || v.eslintUsed
        );
      }
      ...
      for (const variable of unusedVariablesOriginal) {
        ...
        if (
          variable.scope.type ===
            experimental_utils_1.TSESLint.Scope.ScopeType.global &&
          options.vars === "local"
        ) {
        ...
        if (
          def.type ===
            experimental_utils_1.TSESLint.Scope.DefinitionType.CatchClause
        ) {
          ...
          if (
            "name" in def.name &&
            ((_a = options.caughtErrorsIgnorePattern) === null || _a === void 0
              ? void 0
              : _a.test(def.name.name))
          ) {
            continue;
          }
        }
        if (
          ...
          if (
            "name" in def.name &&
            ((_b = options.argsIgnorePattern) === null || _b === void 0
              ? void 0
              : _b.test(def.name.name))
          ) {
            continue;
          }
          ...
          if (
            "name" in def.name &&
            ((_c = options.varsIgnorePattern) === null || _c === void 0
              ? void 0
              : _c.test(def.name.name))
          ) {
            continue;
          }
        }
    ...
    return {
      ...
      [
        ...
        if (
          moduleDecl.id.type === experimental_utils_1.AST_NODE_TYPES.Literal &&
      ...
      "Program:exit"(programNode) {
        ...
        function getDefinedMessageData(unusedVar) {
          var _a;
          const defType = (_a = unusedVar === null || unusedVar === void 0
                  ? void 0
                  : unusedVar.defs[0]) === null || _a === void 0
            ? void 0
            : _a.type;
          let type;
          let pattern;
    ...
    function checkModuleDeclForExportEquals(node) {
      ...
      if (
        node.body &&
        node.body.type === experimental_utils_1.AST_NODE_TYPES.TSModuleBlock
      ) {
    ...
    function markDeclarationChildAsUsed(node) {
      ...
      switch (node.type) {
        ...
        case experimental_utils_1.AST_NODE_TYPES.TSModuleDeclaration:
          if (
            ((_a = node.id) === null || _a === void 0 ? void 0 : _a.type) ===
