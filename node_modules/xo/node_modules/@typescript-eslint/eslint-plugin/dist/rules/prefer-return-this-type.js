...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function tryGetNameInType(name, typeNode) {
      if (
        typeNode.type === experimental_utils_1.AST_NODE_TYPES.TSTypeReference &&
        typeNode.typeName.type ===
    ...
    function checkFunction(originalFunc, originalClass) {
      var _a;
      const className = (_a = originalClass.id) === null || _a === void 0
        ? void 0
        : _a.name;
    ...
    return {
      ...
      "ClassBody > PropertyDefinition"(node) {
        var _a, _b;
        if (
          !(((_a = node.value) === null || _a === void 0 ? void 0 : _a.type) ===
              experimental_utils_1.AST_NODE_TYPES.FunctionExpression ||
            ((_b = node.value) === null || _b === void 0 ? void 0 : _b.type) ===
