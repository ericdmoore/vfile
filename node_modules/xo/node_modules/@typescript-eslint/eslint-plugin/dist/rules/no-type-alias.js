...
exports.default = util.createRule({
  ...
  create(
    ...
    function validateTypeAliases(type, isTopLevel = false) {
      if (
        type.node.type === experimental_utils_1.AST_NODE_TYPES.TSFunctionType
      ) {
        // callback
        ...
        type.node.type === experimental_utils_1.AST_NODE_TYPES.TSConditionalType
      ) {
        // conditional type
        ...
        type.node.type === experimental_utils_1.AST_NODE_TYPES.TSConstructorType
      ) {
        ...
        type.node.type === experimental_utils_1.AST_NODE_TYPES.TSMappedType
      ) {
        // mapped type
        ...
        type.node.type.endsWith(experimental_utils_1.AST_TOKEN_TYPES.Keyword) ||
    ...
    function getTypes(node, compositionType = null) {
      if (
        node.type === experimental_utils_1.AST_NODE_TYPES.TSUnionType ||
