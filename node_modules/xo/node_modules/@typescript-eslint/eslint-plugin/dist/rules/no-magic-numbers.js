...
exports.default = util.createRule({
  ...
  meta: {
    ...
    schema: [
      Object.assign(Object.assign({}, baseRuleSchema), {
        properties: Object.assign(
          Object.assign({}, baseRuleSchema.properties),
          {
...
function isGrandparentTSTypeAliasDeclaration(node) {
  var _a, _b;
  return ((_b = (_a = node.parent) === null || _a === void 0
          ? void 0
          : _a.parent) === null || _b === void 0
    ? void 0
    : _b.type) === experimental_utils_1.AST_NODE_TYPES.TSTypeAliasDeclaration;
}
/**
...
function isGrandparentTSUnionType(node) {
  var _a, _b;
  if (
    ((_b = (_a = node.parent) === null || _a === void 0
            ? void 0
            : _a.parent) === null || _b === void 0
      ? void 0
      : _b.type) === experimental_utils_1.AST_NODE_TYPES.TSUnionType
  ) {
...
function isParentTSEnumDeclaration(node) {
  ...
  return (parent === null || parent === void 0 ? void 0 : parent.type) ===
...
function isParentTSLiteralType(node) {
  var _a;
  return ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) ===
...
function isParentTSReadonlyPropertyDefinition(node) {
  ...
  if (
    (parent === null || parent === void 0 ? void 0 : parent.type) ===
      experimental_utils_1.AST_NODE_TYPES.PropertyDefinition && parent.readonly
  ) {
    return true;
  }
  return false;
