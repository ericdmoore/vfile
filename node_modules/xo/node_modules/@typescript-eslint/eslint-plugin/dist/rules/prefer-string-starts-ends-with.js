...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function isLengthExpression(node, expectedObjectNode) {
      ...
      const evaluatedString = (0, util_1.getStaticValue)(
        expectedObjectNode,
        globalScope,
      );
    ...
    function getLeftNode(node) {
      ...
      if (
        leftNode.type !== experimental_utils_1.AST_NODE_TYPES.MemberExpression
      ) {
