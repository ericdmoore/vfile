...
exports.default = util.createRule({
  ...
  create(contextWithoutDefaults) {
    ...
    function isUnused(name, initialScope = context.getScope()) {
      ...
      while (scope) {
        variable = (_a = scope.set.get(name)) !== null && _a !== void 0
          ? _a
          : null;
        if (variable) {
          break;
    ...
    function isDestructured(id) {
      ...
      return (
        ...
        (((_a = id.parent) === null || _a === void 0 ? void 0 : _a.type) ===
            experimental_utils_1.AST_NODE_TYPES.Property &&
          id.parent.shorthand) ||
        // `const { x = 2 }`
        // does not match const `{ x: y = 2 }`
        (((_b = id.parent) === null || _b === void 0 ? void 0 : _b.type) ===
            experimental_utils_1.AST_NODE_TYPES.AssignmentPattern &&
          ((_c = id.parent.parent) === null || _c === void 0
              ? void 0
              : _c.type) === experimental_utils_1.AST_NODE_TYPES.Property &&
...
function getIdentifiersFromPattern(pattern) {
  const identifiers = [];
  const visitor = new scope_manager_1.PatternVisitor(
    {},
    pattern,
    (id) => identifiers.push(id),
  );
...
function isExported(node, name, scope) {
  ...
  if (
    ...
    ((_b = node === null || node === void 0 ? void 0 : node.parent) === null ||
          _b === void 0
        ? void 0
        : _b.type) ===
  ...
  if (variable) {
    for (const ref of variable.references) {
      ...
      if (
        (refParent === null || refParent === void 0
            ? void 0
            : refParent.type) ===
          experimental_utils_1.AST_NODE_TYPES.ExportDefaultDeclaration ||
        (refParent === null || refParent === void 0
...
function requiresQuoting(node, target) {
  const name = node.type === experimental_utils_1.AST_NODE_TYPES.Identifier ||
