...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function parseRegExp(node) {
      ...
      const { pattern, flags } = (0, regexpp_1.parseRegExpLiteral)(
        evaluated.value,
      );
      if (
    ...
    function checkArrayIndexOf(node, allowFixing) {
      ...
      const compareNode = (((_a = callNode.parent) === null || _a === void 0
          ? void 0
          : _a.type) === experimental_utils_1.AST_NODE_TYPES.ChainExpression
      ...
      const indexofMethodDeclarations = (_b = types
              .getSymbolAtLocation(tsNode)) === null || _b === void 0
        ? void 0
        : _b.getDeclarations();
      if (
      ...
      for (const instanceofMethodDecl of indexofMethodDeclarations) {
        ...
        const includesMethodDecl = (_c = type
                .getProperty("includes")) === null || _c === void 0
          ? void 0
          : _c.getDeclarations();
        if (
      ...
      context.report(
        Object.assign(
          { node: compareNode, messageId: "preferIncludes" },
          allowFixing && {
            *fix(fixer) {
              if (negative) {
    ...
    return {
      ...
      'CallExpression > MemberExpression.callee[property.name="test"][computed=false]'(
        ...
        const includesMethodDecl = (_a = type
                .getProperty("includes")) === null || _a === void 0
          ? void 0
          : _a.getDeclarations();
        ...
        context.report({
          ...
          *fix(fixer) {
            ...
            const needsParen =
              argNode.type !== experimental_utils_1.AST_NODE_TYPES.Literal &&
              argNode.type !==
