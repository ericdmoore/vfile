    ...
    return {
      [
        ...
        const initialExpression =
          (((_a = initialIdentifierOrNotEqualsExpr.parent) === null ||
                _a === void 0
              ? void 0
              : _a.type) ===
        ...
        while (
          current.type === experimental_utils_1.AST_NODE_TYPES.LogicalExpression
        ) {
          if (
            !isValidChainTarget(
              current.right,
        ...
        if (expressionCount > 1) {
          if (
            ...
            optionallyChainedCode += ` ${previous.right.operator} ${
...
function isValidChainTarget(node, allowIdentifier) {
  ...
  if (
    ...
    if (
      node.right.type === experimental_utils_1.AST_NODE_TYPES.Identifier &&
      node.right.name === "undefined"
    ) {
      return true;
    }
    if (
      node.right.type === experimental_utils_1.AST_NODE_TYPES.Literal &&
