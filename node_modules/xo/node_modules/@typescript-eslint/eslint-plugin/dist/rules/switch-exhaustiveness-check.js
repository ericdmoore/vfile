  ...
  create(context) {
    ...
    function fixSwitch(fixer, node, missingBranchTypes, symbolName) {
      ...
      for (const missingBranchType of missingBranchTypes) {
        ...
        const missingBranchName =
          (_a = missingBranchType.getSymbol()) === null || _a === void 0
            ? void 0
            : _a.escapedName;
    ...
    function checkSwitchExhaustive(node) {
      ...
      const symbolName =
        (_a = discriminantType.getSymbol()) === null || _a === void 0
          ? void 0
          : _a.escapedName;
        ...
        context.report({
          ...
          data: {
            missingBranches: missingBranchTypes
              .map((missingType) => {
                var _a;
                return (0, tsutils_1.isTypeFlagSet)(
                    missingType,
                    ts.TypeFlags.ESSymbolLike,
                  )
                  ? `typeof ${
                    (_a = missingType.getSymbol()) === null || _a === void 0
                      ? void 0
                      : _a.escapedName
                  }`
          ...
          suggest: [
            {
              ...
              fix(fixer) {
                return fixSwitch(
                  ...
                  node,
                  missingBranchTypes,
                  symbolName === null || symbolName === void 0
                    ? void 0
                    : symbolName.toString(),
                );
              },
