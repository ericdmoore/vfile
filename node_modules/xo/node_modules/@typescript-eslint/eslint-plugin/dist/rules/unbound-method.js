  ...
  create(context, [{ ignoreStatic }]) {
    ...
    return {
      ...
      "VariableDeclarator, AssignmentExpression"(node) {
        ...
        if (
          initNode &&
          idNode.type === experimental_utils_1.AST_NODE_TYPES.ObjectPattern
        ) {
          ...
          const notImported = rightSymbol &&
            isNotImported(rightSymbol, currentSourceFile);
...
function checkMethod(symbol, ignoreStatic) {
  ...
  switch (valueDeclaration.kind) {
    case ts.SyntaxKind.PropertyDeclaration:
      return {
        dangerous:
          ((_a = valueDeclaration.initializer) === null || _a === void 0
            ? void 0
            : _a.kind) ===
    ...
    case ts.SyntaxKind.MethodSignature: {
      ...
      const firstParamIsThis =
        (firstParam === null || firstParam === void 0
            ? void 0
      ...
      const thisArgIsVoid = firstParamIsThis &&
        ((_b = firstParam === null || firstParam === void 0
                  ? void 0
                  : firstParam.type) === null || _b === void 0
            ? void 0
            : _b.kind) === ts.SyntaxKind.VoidKeyword;
      return {
