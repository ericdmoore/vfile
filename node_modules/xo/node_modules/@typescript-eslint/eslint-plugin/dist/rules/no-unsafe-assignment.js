...
exports.default = util.createRule({
  ...
  create(context) {
    ...
    function checkArrayDestructureHelper(receiverNode, senderNode) {
      if (
        receiverNode.type !== experimental_utils_1.AST_NODE_TYPES.ArrayPattern
      ) {
        return false;
      }
    ...
    function checkObjectDestructureHelper(receiverNode, senderNode) {
      if (
        receiverNode.type !== experimental_utils_1.AST_NODE_TYPES.ObjectPattern
      ) {
        return false;
      }
      const senderTsNode = esTreeNodeToTSNodeMap.get(senderNode);
    ...
    function checkAssignment(
      ...
      const receiverType = comparisonType === 2 /* Contextual */
        ? (_a = util.getContextualType(checker, receiverTsNode)) !== null &&
            _a !== void 0
          ? _a
