  ...
  create(context, [options]) {
      ...
      function checkParameter(param) {
        function report(namedMessageId, unnamedMessageId) {
          if (param.type === experimental_utils_1.AST_NODE_TYPES.Identifier) {
            ...
            param.type === experimental_utils_1.AST_NODE_TYPES.ArrayPattern
          ) {
            context.report({
              node: param,
            ...
            param.type === experimental_utils_1.AST_NODE_TYPES.ObjectPattern
          ) {
            context.report({
              node: param,
              messageId: unnamedMessageId,
            ...
            param.type === experimental_utils_1.AST_NODE_TYPES.RestElement
          ) {
            if (
              param.argument.type ===
    ...
    function isAllowedName(node) {
      ...
      if (
        ...
        return (((_a = node.id) === null || _a === void 0
              ? void 0
              : _a.type) === experimental_utils_1.AST_NODE_TYPES.Identifier &&
        ...
        if (
          node.key.type === experimental_utils_1.AST_NODE_TYPES.Literal &&
        ...
        if (
          !node.computed &&
          node.key.type === experimental_utils_1.AST_NODE_TYPES.Identifier
        ) {
    ...
    function isExportedHigherOrderFunction(node) {
      ...
      while (current) {
        if (
          current.type === experimental_utils_1.AST_NODE_TYPES.ReturnStatement
        ) {
          // the parent of a return will always be a block statement, so we can skip over it
          current = (_a = current.parent) === null || _a === void 0
            ? void 0
            : _a.parent;
          continue;
        }
        if (
          ...
          !(0,
            explicitReturnTypeUtils_1.doesImmediatelyReturnFunctionExpression)(
              current,
            )
        ) {
          return false;
      ...
      switch (node.type) {
        ...
        case experimental_utils_1.AST_NODE_TYPES.PropertyDefinition:
          if (
            ...
            node.key.type ===
              experimental_utils_1.AST_NODE_TYPES.PrivateIdentifier
          ) {
            return;
          }
    ...
    function ancestorHasReturnType(node) {
      ...
      if (
        (ancestor === null || ancestor === void 0 ? void 0 : ancestor.type) ===
      ...
      const isReturnStatement = (ancestor === null || ancestor === void 0
        ? void 0
        : ancestor.type) ===
    ...
    function checkFunctionExpression(node) {
      ...
      if (
        ...
        (0, explicitReturnTypeUtils_1.isTypedFunctionExpression)(
          node,
          options,
        ) ||
      ...
      (0, explicitReturnTypeUtils_1.checkFunctionExpressionReturnType)(
        node,
        options,
        sourceCode,
        (loc) => {
    ...
    function checkFunction(node) {
      ...
      (0, explicitReturnTypeUtils_1.checkFunctionReturnType)(
        node,
        options,
        sourceCode,
        (loc) => {
