  ...
  create(context, [options]) {
    ...
    function isPossiblyUsedBeforeAssigned(node) {
      ...
      if (
        ...
        (0, tsutils_1.isStrictCompilerOptionEnabled)(
          compilerOptions,
          "strictNullChecks",
        ) &&
    ...
    return {
      ...
      "TSAsExpression, TSTypeAssertion"(node) {
        var _a;
        if (
          ((_a = options.typesToIgnore) === null || _a === void 0
            ? void 0
            : _a.includes(sourceCode.getText(node.typeAnnotation))) ||
        ...
        if (
          (0, tsutils_1.isTypeFlagSet)(castType, ts.TypeFlags.Literal) ||
            ...
            fix(fixer) {
              if (originalNode.kind === ts.SyntaxKind.TypeAssertionExpression) {
                ...
                return (closingAngleBracket === null ||
                      closingAngleBracket === void 0
                    ? void 0
                    : closingAngleBracket.value) === ">"
                  ? fixer.removeRange([
                    node.range[0],
