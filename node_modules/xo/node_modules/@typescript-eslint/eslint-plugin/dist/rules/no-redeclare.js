  ...
  create(context, [options]) {
    ...
    function* iterateDeclarations(variable) {
      ...
      const identifiers = variable.identifiers
        ...
        .filter(({ parent }) =>
          parent.type !== experimental_utils_1.AST_NODE_TYPES.TSDeclareFunction
        );
      if (options.ignoreDeclarationMerge && identifiers.length > 1) {
        ...
        if (
          ...
          const classDecls = identifiers.filter(({ parent }) =>
            parent.type === experimental_utils_1.AST_NODE_TYPES.ClassDeclaration
          );
        ...
        if (
          ...
          const functionDecls = identifiers.filter(({ parent }) =>
            parent.type ===
              experimental_utils_1.AST_NODE_TYPES.FunctionDeclaration
          );
        ...
        if (
          ...
          const enumDecls = identifiers.filter(({ parent }) =>
            parent.type ===
              experimental_utils_1.AST_NODE_TYPES.TSEnumDeclaration
          );
