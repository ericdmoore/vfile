...
function getContainingLoopNode(node) {
  for (
    let currentNode = node; currentNode.parent; currentNode = currentNode.parent
  ) {
...
function isSafe(loopNode, reference) {
  ...
  const definition = variable === null || variable === void 0
    ? void 0
    : variable.defs[0];
  const declaration = definition === null || definition === void 0
    ? void 0
    : definition.parent;
  const kind =
    (declaration === null || declaration === void 0
        ? void 0
        : declaration.type) ===
  ...
  function isSafeReference(upperRef) {
    ...
    return (!upperRef.isWrite() ||
      (((_a = variable === null || variable === void 0
                  ? void 0
                  : variable.scope) === null || _a === void 0
            ? void 0
            : _a.variableScope) === upperRef.from.variableScope &&
        id.range[0] < border));
  }
  return (_a = variable === null || variable === void 0
          ? void 0
          : variable.references.every(isSafeReference)) !== null &&
      _a !== void 0
    ? _a
    : false;
}
