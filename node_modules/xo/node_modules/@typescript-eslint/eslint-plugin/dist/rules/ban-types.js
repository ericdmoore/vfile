...
exports.default = util.createRule({
  ...
  create(context, [options]) {
    ...
    const extendDefaults =
      (_a = options.extendDefaults) !== null && _a !== void 0 ? _a : true;
    const customTypes = (_b = options.types) !== null && _b !== void 0
      ? _b
      : {};
    ...
    function checkBannedTypes(
      ...
      const fixWith = bannedType && typeof bannedType === "object" &&
        bannedType.fixWith;
      context.report({
        node: typeNode,
    ...
    const keywordSelectors = util.objectReduceKey(
      ...
      (acc, keyword) => {
        if (bannedTypes.has(keyword)) {
          acc[exports.TYPE_KEYWORDS[keyword]] = (node) =>
