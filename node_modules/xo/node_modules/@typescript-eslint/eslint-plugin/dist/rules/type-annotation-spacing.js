...
function createRules(options) {
  ...
  const override =
    (_a = options === null || options === void 0
          ? void 0
          : options.overrides) !== null && _a !== void 0
      ? _a
      : {};
  const colon = Object.assign(
    Object.assign({ before: false, after: true }, globals),
    override === null || override === void 0 ? void 0 : override.colon,
  );
  const arrow = Object.assign(
    Object.assign({ before: true, after: true }, globals),
    override === null || override === void 0 ? void 0 : override.arrow,
  );
  return {
    colon: colon,
    arrow: arrow,
    variable: Object.assign(
      Object.assign({}, colon),
      override === null || override === void 0 ? void 0 : override.variable,
    ),
    property: Object.assign(
      Object.assign({}, colon),
      override === null || override === void 0 ? void 0 : override.property,
    ),
    parameter: Object.assign(
      Object.assign({}, colon),
      override === null || override === void 0 ? void 0 : override.parameter,
    ),
    returnType: Object.assign(
      Object.assign({}, colon),
      override === null || override === void 0 ? void 0 : override.returnType,
    ),
  };
}
...
function getRules(rules, node) {
  ...
  const scope =
    (_a = node === null || node === void 0 ? void 0 : node.parent) === null ||
      ...
      : _a.parent;
  if (
    (0, util_1.isTSFunctionType)(scope) ||
    (0, util_1.isTSConstructorType)(scope)
  ) {
    return rules.arrow;
...
exports.default = util.createRule({
  ...
  create(context, [options]) {
    ...
    function checkTypeAnnotationSpacing(typeAnnotation) {
      ...
      const previousDelta = punctuatorTokenStart.range[0] -
        previousToken.range[1];
