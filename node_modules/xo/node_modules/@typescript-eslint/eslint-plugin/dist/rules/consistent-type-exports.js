  ...
  create(context) {
    ...
    return {
      ExportNamedDeclaration(node) {
        ...
        const source =
          (_a = getSourceFromExport(node)) !== null && _a !== void 0
            ? _a
            : "undefined";
        const sourceExports =
          (sourceExportsMap[source] || (sourceExportsMap[source] = {
            source,
            reportValueExports: [],
        ...
        for (const sourceExports of Object.values(sourceExportsMap)) {
          ...
          for (const report of sourceExports.reportValueExports) {
            if (!report.valueSpecifiers.length) {
              ...
              const allExportNames = report.typeSpecifiers.map((specifier) =>
...
function getSourceFromExport(node) {
  var _a;
  if (
    ((_a = node.source) === null || _a === void 0 ? void 0 : _a.type) ===
