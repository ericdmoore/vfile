...
exports.default = util.createRule({
  ...
  create(context, [options]) {
            ...
            fix(fixer) {
              ...
              if (util.isParenthesized(arrowBody, sourceCode)) {
                ...
                return fixer.replaceTextRange([
                  bodyOpeningParen.range[0],
                  bodyClosingParen.range[1],
                ], newArrowBodyText);
              }
        ...
        if (
          ...
          return context.report({
            ...
            fix(fixer) {
              ...
              if (
                ((_a = returnStmt.parent) === null || _a === void 0
                  ? void 0
                  : _a.type) !==
    ...
    function findInvalidAncestor(node) {
      ...
      if (
        parent.type === experimental_utils_1.AST_NODE_TYPES.ExpressionStatement
      ) {
        // e.g. `{ console.log("foo"); }`
      ...
      if (parent.type === experimental_utils_1.AST_NODE_TYPES.ChainExpression) {
        // e.g. `console?.log('foo')`
        return findInvalidAncestor(parent);
      }
