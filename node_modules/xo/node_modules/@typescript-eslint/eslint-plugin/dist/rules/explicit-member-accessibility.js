...
exports.default = util.createRule({
  ...
  create(context, [option]) {
    ...
    const baseCheck = (_a = option.accessibility) !== null && _a !== void 0
      ? _a
      : "explicit";
    const overrides = (_b = option.overrides) !== null && _b !== void 0
      ? _b
      : {};
    const ctorCheck = (_c = overrides.constructors) !== null && _c !== void 0
      ? _c
      : baseCheck;
    const accessorCheck = (_d = overrides.accessors) !== null && _d !== void 0
      ? _d
      : baseCheck;
    const methodCheck = (_e = overrides.methods) !== null && _e !== void 0
      ? _e
      : baseCheck;
    const propCheck = (_f = overrides.properties) !== null && _f !== void 0
      ? _f
      : baseCheck;
    const paramPropCheck =
      (_g = overrides.parameterProperties) !== null && _g !== void 0
        ? _g
        : baseCheck;
    const ignoredMethodNames = new Set(
      (_h = option.ignoredMethodNames) !== null && _h !== void 0 ? _h : [],
    );
    /**
    ...
    function getUnwantedPublicAccessibilityFixer(node) {
      return function (fixer) {
        ...
        for (let i = 0; i < tokens.length; i++) {
          ...
          if (
            token.type === experimental_utils_1.AST_TOKEN_TYPES.Keyword &&
            token.value === "public"
          ) {
