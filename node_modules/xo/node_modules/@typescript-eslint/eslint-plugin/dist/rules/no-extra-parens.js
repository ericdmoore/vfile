        ...
        return rule(
          Object.assign(Object.assign({}, node), {
            left: Object.assign(Object.assign({}, node.left), {
              type: experimental_utils_1.AST_NODE_TYPES.SequenceExpression,
            }),
          }),
        );
      }
      ...
      ForStatement(node) {
        ...
        if (node.init && util.isTypeAssertion(node.init)) {
          return rules.ForStatement(
            Object.assign(Object.assign({}, node), { init: null }),
          );
        }
        if (node.test && util.isTypeAssertion(node.test)) {
          return rules.ForStatement(
            Object.assign(Object.assign({}, node), { test: null }),
          );
        }
        if (node.update && util.isTypeAssertion(node.update)) {
          return rules.ForStatement(
            Object.assign(Object.assign({}, node), { update: null }),
          );
        }
      ...
      overrides.ForOfStatement = function (node) {
        if (util.isTypeAssertion(node.right)) {
          ...
          return rules.ForOfStatement(
            Object.assign(Object.assign({}, node), {
              type: experimental_utils_1.AST_NODE_TYPES.ForOfStatement,
              right: Object.assign(Object.assign({}, node.right), {
                type: experimental_utils_1.AST_NODE_TYPES.SequenceExpression,
              }),
            }),
