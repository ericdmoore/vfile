...
exports.default = util.createRule({
  ...
  create(context, [options]) {
    ...
    const overrides = (_a = baseOptions.overrides) !== null && _a !== void 0
      ? _a
      : {};
    ...
    function checkMemberSeparatorStyle(node) {
      const members =
        node.type === experimental_utils_1.AST_NODE_TYPES.TSInterfaceBody
          ? node.body
          : node.members;
      ...
      const opts = isSingleLine
        ? Object.assign(Object.assign({}, typeOpts.singleline), {
          type: "single-line",
        })
