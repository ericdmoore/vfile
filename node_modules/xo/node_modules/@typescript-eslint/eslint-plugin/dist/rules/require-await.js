...
exports.default = util.createRule({
  ...
  create(context) {
    ...
    function markAsHasDelegateGen(node) {
      ...
      if (
        ((_a = node === null || node === void 0 ? void 0 : node.argument) ===
              null || _a === void 0
          ? void 0
          : _a.type) === experimental_utils_1.AST_NODE_TYPES.Literal
      ) {
      ...
      const tsNode = parserServices.esTreeNodeToTSNodeMap.get(
        node === null || node === void 0 ? void 0 : node.argument,
      );
      const type = checker.getTypeAtLocation(tsNode);
      const symbol = type.getSymbol();
      // async function* test1() {yield* asyncGenerator() }
      if (
        (symbol === null || symbol === void 0 ? void 0 : symbol.getName()) ===
          "AsyncGenerator"
      ) {
...
function isEmptyFunction(node) {
  var _a;
  return (((_a = node.body) === null || _a === void 0 ? void 0 : _a.type) ===
