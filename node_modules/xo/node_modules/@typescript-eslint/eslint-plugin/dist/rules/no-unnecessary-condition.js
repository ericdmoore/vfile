...
const isTruthyLiteral = (type) =>
  (0, tsutils_1.isBooleanLiteralType)(type, true) ||
  ((0, tsutils_1.isLiteralType)(type) && !!type.value);
const isPossiblyFalsy = (type) =>
  (0, tsutils_1.unionTypeParts)(type)
    // PossiblyFalsy flag includes literal values, so exclude ones that
    // are definitely truthy
    .filter((t) => !isTruthyLiteral(t))
    .some((type) =>
      (0, util_1.isTypeFlagSet)(type, ts.TypeFlags.PossiblyFalsy)
    );
const isPossiblyTruthy = (type) =>
  (0, tsutils_1.unionTypeParts)(type).some((type) =>
    !(0, tsutils_1.isFalsyType)(type)
  );
// Nullish utilities
const nullishFlag = ts.TypeFlags.Undefined | ts.TypeFlags.Null;
const isNullishType = (type) => (0, util_1.isTypeFlagSet)(type, nullishFlag);
const isPossiblyNullish = (type) =>
  (0, tsutils_1.unionTypeParts)(type).some(isNullishType);
const isAlwaysNullish = (type) =>
  (0, tsutils_1.unionTypeParts)(type).every(isNullishType);
...
exports.default = (0, util_1.createRule)({
  ...
  create(
    ...
    const isStrictNullChecks = (0, tsutils_1.isStrictCompilerOptionEnabled)(
      compilerOptions,
      "strictNullChecks",
    );
    if (
    ...
    function checkNode(node, isUnaryNotArgument = false) {
      ...
      if (
        node.type === experimental_utils_1.AST_NODE_TYPES.LogicalExpression &&
        node.operator !== "??"
      ) {
      ...
      if (
        (0, tsutils_1.unionTypeParts)(type).some((part) =>
          (0, util_1.isTypeAnyType)(part) ||
    ...
    function checkNodeForNullish(node) {
      ...
      if (
        (0, util_1.isTypeAnyType)(type) || (0, util_1.isTypeUnknownType)(type)
      ) {
        return;
      }
      let messageId = null;
    ...
    function checkCallExpression(node) {
      ...
      if (isArrayPredicateFunction(node) && node.arguments.length) {
        ...
        const returnTypes = (0, tsutils_1.getCallSignaturesOfType)(
        ...
        if (
          returnTypes.some((t) =>
            (0, util_1.isTypeAnyType)(t) || (0, util_1.isTypeUnknownType)(t)
          )
        ) {
          return;
        }
    ...
    function optionChainContainsOptionArrayIndex(node) {
      ...
      if (
        lhsNode.type === experimental_utils_1.AST_NODE_TYPES.MemberExpression ||
    ...
    function isNullablePropertyType(objType, propertyType) {
      ...
      if (propertyType.isNumberLiteral() || propertyType.isStringLiteral()) {
        const propType = (0, util_1.getTypeOfPropertyOfName)(
          checker,
          objType,
    ...
    function isNullableOriginFromPrev(node) {
      ...
      if (prevType.isUnion() && (0, util_1.isIdentifier)(property)) {
        const isOwnNullable = prevType.types.some((type) => {
          ...
          return propType &&
            (0, util_1.isNullableType)(propType, { allowUndefined: true });
        });
        return (!isOwnNullable &&
          (0, util_1.isNullableType)(prevType, { allowUndefined: true }));
      }
      return false;
    }
    function isOptionableExpression(node) {
      ...
      return ((0, util_1.isTypeAnyType)(type) ||
        ...
        ((0, util_1.isNullableType)(type, { allowUndefined: true }) &&
          isOwnNullable));
    }
    function checkOptionalChain(node, beforeOperator, fix) {
      ...
      const questionDotOperator = (0, util_1.nullThrows)(
        sourceCode.getTokenAfter(beforeOperator, (token) =>
