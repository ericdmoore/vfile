...
var _PatternVisitor_rootPattern,
  _PatternVisitor_callback,
  _PatternVisitor_assignments,
  _PatternVisitor_restElements;
...
class PatternVisitor extends VisitorBase_1.VisitorBase {
  ...
  AssignmentPattern(pattern) {
    __classPrivateFieldGet(this, _PatternVisitor_assignments, "f").push(
      pattern,
    );
    ...
    const lastRestElement =
      (_a =
            __classPrivateFieldGet(
              ...
              __classPrivateFieldGet(this, _PatternVisitor_restElements, "f")
                .length - 1
            ]) !== null && _a !== void 0
        ? _a
        : null;
    __classPrivateFieldGet(this, _PatternVisitor_callback, "f").call(
      this,
      pattern,
      {
        topLevel:
          pattern ===
            __classPrivateFieldGet(this, _PatternVisitor_rootPattern, "f"),
        rest: lastRestElement !== null &&
          lastRestElement !== undefined &&
          lastRestElement.argument === pattern,
        assignments: __classPrivateFieldGet(
          this,
          _PatternVisitor_assignments,
          "f",
        ),
  ...
  RestElement(pattern) {
    __classPrivateFieldGet(this, _PatternVisitor_restElements, "f").push(
      pattern,
    );
...
_PatternVisitor_rootPattern = new WeakMap(),
  _PatternVisitor_callback = new WeakMap(),
  _PatternVisitor_assignments = new WeakMap(),
  _PatternVisitor_restElements = new WeakMap();
