...
class TypeVisitor extends Visitor_1.Visitor {
  ...
  visitFunctionType(node) {
    ...
    __classPrivateFieldGet(this, _TypeVisitor_referencer, "f").scopeManager
  ...
  /////////////////////
  Identifier(node) {
    __classPrivateFieldGet(this, _TypeVisitor_referencer, "f").currentScope()
      .referenceType(node);
  }
  ...
  TSInferType(node) {
    ...
    let scope = __classPrivateFieldGet(this, _TypeVisitor_referencer, "f")
      .currentScope();
    /*
        ...
        */
    if (
      scope.type === scope_1.ScopeType.functionType ||
      ...
      while (currentScope) {
        if (
          currentScope.type === scope_1.ScopeType.functionType ||
    ...
    scope.defineIdentifier(
      typeParameter.name,
      new definition_1.TypeDefinition(typeParameter.name, typeParameter),
    );
  }
  TSInterfaceDeclaration(node) {
    ...
    __classPrivateFieldGet(this, _TypeVisitor_referencer, "f")
      ...
      .defineIdentifier(
        node.id,
        new definition_1.TypeDefinition(node.id, node),
      );
    ...
    (_a = node.extends) === null || _a === void 0
      ? void 0
      : _a.forEach(this.visit, this);
    (_b = node.implements) === null || _b === void 0
      ? void 0
      : _b.forEach(this.visit, this);
  ...
  TSTypeParameter(node) {
    __classPrivateFieldGet(this, _TypeVisitor_referencer, "f")
      ...
      .defineIdentifier(
        node.name,
        new definition_1.TypeDefinition(node.name, node),
      );
  ...
  TSTypePredicate(node) {
    if (node.parameterName.type !== types_1.AST_NODE_TYPES.TSThisType) {
      __classPrivateFieldGet(this, _TypeVisitor_referencer, "f").currentScope()
        .referenceValue(node.parameterName);
    }
    this.visit(node.typeAnnotation);
  }
