...
class ImportVisitor extends Visitor_1.Visitor {
  ...
  visitImport(id, specifier) {
    __classPrivateFieldGet(this, _ImportVisitor_referencer, "f")
      ...
      .defineIdentifier(
        id,
        new definition_1.ImportBindingDefinition(
          id,
          specifier,
          __classPrivateFieldGet(this, _ImportVisitor_declaration, "f"),
        ),
      );
  }
...
_ImportVisitor_declaration = new WeakMap(),
  _ImportVisitor_referencer = new WeakMap();
