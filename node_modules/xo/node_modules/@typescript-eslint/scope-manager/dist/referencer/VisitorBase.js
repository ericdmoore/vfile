...
var _VisitorBase_childVisitorKeys,
  _VisitorBase_visitChildrenEvenIfSelectorExists;
...
class VisitorBase {
  constructor(options) {
    ...
    __classPrivateFieldSet(
      ...
      (_a = options.childVisitorKeys) !== null && _a !== void 0
        ? _a
        : visitor_keys_1.visitorKeys,
      "f",
    );
    __classPrivateFieldSet(
      this,
      _VisitorBase_visitChildrenEvenIfSelectorExists,
      (_b = options.visitChildrenEvenIfSelectorExists) !== null && _b !== void 0
        ? _b
        : false,
      "f",
    );
...
_VisitorBase_childVisitorKeys = new WeakMap(),
  _VisitorBase_visitChildrenEvenIfSelectorExists = new WeakMap();
