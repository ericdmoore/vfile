...
const ClassFieldInitializerScope_1 = require(
...
class ScopeManager {
  ...
  isGlobalReturn() {
    return __classPrivateFieldGet(this, _ScopeManager_options, "f")
      .globalReturn === true;
  }
  isModule() {
    return __classPrivateFieldGet(this, _ScopeManager_options, "f")
  ...
  isStrictModeSupported() {
    return __classPrivateFieldGet(this, _ScopeManager_options, "f")
          .ecmaVersion != null &&
      __classPrivateFieldGet(this, _ScopeManager_options, "f").ecmaVersion >= 5;
  }
  isES6() {
    return __classPrivateFieldGet(this, _ScopeManager_options, "f")
          .ecmaVersion != null &&
      __classPrivateFieldGet(this, _ScopeManager_options, "f").ecmaVersion >= 6;
  }
  /**
  ...
  getDeclaredVariables(node) {
    var _a;
    return (_a = this.declaredVariables.get(node)) !== null && _a !== void 0
      ? _a
      : [];
  }
  /**
  ...
  nestBlockScope(node) {
    ...
    return this.nestScope(
      new scope_1.BlockScope(this, this.currentScope, node),
    );
  }
  nestCatchScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.CatchScope(this, this.currentScope, node),
    );
  }
  nestClassScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.ClassScope(this, this.currentScope, node),
    );
  }
  nestClassFieldInitializerScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new ClassFieldInitializerScope_1.ClassFieldInitializerScope(
        this,
        this.currentScope,
        node,
      ),
  ...
  nestConditionalTypeScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.ConditionalTypeScope(this, this.currentScope, node),
    );
  }
  nestForScope(node) {
    (0, assert_1.assert)(this.currentScope);
  ...
  nestFunctionExpressionNameScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.FunctionExpressionNameScope(this, this.currentScope, node),
    );
  }
  nestFunctionScope(node, isMethodDefinition) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.FunctionScope(
        this,
        this.currentScope,
        node,
        isMethodDefinition,
  ...
  nestFunctionTypeScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.FunctionTypeScope(this, this.currentScope, node),
    );
  }
  ...
  nestMappedTypeScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.MappedTypeScope(this, this.currentScope, node),
    );
  }
  nestModuleScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.ModuleScope(this, this.currentScope, node),
    );
  }
  nestSwitchScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.SwitchScope(this, this.currentScope, node),
    );
  }
  nestTSEnumScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.TSEnumScope(this, this.currentScope, node),
    );
  }
  nestTSModuleScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new scope_1.TSModuleScope(this, this.currentScope, node),
    );
  }
  nestTypeScope(node) {
    (0, assert_1.assert)(this.currentScope);
