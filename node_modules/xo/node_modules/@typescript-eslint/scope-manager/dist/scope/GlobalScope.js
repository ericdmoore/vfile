...
const ImplicitGlobalVariableDefinition_1 = require(
  "../definition/ImplicitGlobalVariableDefinition",
);
...
class GlobalScope extends ScopeBase_1.ScopeBase {
  ...
  defineImplicitVariable(name, options) {
    this.defineVariable(
      new variable_1.ImplicitLibVariable(this, name, options),
      this.set,
      this.variables,
      null,
      null,
      ...
      if (ref.maybeImplicitGlobal && !this.set.has(ref.identifier.name)) {
        ...
        if (node && node.type === types_1.AST_NODE_TYPES.Identifier) {
          this.defineVariable(
            ...
            node,
            new ImplicitGlobalVariableDefinition_1
              .ImplicitGlobalVariableDefinition(info.pattern, info.node),
          );
        }
      }
    }
