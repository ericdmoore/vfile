...
var _ScopeBase_declaredVariables,
  _ScopeBase_dynamic,
  _ScopeBase_staticCloseRef,
  _ScopeBase_dynamicCloseRef,
  _ScopeBase_globalCloseRef;
...
function isStrictScope(scope, block, isMethodDefinition) {
  ...
  if (
    scope.type === ScopeType_1.ScopeType.class ||
  ...
  if (
    scope.type === ScopeType_1.ScopeType.block ||
    scope.type === ScopeType_1.ScopeType.switch
  ) {
    return false;
  }
...
class ScopeBase {
  constructor(scopeManager, type, upperScope, block, isMethodDefinition) {
    ...
    _ScopeBase_staticCloseRef.set(this, (ref) => {
      const resolve = () => {
        ...
        const isValidTypeReference = ref.isTypeReference &&
          variable.isTypeVariable;
        const isValidValueReference = ref.isValueReference &&
    ...
    _ScopeBase_globalCloseRef.set(this, (ref, scopeManager) => {
      ...
      if (this.shouldStaticallyCloseForGlobal(ref, scopeManager)) {
        __classPrivateFieldGet(this, _ScopeBase_staticCloseRef, "f").call(
          this,
          ref,
        );
      } else {
        __classPrivateFieldGet(this, _ScopeBase_dynamicCloseRef, "f").call(
          this,
          ref,
        );
      }
    ...
    __classPrivateFieldSet(
      this,
      _ScopeBase_dynamic,
      this.type === ScopeType_1.ScopeType.global ||
        this.type === ScopeType_1.ScopeType.with,
      "f",
    );
    this.block = block;
    ...
    __classPrivateFieldSet(
      this,
      _ScopeBase_declaredVariables,
      scopeManager.declaredVariables,
      "f",
    );
  ...
  shouldStaticallyCloseForGlobal(ref, scopeManager) {
    ...
    return (defs.length > 0 &&
      defs.every((def) => {
        var _a;
        if (
          def.type === definition_1.DefinitionType.Variable &&
          ((_a = def.parent) === null || _a === void 0 ? void 0 : _a.type) ===
            types_1.AST_NODE_TYPES.VariableDeclaration &&
          def.parent.kind === "var"
        ) {
          return false;
        }
  ...
  addDeclaredVariablesOfNode(variable, node) {
    ...
    let variables = __classPrivateFieldGet(
      this,
      _ScopeBase_declaredVariables,
      "f",
    ).get(node);
    if (variables == null) {
      variables = [];
      __classPrivateFieldGet(this, _ScopeBase_declaredVariables, "f").set(
        node,
        variables,
      );
    }
  ...
  referenceValue(
    node,
    assign = Reference_1.ReferenceFlag.Read,
    writeExpr,
    maybeImplicitGlobal,
    init = false,
  ) {
    var _a;
    const ref = new Reference_1.Reference(
      node,
      this,
      assign,
      writeExpr,
      maybeImplicitGlobal,
      init,
      Reference_1.ReferenceTypeFlag.Value,
    );
  ...
  referenceType(node) {
    ...
    const ref = new Reference_1.Reference(
      node,
      this,
      Reference_1.ReferenceFlag.Read,
      null,
      null,
      false,
      Reference_1.ReferenceTypeFlag.Type,
    );
    this.references.push(ref);
    (_a = this.leftToResolve) === null || _a === void 0 ? void 0 : _a.push(ref);
  }
  referenceDualValueType(node) {
    ...
    const ref = new Reference_1.Reference(
      ...
      null,
      false,
      Reference_1.ReferenceTypeFlag.Type | Reference_1.ReferenceTypeFlag.Value,
    );
    this.references.push(ref);
    (_a = this.leftToResolve) === null || _a === void 0 ? void 0 : _a.push(ref);
  }
...
_ScopeBase_declaredVariables = new WeakMap(),
  _ScopeBase_dynamic = new WeakMap(),
  _ScopeBase_staticCloseRef = new WeakMap(),
  _ScopeBase_dynamicCloseRef = new WeakMap(),
  _ScopeBase_globalCloseRef = new WeakMap();
