...
declare type ReportFixFunction = (
  fixer: RuleFixer,
) => null | RuleFix | readonly RuleFix[] | IterableIterator<RuleFix>;
declare type ReportSuggestionArray<TMessageIds extends string> =
...
declare type ReportDescriptor<TMessageIds extends string> =
...
declare type RuleFunction<T extends TSESTree.BaseNode = never> = (
  node: T,
) => void;
...
declare type RuleCreateFunction<
