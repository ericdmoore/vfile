...
declare const isOptionalChainPunctuator: (
...
declare function isNotOptionalChainPunctuator(
...
>;
declare const isNonNullAssertionPunctuator: (
  token: TSESTree.Token | null | undefined,
) => token is TSESTree.PunctuatorToken & {
  type: AST_TOKEN_TYPES.Punctuator;
} & {
...
declare function isNotNonNullAssertionPunctuator(
  token: TSESTree.Token,
): token is Exclude<
  TSESTree.Token,
  TSESTree.PunctuatorToken & {
 ...
 */
declare const isOptionalCallExpression: (
 ...
 */
declare const isLogicalOrOperator: (
  node: TSESTree.Node | null | undefined,
...
declare const isVariableDeclarator: (
  node: TSESTree.Node | null | undefined,
...
declare const isFunctionOrFunctionType: (
  node: TSESTree.Node | null | undefined,
) => node is
  | (TSESTree.ArrowFunctionExpression & {
    type:
...
declare const isTSFunctionType: (
  node: TSESTree.Node | null | undefined,
) => node is TSESTree.TSFunctionType & {
  type: AST_NODE_TYPES.TSFunctionType;
};
declare const isTSConstructorType: (
  node: TSESTree.Node | null | undefined,
) => node is TSESTree.TSConstructorType & {
  type: AST_NODE_TYPES.TSConstructorType;
};
declare const isClassOrTypeElement: (
  node: TSESTree.Node | null | undefined,
) => node is
  | (TSESTree.FunctionExpression & {
    type:
 ...
 */
declare const isAwaitExpression: (
  node: TSESTree.Node | null | undefined,
