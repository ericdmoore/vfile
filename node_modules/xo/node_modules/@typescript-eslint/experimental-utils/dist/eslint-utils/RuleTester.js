...
class RuleTester extends TSESLint.RuleTester {
      ...
      Object.assign(Object.assign({}, options), {
        parserOptions: Object.assign(Object.assign({}, options.parserOptions), {
          warnOnUnsupportedTypeScriptVersion:
            (_b = (_a = options.parserOptions) === null || _a === void 0
                  ? void 0
                  : _a.warnOnUnsupportedTypeScriptVersion) !== null &&
              _b !== void 0
              ? _b
              : false,
        }),
  ...
  getFilename(options) {
    ...
    if (options) {
      const filename = `file.ts${
        ((_a = options.ecmaFeatures) === null || _a === void 0
            ? void 0
            : _a.jsx)
          ? "x"
          : ""
      ...
      __classPrivateFieldGet(this, _RuleTester_options, "f").parserOptions
    ) {
  ...
  run(name, rule, testsReadonly) {
    const errorMessage =
      `Do not set the parser at the test level unless you want to use a parser other than ${parser}`;
