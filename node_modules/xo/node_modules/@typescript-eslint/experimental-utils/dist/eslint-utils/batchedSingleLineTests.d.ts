import { InvalidTestCase, ValidTestCase } from "../ts-eslint";
/**
 ...
 */
declare function batchedSingleLineTests<TOptions extends Readonly<unknown[]>>(
 ...
 */
declare function batchedSingleLineTests<
