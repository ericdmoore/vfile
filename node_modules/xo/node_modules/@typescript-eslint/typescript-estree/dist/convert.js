...
function convertError(error) {
  return (0, node_utils_1.createError)(
    error.file,
    error.start,
...
class Converter {
  ...
  converter(node, parent, inTypeMode, allowPattern) {
    ...
    const result = this.convertNode(
      node,
      parent !== null && parent !== void 0 ? parent : node.parent,
    );
  ...
  fixExports(node, result) {
    ...
    if (node.modifiers && node.modifiers[0].kind === SyntaxKind.ExportKeyword) {
      ...
      const declarationIsDefault = nextModifier &&
      ...
      result.loc = (0, node_utils_1.getLocFor)(
        result.range[0],
        result.range[1],
        this.ast,
      );
      if (declarationIsDefault) {
        ...
        const isType =
          result.type === ts_estree_1.AST_NODE_TYPES.TSInterfaceDeclaration ||
  ...
  convertTypeAnnotation(child, parent) {
    ...
    const offset =
      (parent === null || parent === void 0 ? void 0 : parent.kind) ===
    ...
    const loc = (0, node_utils_1.getLocFor)(
      annotationStartCol,
      child.end,
      this.ast,
    );
  ...
  convertBodyExpressions(nodes, parent) {
    ...
    return (nodes
      .map((statement) => {
        ...
        if (allowDirectives) {
          if (
            (child === null || child === void 0 ? void 0 : child.expression) &&
  ...
  convertTypeArgumentsToTypeParameters(typeArguments, node) {
    const greaterThanToken = (0, node_utils_1.findNextToken)(
      typeArguments,
      this.ast,
      this.ast,
    );
  ...
  convertChainExpression(node, tsNode) {
    ...
    const isChildUnwrappable =
      (0, node_utils_1.isChildUnwrappableOptionalChain)(tsNode, child);
  ...
  deeplyCopy(node) {
    if (node.kind === ts.SyntaxKind.JSDocFunctionType) {
      throw (0, node_utils_1.createError)(
        this.ast,
        node.pos,
    ...
    Object.entries(node)
      .filter(([key]) =>
        !/^(?:_children|kind|parent|pos|end|flags|modifierFlagsCache|jsDoc|type|typeArguments|typeParameters|decorators|transformFlags)$/
          .test(key)
      )
      .forEach(([key, value]) => {
  ...
  fixParentLocation(result, childRange) {
    if (childRange[0] < result.range[0]) {
      ...
      result.loc.start = (0, node_utils_1.getLineAndCharacterFor)(
        result.range[0],
        this.ast,
      );
    }
    if (childRange[1] > result.range[1]) {
      ...
      result.loc.end = (0, node_utils_1.getLineAndCharacterFor)(
        result.range[1],
        this.ast,
      );
    }
  ...
  convertNode(node, parent) {
    ...
    switch (node.kind) {
      ...
      case SyntaxKind.FunctionDeclaration: {
        const isDeclare = (0, node_utils_1.hasModifier)(
      ...
      case SyntaxKind.PropertyDeclaration: {
        const isAbstract = (0, node_utils_1.hasModifier)(
        ...
        const result = this.createNode(node, {
          ...
          readonly:
            (0, node_utils_1.hasModifier)(SyntaxKind.ReadonlyKeyword, node) ||
            undefined,
          declare: (0, node_utils_1.hasModifier)(
            SyntaxKind.DeclareKeyword,
            node,
          ),
          override: (0, node_utils_1.hasModifier)(
        ...
        if (
          result.key.type === ts_estree_1.AST_NODE_TYPES.Literal &&
          node.questionToken
        ) {
          result.optional = true;
        }
      ...
      case SyntaxKind.MethodDeclaration: {
        ...
        if (parent.kind === SyntaxKind.ObjectLiteralExpression) {
          ...
          const methodDefinitionType =
            (0, node_utils_1.hasModifier)(SyntaxKind.AbstractKeyword, node)
          ...
          result = this.createNode(node, {
            ...
            value: method,
            computed: (0, node_utils_1.isComputedProperty)(node.name),
            static: (0, node_utils_1.hasModifier)(
      ...
      case SyntaxKind.Constructor: {
        ...
        const constructorToken =
          (lastModifier &&
            (0, node_utils_1.findNextToken)(lastModifier, node, this.ast)) ||
          node.getFirstToken();
        ...
        // Process typeParameters
        if (node.typeParameters) {
          constructor.typeParameters = this
            .convertTSTypeParametersToTypeParametersDeclaration(
              node.typeParameters,
            );
        ...
        const isStatic = (0, node_utils_1.hasModifier)(
          SyntaxKind.StaticKeyword,
          node,
        );
        const result = this.createNode(node, {
          ...
          if (node.dotDotDotToken) {
            result = this.createNode(node, {
              ...
              argument: this.convertChild(
                (_a = node.propertyName) !== null && _a !== void 0
                  ? _a
                  : node.name,
              ),
            });
            ...
            result = this.createNode(node, {
              ...
              key: this.convertChild(
                (_b = node.propertyName) !== null && _b !== void 0
                  ? _b
                  : node.name,
              ),
              value: this.convertChild(node.name),
      ...
      case SyntaxKind.Parameter: {
        ...
        if (node.questionToken) {
          if (node.questionToken.end > parameter.range[1]) {
            ...
            parameter.loc.end = (0, node_utils_1.getLineAndCharacterFor)(
              parameter.range[1],
              this.ast,
            );
          }
        ...
        if (node.modifiers) {
          return this.createNode(node, {
            ...
            accessibility:
              (_c = (0, node_utils_1.getTSNodeAccessibility)(node)) !== null &&
                _c !== void 0
                ? _c
                : undefined,
            readonly:
              ...
              undefined,
            static:
              (0, node_utils_1.hasModifier)(SyntaxKind.StaticKeyword, node) ||
              undefined,
            export:
              (0, node_utils_1.hasModifier)(SyntaxKind.ExportKeyword, node) ||
              undefined,
            override:
              (0, node_utils_1.hasModifier)(SyntaxKind.OverrideKeyword, node) ||
              undefined,
            parameter: result,
          });
        }
      ...
      case SyntaxKind.ClassExpression: {
        const heritageClauses =
          (_d = node.heritageClauses) !== null && _d !== void 0 ? _d : [];
        ...
        const superClass = heritageClauses.find((clause) =>
          clause.token === SyntaxKind.ExtendsKeyword
        );
        const implementsClause = heritageClauses.find((clause) =>
        ...
        const result = this.createNode(node, {
          ...
          superClass: (superClass === null || superClass === void 0
              ? void 0
              : superClass.types[0])
        ...
        if (superClass) {
          ...
          if (
            (_e = superClass.types[0]) === null || _e === void 0
              ? void 0
              : _e.typeArguments
          ) {
            result.superTypeParameters = this
      ...
      case SyntaxKind.ImportSpecifier:
        return this.createNode(node, {
          ...
          imported: this.convertChild(
            (_f = node.propertyName) !== null && _f !== void 0 ? _f : node.name,
          ),
      ...
      case SyntaxKind.ExportDeclaration: {
        this.assertModuleSpecifier(node);
        if (
          ((_g = node.exportClause) === null || _g === void 0
            ? void 0
            : _g.kind) === SyntaxKind.NamedExports
        ) {
          return this.createNode(node, {
            type: ts_estree_1.AST_NODE_TYPES.ExportNamedDeclaration,
            source: this.convertChild(node.moduleSpecifier),
      ...
      case SyntaxKind.ExportSpecifier:
        return this.createNode(node, {
          ...
          local: this.convertChild(
            (_h = node.propertyName) !== null && _h !== void 0 ? _h : node.name,
          ),
      ...
      case SyntaxKind.BinaryExpression: {
        ...
        if ((0, node_utils_1.isComma)(node.operatorToken)) {
          ...
          if (
            left.type === ts_estree_1.AST_NODE_TYPES.SequenceExpression &&
          ...
          const type = (0, node_utils_1.getBinaryExpressionType)(
            node.operatorToken,
          );
          if (
            this.allowPattern &&
          ...
          return this.createNode(node, {
            type,
            operator: (0, node_utils_1.getTextForTokenKind)(
      ...
      case SyntaxKind.NullKeyword: {
        if (
          !version_check_1.typescriptVersionIsAtLeast["4.0"] && this.inTypeMode
        ) {
      ...
      case SyntaxKind.MappedType: {
        const result = this.createNode(node, {
          ...
          nameType:
            (_j = this.convertType(node.nameType)) !== null && _j !== void 0
              ? _j
              : null,
        });
        if (node.readonlyToken) {
          if (node.readonlyToken.kind === SyntaxKind.ReadonlyKeyword) {
            ...
            result.readonly = (0, node_utils_1.getTextForTokenKind)(
        ...
        if (node.questionToken) {
          if (node.questionToken.kind === SyntaxKind.QuestionToken) {
            ...
            result.optional = (0, node_utils_1.getTextForTokenKind)(
      ...
      case SyntaxKind.ConstructorType: {
        const result = this.createNode(node, {
          ...
          params: this.convertParameters(node.parameters),
          abstract: (0, node_utils_1.hasModifier)(
            SyntaxKind.AbstractKeyword,
            node,
          ),
        });
      ...
      case SyntaxKind.InterfaceDeclaration: {
        const interfaceHeritageClauses =
          (_k = node.heritageClauses) !== null && _k !== void 0 ? _k : [];
        const result = this.createNode(node, {
      ...
      case SyntaxKind.LiteralType: {
        if (
          version_check_1.typescriptVersionIsAtLeast["4.0"] &&
      ...
      case SyntaxKind.ImportEqualsDeclaration: {
        return this.createNode(node, {
          ...
          importKind: node.isTypeOnly ? "type" : "value",
          isExport: (0, node_utils_1.hasModifier)(
