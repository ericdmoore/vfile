 ...
 */
export declare function isAssignmentOperator<T extends ts.SyntaxKind>(
  operator: ts.Token<T>,
): boolean;
/**
 ...
 */
export declare function isLogicalOperator<T extends ts.SyntaxKind>(
  operator: ts.Token<T>,
): boolean;
/**
 ...
 */
export declare function getTextForTokenKind<T extends ts.SyntaxKind>(
  kind: T,
 ...
 * @returns is comma
 */
export declare function isComma(
  token: ts.Node,
 ...
 */
export declare function getBinaryExpressionType<T extends ts.SyntaxKind>(
  operator: ts.Token<T>,
):
 ...
 */
export declare function getLineAndCharacterFor(
  pos: number,
  ast: ts.SourceFile,
): TSESTree.Position;
/**
 ...
 */
export declare function getLocFor(
  start: number,
  end: number,
  ast: ts.SourceFile,
 ...
 */
export declare function canContainDirective(
  node:
    | ts.SourceFile
    | ts.Block
    | ts.ModuleBlock
 ...
 */
export declare function getDeclarationKind(
 ...
 */
export declare function getTSNodeAccessibility(
  node: ts.Node,
 ...
 */
export declare function findNextToken(
 ...
 */
export declare function findFirstMatchingAncestor(
  node: ts.Node,
 ...
 */
export declare function isComputedProperty(
  node: ts.Node,
 ...
 */
export declare function isChainExpression(
  node: TSESTree.Node,
): node is TSESTree.ChainExpression;
/**
 * Returns true of the child of property access expression is an optional chain
 */
export declare function isChildUnwrappableOptionalChain(
  node:
 ...
 */
export declare function convertToken(
 ...
 * @param callback
 */
export declare function firstDefined<T, U>(
