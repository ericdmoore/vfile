...
function createProjectProgram(code, createDefaultProgram, extra) {
  ...
  const astAndProgram = (0, node_utils_1.firstDefined)(
    (0, createWatchProgram_1.getProgramsForProjects)(
      code,
      extra.filePath,
      extra,
    ),
    (currentProgram) => (0, shared_1.getAstFromProgram)(currentProgram, extra),
  );
  if (!astAndProgram && !createDefaultProgram) {
    ...
    if (!DEFAULT_EXTRA_FILE_EXTENSIONS.includes(fileExtension)) {
      const nonStandardExt =
        `The extension for the file (${fileExtension}) is non-standard`;
