...
v3.0 is a complete refactor, resulting in a faster, smaller codebase, with fewer
deps, and a more accurate parser and compiler.
...
- fixes the first example in
  https://github.com/jonschlinkert/micromatch/issues/38
