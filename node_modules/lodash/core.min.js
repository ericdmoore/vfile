 ...
 */(function () {
  ...
  function a(n, t, r) {
    for (var e = -1, u = n.length; ++e < u;) {
      var o = n[e], i = t(o);
      if (null != i && (c === Z ? i === i : r(i, c))) var c = i, f = o;
    }
    return f;
  }
  function l(n, t) {
  ...
  function g(n) {
    return typeof n == "function"
      ...
      : null == n
      ? X
      : (typeof n == "object" ? d : r)(n);
  }
  function _(n, t) {
    return n < t;
  }
  function j(n, t) {
    var r = -1, e = M(n) ? Array(n.length) : [];
  ...
  function B(n, t, r, e, u, o) {
    var i = 1 & r, c = Dn(n), f = c.length, a = Dn(t).length;
    if (f != a && !i) return false;
    for (a = f; a--;) {
      var l = c[a];
      if (!(i ? l in t : pn.call(t, l))) return false;
    }
    var p = o.get(n), l = o.get(t);
    if (p && l) return p == t && l == n;
    for (p = true; ++a < f;) {
      var l = c[a], s = n[l], h = t[l];
    ...
    return p && !i &&
      (r = n.constructor,
        ...
        !(typeof r == "function" && r instanceof r && typeof e == "function" &&
          e instanceof e) &&
        (p = false)),
      p;
  }
  ...
  function I(n, t, r) {
    return t = jn(t === Z ? n.length - 1 : t, 0), function () {
      for (
        var e = arguments, u = -1, o = jn(e.length - t, 0), i = Array(o);
        ++u < o;
      ) {
        i[u] = e[t + u];
      }
  ...
  function L(n) {
    return typeof n == "string" ||
      !Nn(n) && H(n) && "[object String]" == hn.call(n);
  }
  function Q(n) {
  ...
  function Y(n, r, e) {
    var u = Dn(r), o = h(r, u);
    null != e || V(r) && (o.length || !u.length) ||
      (e = r, r = n, n = this, o = h(r, Dn(r)));
    var i = !(V(e) && "chain" in e && !e.chain), c = U(n);
  ...
  var Z,
    ...
    on =
      typeof global == "object" && global && global.Object === Object &&
        global || un || Function("return this")(),
    cn =
      (un = typeof exports == "object" && exports && !exports.nodeType &&
        exports) &&
    ...
    dn = function () {
      ...
      return function (t) {
        return V(t)
          ? bn ? bn(t) : (n.prototype = t, t = new n(), n.prototype = Z, t)
          : {};
      };
    }();
          ...
          if ("number" == c) {
            if (c = M(o)) {
              var c = o.length,
                ...
                c = !!c && ("number" == f || "symbol" != f && en.test(i)) &&
                  -1 < i && 0 == i % 1 && i < c;
            }
  ...
  o.assignIn = Bn,
    ...
    o.isBoolean = function (n) {
      return true === n || false === n ||
        H(n) && "[object Boolean]" == hn.call(n);
    },
    o.isDate = function (n) {
      return H(n) && "[object Date]" == hn.call(n);
    },
    o.isEmpty = function (t) {
      return M(t) && (Nn(t) || L(t) || U(t.splice) || n(t)) ? !t.length
      : !_n(t).length;
    },
