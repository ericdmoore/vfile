 ...
 */(function () {
  ...
  var rsMiscLower = "(?:" + rsLower + "|" + rsMisc + ")",
    ...
    rsOptVar = "[" + rsVarRange + "]?",
    rsOptJoin = "(?:" + rsZWJ + "(?:" +
      [rsNonAstral, rsRegional, rsSurrPair].join("|") + ")" + rsOptVar +
      reOptMod + ")*",
    rsOrdLower = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",
    rsOrdUpper = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",
    rsSeq = rsOptVar + reOptMod + rsOptJoin,
    rsEmoji = "(?:" + [rsDingbat, rsRegional, rsSurrPair].join("|") + ")" +
      rsSeq,
    rsSymbol = "(?:" +
                  ...
                  cloneableTags[stringTag] = cloneableTags[symbolTag] =
                    cloneableTags[uint8Tag] = cloneableTags[uint8ClampedTag] =
                      cloneableTags[uint16Tag] = cloneableTags[uint32Tag] =
                        true;
  cloneableTags[errorTag] = cloneableTags[funcTag] = cloneableTags[weakMapTag] =
    false;
  ...
  var runInContext = (function runInContext(context) {
    ...
    /** Mocked built-ins. */
    var ctxClearTimeout = context.clearTimeout !== root.clearTimeout &&
        context.clearTimeout,
      ctxNow = Date && Date.now !== root.Date.now && Date.now,
      ctxSetTimeout = context.setTimeout !== root.setTimeout &&
        context.setTimeout;
    ...
    function baseSortedIndex(array, value, retHighest) {
      ...
      if (
        ...
        while (low < high) {
          ...
          if (
            computed !== null && !isSymbol(computed) &&
    ...
    function compareAscending(value, other) {
      if (value !== other) {
        ...
        if (
          ...
          (valIsSymbol && othIsDefined && othIsReflexive && !othIsNull &&
            !othIsSymbol) ||
        ...
        if (
          ...
          (othIsSymbol && valIsDefined && valIsReflexive && !valIsNull &&
            !valIsSymbol) ||
      ...
      return flatRest(function (funcs) {
        ...
        while (++index < length) {
          ...
          if (
            ...
            data[1] ==
              (WRAP_ARY_FLAG | WRAP_CURRY_FLAG | WRAP_PARTIAL_FLAG |
                WRAP_REARG_FLAG) &&
    ...
    function createRange(fromRight) {
      return function (start, end, step) {
        if (
          step && typeof step != "number" && isIterateeCall(start, end, step)
        ) {
          end = step = undefined;
        }
    ...
    function createWrap(
      ...
      if (!bitmask || bitmask == WRAP_BIND_FLAG) {
        ...
        (bitmask == WRAP_PARTIAL_FLAG ||
          bitmask == (WRAP_BIND_FLAG | WRAP_PARTIAL_FLAG)) && !holders.length
      ) {
    ...
    function mergeData(data, source) {
      ...
      var isCombo =
        ...
        ((srcBitmask == WRAP_ARY_FLAG) && (bitmask == WRAP_REARG_FLAG) &&
          (data[7].length <= source[8])) ||
        ((srcBitmask == (WRAP_ARY_FLAG | WRAP_REARG_FLAG)) &&
          (source[7].length <= source[8]) && (bitmask == WRAP_CURRY_FLAG));
    ...
    function fill(array, value, start, end) {
      ...
      if (
        start && typeof start != "number" && isIterateeCall(array, value, start)
      ) {
        start = 0;
        end = length;
      }
    ...
    var zipWith = baseRest(function (arrays) {
      ...
      iteratee = typeof iteratee == "function"
        ? (arrays.pop(), iteratee)
        : undefined;
    ...
    var sortBy = baseRest(function (collection, iteratees) {
      ...
      if (
        ...
        length > 2 && isIterateeCall(iteratees[0], iteratees[1], iteratees[2])
      ) {
    ...
    function isSafeInteger(value) {
      return isInteger(value) && value >= -MAX_SAFE_INTEGER &&
    ...
    function random(lower, upper, floating) {
      if (
        floating && typeof floating != "boolean" &&
    ...
    function template(string, options, guard) {
      ...
      var variable = hasOwnProperty.call(options, "variable") &&
        options.variable;
      if (!variable) {
        source = "with (obj) {\n" + source + "\n}\n";
    ...
    baseForOwn(LazyWrapper.prototype, function (func, methodName) {
      ...
      lodash.prototype[methodName] = function () {
        ...
        if (
          useLazy && checkIteratee && typeof iteratee == "function" &&
          iteratee.length != 1
        ) {
    ...
    lodash.prototype.toJSON = lodash.prototype.valueOf = lodash.prototype
      .value = wrapperValue;
