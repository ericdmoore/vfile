...
You can use this package to check that table cell dividers are aligned. Tables
are a GFM feature enabled with
...
While aligning table dividers improves their legibility, it is somewhat hard to
maintain manually, especially for tables with many rows.

## Fix

[`remark-gfm`](https://github.com/remarkjs/remark-gfm) aligns table dividers by
default. Pass
...
depends on where the markup is shown: some characters (such as emoji or Chinese
characters) show smaller or bigger in different places. You can pass your own
[`stringLength`](https://github.com/remarkjs/remark-gfm#optionsstringlength) to
