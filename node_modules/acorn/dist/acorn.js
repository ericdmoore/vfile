(function (global, factory) {
  ...
  function getOptions(opts) {
    ...
    for (var opt in defaultOptions) {
      options[opt] = opts && hasOwn(opts, opt)
        ? opts[opt]
        : defaultOptions[opt];
    }
  ...
  pp$9.isContextual = function (name) {
    return this.type === types$1.name && this.value === name &&
      !this.containsEsc;
  };
  ...
  pp$8.parseExport = function (node, exports) {
    ...
    if (this.eat(types$1._default)) { // export default ...
      ...
      var isAsync;
      if (
        this.type === types$1._function || (isAsync = this.isAsyncFunction())
      ) {
  ...
  types$1.parenL.updateContext = function (prevType) {
    var statementParens = prevType === types$1._if ||
      prevType === types$1._for || prevType === types$1._with ||
  ...
  pp$5.parseParenAndDistinguishExpression = function (canBeArrow, forInit) {
    ...
    if (this.options.ecmaVersion >= 6) {
      ...
      while (this.type !== types$1.parenR) {
        ...
        if (
          allowTrailingComma && this.afterTrailingComma(types$1.parenR, true)
        ) {
          lastIsComma = true;
          break;
        } else if (this.type === types$1.ellipsis) {
  ...
  var RegExpValidationState = function RegExpValidationState(parser) {
    ...
    this.unicodeProperties = data[
      parser.options.ecmaVersion >= 13
        ? 13
  ...
  pp$1.regexp_eatTerm = function (state) {
    ...
    if (
      state.switchU ? this.regexp_eatAtom(state)
  ...
  pp.fullCharCodeAtPos = function () {
    ...
    return next <= 0xdbff || next >= 0xe000 ? code
  ...
  pp.readToken_lt_gt = function (code) { // '<>'
    ...
    if (next === code) {
      ...
      if (this.input.charCodeAt(this.pos + size) === 61) {return this.finishOp(
          types$1.assign,
          size + 1,
        );}
        ...
        if (ch >= 48 && ch <= 55) {
          ...
          if (
            ...
            this.invalidStringToken(
              ...
              inTemplate ? "Octal literal in template string"
  ...
  pp.readHexChar = function (len) {
    ...
    if (n === null) {this.invalidStringToken(
        codePos,
