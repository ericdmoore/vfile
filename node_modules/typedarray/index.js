...
if (
  ...
  defineProp = function (o, p, desc) {
    ...
    if (
      ECMAScript.HasProperty(desc, "get") && Object.prototype.__defineGetter__
    ) {
      Object.prototype.__defineGetter__.call(o, p, desc.get);
    }
    if (
      ECMAScript.HasProperty(desc, "set") && Object.prototype.__defineSetter__
    ) {
  ...
  function makeConstructor(bytesPerElement, pack, unpack) {
    ...
    ctor = function (buffer, byteOffset, length) {
      ...
      if (!arguments.length || typeof arguments[0] === "number") {
        ...
        typeof arguments[0] === "object" && arguments[0].constructor === ctor
      ) {
        ...
        !(arguments[0] instanceof ArrayBuffer ||
          ECMAScript.Class(arguments[0]) === "ArrayBuffer")
      ) {
...
(function () {
  ...
  var DataView = function DataView(buffer, byteOffset, byteLength) {
    if (arguments.length === 0) {
      ...
      !(buffer instanceof exports.ArrayBuffer ||
        ECMAScript.Class(buffer) === "ArrayBuffer")
    ) {
  ...
  function makeGetter(arrayType) {
    return function (byteOffset, littleEndian) {
      ...
      var uint8Array = new exports.Uint8Array(
          this.buffer,
          byteOffset,
  ...
  function makeSetter(arrayType) {
    return function (byteOffset, value, littleEndian) {
      ...
      // Write them
      byteView = new exports.Uint8Array(
        this.buffer,
        byteOffset,
        arrayType.BYTES_PER_ELEMENT,
      );
