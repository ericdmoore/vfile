...
var safeBuffer = typeof Buffer === "function"
  ? Buffer.from && Buffer.from.length > 1 ? Buffer.from : Buffer
  : null;
var buffersAreTypedArrays = typeof Buffer === "function" &&
  new Buffer(0) instanceof Uint8Array;
...
test("Set and Map", {
  skip: !Object.defineProperty || typeof Set !== "function" ||
    typeof Map !== "function",
}, function (t) {
  t.deepEqualTest(
    new Set(),
...
test("buffers", { skip: typeof Buffer !== "function" }, function (t) {
  ...
  t.test(
    "bufferlikes",
    { skip: !Object.defineProperty || !hasTypedArrays },
    function (st) {
      var fakeBuffer = {
        0: "a",
        length: 1,
      ...
      st.test("bufferlike", {
        skip: buffersAreTypedArrays
          ? !hasSymbols || !Symbol.toStringTag
          : false,
      }, function (s2t) {
...
var isNode14 = isNode && process.env.ASSERT &&
...
test("functions", function (t) {
  ...
  t.deepEqualTest(
    [f],
    [f],
    "a function and itself in an array",
    true,
    true,
    true,
  );
...
test("Errors", function (t) {
  ...
  t.test(
    "fake error",
    { skip: !process.env.ASSERT || !hasDunderProto },
    function (st) {
      var a = tag({
        __proto__: null,
      }, "Error");
...
test("boxed primitives", function (t) {
  ...
  t.test("`valueOf` is called for boxed primitives", function (st) {
    ...
    st.deepEqualTest(
      a,
      b,
      "two boxed numbers with a thrower valueOf",
      false,
      false,
    );
...
var isBrokenNode = isNode && process.env.ASSERT &&
  semver.satisfies(process.version, "<= 13.3.0");
test("fake arrays: extra keys will be tested", {
  skip: !hasDunderProto || isBrokenNode,
}, function (t) {
  var a = tag({
...
var isNodeWhereBufferBreaks = isNode &&
  semver.satisfies(process.version, "< 3");
...
test("TypedArrays", { skip: !hasTypedArrays }, function (t) {
  t.test("Buffer faked as Uint8Array", {
    skip: typeof Buffer !== "function" || !Object.create || !hasDunderProto ||
      isNode06,
  }, function (st) {
