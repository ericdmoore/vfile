...
const remarkLintTableCellPadding = lintRule(
  {
    ...
    url:
      "https://github.com/remarkjs/remark-lint/tree/main/packages/remark-lint-table-cell-padding#readme",
  },
  ...
  (tree, file, option = "consistent") => {
    ...
    visit(tree, "table", (node) => {
      ...
      const style = option === "consistent"
        ? entries[0] && (!entries[0].start || !entries[0].end) ? 0 : 1
        : option === "padded"
        ? 1
        : 0;
