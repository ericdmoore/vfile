...
- `'consistent'` — detect the first used style and warn when further tables
  differ
...
[`remark-gfm`](https://github.com/remarkjs/remark-gfm) formats all table cells
as padded by default. Pass
