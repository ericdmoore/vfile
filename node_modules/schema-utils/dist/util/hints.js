...
module.exports.stringHints = function stringHints(schema, logic) {
  ...
  if (!logic) {
    ...
    currentSchema.formatExclusiveMaximum = !currentSchema
  ...
  if (currentSchema.pattern) {
    hints.push(
      `should${logic ? "" : " not"} match pattern ${
        JSON.stringify(currentSchema.pattern)
      }`,
    );
  }
  ...
  if (currentSchema.format) {
    hints.push(
      `should${logic ? "" : " not"} match format ${
        JSON.stringify(currentSchema.format)
      }`,
    );
  }
  ...
  if (currentSchema.formatMinimum) {
    hints.push(
      `should be ${currentSchema.formatExclusiveMinimum ? ">" : ">="} ${
  ...
  if (currentSchema.formatMaximum) {
    hints.push(
      `should be ${currentSchema.formatExclusiveMaximum ? "<" : "<="} ${
