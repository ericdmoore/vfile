(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? module.exports = factory(require("@jridgewell/trace-mapping"))
    : typeof define === "function" && define.amd
    ? define(["@jridgewell/trace-mapping"], factory)
    : (global = typeof globalThis !== "undefined" ? globalThis : global || self,
      global.remapping = factory(global.traceMapping));
  ...
  function build(map, loader, importer, importerDepth) {
    ...
    const children = resolvedSources.map((sourceFile, i) => {
      ...
      if (!sourceMap) {
        ...
        const sourceContent = content !== undefined
          ? content
          : sourcesContent
          ? sourcesContent[i]
          : null;
      ...
      // source files.
      return build(
        new traceMapping.TraceMap(sourceMap, source),
        loader,
        source,
        depth,
      );
  ...
  class SourceMap {
    constructor(map, options) {
      ...
      this.mappings = options.decodedMappings
        ? traceMapping.decodedMappings(map)
        : traceMapping.encodedMappings(map);
