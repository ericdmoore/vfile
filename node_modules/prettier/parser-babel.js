!function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self)
      .prettierPlugins = t.prettierPlugins || {},
      t.prettierPlugins.babel = e());
}(this, function () {
  "use strict";
  ...
  var d,
    ...
    G = W.process,
    X = W.Deno,
    J = G && G.versions || X && X.version,
    $ = J && J.v8;
  $ && (D = (d = $.split("."))[0] > 0 && d[0] < 4 ? 1 : +(d[0] + d[1])),
    !D && K && (!(d = K.match(/Edge\/(\d+)/)) || d[1] >= 74) &&
    (d = K.match(/Chrome\/(\d+)/)) && (D = +d[1]);
  var Y = D,
    Q = Y,
    Z = n,
  ...
  var wt = v,
    ...
    Rt = Lt(1..toString),
    jt = function (t) {
      return "Symbol(" + (void 0 === t ? "" : t) + ")_" + Rt(++Ot + Mt, 36);
    },
    Ut = r,
    _t = Ct.exports,
    zt = kt,
    ...
    Kt = Ut.Symbol,
    Gt = Kt && Kt.for,
    Xt = qt ? Kt : Kt && Kt.withoutSetter || Ht,
    Jt = function (t) {
      if (!zt(Wt, t) || !Vt && "string" != typeof Wt[t]) {
        var e = "Symbol." + t;
        Vt && zt(Kt, t) ? Wt[t] = Kt[t] : Wt[t] = qt && Gt ? Gt(e) : Xt(e);
      }
      return Wt[t];
    },
    $t = u,
    ...
    re = ee("toPrimitive"),
    ie = function (t, e) {
      if (!Yt(t) || Qt(t)) return t;
      var s, r = Zt(t, re);
      if (r) {
        if (void 0 === e && (e = "default"), s = $t(r, t, e), !Yt(s) || Qt(s)) {
          return s;
        }
    ...
    oe = j,
    ue = r.document,
    he = oe(ue) && oe(ue.createElement),
    pe = function (t) {
      return he ? ue.createElement(t) : {};
    },
    ce = !a && !n(function () {
  ...
  i.f = le ? Ce : function (t, e) {
    if (t = fe(t), e = ye(e), Ae) {
      try {
        return Ce(t, e);
      } catch (t) {}
    }
    if (Ee(t, e)) return me(!de(De.f, t, e), t[e]);
  };
  var xe = {},
    Fe = r,
    ge = j,
    ...
    be = function (t) {
      if (ge(t)) return t;
      throw Te(Pe(t) + " is not an object");
    },
    Se = a,
    we = ce,
    Be = be,
  ...
  xe.f = Se ? ve : function (t, e, s) {
    if (Be(t), e = Ne(e), Be(s), we) {
      try {
        return ve(t, e, s);
      } catch (t) {}
    }
    if ("get" in s || "set" in s) throw Ie("Accessors not supported");
  ...
  var ke = xe,
    ...
    Re = M,
    je = bt,
    Ue = C(Function.toString);
  Re(je.inspectSource) || (je.inspectSource = function (t) {
    return Ue(t);
  });
  var _e,
    ze,
    ...
    We = Ve,
    Ke = r.WeakMap,
    Ge = qe(Ke) && /native code/.test(We(Ke)),
    Xe = Ct.exports,
    Je = jt,
    $e = Xe("keys"),
    Ye = {},
    ...
    as = Ye,
    os = "Object already initialized",
    us = Ze.TypeError,
    hs = Ze.WeakMap;
  if (Qe || is.state) {
    var ps = is.state || (is.state = new hs()),
      cs = ts(ps.get),
      ls = ts(ps.has),
      ds = ts(ps.set);
    _e = function (t, e) {
      if (ls(ps, t)) throw new us(os);
      return e.facade = t, ds(ps, t, e), e;
    },
      ze = function (t) {
        return cs(ps, t) || {};
      },
    ...
    as[Ds] = !0,
      _e = function (t, e) {
        if (rs(t, Ds)) throw new us(os);
        return e.facade = t, ss(t, Ds, e), e;
      },
      ze = function (t) {
        return rs(t, Ds) ? t[Ds] : {};
      },
  ...
  var ms = {
      ...
      has: He,
      enforce: function (t) {
        return He(t) ? ze(t) : _e(t, {});
      },
      getterFor: function (t) {
        return function (e) {
          var s;
          if (!es(e) || (s = ze(e)).type !== t) {
            throw us("Incompatible receiver, " + t + " required");
          }
          return s;
        };
      },
    ...
    As = fs && Object.getOwnPropertyDescriptor,
    Cs = ys(Es, "name"),
    xs = Cs && "something" === function () {}.name,
    Fs = Cs && (!fs || fs && As(Es, "name").configurable),
    gs = r,
    Ps = M,
    Ts = kt,
    bs = Oe,
    Ss = gt,
    ws = Ve,
    Bs = { EXISTS: Cs, PROPER: xs, CONFIGURABLE: Fs }.CONFIGURABLE,
    Ns = ms.get,
    Is = ms.enforce,
    vs = String(String).split("String");
  (Me.exports = function (t, e, s, r) {
    var i,
      n = !!r && !!r.unsafe,
      a = !!r && !!r.enumerable,
      o = !!r && !!r.noTargetGet,
    ...
    ("Symbol(" === String(u).slice(0, 7) &&
      ...
      (!Ts(s, "name") || Bs && s.name !== u) && bs(s, "name", u),
      (i = Is(s)).source || (i.source = vs.join(
        "string" == typeof u
          ? u
          : "",
      ))),
      t !== gs
        ? (n ? !o && t[e] && (a = !0) : delete t[e], a ? t[e] = s : bs(t, e, s))
        : a
        ? t[e] = s
        : Ss(e, s);
  ...
  var ks = {},
    ...
    zs = Math.min,
    Hs = function (t) {
      return t > 0 ? zs(_s(t), 9007199254740991) : 0;
    },
    Vs = function (t) {
      return Hs(t.length);
    },
    ...
    Ws = function (t, e) {
      var s = Rs(t);
      return s < 0 ? js(s + e, 0) : Us(s, e);
    },
    Ks = Vs,
    Gs = function (t) {
      return function (e, s, r) {
        var i, n = qs(e), a = Ks(n), o = Ws(r, a);
        if (t && s != s) for (; a > o;) if ((i = n[o++]) != i) return !0;
        else {
          for (; a > o; o++) {
            if ((t || o in n) && n[o] === s) return t || o || 0;
          }
        }
        return !t && -1;
      };
    },
    Xs = { includes: Gs(!0), indexOf: Gs(!1) },
    Js = kt,
    $s = O,
    Ys = Xs.indexOf,
    Qs = Ye,
    ...
    tr = function (t, e) {
      var s, r = $s(t), i = 0, n = [];
      for (s in r) !Js(Qs, s) && Js(r, s) && Zs(n, s);
      for (; e.length > i;) Js(r, s = e[i++]) && (~Ys(n, s) || Zs(n, s));
      return n;
    },
    er = [
      "constructor",
  ...
  var rr = H,
    ...
    ar = be,
    or = C([].concat),
    ur = rr("Reflect", "ownKeys") || function (t) {
      var e = ir.f(ar(t)), s = nr.f;
      return s ? or(e, s(t)) : e;
    },
    hr = kt,
    pr = ur,
    ...
    fr = function (t, e) {
      var s = Er[yr(t)];
      return s == Cr || s != Ar && (Dr(e) ? dr(e) : !!e);
    },
    yr = fr.normalize = function (t) {
    ...
    br = gt,
    Sr = function (t, e) {
      for (var s = pr(e), r = lr.f, i = cr.f, n = 0; n < s.length; n++) {
        var a = s[n];
        hr(t, a) || r(t, a, i(e, a));
      }
    },
    ...
    Br = function (t, e) {
      ...
      if (s = u ? Fr : h ? Fr[o] || br(o, {}) : (Fr[o] || {}).prototype) {
        for (r in e) {
          if (
            n = e[r],
              i = t.noTargetGet
          ...
          (t.sham || i && i.sham) && Pr(n, "sham", !0), Tr(s, r, n, t);
        }
      }
    },
    Nr = P,
    Ir = Array.isArray || function (t) {
      return "Array" == Nr(t);
    },
    vr = dt,
    kr = C(C.bind),
    ...
    Rr = Lr,
    jr = r.TypeError,
    Ur = function (t, e, s, r, i, n, a, o) {
      for (var u, h, p = i, c = 0, l = !!a && Rr(a, o); c < r;) {
        if (c in s) {
          if (u = l ? l(s[c], c, e) : s[c], n > 0 && Or(u)) {
            h = Mr(u), p = Ur(t, e, u, h, p, n - 1) - 1;
          } else {
  ...
  zr[Jt("toStringTag")] = "z";
  var Hr = r,
    Vr = "[object z]" === String(zr),
    qr = M,
    Wr = P,
    Kr = Jt("toStringTag"),
    Gr = Hr.Object,
    Xr = "Arguments" == Wr(function () {
      return arguments;
    }()),
    Jr = Vr ? Wr : function (t) {
      var e, s, r;
    ...
    mi = function (t) {
      ...
      return pi(t) &&
        (e = t.constructor,
          (ci(e) && (e === Di || pi(e.prototype)) ||
            li(e) && null === (e = e[di])) && (e = void 0)),
        void 0 === e ? Di : e;
    },
    fi = _r,
    yi = dt,
  ...
  Br({ target: "Array", proto: !0 }, {
    flatMap: function (t) {
      var e, s = Ei(this), r = Ai(s);
      return yi(t),
        (e = Ci(s, 0)).length = fi(
          e,
          s,
  ...
  const bi = (t) => "string" == typeof t ? t.replace(gi(), "") : t,
    Si = Pi.exports,
    wi = function () {
    ...
    Bi = (t) => {
      ...
      for (let s = 0; s < t.length; s++) {
        ...
        r <= 31 || r >= 127 && r <= 159 ||
          (r >= 768 && r <= 879 || (r > 65535 && s++, e += Si(r) ? 2 : 1));
      }
      return e;
    };
  Fi.exports = Bi, Fi.exports.default = Bi;
  var Ni = (t) => t[t.length - 1];
  function Ii(t, e) {
    if (null == t) return {};
    var s,
      r,
  ...
  var ki = Jr,
    ...
    Mi = Math.floor,
    Ri = function (t, e) {
      var s = t.length, r = Mi(s / 2);
      return s < 8 ? ji(t, e) : Ui(t, Ri(Oi(t, 0, r), e), Ri(Oi(t, r), e), e);
    },
    ji = function (t, e) {
    ...
    _i = Ri,
    zi = n,
    Hi = q.match(/firefox\/(\d+)/i),
    Vi = !!Hi && +Hi[1],
    qi = /MSIE|Trident/.test(q),
    Wi = q.match(/AppleWebKit\/(\d+)\./),
    Ki = !!Wi && +Wi[1],
    Gi = Br,
    Xi = C,
    Ji = dt,
    ...
    dn = !Zi(function () {
      ...
      if (!(sn && sn > 3)) {
        ...
        for (t = 65; t < 76; t++) {
          ...
          for (r = 0; r < 47; r++) on.push({ k: e + r, v: s });
        }
        for (
          ...
          e = on[r].k.charAt(0), i.charAt(i.length - 1) !== e && (i += e);
        }
        return "DGBEFHACIJK" !== i;
      }
    });
  Gi({ target: "Array", proto: !0, forced: pn || !cn || !ln || !dn }, {
    sort: function (t) {
      void 0 !== t && Ji(t);
      var e = $i(this);
      if (dn) return void 0 === t ? un(e) : un(e, t);
      var s, r, i = [], n = Yi(e);
      for (r = 0; r < n; r++) r in e && hn(i, e[r]);
      for (
        tn(
          i,
          function (t) {
  ...
  var Dn = {},
    ...
    xn = Jt("iterator"),
    Fn = function (t) {
      if (null != t) return An(t, xn) || An(t, "@@iterator") || Cn[En(t)];
    },
    gn = u,
    Pn = dt,
    Tn = be,
    ...
    On = ht,
    Mn = function (t) {
      return void 0 !== t && (mn.Array === t || yn[fn] === t);
    },
    Rn = Vs,
    jn = V,
    Un = function (t, e) {
      var s = arguments.length < 2 ? Sn(t) : e;
      if (Pn(s)) return Tn(gn(s, t));
      throw wn(bn(t) + " is not iterable");
    },
    _n = Fn,
    zn = function (t, e, s) {
      var r, i;
    ...
    Xn = function (t, e, s) {
      var r,
        ...
        D = vn(e, p),
        m = function (t) {
          return r && zn(r, "normal", t), new Vn(!0, t);
        },
        f = function (t) {
          return c ? (Ln(t), d ? D(t[0], t[1], m) : D(t[0], t[1]))
          : d ? D(t, m) : D(t);
        };
      if (l) r = t;
      else {
        if (!(i = _n(t))) throw Hn(On(t) + " is not iterable");
        if (Mn(i)) {
          for (n = 0, a = Rn(t); a > n; n++) {
            if ((o = f(t[n])) && jn(qn, o)) return o;
          }
          return new Vn(!1);
        }
        r = Un(t, i);
      }
      for (u = r.next; !(h = kn(u, r)).done;) {
        try {
          o = f(h.value);
        } catch (t) {
          zn(r, "throw", t);
        }
        if ("object" == typeof o && o && jn(qn, o)) return o;
      }
      return new Vn(!1);
    },
    Jn = function (t, e, s) {
      var r = Wn(e);
      r in t ? Kn.f(t, r, Gn(0, s)) : t[r] = s;
    };
  Br({ target: "Object", stat: !0 }, {
    fromEntries: function (t) {
      var e = {};
      return Xn(t, function (t, s) {
        Jn(e, t, s);
      }, { AS_ENTRIES: !0 }),
        e;
    },
  });
  var $n = void 0 !== $n ? $n : "undefined" != typeof self
    ? self
    : "undefined" != typeof window
    ? window
    : {};
  ...
  var Zn = Yn, ta = Qn;
  function ea(t) {
    if (Zn === setTimeout) return setTimeout(t, 0);
    if ((Zn === Yn || !Zn) && setTimeout) {return Zn = setTimeout,
        setTimeout(t, 0);}
    try {
      return Zn(t, 0);
    } catch (e) {
  ...
  "function" == typeof $n.setTimeout && (Zn = setTimeout),
    "function" == typeof $n.clearTimeout && (ta = clearTimeout);
  var sa, ra = [], ia = !1, na = -1;
  function aa() {
    ia && sa &&
      (ia = !1, sa.length ? ra = sa.concat(ra) : na = -1, ra.length && oa());
  }
  function oa() {
    if (!ia) {
      var t = ea(aa);
      ...
      for (var e = ra.length; e;) {
        for (sa = ra, ra = []; ++na < e;) sa && sa[na].run();
        na = -1, e = ra.length;
      }
      sa = null,
        ia = !1,
        function (t) {
          if (ta === clearTimeout) return clearTimeout(t);
          if ((ta === Qn || !ta) && clearTimeout) {
            return ta = clearTimeout, clearTimeout(t);
          }
          try {
            ta(t);
          } catch (e) {
            try {
              return ta.call(null, t);
            } catch (e) {
  ...
  var ya = $n.performance || {},
    Ea = ya.now || ya.mozNow || ya.msNow || ya.oNow || ya.webkitNow ||
      function () {
  ...
  var Ca = {
      nextTick: function (t) {
        ...
        ra.push(new ua(t, e)), 1 !== ra.length || ia || ea(oa);
      },
      title: "browser",
      browser: !0,
      env: {},
    ...
    xa = Ca;
  const Fa =
    "object" == typeof xa && xa.env && xa.env.NODE_DEBUG &&
      /\bsemver\b/i.test(xa.env.NODE_DEBUG)
      ? function () {
        for (
  ...
  var Pa = {
    ...
    Ta = { exports: {} };
  !function (t, e) {
    const { MAX_SAFE_COMPONENT_LENGTH: s } = Pa,
      r = ga,
      i = (e = t.exports = {}).re = [],
      n = e.src = [],
      a = e.t = {};
    ...
    u("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
      ...
      u(
        "LOOSEPLAIN",
        "[v=\\s]*".concat(n[a.MAINVERSIONLOOSE]).concat(
          n[a.PRERELEASELOOSE],
          "?",
        ).concat(n[a.BUILD], "?"),
      ),
  ...
  var Sa = (t) =>
    t
      ? "object" != typeof t
        ? { loose: !0 }
        : ba.filter((e) => t[e]).reduce((t, e) => (t[e] = !0, t), {})
      : {};
  const wa = /^[0-9]+$/,
    Ba = (t, e) => {
      const s = wa.test(t), r = wa.test(e);
      return s && r && (t = +t, e = +e),
        t === e ? 0 : s && !r ? -1 : r && !s ? 1 : t < e ? -1 : 1;
    };
  var Na = { compareIdentifiers: Ba, rcompareIdentifiers: (t, e) => Ba(e, t) };
  const Ia = ga,
    { MAX_LENGTH: va, MAX_SAFE_INTEGER: ka } = Pa,
    { re: La, t: Oa } = Ta.exports,
    Ma = Sa,
    { compareIdentifiers: Ra } = Na;
  class ja {
    constructor(t, e) {
      if (e = Ma(e), t instanceof ja) {
        if (
      ...
      if (t.length > va) {
        throw new TypeError(
          "version is longer than ".concat(va, " characters"),
        );
      }
      Ia("SemVer", t, e),
        this.options = e,
      ...
      const s = t.trim().match(e.loose ? La[Oa.LOOSE] : La[Oa.FULL]);
    ...
    compare(t) {
      if (
        Ia("SemVer.compare", this.version, this.options, t), !(t instanceof ja)
      ) {
        if ("string" == typeof t && t === this.version) return 0;
        t = new ja(t, this.options);
      }
    ...
    compareMain(t) {
      return t instanceof ja || (t = new ja(t, this.options)),
        Ra(this.major, t.major) || Ra(this.minor, t.minor) ||
        Ra(this.patch, t.patch);
    }
    comparePre(t) {
      if (
        t instanceof ja || (t = new ja(t, this.options)),
      ...
      do {
        ...
        if (Ia("prerelease compare", e, s, r), void 0 === s && void 0 === r) {
          return 0;
        }
        if (void 0 === r) return 1;
        if (void 0 === s) return -1;
        if (s !== r) return Ra(s, r);
      } while (++e);
    }
    compareBuild(t) {
      t instanceof ja || (t = new ja(t, this.options));
    ...
    inc(t, e) {
      switch (t) {
        ...
        case "prerelease":
          ...
          break;
        case "major":
          0 === this.minor && 0 === this.patch &&
            0 !== this.prerelease.length || this.major++,
            this.minor = 0,
            this.patch = 0,
            this.prerelease = [];
          break;
  ...
  const Ua = ja;
  var _a = (t, e, s) => new Ua(t, s).compare(new Ua(e, s));
  const za = _a;
  var Ha = (t, e, s) => za(t, e, s) < 0;
  const Va = _a;
  var qa,
    Wa,
    Ka,
  ...
  const no = ["cliName", "cliCategory", "cliDescription"],
    ao = { compare: _a, lt: Ha, gte: $a },
    oo = (t, e) =>
  ...
  var co = {
    getSupportInfo: function () {
        ...
        a = oo(
          ...
          e = Object.assign({}, e),
            Array.isArray(e.default) && (e.default = 1 === e.default.length
              ? e.default[0].value
              : e.default.filter(o).sort((t, e) =>
                ao.compare(e.since, t.since))[0].value),
            Array.isArray(e.choices) && (e.choices = e.choices.filter((t) =>
              o(t) && u(t)),
              "parser" === e.name && po(e, n, t));
      ...
      function o(t) {
        return e || !("since" in t) || t.since && ao.gte(i, t.since);
      }
      function u(t) {
        return s || !("deprecated" in t) ||
          t.deprecated && ao.lt(i, t.deprecated);
      }
      function h(t) {
        if (r) {
          return t;
  ...
  function Po(t, e) {
    return !1 !== e &&
      ("/" === t.charAt(e) && "/" === t.charAt(e + 1) ? Fo(t, e) : e);
  }
  function To(t, e, s) {
  ...
  function bo(t, e) {
    ...
    const r = Co(t, s.backwards ? e - 1 : e, s), i = To(t, r, s);
    return r !== i;
  }
  function So(t, e) {
    let s = null, r = e;
    for (; r !== s;) s = r, r = xo(t, r), r = go(t, r), r = Co(t, r);
    return r = Po(t, r), r = To(t, r), !1 !== r && bo(t, r);
  }
  function wo(t, e) {
    let s = null, r = e;
    for (; r !== s;) {
      s = r, r = Co(t, r), r = go(t, r), r = Po(t, r), r = To(t, r);
    }
    return r;
  }
  function Bo(t, e, s) {
  ...
  var Lo,
    Oo = {
      inferParserByLanguage: function (t, e) {
        const { languages: s } = fo({ plugins: e.plugins }),
          r = s.find((e) => {
            let { name: s } = e;
      ...
      getStringWidth: function (t) {
        return t ? yo.test(t) ? lo(t) : t.length : 0;
      },
      getMaxContinuousCount: function (t, e) {
        const s = t.match(new RegExp("(".concat(Do(e), ")+"), "g"));
        return null === s
          ? 0
      ...
      getLast: mo,
      getNextNonSpaceNonCommentCharacterIndexWithStartIndex: wo,
      getNextNonSpaceNonCommentCharacterIndex: Bo,
      getNextNonSpaceNonCommentCharacter: function (t, e, s) {
        return t.charAt(Bo(t, e, s));
      },
      skip: Eo,
      skipWhitespace: Ao,
      skipSpaces: Co,
      skipToLineEnd: xo,
      skipEverythingButNewLine: Fo,
      skipInlineComment: go,
      skipTrailingComment: Po,
      skipNewline: To,
      isNextLineEmptyAfterIndex: So,
      isNextLineEmpty: function (t, e, s) {
        return So(t, s(e));
      },
      isPreviousLineEmpty: function (t, e, s) {
        let r = s(e) - 1;
        return r = Co(t, r, { backwards: !0 }),
          r = To(t, r, { backwards: !0 }),
          r = Co(t, r, { backwards: !0 }),
          r !== To(t, r, { backwards: !0 });
      },
      hasNewline: bo,
      ...
      hasSpaces: function (t, e) {
        let s = arguments.length > 2 && void 0 !== arguments[2]
          ? arguments[2]
          : {};
        const r = Co(t, s.backwards ? e - 1 : e, s);
        return r !== e;
      },
      getAlignmentSize: No,
      getIndentSize: function (t, e) {
        const s = t.lastIndexOf("\n");
        return -1 === s ? 0 : No(t.slice(s + 1).match(/^[\t ]*/)[0], e);
      },
      getPreferredQuote: Io,
      printString: function (t, e) {
        const s = t.slice(1, -1);
        return vo(
          s,
          "json" === e.parser ||
            "json5" === e.parser && "preserve" === e.quoteProps &&
              !e.singleQuote
            ? '"'
            : e.__isInHtmlAttribute
            ? "'"
            : Io(s, e.singleQuote ? "'" : '"').quote,
      ...
      addLeadingComment: function (t, e) {
        e.leading = !0, e.trailing = !1, ko(t, e);
      },
      addDanglingComment: function (t, e, s) {
        e.leading = !1, e.trailing = !1, s && (e.marker = s), ko(t, e);
      },
      addTrailingComment: function (t, e) {
        e.leading = !1, e.trailing = !0, ko(t, e);
      },
  ...
  function ru() {
    const t = (e = tu.exports) && e.__esModule ? e : { default: e };
    var e;
    return ru = function () {
      return t;
    },
  ...
  tu.exports = eu,
    tu.exports.graceful = (t) => "string" == typeof t && eu(t) || "\n",
    Object.defineProperty(Mo, "__esModule", { value: !0 }),
    Mo.extract = function (t) {
      const e = t.match(au);
    ...
    Mo.parseWithComments = du,
    Mo.print = function (t) {
      let { comments: e = "", pragmas: s = {} } = t;
      const r = (0, ru().default)(e) || su().EOL,
        i = " *",
        n = Object.keys(s),
        a = n.map((t) => Du(t, s[t])).reduce((t, e) => t.concat(e), []).map(
          (t) => " * " + t + r,
        ).join("");
      if (!e) {
        ...
        if (1 === n.length && !Array.isArray(s[n[0]])) {
          const t = s[n[0]];
          return "".concat("/**", " ").concat(Du(n[0], t)[0]).concat(" */");
        }
      }
  ...
  const iu = /\*\/$/,
    ...
    lu = [];
  function du(t) {
    const e = (0, ru().default)(t) || su().EOL;
    t = t.replace(nu, "").replace(iu, "").replace(cu, "$1");
    let s = "";
    for (; s !== t;) s = t, t = t.replace(hu, "".concat(e, "$1 $2").concat(e));
    t = t.replace(uu, "").trimRight();
    const r = Object.create(null),
      i = t.replace(pu, "").replace(uu, "").trimRight();
    let n;
    for (; n = pu.exec(t);) {
      const t = n[2].replace(ou, "");
      "string" == typeof r[n[1]] || Array.isArray(r[n[1]])
        ? r[n[1]] = lu.concat(r[n[1]], t)
        : r[n[1]] = t;
    }
    return { comments: i, pragmas: r };
  }
  function Du(t, e) {
    return lu.concat(e).map((e) => "@".concat(t, " ").concat(e).trim());
  }
  var mu = {
    ...
    countEndOfLineChars: function (t, e) {
      ...
      if ("\n" === e) s = /\n/g;
        ...
        if ("\r\n" !== e) {throw new Error(
            'Unexpected "eol" '.concat(JSON.stringify(e), "."),
          );}
        s = /\r\n/g;
      }
      const r = t.match(s);
  ...
  const { parseWithComments: fu, strip: yu, extract: Eu, print: Au } = Mo,
    { getShebang: Cu } = Oo,
    { normalizeEndOfLine: xu } = mu;
  function Fu(t) {
    const e = Cu(t);
    e && (t = t.slice(e.length + 1));
    const s = Eu(t), { pragmas: r, comments: i } = fu(s);
    return { shebang: e, text: t, pragmas: r, comments: i };
  }
  var gu = {
    hasPragma: function (t) {
      const e = Object.keys(Fu(t).pragmas);
      return e.includes("prettier") || e.includes("format");
    },
    insertPragma: function (t) {
      const { shebang: e, text: s, pragmas: r, comments: i } = Fu(t),
        n = yu(s),
        a = Au({
  ...
  !function () {
    ...
    Mu.ast = Ru.exports,
    Mu.code = ju.exports,
    Mu.keyword = Uu.exports;
  const _u = Mu.keyword.isIdentifierNameES5,
    {
      getLast: zu,
      hasNewline: Hu,
      skipWhitespace: Vu,
      isNonEmptyArray: qu,
      isNextLineEmptyAfterIndex: Wu,
      getStringWidth: Ku,
    } = Oo,
    { locStart: Gu, locEnd: Xu, hasSameLocStart: Ju } = wu,
    $u = "(?:(?=.)\\s)",
    Yu = new RegExp("^".concat($u, "*:")),
    Qu = new RegExp("^".concat($u, "*::"));
  function Zu(t) {
  ...
  function ah(t) {
    return dh(t) && "Identifier" === t.callee.type &&
  ...
  function wh(t) {
    return t && (t.prettierIgnore || Ih(t, Bh.PrettierIgnore));
  }
  const Bh = {
      Leading: 2,
      Trailing: 4,
    ...
    Nh = (t, e) => {
      if ("function" == typeof t && (e = t, t = 0), t || e) {
        return (s, r, i) =>
          !(t & Bh.Leading && !s.leading || t & Bh.Trailing && !s.trailing ||
            t & Bh.Dangling && (s.leading || s.trailing) ||
            t & Bh.Block && !Zu(s) || t & Bh.Line && !th(s) ||
            t & Bh.First && 0 !== r || t & Bh.Last && r !== i.length - 1 ||
            t & Bh.PrettierIgnore && !Sh(s) || e && !e(s));
      }
    };
  function Ih(t, e, s) {
    if (!t || !qu(t.comments)) return !1;
    const r = Nh(e, s);
  ...
  function kh(t) {
    return dh(t) || "NewExpression" === t.type || "ImportExpression" === t.type;
  }
  var Lh = {
    getFunctionParameters: Ph,
    ...
    hasRestParameter: function (t) {
      if (t.rest) return !0;
      const e = Ph(t);
      return e.length > 0 && "RestElement" === zu(e).type;
    },
    ...
    getParentExportDeclaration: function (t) {
      ...
      return "declaration" === t.getName() && sh(e) ? e : null;
    },
    getTypeScriptMappedTypeModifier: function (t, e) {
      return "+" === t ? "+" + e : "-" === t ? "-" + e : e;
    },
    hasFlowAnnotationComment: function (t) {
      return qu(t) && Zu(t[0]) && Qu.test(t[0].value);
    },
    hasFlowShorthandAnnotationComment: function (t) {
      return t.extra && t.extra.parenthesized && qu(t.trailingComments) &&
        Zu(t.trailingComments[0]) && Yu.test(t.trailingComments[0].value);
    },
    hasLeadingOwnLineComment: function (t, e) {
      return oh(e) ? wh(e) : Ih(e, Bh.Leading, (e) => Hu(t, Xu(e)));
    },
    hasNakedLeftSide: function (t) {
      return "AssignmentExpression" === t.type ||
        "BinaryExpression" === t.type || "LogicalExpression" === t.type ||
        "NGPipeExpression" === t.type || "ConditionalExpression" === t.type ||
        dh(t) || Dh(t) || "SequenceExpression" === t.type ||
    ...
    hasIgnoreComment: function (t) {
      return wh(t.getValue());
    },
    hasNodeIgnoreComment: wh,
    identity: function (t) {
      return t;
    },
    isBinaryish: function (t) {
      return ph.has(t.type);
    },
    isBlockComment: Zu,
    isCallLikeExpression: kh,
    isEnabledHackPipeline: function (t) {
      return Boolean(t.__isUsingHackPipeline);
    },
    isLineComment: th,
    isPrettierIgnoreComment: Sh,
    isCallExpression: dh,
    isMemberExpression: Dh,
    isExportDeclaration: sh,
    isFlowAnnotationComment: function (t, e) {
      const s = Gu(e), r = Vu(t, Xu(e));
      return !1 !== r && "/*" === t.slice(s, s + 2) &&
        "*/" === t.slice(r, r + 2);
    },
    isFunctionCompositionArgs: function (t) {
      ...
      let e = 0;
      for (const s of t) {
        if (nh(s)) if (e += 1, e > 1) return !0;
        else if (dh(s)) for (const t of s.arguments) if (nh(t)) return !0;
      }
      return !1;
    },
    isFunctionNotation: hh,
    isFunctionOrArrowExpression: nh,
    isGetterOrSetter: uh,
    ...
    isMemberish: function (t) {
      return Dh(t) || "BindExpression" === t.type && Boolean(t.object);
    },
    isNumericLiteral: rh,
    isSignedNumericLiteral: function (t) {
      return "UnaryExpression" === t.type &&
        ("+" === t.operator || "-" === t.operator) && rh(t.argument);
    },
    ...
    isObjectTypePropertyAFunction: function (t) {
      return !("ObjectTypeProperty" !== t.type &&
        ...
        "FunctionTypeAnnotation" !== t.value.type || t.static || hh(t));
    },
    isSimpleType: function (t) {
      return !!t &&
        (!("GenericTypeAnnotation" !== t.type && "TSTypeReference" !== t.type ||
          t.typeParameters) || !!ch.has(t.type));
    },
    isSimpleNumber: mh,
    ...
    isTestCall: function t(e, s) {
      ...
      if (1 === e.arguments.length) {
        ...
        if (
          ...
          return ah(e.arguments[0]);
        }
      } else if (
        (2 === e.arguments.length || 3 === e.arguments.length) &&
        ("Identifier" === e.callee.type && lh.test(e.callee.name) ||
          function (t) {
            return Dh(t.callee) && "Identifier" === t.callee.object.type &&
              "Identifier" === t.callee.property.type &&
              lh.test(t.callee.object.name) &&
              ("only" === t.callee.property.name ||
                "skip" === t.callee.property.name);
          }(e)) &&
        (function (t) {
          return "TemplateLiteral" === t.type;
        }(e.arguments[0]) || ih(e.arguments[0]))
      ) {
        return !(e.arguments[2] && !rh(e.arguments[2])) &&
          ((2 === e.arguments.length ? nh(e.arguments[1]) : function (t) {
            return "FunctionExpression" === t.type ||
              "ArrowFunctionExpression" === t.type &&
                "BlockStatement" === t.body.type;
          }(e.arguments[1]) && Ph(e.arguments[1]).length <= 1) ||
            ah(e.arguments[1]));
      }
      return !1;
    },
    isTheOnlyJsxElementInMarkdown: function (t, e) {
      ...
      const s = e.getNode();
      if (!s.expression || !oh(s.expression)) return !1;
    ...
    hasComment: Ih,
    getComments: vh,
    CommentCheckFlags: Bh,
  };
  const {
      getLast: Oh,
      hasNewline: Mh,
      getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Rh,
      getNextNonSpaceNonCommentCharacter: jh,
      hasNewlineInRange: Uh,
      addLeadingComment: _h,
      addTrailingComment: zh,
      addDanglingComment: Hh,
      getNextNonSpaceNonCommentCharacterIndex: Vh,
      isNonEmptyArray: qh,
    } = Oo,
    {
      isBlockComment: Wh,
      getFunctionParameters: Kh,
      isPrettierIgnoreComment: Gh,
      isJsxNode: Xh,
      hasFlowShorthandAnnotationComment: Jh,
      hasFlowAnnotationComment: $h,
      hasIgnoreComment: Yh,
      isCallLikeExpression: Qh,
      getCallArguments: Zh,
      isCallExpression: tp,
      isMemberExpression: ep,
      isObjectProperty: sp,
      getComments: rp,
      CommentCheckFlags: ip,
    } = Lh,
    { locStart: np, locEnd: ap } = wu;
  function op(t, e) {
  ...
  function up(t, e) {
    "BlockStatement" === t.type ? op(t, e) : _h(t, e);
  }
  function hp(t) {
    let { comment: e, followingNode: s } = t;
    return !(!s || !jp(e)) && (_h(s, e), !0);
  }
  function pp(t) {
    let {
      comment: e,
    ...
    return ")" === jh(n, e, ap)
      ...
      ? ("BlockStatement" === s.type ? zh(s, e) : Hh(r, e), !0)
      : "BlockStatement" === i.type
      ? (op(i, e), !0)
      : "IfStatement" === i.type
      ? (up(i.consequent, e), !0)
      : r.consequent === i && (_h(i, e), !0);
  }
  function cp(t) {
    let {
      comment: e,
  ...
  function lp(t) {
    let { comment: e, precedingNode: s, enclosingNode: r, followingNode: i } =
      t;
    return !(!r || "TryStatement" !== r.type && "CatchClause" !== r.type ||
      !i) && ("CatchClause" === r.type && s
        ? (zh(s, e), !0)
        : "BlockStatement" === i.type
        ? (op(i, e), !0)
        : "TryStatement" === i.type
        ? (up(i.finalizer, e), !0)
        : "CatchClause" === i.type && (up(i.body, e), !0));
  }
  function dp(t) {
    let { comment: e, enclosingNode: s, followingNode: r } = t;
    return !(!ep(s) || !r || "Identifier" !== r.type) && (_h(s, e), !0);
  }
  function Dp(t) {
    let {
      comment: e,
  ...
  function mp(t) {
    ...
    return !(!sp(r) || !r.shorthand || r.key !== s ||
      "AssignmentPattern" !== r.value.type) && (zh(r.value.left, e), !0);
  }
  function fp(t) {
    let { comment: e, precedingNode: s, enclosingNode: r, followingNode: i } =
      t;
    if (
      ...
      if (qh(r.decorators) && (!i || "Decorator" !== i.type)) {
        return zh(Oh(r.decorators), e), !0;
      }
      if (r.body && i === r.body) return op(r.body, e), !0;
      if (i) {
  ...
  function yp(t) {
    ...
    return (r && s &&
        ...
        "Identifier" === s.type && r.key === s && ":" !== jh(i, s, ap) ||
  ...
  function xp(t) {
    ...
    if (
      ...
      const t = (() => {
        const t = Kh(r);
        if (t.length > 0) return Rh(n, ap(Oh(t)));
        const e = Rh(n, ap(r.id));
        return !1 !== e && Rh(n, e + 1);
      })();
      if (np(e) > t) return op(i, e), !0;
    }
    return !1;
  }
  function Fp(t) {
    let { comment: e, enclosingNode: s } = t;
    return !(!s || "ImportSpecifier" !== s.type) && (_h(s, e), !0);
  }
  function gp(t) {
    let { comment: e, enclosingNode: s } = t;
    return !(!s || "LabeledStatement" !== s.type) && (_h(s, e), !0);
  }
  function Pp(t) {
    let { comment: e, enclosingNode: s } = t;
    return !(!s ||
      "ContinueStatement" !== s.type && "BreakStatement" !== s.type ||
      s.label) && (zh(s, e), !0);
  }
  function Tp(t) {
    let { comment: e, precedingNode: s, enclosingNode: r } = t;
    return !!(tp(r) && s && r.callee === s && r.arguments.length > 0) &&
      (_h(r.arguments[0], e), !0);
  }
  function bp(t) {
    let { comment: e, precedingNode: s, enclosingNode: r, followingNode: i } =
      t;
    return !r || "UnionTypeAnnotation" !== r.type && "TSUnionType" !== r.type
      ? (i && ("UnionTypeAnnotation" === i.type || "TSUnionType" === i.type) &&
        Gh(e) && (i.types[0].prettierIgnore = !0, e.unignore = !0),
        !1)
      : (Gh(e) && (i.prettierIgnore = !0, e.unignore = !0),
        !!s && (zh(s, e), !0));
  }
  function Sp(t) {
    let { comment: e, enclosingNode: s } = t;
    return !!sp(s) && (_h(s, e), !0);
  }
  function wp(t) {
    let {
      comment: e,
    ...
    return i && i.body && 0 === i.body.length
      ? (n ? Hh(i, e) : _h(i, e), !0)
      : s && "Program" === s.type && 0 === s.body.length && !qh(s.directives)
      ? (n ? Hh(s, e) : _h(s, e), !0)
      : !(!r || "Program" !== r.type || 0 !== r.body.length || !s ||
        "ModuleExpression" !== s.type) && (Hh(r, e), !0);
  }
  function Bp(t) {
    let { comment: e, enclosingNode: s } = t;
    return !(!s ||
      "ForInStatement" !== s.type && "ForOfStatement" !== s.type) &&
      (_h(s, e), !0);
  }
  function Np(t) {
    let { comment: e, precedingNode: s, enclosingNode: r, text: i } = t;
    return !!(s && "ImportSpecifier" === s.type && r &&
      "ImportDeclaration" === r.type && Mh(i, ap(e))) && (zh(s, e), !0);
  }
  function Ip(t) {
    let { comment: e, enclosingNode: s } = t;
    return !(!s || "AssignmentPattern" !== s.type) && (_h(s, e), !0);
  }
  function vp(t) {
    let { comment: e, enclosingNode: s } = t;
    return !(!s || "TypeAlias" !== s.type) && (_h(s, e), !0);
  }
  function kp(t) {
    let { comment: e, enclosingNode: s, followingNode: r } = t;
    return !(!s ||
  ...
  function jp(t) {
    return Wh(t) && "*" === t.value[0] && /@type\b/.test(t.value);
  }
  var Up = {
    handleOwnLineComment: function (t) {
      return [Op, xp, dp, pp, cp, lp, fp, Fp, Bp, bp, wp, Np, Ip, yp, gp].some(
        (e) => e(t),
      );
    },
    handleEndOfLineComment: function (t) {
      return [hp, xp, Dp, Fp, pp, cp, lp, fp, gp, Tp, Sp, wp, vp, kp].some(
        (e) => e(t),
      );
    },
    handleRemainingComment: function (t) {
      return [Op, pp, cp, mp, Cp, yp, wp, Ap, Ep, Mp, Pp, Lp].some((e) => e(t));
    },
    isTypeCastComment: jp,
    getCommentChildNodes: function (t, e) {
      if (
        ...
        "FunctionExpression" === t.value.type && 0 === Kh(t.value).length &&
        !t.value.returnType && !qh(t.value.typeParameters) && t.value.body
      ) {
    ...
    willPrintOwnComments: function (t) {
      ...
      return (e &&
          (Xh(e) || Jh(e) || tp(s) && ((t) =>
                $h(rp(t, ip.Leading)) || $h(rp(t, ip.Trailing)))(e)) ||
        s &&
          ("JSXSpreadAttribute" === s.type || "JSXSpreadChild" === s.type ||
            ...
            ("ClassDeclaration" === s.type || "ClassExpression" === s.type) &&
              s.superClass === e)) &&
        (!Yh(t) || "UnionTypeAnnotation" === s.type ||
          "TSUnionType" === s.type);
    },
  };
  var _p = function t(e, s) {
    let r;
      ...
      t = Hp(t, (t) => {
        ...
        i === t && (function (t, e, s) {
          ...
          Array.isArray(i) && i.length === r.length && !r.some((t) => {
            ...
            Vp(e, "Leading decorators must be attached to a class declaration");
        }(e, i, r),
          function (t, e) {
            166 !== t.kind || t.modifiers && !t.modifiers.some((t) =>
                  126 === t.kind) ||
              t.initializer && null === e.value &&
                Vp(e, "Abstract property cannot have an initializer");
          }(e, i));
      });
    },
  };
  const { getLast: Wp } = Oo,
    { locStart: Kp, locEnd: Gp } = wu,
    { isTypeCastComment: Xp } = Up,
    Jp = _p,
    { throwErrorForInvalidNodes: $p } = qp;
  function Yp(t) {
    return "CallExpression" === t.type
      ? (t.type = "OptionalCallExpression", t.callee = Yp(t.callee))
      : "MemberExpression" === t.type
      ? (t.type = "OptionalMemberExpression", t.object = Yp(t.object))
      : "TSNonNullExpression" === t.type && (t.expression = Yp(t.expression)),
      t;
  }
  function Qp(t) {
    ...
    return Qp(t)
      ? Zp({
        ...
        left: Zp({
          ...
          left: t.left,
          right: t.right.left,
          range: [Kp(t.left), Gp(t.right.left)],
        }),
        right: t.right.right,
        range: [Kp(t), Gp(t)],
      })
  ...
  var tc = function (t, e) {
      if (
        ...
        const e = new Set();
        t = Jp(t, (t) => {
          t.leadingComments && t.leadingComments.some(Xp) && e.add(Kp(t));
        }),
          t = Jp(t, (t) => {
      ...
      return t = Jp(t, (t) => {
        switch (t.type) {
          case "ChainExpression":
            return Yp(t.expression);
          case "LogicalExpression":
            if (Qp(t)) return Zp(t);
            break;
          case "VariableDeclaration": {
            const s = Wp(t.declarations);
            s && s.init && function (t, s) {
              if (";" === e.originalText[Gp(s)]) return;
              t.range = [Kp(t), Gp(s)];
            }(t, s);
            break;
          }
          case "TSParenthesizedType":
            return t.typeAnnotation.range = [Kp(t), Gp(t)], t.typeAnnotation;
          case "TSTypeParameter":
            ...
            break;
          case "SequenceExpression": {
            const e = Wp(t.expressions);
            t.range = [Kp(t), Math.min(Gp(e), Gp(t))];
            break;
          }
          case "TopicReference":
  ...
  function lc(t, e, s) {
    ...
    null === r || r.start > s.start ? cc(t, s.comments) : pc(r, s.comments);
  }
  ...
  function yc(t, e, s) {
    ...
    return Object.keys(t).forEach((i) => {
      r[i] = Object.freeze({ code: e, reasonCode: fc(i, s), template: t[i] });
    }),
      Object.freeze(r);
  }
  class Ec {
  ...
  const Ac = { brace: new Ec("{"), template: new Ec("`", !0) },
    Cc = !0,
    xc = !0,
    Fc = !0,
    gc = !0,
  ...
  function wc(t, e) {
    return Mc(t, { beforeExpr: Cc, binop: e });
  }
  let Bc = -1;
  ...
  function Mc(t) {
    ...
    return ++Bc,
      Ic.push(t),
      vc.push(null != (s = e.binop) ? s : -1),
      kc.push(null != (r = e.beforeExpr) && r),
      Lc.push(null != (i = e.startsExpr) && i),
      Oc.push(null != (n = e.prefix) && n),
      Nc.push(new Tc(t, e)),
      Bc;
  }
  function Rc(t) {
    ...
    return ++Bc,
      ...
      Lc.push(null != (i = e.startsExpr) && i),
      Oc.push(null != (n = e.prefix) && n),
      Nc.push(new Tc("name", e)),
      Bc;
  }
  const jc = {
    bracketL: Mc("[", { beforeExpr: Cc, startsExpr: xc }),
    bracketHashL: Mc("#[", { beforeExpr: Cc, startsExpr: xc }),
    bracketBarL: Mc("[|", { beforeExpr: Cc, startsExpr: xc }),
    bracketR: Mc("]"),
    bracketBarR: Mc("|]"),
    braceL: Mc("{", { beforeExpr: Cc, startsExpr: xc }),
    braceBarL: Mc("{|", { beforeExpr: Cc, startsExpr: xc }),
    braceHashL: Mc("#{", { beforeExpr: Cc, startsExpr: xc }),
    braceR: Mc("}", { beforeExpr: Cc }),
    braceBarR: Mc("|}"),
    parenL: Mc("(", { beforeExpr: Cc, startsExpr: xc }),
    parenR: Mc(")"),
    comma: Mc(",", { beforeExpr: Cc }),
    semi: Mc(";", { beforeExpr: Cc }),
    colon: Mc(":", { beforeExpr: Cc }),
    doubleColon: Mc("::", { beforeExpr: Cc }),
    dot: Mc("."),
    question: Mc("?", { beforeExpr: Cc }),
    questionDot: Mc("?."),
    arrow: Mc("=>", { beforeExpr: Cc }),
    template: Mc("template"),
    ellipsis: Mc("...", { beforeExpr: Cc }),
    backQuote: Mc("`", { startsExpr: xc }),
    dollarBraceL: Mc("${", { beforeExpr: Cc, startsExpr: xc }),
    at: Mc("@"),
    hash: Mc("#", { startsExpr: xc }),
    interpreterDirective: Mc("#!..."),
    eq: Mc("=", { beforeExpr: Cc, isAssign: gc }),
    assign: Mc("_=", { beforeExpr: Cc, isAssign: gc }),
    slashAssign: Mc("_=", { beforeExpr: Cc, isAssign: gc }),
    xorAssign: Mc("_=", { beforeExpr: Cc, isAssign: gc }),
    moduloAssign: Mc("_=", { beforeExpr: Cc, isAssign: gc }),
    incDec: Mc("++/--", { prefix: Pc, postfix: !0, startsExpr: xc }),
    bang: Mc("!", { beforeExpr: Cc, prefix: Pc, startsExpr: xc }),
    tilde: Mc("~", { beforeExpr: Cc, prefix: Pc, startsExpr: xc }),
    pipeline: wc("|>", 0),
    nullishCoalescing: wc("??", 1),
    logicalOR: wc("||", 1),
    logicalAND: wc("&&", 2),
    bitwiseOR: wc("|", 3),
    bitwiseXOR: wc("^", 4),
    ...
    modulo: Mc("%", { binop: 10, startsExpr: xc }),
    star: Mc("*", { binop: 10 }),
    slash: wc("/", 10),
    exponent: Mc("**", { beforeExpr: Cc, binop: 11, rightAssociative: !0 }),
    _in: Sc("in", { beforeExpr: Cc, binop: 7 }),
    _instanceof: Sc("instanceof", { beforeExpr: Cc, binop: 7 }),
    _break: Sc("break"),
    _case: Sc("case", { beforeExpr: Cc }),
    _catch: Sc("catch"),
    _continue: Sc("continue"),
    _debugger: Sc("debugger"),
    _default: Sc("default", { beforeExpr: Cc }),
    _else: Sc("else", { beforeExpr: Cc }),
    _finally: Sc("finally"),
    _function: Sc("function", { startsExpr: xc }),
    _if: Sc("if"),
    _return: Sc("return", { beforeExpr: Cc }),
    _switch: Sc("switch"),
    _throw: Sc("throw", { beforeExpr: Cc, prefix: Pc, startsExpr: xc }),
    _try: Sc("try"),
    _var: Sc("var"),
    _const: Sc("const"),
    _with: Sc("with"),
    _new: Sc("new", { beforeExpr: Cc, startsExpr: xc }),
    _this: Sc("this", { startsExpr: xc }),
    _super: Sc("super", { startsExpr: xc }),
    _class: Sc("class", { startsExpr: xc }),
    _extends: Sc("extends", { beforeExpr: Cc }),
    _export: Sc("export"),
    _import: Sc("import", { startsExpr: xc }),
    _null: Sc("null", { startsExpr: xc }),
    _true: Sc("true", { startsExpr: xc }),
    _false: Sc("false", { startsExpr: xc }),
    _typeof: Sc("typeof", { beforeExpr: Cc, prefix: Pc, startsExpr: xc }),
    _void: Sc("void", { beforeExpr: Cc, prefix: Pc, startsExpr: xc }),
    _delete: Sc("delete", { beforeExpr: Cc, prefix: Pc, startsExpr: xc }),
    _do: Sc("do", { isLoop: Fc, beforeExpr: Cc }),
    _for: Sc("for", { isLoop: Fc }),
    _while: Sc("while", { isLoop: Fc }),
    _as: Rc("as", { startsExpr: xc }),
    _assert: Rc("assert", { startsExpr: xc }),
    _async: Rc("async", { startsExpr: xc }),
    _await: Rc("await", { startsExpr: xc }),
    _from: Rc("from", { startsExpr: xc }),
    _get: Rc("get", { startsExpr: xc }),
    _let: Rc("let", { startsExpr: xc }),
    _meta: Rc("meta", { startsExpr: xc }),
    _of: Rc("of", { startsExpr: xc }),
    _sent: Rc("sent", { startsExpr: xc }),
    _set: Rc("set", { startsExpr: xc }),
    _static: Rc("static", { startsExpr: xc }),
    _yield: Rc("yield", { startsExpr: xc }),
    _asserts: Rc("asserts", { startsExpr: xc }),
    _checks: Rc("checks", { startsExpr: xc }),
    _exports: Rc("exports", { startsExpr: xc }),
    _global: Rc("global", { startsExpr: xc }),
    _implements: Rc("implements", { startsExpr: xc }),
    _intrinsic: Rc("intrinsic", { startsExpr: xc }),
    _infer: Rc("infer", { startsExpr: xc }),
    _is: Rc("is", { startsExpr: xc }),
    _mixins: Rc("mixins", { startsExpr: xc }),
    _proto: Rc("proto", { startsExpr: xc }),
    _require: Rc("require", { startsExpr: xc }),
    _keyof: Rc("keyof", { startsExpr: xc }),
    _readonly: Rc("readonly", { startsExpr: xc }),
    _unique: Rc("unique", { startsExpr: xc }),
    _abstract: Rc("abstract", { startsExpr: xc }),
    _declare: Rc("declare", { startsExpr: xc }),
    _enum: Rc("enum", { startsExpr: xc }),
    _module: Rc("module", { startsExpr: xc }),
    _namespace: Rc("namespace", { startsExpr: xc }),
    _interface: Rc("interface", { startsExpr: xc }),
    _type: Rc("type", { startsExpr: xc }),
    _opaque: Rc("opaque", { startsExpr: xc }),
    name: Mc("name", { startsExpr: xc }),
    string: Mc("string", { startsExpr: xc }),
    num: Mc("num", { startsExpr: xc }),
    bigint: Mc("bigint", { startsExpr: xc }),
    decimal: Mc("decimal", { startsExpr: xc }),
    regexp: Mc("regexp", { startsExpr: xc }),
    privateName: Mc("#name", { startsExpr: xc }),
    eof: Mc("eof"),
    jsxName: Mc("jsxName"),
    jsxText: Mc("jsxText", { beforeExpr: !0 }),
    jsxTagStart: Mc("jsxTagStart", { startsExpr: !0 }),
    jsxTagEnd: Mc("jsxTagEnd"),
    placeholder: Mc("%%", { startsExpr: !0 }),
  };
  function Uc(t) {
    return t >= 87 && t <= 122;
  }
  ...
  Nc[8].updateContext = (t) => {
    t.pop();
  },
    Nc[5].updateContext = Nc[7].updateContext = Nc[23].updateContext = (t) => {
      t.push(Ac.brace);
    },
    Nc[22].updateContext = (t) => {
      t[t.length - 1] === Ac.template ? t.pop() : t.push(Ac.template);
    },
    Nc[132].updateContext = (t) => {
      t.push(Ac.j_expr, Ac.j_oTag);
    };
  let Xc =
  ...
  function sl(t) {
    return t < 48
      ...
      : t < 58 || !(t < 65) && (t <= 90 || (t < 97
            ? 95 === t
            : t <= 122 || (t <= 65535
              ? t >= 170 && Yc.test(String.fromCharCode(t))
              : tl(t, Qc) || tl(t, Zc))));
  }
  const rl = [
      "implements",
  ...
  class Cl {
    ...
    checkRedeclarationInScope(t, e, s, r) {
      this.isRedeclaredInScope(t, e, s) &&
        this.raise(r, Dc.VarRedeclaration, e);
    }
  ...
  class gl {
    ...
    init(t) {
      ...
      this.strict = !1 !== e && (!0 === e || "module" === s),
        this.curLine = r,
        this.lineStart = -i,
        this.startLoc = this.endLoc = new uc(r, i);
    }
    curPosition() {
      return new uc(this.curLine, this.pos - this.lineStart);
    }
    clone(t) {
      const e = new gl(), s = Object.keys(this);
  ...
  const Tl = new Set([103, 109, 115, 105, 121, 117, 100]),
    bl = {
      decBinOct: [46, 66, 69, 79, 95, 98, 101, 111],
      hex: [46, 88, 95, 120],
    },
    Sl = { bin: [48, 49] };
  Sl.oct = [...Sl.bin, 50, 51, 52, 53, 54, 55],
    Sl.dec = [...Sl.oct, 56, 57],
    Sl.hex = [...Sl.dec, 65, 66, 67, 68, 69, 70, 97, 98, 99, 100, 101, 102];
  class wl {
    constructor(t) {
      this.type = t.type,
        this.value = t.value,
        this.start = t.start,
        this.end = t.end,
        this.loc = new hc(t.startLoc, t.endLoc);
    }
  }
  class Bl {
    constructor() {
  ...
  class Nl {
    ...
    exit() {
      ...
      for (const [s, r] of Array.from(t.undefinedPrivateNames)) {
        e
          ...
          : this.raise(r, Dc.InvalidPrivateFieldResolution, s);
      }
    }
    declarePrivateName(t, e, s) {
      ...
      i && this.raise(s, Dc.PrivateNameRedeclaration, t),
    ...
    usePrivateName(t, e) {
      ...
      s
        ...
        : this.raise(e, Dc.InvalidPrivateFieldResolution, t);
    }
  }
  class Il {
    constructor() {
  ...
  class kl {
    constructor(t) {
      this.stack = [new Il()], this.raise = t;
    }
    enter(t) {
      this.stack.push(t);
    }
  ...
  function _l(t) {
    const { type: e, start: s, end: r, loc: i, range: n, extra: a, name: o } =
        t,
      u = Object.create(Ul);
    return u.type = e,
      u.start = s,
  ...
  Ul.__clone = function () {
    const t = new jl(), e = Object.keys(this);
  ...
  function Zl(t) {
    ...
    if ("JSXMemberExpression" === t.type) {
      return Zl(t.object) + "." + Zl(t.property);
    }
    throw new Error("Node had unexpected type: " + t.type);
  }
  Ac.j_oTag = new Ec("<tag"),
    Ac.j_cTag = new Ec("</tag"),
    Ac.j_expr = new Ec("<tag>...</tag>", !0);
  class td extends Al {
    constructor() {
      super(...arguments),
        this.types = new Set(),
  ...
  class ed extends Cl {
    ...
    checkLocalExport(t) {
      ...
      e.types.has(s) || e.exportOnlyBindings.has(s) ||
        super.checkLocalExport(t);
    }
  }
  function sd(t) {
  ...
  const ud = ["minimal", "fsharp", "hack", "smart"],
    hd = ["^", "%", "#"],
    pd = ["hash", "bar"];
  const cd = {
      estree: (t) =>
        class extends t {
          ...
          getPrivateNameSV(t) {
            return this.getPluginOption("estree", "classFeatures") ? t.name
          ...
          isAssignable(t, e) {
            return null != t && this.isObjectProperty(t)
              ? this.isAssignable(t.value, e) : super.isAssignable(t, e);
          }
          toAssignable(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] &&
              arguments[1];
          ...
          toAssignableObjectExpressionProp(t) {
            if ("get" === t.kind || "set" === t.kind) {
              this.raise(t.key.start, Dc.PatternHasAccessor);
            } else if (t.method) {
              this.raise(t.key.start, Dc.PatternHasMethod);
            } else {
              for (
          ...
          parseSubscript(t, e, s, r, i) {
            ...
            if (i.optionalChainMember) {
              ...
              "MemberExpression" !== n.type && "CallExpression" !== n.type ||
                (n.optional = !1);
            }
            return n;
          }
        ...
        class extends t {
            ...
            for (; this.state.pos < this.length && s++ < 10;) {
              if (r = this.input[this.state.pos++], ";" === r) {
                "#" === e[0]
                  ? "x" === e[1]
                    ? (e = e.substr(2),
                      Jl.test(e) && (t = String.fromCodePoint(parseInt(e, 16))))
                    : (e = e.substr(1),
                      $l.test(e) && (t = String.fromCodePoint(parseInt(e, 10))))
                  : t = Xl[e];
                break;
              }
              e += r;
            ...
            switch (this.state.type) {
              case 5:
                return t = this.startNode(),
                  ...
                  this.raise(t.start, Yl.AttributeIsEmpty),
                  t;
              case 132:
              case 123:
          ...
          jsxParseElementAt(t, e) {
            ...
            if (!i.selfClosing) {
              ...
              Ql(i) && !Ql(n)
                ? this.raise(n.start, Yl.MissingClosingTagFragment)
                : !Ql(i) && Ql(n)
                ? this.raise(n.start, Yl.MissingClosingTagElement, Zl(i.name))
                : Ql(i) || Ql(n) ||
                  Zl(n.name) !== Zl(i.name) &&
                    this.raise(
                      n.start,
                      Yl.MissingClosingTagElement,
                      Zl(i.name),
                    );
            }
            if (
              ...
              throw this.raise(
                this.state.start,
                Yl.UnwrappedAdjacentJSXElements,
              );
            }
            return Ql(i) ? this.finishNode(s, "JSXFragment")
          ...
          getTokenFromCode(t) {
            ...
            if (e === Ac.j_expr) return this.jsxReadToken();
            if (e === Ac.j_oTag || e === Ac.j_cTag) {
              if (el(t)) return this.jsxReadWord();
              if (62 === t) return ++this.state.pos, this.finishToken(133);
              if ((34 === t || 39 === t) && e === Ac.j_oTag) {
          ...
          updateContext(t) {
            ...
            if (50 === s && 132 === t) {
              e.splice(-2, 2, Ac.j_cTag), this.state.canStartJSXElement = !1;
            } else if (132 === s) e.push(Ac.j_expr, Ac.j_oTag);
            else if (133 === s) {
              const s = e.pop();
              s === Ac.j_oTag && 50 === t || s === Ac.j_cTag
                ? (e.pop(),
                  this.state.canStartJSXElement = e[e.length - 1] === Ac.j_expr)
                : this.state.canStartJSXElement = !0;
            } else this.state.canStartJSXElement = kc[s];
          }
        },
      flow: (t) =>
        class extends t {
          ...
          flowParsePredicate() {
            ...
            return this.next(),
              ...
              this.raise(e, Vl.UnexpectedSpaceBetweenModuloChecks),
              this.eat(10)
          ...
          flowParseDeclare(t, e) {
            ...
            if (this.eatContextual(117)) {
              ...
              : (e &&
                this.raise(this.state.lastTokStart, Vl.NestedDeclareModule),
              ...
              this.match(77)
                ? (this.next(),
                  ...
                  this.raise(
                    ...
                    Vl.InvalidNonTypeImportInDeclareModule,
                  ),
                  this.parseImport(t))
                : (this.expectContextual(
                  115,
                  Vl.UnsupportedStatementInDeclareModule,
                ),
            ...
            return s.forEach((t) => {
              !function (t) {
                ...
                ? "DeclareModuleExports" === t.type &&
                  (i && this.raise(t.start, Vl.DuplicateDeclareModuleExports),
                    "ES" === r &&
                    this.raise(t.start, Vl.AmbiguousDeclareModuleKind),
                    r = "CommonJS",
                    i = !0)
                : ("CommonJS" === r &&
                  this.raise(t.start, Vl.AmbiguousDeclareModuleKind),
          ...
          flowParseDeclareExportDeclaration(t, e) {
            ...
            if (
              ...
              const t = this.state.value, e = Kl[t];
              throw this.raise(
                this.state.start,
                Vl.UnsupportedDeclareExportKind,
                t,
                e,
              );
            }
          ...
          checkNotUnderscore(t) {
            "_" === t &&
              this.raise(this.state.start, Vl.UnexpectedReservedUnderscore);
          }
          checkReservedType(t, e, s) {
            Hl.has(t) && this.raise(
              e,
              s ? Vl.AssignReservedType : Vl.UnexpectedReservedType,
              t,
            );
          }
          ...
          flowParseTypeParameter() {
            ...
            return s.name = i.name,
              ...
              : t && this.raise(e, Vl.MissingTypeParamDefault),
          ...
          flowParseTypeParameterInstantiation() {
            ...
            for (
              this.state.noAnonFunctionType = !1; !this.match(44);
            ) {
          ...
          flowParseObjectType(t) {
            ...
            for (
              ...
              this.flowObjectTypeSemicolon(),
                ...
                this.raise(a, Vl.UnexpectedExplicitInexactInObject);
            }
          ...
          flowParseObjectTypeProperty(t, e, s, r, i, n, a) {
            if (this.eat(21)) {
              return this.match(12) || this.match(13) || this.match(8) ||
                ...
                ? (n
                  ? a ||
                    this.raise(this.state.lastTokStart, Vl.InexactInsideExact)
                  : this.raise(
                    this.state.lastTokStart,
                    Vl.InexactInsideNonObject,
                  ),
                  r && this.raise(r.start, Vl.InexactVariance),
                  null)
                : (n ||
                  this.raise(this.state.lastTokStart, Vl.UnexpectedSpreadType),
                  null != s && this.unexpected(s),
                  r && this.raise(r.start, Vl.SpreadVariance),
            ...
            }
            {
              ...
              return this.match(43) || this.match(10)
                ? (t.method = !0,
                  ...
                  this.raise(
                    t.value.this.start,
                    Vl.ThisParamBannedInConstructor,
                  ))
          ...
          flowCheckGetterSetterParams(t) {
            ...
            t.value.this && this.raise(
              t.value.this.start,
              "get" === t.kind
                ? Vl.GetterMayNotHaveThisParam
                : Vl.SetterMayNotHaveThisParam,
            ),
              r !== e &&
              ("get" === t.kind
                ? this.raise(s, Dc.BadGetterArity)
                : this.raise(s, Dc.BadSetterArity)),
              "set" === t.kind && t.value.rest &&
              this.raise(s, Dc.BadSetterRestParameter);
          }
          ...
          flowParseFunctionTypeParam(t) {
            ...
            return 14 === n.type || 17 === n.type
              ? (a && !t && this.raise(i.start, Vl.ThisParamMustBeFirst),
                e = this.parseIdentifier(a),
                this.eat(17) &&
                (s = !0,
                  a && this.raise(i.start, Vl.ThisParamMayNotBeOptional)),
            ...
            switch (this.state.type) {
              ...
              case 10:
                if (this.next(), !this.match(11) && !this.match(21)) {if (
                    Uc(this.state.type) || this.match(72)
                  ) {
              ...
              case 47:
                if ("-" === this.state.value) {
                  ...
                  throw this.raise(
                    this.state.start,
                    Vl.UnexpectedSubtractionOperand,
                  );
                }
                throw this.unexpected();
              case 124:
              ...
              default:
                if (qc(this.state.type)) {
                  const t = Wc(this.state.type);
                  return this.next(), super.createIdentifier(s, t);
                }
                if (Uc(this.state.type)) {
                  return this.isContextual(119) ? this.flowParseInterfaceType()
          ...
          parseStatement(t, e) {
            if (this.state.strict && this.isContextual(119)) {if (
                _c(this.lookahead().type)
              ) {
                const t = this.startNode();
          ...
          parseExpressionStatement(t, e) {
            if ("Identifier" === e.type) {
              if ("declare" === e.name) {
                if (
                  this.match(74) || Uc(this.state.type) || this.match(62) ||
          ...
          shouldParseExportDeclaration() {
            ...
            return Vc(t) || this.shouldParseEnums() && 116 === t
          ...
          parseConditional(t, e, s, r) {
            ...
            if (u || p.length > 0) {
              ...
              u && h.length > 1 &&
              this.raise(i.start, Vl.AmbiguousConditionalArrow),
                u && 1 === h.length &&
                (this.state = i,
                  t.push(h[0].start),
          ...
          parseClassMember(t, e, s) {
            ...
            super.parseClassMember(t, e, s),
              ...
              ("ClassProperty" !== e.type &&
                ...
                ? this.raise(r, Vl.DeclareClassElement)
                : e.value &&
                  this.raise(e.value.start, Vl.DeclareClassFieldInitializer));
          }
          isIterator(t) {
          ...
          readIterator() {
            ...
            this.raise(this.state.pos, Dc.InvalidIdentifier, e),
          ...
          toReferencedList(t, e) {
            for (let r = 0; r < t.length; r++) {
              ...
              !i || "TypeCastExpression" !== i.type ||
                ...
                !(t.length > 1) && e ||
                this.raise(i.typeAnnotation.start, Vl.TypeCastInPattern);
            }
            return t;
          }
          ...
          pushClassMethod(t, e, s, r, i, n) {
            if (
              ...
              t.length > 0 && this.isThisParam(t[0]) &&
                this.raise(e.start, Vl.ThisParamBannedInConstructor);
          ...
          checkGetterSetterParams(t) {
            ...
            if (e.length > 0) {
              ...
              this.isThisParam(s) && "get" === t.kind
                ? this.raise(s.start, Vl.GetterMayNotHaveThisParam)
                : this.isThisParam(s) &&
                  this.raise(s.start, Vl.SetterMayNotHaveThisParam);
            }
          }
          ...
          parseAssignableListItemTypes(t) {
            return this.eat(17) &&
              ("Identifier" !== t.type &&
                this.raise(t.start, Vl.PatternIsOptional),
                this.isThisParam(t) &&
                this.raise(t.start, Vl.ThisParamMayNotBeOptional),
                t.optional = !0),
              this.match(14)
                ? t.typeAnnotation = this.flowParseTypeAnnotation()
                : this.isThisParam(t) &&
                  this.raise(t.start, Vl.ThisParamAnnotationRequired),
              this.match(27) && this.isThisParam(t) &&
              this.raise(t.start, Vl.ThisParamNoDefault),
          ...
          parseMaybeDefault(t, e, s) {
            ...
            return "AssignmentPattern" === r.type && r.typeAnnotation &&
              ...
              this.raise(r.typeAnnotation.start, Vl.TypeBeforeInitializer),
              r;
          }
          shouldParseDefaultImport(t) {
            return ql(t) ? Wl(this.state.type)
          ...
          parseImportSpecifier(t, e, s, r) {
            ...
            if (this.isContextual(87) && !this.isLookaheadContextual("as")) {
              ...
              null === n || _c(this.state.type)
                ? (t.imported = i,
                  t.importKind = null,
                  t.local = this.parseIdentifier())
                : (t.imported = e, t.importKind = n, t.local = _l(e));
            } else {
              if (null !== n && _c(this.state.type)) {
                t.imported = this.parseIdentifier(!0), t.importKind = n;
              } else {
                if (e) {
                  throw this.raise(t.start, Dc.ImportBindingIsString, i.value);
                }
                t.imported = i, t.importKind = null;
              }
              this.eatContextual(87) ? t.local = this.parseIdentifier()
              : (a = !0, t.local = _l(t.imported));
            }
            const o = ql(t);
            return s && o &&
              this.raise(t.start, Vl.ImportTypeShorthandOnlyInPureImport),
              (s || o) &&
          ...
          parseMaybeAssign(t, e) {
            ...
            if (this.hasPlugin("jsx") && (this.match(132) || this.match(43))) {
              ...
              n === Ac.j_oTag ? s.length -= 2
              : n === Ac.j_expr && (s.length -= 1);
            }
            if (null != (s = r) && s.error || this.match(43)) {
              ...
              if (
                ...
                if (!o.error && !o.aborted) {
                  return o.node.async &&
                    this.raise(
                      s.start,
                      Vl.UnexpectedTypeParameterBeforeAsyncArrowFunction,
                    ),
                    o.node;
                }
                u = o.node;
              ...
              throw this.raise(s.start, Vl.UnexpectedTokenAfterTypeParameter);
            }
            ...
            if (
              ...
              for (let e = 0; e < t.params.length; e++) {
                this.isThisParam(t.params[e]) && e > 0 &&
                  this.raise(t.params[e].start, Vl.ThisParamMustBeFirst);
              }
          ...
          parseTopLevel(t, e) {
            ...
            return this.state.hasFlowComment &&
              this.raise(this.state.pos, Vl.UnterminatedFlowComment),
              s;
          }
          skipBlockComment() {
            if (
              this.hasPlugin("flowComments") && this.skipFlowComment()
            ) {
              return this.state.hasFlowComment &&
                this.unexpected(null, Vl.NestedFlowComment),
          ...
          flowEnumErrorBooleanMemberNotInitialized(t, e) {
            ...
            this.raise(t, Vl.EnumBooleanMemberNotInitialized, r, s);
          }
          flowEnumErrorInvalidMemberName(t, e) {
            let { enumName: s, memberName: r } = e;
            const i = r[0].toUpperCase() + r.slice(1);
            this.raise(t, Vl.EnumInvalidMemberName, r, i, s);
          }
          flowEnumErrorDuplicateMemberName(t, e) {
            let { enumName: s, memberName: r } = e;
            this.raise(t, Vl.EnumDuplicateMemberName, r, s);
          }
          flowEnumErrorInconsistentMemberValues(t, e) {
            let { enumName: s } = e;
            this.raise(t, Vl.EnumInconsistentMemberValues, s);
          }
          flowEnumErrorInvalidExplicitType(t, e) {
            let { enumName: s, suppliedType: r } = e;
            return this.raise(
              t,
              null === r ? Vl.EnumInvalidExplicitTypeUnknownSupplied
              : Vl.EnumInvalidExplicitType,
              s,
              r,
            );
          }
          flowEnumErrorInvalidMemberInitializer(t, e) {
            ...
            switch (r) {
              ...
              case "number":
              case "string":
                n = Vl.EnumInvalidMemberInitializerPrimaryType;
                break;
              case "symbol":
                n = Vl.EnumInvalidMemberInitializerSymbolType;
                break;
              default:
                n = Vl.EnumInvalidMemberInitializerUnknownType;
            }
            return this.raise(t, n, s, i, r);
          }
          flowEnumErrorNumberMemberNotInitialized(t, e) {
            let { enumName: s, memberName: r } = e;
            this.raise(t, Vl.EnumNumberMemberNotInitialized, s, r);
          }
          flowEnumErrorStringMemberInconsistentlyInitailized(t, e) {
            let { enumName: s } = e;
            this.raise(t, Vl.EnumStringMemberInconsistentlyInitailized, s);
          }
          flowEnumMemberInit() {
            const t = this.state.start,
              e = () => this.match(12) || this.match(8);
            switch (this.state.type) {
              case 124: {
                ...
                case "number":
                  this.flowEnumCheckExplicitTypeMismatch(o.pos, h, "number"),
                    ...
                    i.numberMembers.push(
                      this.finishNode(t, "EnumNumberMember"),
                    );
                  break;
                case "string":
                  this.flowEnumCheckExplicitTypeMismatch(o.pos, h, "string"),
                    ...
                    i.stringMembers.push(
                      this.finishNode(t, "EnumStringMember"),
                    );
                  break;
                case "invalid":
      ...
      typescript: (t) =>
        class extends t {
          ...
          tsParseModifiers(t, e, s, r, i) {
            const n = (e, s, r, i) => {
                s === r && t[i] &&
                  this.raise(e, rd.InvalidModifiersOrder, r, i);
              },
              a = (e, s, r, i) => {
                (t[r] && s === i || t[i] && s === r) &&
                  this.raise(e, rd.IncompatibleModifiers, r, i);
              };
            for (;;) {
              ...
              id(u)
                ? t.accessibility
                  ? this.raise(o, rd.DuplicateAccessibilityModifier)
                  : (n(o, u, u, "override"),
                    n(o, u, u, "static"),
                    n(o, u, u, "readonly"),
                    t.accessibility = u)
                : (Object.hasOwnProperty.call(t, u)
                  ? this.raise(o, rd.DuplicateModifier, u)
          ...
          tsParseImportType() {
            ...
            return this.expect(77),
              this.expect(10),
              this.match(123) ||
              this.raise(this.state.start, rd.UnsupportedImportTypeArgument),
          ...
          tsParseTypeParameters() {
            ...
            return t.params = this.tsParseBracketedList(
              ...
              0 === t.params.length &&
              this.raise(t.start, rd.EmptyTypeParameters),
          ...
          tsParseBindingListForSignature() {
            return this.parseBindingList(11, 41).map(
              (t) => ("Identifier" !== t.type && "RestElement" !== t.type &&
                ...
                this.raise(
                  t.start,
                  rd.UnsupportedSignatureParameterKind,
                  t.type,
                ),
                t),
            );
          ...
          tsIsUnambiguouslyIndexSignature() {
            return this.next(),
              !!Uc(this.state.type) && (this.next(), this.match(14));
          }
          ...
          tsParsePropertyOrMethodSignature(t, e) {
            ...
            if (this.match(10) || this.match(43)) {
              e && this.raise(t.start, rd.ReadonlyForMethodSignature);
              const r = s;
              if (
                r.kind && this.match(43) &&
                this.raise(this.state.pos, rd.AccesorCannotHaveTypeParameters),
                  this.tsFillSignature(14, r),
                  this.tsParseTypeMemberSemicolon(),
                  "get" === r.kind
              ) {
                r.parameters.length > 0 &&
                  (this.raise(this.state.pos, Dc.BadGetterArity),
                    this.isThisParam(r.parameters[0]) &&
                    this.raise(
                      this.state.pos,
                      rd.AccesorCannotDeclareThisParameter,
                    ));
              } else if ("set" === r.kind) {
                if (1 !== r.parameters.length) {
                  ...
                  this.raise(
                    ...
                    this.raise(
                      this.state.pos,
                      rd.SetAccesorCannotHaveOptionalParameter,
                    ),
                    "RestElement" === t.type &&
                    this.raise(
                      this.state.pos,
                      rd.SetAccesorCannotHaveRestParameter,
                    );
                }
                r.typeAnnotation &&
                  this.raise(
                    r.typeAnnotation.start,
                    rd.SetAccesorCannotHaveReturnType,
                  );
              } else r.kind = "method";
          ...
          tsParseTypeMember() {
            ...
            this.tsParseModifiers(t, ["readonly"], [
              ...
              "static",
              "override",
            ], rd.InvalidModifierOnTypeMember);
          ...
          tsParseTupleType() {
            ...
            return t.elementTypes.forEach((t) => {
              ...
              this.raise(t.start, rd.OptionalTypeBeforeRequired),
              ...
              s = null != (r = s) ? r : n,
                s !== n &&
                this.raise(t.start, rd.MixedLabeledAndUnlabeledElements);
            }),
            ...
            if (this.eat(14)) {
              ...
              t.optional = i,
                "TSTypeReference" !== r.type || r.typeParameters ||
                  ...
                  ? (this.raise(r.start, rd.InvalidTupleMemberLabel),
                    t.label = r)
                  : t.label = r.typeName,
          ...
          tsCheckTypeAnnotationForReadOnly(t) {
            switch (t.typeAnnotation.type) {
              ...
              case "TSArrayType":
                return;
              default:
                this.raise(t.start, rd.UnexpectedReadonly);
            }
          }
          tsParseInferType() {
            const t = this.startNode();
          ...
          tsSkipParameterStart() {
            if (Uc(this.state.type) || this.match(72)) return this.next(), !0;
            if (this.match(5)) {
              let t = 1;
              for (this.next(); t > 0;) {
          ...
          tsTryParseTypeOrTypePredicateAnnotation() {
            return this.match(14)
              ? this.tsParseTypeOrTypePredicateAnnotation(14) : void 0;
          }
          ...
          tsParseTypeAssertion() {
            this.getPluginOption("typescript", "disallowAmbiguousJSXLike") &&
              this.raise(this.state.start, rd.ReservedTypeAssertion);
            const t = this.startNode(),
          ...
          tsParseHeritageClause(t) {
            ...
            return s.length || this.raise(e, rd.EmptyHeritageClauseType, t), s;
          }
          ...
          tsParseInterfaceDeclaration(t) {
            Uc(this.state.type)
              ...
              : (t.id = null,
                this.raise(this.state.start, rd.MissingInterfaceName)),
          ...
          tsParseImportEqualsDeclaration(t, e) {
            ...
            return "type" === t.importKind &&
              ...
              this.raise(s.start, rd.ImportAliasHasImportType),
              t.moduleReference = s,
              this.semicolon(),
            ...
            switch (e) {
              case "abstract":
                if (
                  ...
                  (this.match(74) || Uc(this.state.type))
                ) {
                  return this.tsParseAbstractDeclaration(t);
                }
                break;
              case "enum":
                if (s || Uc(this.state.type)) {
                  return s && this.next(), this.tsParseEnumDeclaration(t, !1);
                }
                break;
              case "interface":
                if (this.tsCheckLineTerminator(s) && Uc(this.state.type)) {
          ...
          tsCheckLineTerminator(t) {
            return t ? !this.hasFollowingLineBreak() && (this.next(), !0)
          ...
          tsParseTypeArguments() {
            ...
            return t.params = this.tsInType(
              ...
              0 === t.params.length &&
              this.raise(t.start, rd.EmptyTypeArguments),
              this.expect(44),
          ...
          parseAssignableListItem(t, e) {
            ...
            if (void 0 !== t) {
              ...
              this.tsParseModifiers(e, [
                ...
                n = e.readonly,
                !1 === t && (i || n || a) &&
                this.raise(s, rd.UnexpectedParameterModifier);
            }
            ...
            if (i || n || a) {
              ...
              return e.length && (t.decorators = e),
                ...
                this.raise(t.start, rd.UnsupportedParameterPropertyKind),
                t.parameter = u,
          ...
          parseFunctionBodyAndFinish(t, e) {
            ...
            : "ClassMethod" === e || "ClassPrivateMethod" === e
              ? "TSDeclareMethod" : void 0;
            r && !this.match(5) && this.isLineTerminator()
              ? this.finishNode(t, r)
              : "TSDeclareFunction" === r && this.state.isAmbientContext &&
                  (this.raise(t.start, rd.DeclareFunctionHasImplementation),
                    t.declare) ? super.parseFunctionBodyAndFinish(t, r, s)
              : super.parseFunctionBodyAndFinish(t, e, s);
          }
          ...
          tsCheckForInvalidTypeCasts(t) {
            t.forEach((t) => {
              "TSTypeCastExpression" === (null == t ? void 0 : t.type) &&
                this.raise(t.typeAnnotation.start, rd.UnexpectedTypeAnnotation);
            });
          }
          toReferencedList(t, e) {
          ...
          parseExprOp(t, e, s, r) {
            if (
              Kc(52) > r && !this.hasPrecedingLineBreak() &&
              this.isContextual(87)
            ) {
          ...
          parseImport(t) {
            if (
              t.importKind = "value",
                Uc(this.state.type) || this.match(49) || this.match(5)
            ) {
            ...
            return "type" === e.importKind && e.specifiers.length > 1 &&
              ...
              this.raise(e.start, rd.TypeImportCannotSpecifyDefaultAndNamed),
              e;
          }
          parseExport(t) {
            if (this.match(77)) {
          ...
          tsHasSomeModifiers(t, e) {
            return e.some((e) => id(e) ? t.accessibility === e : !!t[e]);
          }
            ...
            const i = () => {
              this.tsIsStartOfStaticBlocks()
                ? (this.next(),
                  ...
                  this.raise(this.state.pos, rd.StaticBlockCannotHaveModifier),
          ...
          parseClassMemberWithIsStatic(t, e, s, r) {
            ...
            if (i) {return t.body.push(i),
                e.abstract && this.raise(e.start, rd.IndexSignatureHasAbstract),
                e.accessibility &&
                this.raise(
                  e.start,
                  rd.IndexSignatureHasAccessibility,
                  e.accessibility,
                ),
                e.declare && this.raise(e.start, rd.IndexSignatureHasDeclare),
                void (e.override &&
                  this.raise(e.start, rd.IndexSignatureHasOverride));}
            !this.state.inAbstractClass && e.abstract &&
            this.raise(e.start, rd.NonAbstractClassHasAbstractMethod),
              e.override &&
              (s.hadSuperClass ||
                this.raise(e.start, rd.OverrideNotInSubClass)),
              super.parseClassMemberWithIsStatic(t, e, s, r);
          }
          parsePostMemberNameModifiers(t) {
            this.eat(17) && (t.optional = !0),
              t.readonly && this.match(10) &&
              this.raise(t.start, rd.ClassMethodHasReadonly),
              t.declare && this.match(10) &&
              this.raise(t.start, rd.ClassMethodHasDeclare);
          }
          parseExpressionStatement(t, e) {
          ...
          parseExportDeclaration(t) {
            ...
            if (
              ...
              throw this.raise(
                this.state.start,
                rd.ExpectedAmbientAfterExportDeclare,
              );
            }
            let i;
            return Uc(this.state.type) &&
          ...
          parseClassProperty(t) {
            if (
              this.parseClassPropertyAnnotation(t),
                ...
                this.raise(
                  this.state.start,
                  rd.DeclareClassFieldHasInitializer,
                ),
              ...
              this.raise(
                this.state.start,
                rd.AbstractPropertyHasInitializer,
          ...
          parseClassPrivateProperty(t) {
            return t.abstract &&
              this.raise(t.start, rd.PrivateElementHasAbstract),
              t.accessibility &&
              this.raise(
                t.start,
                rd.PrivateElementHasAccessibility,
                t.accessibility,
              ),
              this.parseClassPropertyAnnotation(t),
              super.parseClassPrivateProperty(t);
          ...
          pushClassMethod(t, e, s, r, i, n) {
            ...
            a && i && this.raise(a.start, rd.ConstructorHasTypeParameters),
              !e.declare || "get" !== e.kind && "set" !== e.kind ||
              this.raise(e.start, rd.DeclareAccessor, e.kind),
          ...
          parseMaybeAssign() {
            ...
            if (this.hasPlugin("jsx") && (this.match(132) || this.match(43))) {
              ...
              t[t.length - 1] === Ac.j_oTag ? t.length -= 2
              : t[t.length - 1] === Ac.j_expr && (t.length -= 1);
            }
          ...
          reportReservedArrowTypeParam(t) {
            ...
            1 !== t.params.length || null != (e = t.extra) && e.trailingComma ||
              !this.getPluginOption("typescript", "disallowAmbiguousJSXLike") ||
              this.raise(t.start, rd.ReservedArrowTypeParam);
          }
          parseMaybeUnary(t) {
          ...
          parseAssignableListItemTypes(t) {
            this.eat(17) &&
              ("Identifier" === t.type || this.state.isAmbientContext ||
                this.state.inType || this.raise(t.start, rd.PatternIsOptional),
                t.optional = !0);
            const e = this.tsTryParseTypeAnnotation();
            ...
            switch (t.type) {
              ...
              case "TSTypeAssertion":
                if (
                  ...
                  this.raise(t.start, Dc.InvalidLhs, e);
                  break;
                }
                return void this.checkLVal(
                  t.expression,
          ...
          parseMaybeDefault() {
            ...
            return "AssignmentPattern" === t.type && t.typeAnnotation &&
              ...
              this.raise(t.typeAnnotation.start, rd.TypeAnnotationAfterAssign),
              t;
          }
          getTokenFromCode(t) {
              ...
              if (s) {switch (s.type) {
                  ...
                  case "TSTypeAssertion":
                    this.state.maybeInArrowParameters
                      ? this.raise(s.start, rd.UnexpectedTypeCastInParameter)
                      : t[e] = this.typeCastToParameter(s);
                }}
            }
            ...
            if (this.isContextual(119)) {
              if (!this.hasFollowingLineBreak()) {
                return t.abstract = !0,
                  this.raise(
                    t.start,
                    rd.NonClassMethodPropertyHasAbstractModifer,
                  ),
                  this.next(),
          ...
          parseMethod() {
            ...
            if (t.abstract) {
              if (this.hasPlugin("estree") ? !!t.value.body : !!t.body) {
                ...
                this.raise(
                  t.start,
                  rd.AbstractMethodHasImplementation,
                  "Identifier" !== e.type || t.computed
                    ? "[".concat(this.input.slice(e.start, e.end), "]")
                    : e.name,
                );
              }
            }
          ...
          parseExportSpecifier(t, e, s, r) {
            return !e && r
              ...
              : (t.exportKind = "value",
                super.parseExportSpecifier(t, e, s, r));
          }
          parseImportSpecifier(t, e, s, r) {
            return !e && r
              ? (this.parseTypeOnlyImportExportSpecifier(t, !0, s),
                this.finishNode(t, "ImportSpecifier"))
              : (t.importKind = "value",
                super.parseImportSpecifier(t, e, s, r));
          }
          parseTypeOnlyImportExportSpecifier(t, e, s) {
            ...
            if (this.isContextual(87)) {
              ...
              if (this.isContextual(87)) {
                ...
                _c(this.state.type) ? (u = !1, n = this.parseIdentifier())
                : (o = !0, a = t);
              }
            } else _c(this.state.type) && (o = !0, a = this.parseIdentifier());
            o && s &&
            this.raise(
              h,
              e
                ? rd.TypeModifierIsUsedInTypeImports
                : rd.TypeModifierIsUsedInTypeExports,
            ),
              t[r] = a,
              t[i] = n;
        ...
        class extends t {
          ...
          getTokenFromCode(t) {
            return 37 === t && 37 === this.input.charCodeAt(this.state.pos + 1)
              ? this.finishOp(134, 2) : super.getTokenFromCode(...arguments);
          }
          parseExprAtom() {
          ...
          parseClass(t, e, s) {
            ...
            if (n) {
              if (this.match(75) || this.match(134) || this.match(5)) {t.id =
                  n;} else {
                if (s || !e) {
                  return t.id = null,
          ...
          isExportDefaultSpecifier() {
            if (this.match(59)) {
              ...
              if (
                ...
                this.input.startsWith(Wc(134), this.nextTokenStartSince(t + 4))
              ) {
                return !0;
              }
            }
          ...
          checkExport(t) {
            ...
            null != e && e.length &&
            (t.specifiers = e.filter((t) =>
              "Placeholder" === t.exported.type)),
              super.checkExport(t),
              t.specifiers = e;
          }
          parseImport(t) {
            ...
            if (t.specifiers = [], !this.isContextual(91) && !this.match(12)) {
  ...
  const Dd = (t) => "ParenthesizedExpression" === t.type ? Dd(t.expression) : t;
  const md = new Map([
  ...
  class Cd
    extends class
      extends class
        extends class
            ...
            extends class
              extends class extends class extends class extends class {
                ...
                finalizeComment(t) {
                  ...
                  if (null !== t.leadingNode || null !== t.trailingNode) {
                    null !== t.leadingNode && pc(t.leadingNode, e),
                ...
                getLocationForPosition(t) {
                  ...
                  return e = t === this.state.start
                    ...
                    : function (t, e) {
                      let s, r = 1, i = 0;
                      for (rc.lastIndex = 0; (s = rc.exec(t)) && s.index < e;) {
                        r++, i = rc.lastIndex;
                      }
                      return new uc(r, e - i);
                    }(this.input, t),
                ...
                next() {
                  this.checkKeywordEscapes(),
                    this.options.tokens && this.pushToken(new wl(this.state)),
                ...
                nextTokenStartSince(t) {
                  return nc.lastIndex = t,
                    nc.test(this.input) ? nc.lastIndex : t;
                }
                lookaheadCharCode() {
                ...
                skipBlockComment() {
                  ...
                  if (-1 === s) throw this.raise(e, Dc.UnterminatedComment);
                  for (
                    this.state.pos = s + 2, rc.lastIndex = e + 2;
                    rc.test(this.input) && rc.lastIndex <= s;
                  ) {
                  ...
                  const r = {
                    ...
                    loc: new hc(t, this.state.curPosition()),
                  };
                ...
                skipLineComment(t) {
                  ...
                  if (this.state.pos < this.length) {
                    for (; !ic(r) && ++this.state.pos < this.length;) {
                  ...
                  const i = this.state.pos,
                    n = {
                      ...
                      loc: new hc(s, this.state.curPosition()),
                    };
                ...
                readToken_numberSign() {
                  ...
                  if (e >= 48 && e <= 57) {
                    throw this.raise(
                      this.state.pos,
                      Dc.UnexpectedDigitAfterHash,
                    );
                  }
                  if (
                    123 === e || 91 === e && this.hasPlugin("recordAndTuple")
                  ) {
                    if (
                      ...
                      throw this.raise(
                        this.state.pos,
                        123 === e
                          ? Dc.RecordExpressionHashIncorrectStartSyntaxType
                          : Dc.TupleExpressionHashIncorrectStartSyntaxType,
                      );
                    }
                    this.state.pos += 2,
                ...
                readToken_slash() {
                  61 === this.input.charCodeAt(this.state.pos + 1)
                    ? this.finishOp(29, 2) : this.finishOp(50, 1);
                }
                readToken_interpreter() {
                  ...
                  for (
                    this.state.pos += 1;
                    !ic(t) && ++this.state.pos < this.length;
                  ) {
                    t = this.input.charCodeAt(this.state.pos);
                  }
                    ...
                    if (124 === t) {
                      ...
                      if (this.hasPlugin("recordAndTuple") && 125 === e) {
                        if (
                          ...
                          throw this.raise(
                            this.state.pos,
                            Dc.RecordExpressionBarIncorrectEndSyntaxType,
                          );
                        }
                      ...
                      if (this.hasPlugin("recordAndTuple") && 93 === e) {
                        if (
                          ...
                          throw this.raise(
                            this.state.pos,
                            Dc.TupleExpressionBarIncorrectEndSyntaxType,
                          );
                        }
                        return this.state.pos += 2, void this.finishToken(4);
                      }
                    }
                    61 !== e ? this.finishOp(124 === t ? 39 : 41, 1)
                    : this.finishOp(28, 2);
                  } else {
                ...
                readToken_caret() {
                  61 !== this.input.charCodeAt(this.state.pos + 1) ||
                    this.state.inType ? this.finishOp(40, 1)
                  : this.finishOp(30, 2);
                }
                ...
                readToken_lt() {
                  ...
                  if (60 === e) {return 61 === this.input.charCodeAt(t + 2)
                      ? void this.finishOp(28, 3) : void this.finishOp(46, 2);}
                ...
                getTokenFromCode(t) {
                  switch (t) {
                    ...
                    case 91:
                      if (
                        ...
                        if (
                          ...
                          throw this.raise(
                            this.state.pos,
                            Dc.TupleExpressionBarIncorrectStartSyntaxType,
                          );
                        }
                    ...
                    case 123:
                      if (
                        ...
                        if (
                          ...
                          throw this.raise(
                            this.state.pos,
                            Dc.RecordExpressionBarIncorrectStartSyntaxType,
                          );
                        }
                    ...
                    default:
                      if (el(t)) return void this.readWord(t);
                  }
                  throw this.raise(
                    this.state.pos,
                    Dc.InvalidOrUnexpectedToken,
                ...
                readRegexp() {
                  ...
                  for (;; ++r) {
                    if (r >= this.length) {
                      throw this.raise(t, Dc.UnterminatedRegExp);
                    }
                    const i = this.input.charCodeAt(r);
                    if (ic(i)) throw this.raise(t, Dc.UnterminatedRegExp);
                    if (e) e = !1;
                    else {
                      if (91 === i) s = !0;
                      else if (93 === i && s) s = !1;
                  ...
                  let n = "";
                  for (; r < this.length;) {
                    const t = this.codePointAtPos(r),
                      e = String.fromCharCode(t);
                    if (Tl.has(t)) {
                      n.includes(e) &&
                        this.raise(r + 1, Dc.DuplicateRegExpFlags);
                    } else {
                      if (!sl(t) && 92 !== t) break;
                      this.raise(r + 1, Dc.MalformedRegExpFlags);
                    }
                    ++r, n += e;
                  }
                  this.state.pos = r,
                ...
                readInt(t, e, s) {
                  ...
                  for (let i = 0, h = null == e ? 1 / 0 : e; i < h; ++i) {
                    ...
                    if (95 !== e) {
                      ...
                      this.raise(this.state.pos, Dc.UnexpectedNumericSeparator),
                        r ||
                        this.raise(
                          this.state.pos,
                          Dc.NumericSeparatorInEscapeSequence,
                        ),
                        ++this.state.pos;
                    }
                  }
                ...
                readRadixNumber(t) {
                  ...
                  null == r &&
                    this.raise(this.state.start + 2, Dc.InvalidDigit, t);
                  const i = this.input.charCodeAt(this.state.pos);
                  if (110 === i) ++this.state.pos, s = !0;
                  else if (109 === i) throw this.raise(e, Dc.InvalidDecimal);
                ...
                readNumber(t) {
                  ...
                  t || null !== this.readInt(10) ||
                    this.raise(e, Dc.InvalidNumber);
                  const o = this.state.pos - e >= 2 &&
                    48 === this.input.charCodeAt(e);
                  if (o) {
                    const t = this.input.slice(e, this.state.pos);
                    if (
                      this.recordStrictModeErrors(e, Dc.StrictOctalLiteral),
                        !this.state.strict
                    ) {
                      const s = t.indexOf("_");
                      s > 0 && this.raise(s + e, Dc.ZeroDigitNumericSeparator);
                    }
                    a = o && !/[89]/.test(t);
                  }
                  ...
                  if (
                    ...
                    (++this.state.pos,
                      ...
                      (u = this.input.charCodeAt(++this.state.pos),
                        ...
                        this.raise(e, Dc.InvalidOrMissingExponent),
                        s = !0,
                        n = !0,
                        u = this.input.charCodeAt(this.state.pos)),
                      110 === u &&
                      ((s || o) && this.raise(e, Dc.InvalidBigIntLiteral),
                        ++this.state.pos,
                        r = !0),
                      109 === u &&
                      (this.expectPlugin("decimal", this.state.pos),
                        (n || o) && this.raise(e, Dc.InvalidDecimal),
                        ++this.state.pos,
                        i = !0),
                      el(this.codePointAtPos(this.state.pos))
                  ) {
                    throw this.raise(this.state.pos, Dc.NumberIdentifier);
                  }
                ...
                readCodePoint(t) {
                  ...
                  if (123 === this.input.charCodeAt(this.state.pos)) {
                    ...
                    if (
                      ...
                      if (!t) return null;
                      this.raise(s, Dc.InvalidCodePoint);
                    }
                ...
                readHexChar(t, e, s) {
                  ...
                  return null === i &&
                    (s
                      ? this.raise(r, Dc.InvalidEscapeSequence)
                      : this.state.pos = r - 1),
                    i;
                }
                readWord1(t) {
                  ...
                  for (
                    ...
                    if (sl(t)) this.state.pos += t <= 65535 ? 1 : 2;
                    else {
                      if (92 !== t) break;
                      {
                        ...
                        const t = this.state.pos,
                          i = this.state.pos === s ? el : sl;
                        if (117 !== this.input.charCodeAt(++this.state.pos)) {
                          this.raise(this.state.pos, Dc.MissingUnicodeEscape),
                            r = this.state.pos - 1;
                          continue;
                        }
                        ++this.state.pos;
                        ...
                        null !== n &&
                        (i(n) || this.raise(t, Dc.EscapedCharNotAnIdentifier),
                ...
                readWord(t) {
                  const e = this.readWord1(t), s = bc.get(e);
                  void 0 !== s
                    ? this.finishToken(s, Wc(s))
                    : this.finishToken(122, e);
                }
                checkKeywordEscapes() {
                  const { type: t } = this.state;
                  qc(t) && this.state.containsEsc &&
                    this.raise(
                      this.state.start,
                      Dc.InvalidEscapedReservedWord,
                      Wc(t),
              ...
              semicolon() {
                (!(arguments.length > 0 && void 0 !== arguments[0]) ||
                  ...
                  ? this.isLineTerminator()
                  : this.eat(13)) ||
                  this.raise(this.state.lastTokEnd, Dc.MissingSemicolon);
              }
              expect(t, e) {
              ...
              unexpected(t) {
                ...
                throw "number" == typeof e &&
                  (e = {
                    code: dc.SyntaxError,
                    reasonCode: "UnexpectedToken",
                    template: 'Unexpected token, expected "'.concat(Wc(e), '"'),
                  }),
              ...
              checkExpressionErrors(t, e) {
                ...
                n &&
                  (s >= 0 && this.unexpected(s),
                    r >= 0 && this.raise(r, Dc.DuplicateProto),
          ...
          toAssignable(t) {
            ...
            switch (
              ("ParenthesizedExpression" === t.type ||
                null != (s = t.extra) && s.parenthesized) && (i = Dd(t),
                  e
                    ? "Identifier" === i.type
                      ? this.expressionScope.recordParenthesizedIdentifierError(
                        t.start,
                        Dc.InvalidParenthesizedAssignment,
                      )
                      : "MemberExpression" !== i.type &&
                        this.raise(t.start, Dc.InvalidParenthesizedAssignment)
                    : this.raise(t.start, Dc.InvalidParenthesizedAssignment)),
                t.type
            ) {
              case "Identifier":
              ...
              case "ObjectExpression":
                ...
                for (
                  let s = 0, r = t.properties.length, i = r - 1; s < r; s++
                ) {
                  var n;
              ...
              case "AssignmentExpression":
                "=" !== t.operator &&
                this.raise(t.left.end, Dc.MissingEqInAssignment),
          ...
          parseBindingList(t, e, s, r) {
            ...
            let n = !0;
            for (; !this.eat(t);) {
              if (n ? n = !1 : this.expect(12), s && this.match(12)) {
                i.push(null);
              } else {
                if (this.eat(t)) break;
                if (this.match(21)) {
          ...
          checkLVal(t, e) {
            let s = arguments.length > 2 && void 0 !== arguments[2]
              ...
              n = arguments.length > 5 && void 0 !== arguments[5] &&
                arguments[5];
            switch (t.type) {
              case "Identifier": {
                const { name: e } = t;
                this.state.strict && (n ? cl(e, this.inModule) : pl(e)) &&
                this.raise(
                  t.start,
                  64 === s
                    ? Dc.StrictEvalArguments
                    : Dc.StrictEvalArgumentsBinding,
                  e,
                ),
                  r &&
                  (r.has(e) ? this.raise(t.start, Dc.ParamDupe) : r.add(e)),
                  i && "let" === e &&
                  this.raise(t.start, Dc.LetInLexicalBinding),
                  64 & s || this.scope.declareName(e, s, t.start);
                break;
              }
              case "MemberExpression":
                64 !== s &&
                  this.raise(t.start, Dc.InvalidPropertyBindingPattern);
                break;
              case "ObjectPattern":
              ...
              case "ArrayPattern":
                for (const e of t.elements) {
                  e &&
                    this.checkLVal(e, "array destructuring pattern", s, r, i);
                }
                break;
              case "AssignmentPattern":
              ...
              default:
                this.raise(
                  t.start,
                  64 === s ? Dc.InvalidLhs : Dc.InvalidLhsBinding,
                  e,
                );
            }
          }
          checkToRestConversion(t) {
            "Identifier" !== t.argument.type &&
              ...
              this.raise(t.argument.start, Dc.InvalidRestAssignmentPattern);
          }
          checkCommaAfterRest(t) {
            this.match(12) &&
          ...
          raiseRestNotLast(t) {
            throw this.raise(t, Dc.ElementAfterRest);
          }
          raiseTrailingCommaAfterRest(t) {
            this.raise(t, Dc.RestTrailingComma);
          }
        } {
        checkProto(t, e, s, r) {
          if (
            "SpreadElement" === t.type || this.isObjectMethod(t) ||
          ...
          if ("__proto__" === ("Identifier" === i.type ? i.name : i.value)) {
            if (e) return void this.raise(i.start, Dc.RecordNoProto);
            s.used &&
            (r
              ? -1 === r.doubleProto && (r.doubleProto = i.start)
              : this.raise(i.start, Dc.DuplicateProto)), s.used = !0;
          }
        }
        ...
        parseExprOp(t, e, s, r) {
          if (this.isPrivateName(t)) {
            ...
            (r >= Kc(52) || !this.prodParam.hasIn || !this.match(52)) &&
            this.raise(s, Dc.PrivateInExpectedIn, e),
              this.classScope.usePrivateName(e, s);
          }
          const i = this.state.type;
          if (
            (n = i) >= 35 && n <= 53 &&
            (this.prodParam.hasIn || !this.match(52))
          ) {
            let n = Kc(i);
            if (n > r) {
              if (35 === i) {
        ...
        parseHackPipeBody() {
          ...
          return !md.has(s.type) || null != (t = s.extra) && t.parenthesized ||
            this.raise(e, Dc.PipeUnparenthesizedBody, md.get(s.type)),
            this.topicReferenceWasUsedInCurrentContext() ||
            this.raise(e, Dc.PipeTopicUnused),
            s;
        }
        checkExponentialAfterUnary(t) {
          this.match(51) &&
            this.raise(t.argument.start, Dc.UnexpectedTokenUnaryExponentiation);
        }
        parseMaybeUnary(t, e) {
          ...
          if (o = this.state.type, Oc[o]) {
            ...
            if (
              ...
              const t = a.argument;
              "Identifier" === t.type
                ? this.raise(a.start, Dc.StrictDelete)
                : this.hasPropertyAsPrivateName(t) &&
                  this.raise(a.start, Dc.DeletePrivateField);
            }
            if (!n) {
          ...
          if (i) {
            ...
            if (
              (this.hasPlugin("v8intrinsic")
                ? Hc(t)
                : Hc(t) && !this.match(48)) && !this.isAmbiguousAwait()
            ) {
              return this.raiseOverwrite(s, Dc.AwaitNotInAsyncContext),
                this.parseAwait(s, r);
            }
          }
          return u;
        ...
        parseMember(t, e, s, r, i, n) {
          ...
          const o = !i && this.match(128) && this.state.value,
            u = i
              ...
              : this.parseIdentifier(!0);
          return !1 !== o &&
            ("Super" === a.object.type && this.raise(e, Dc.SuperPrivateField),
        ...
        parseCoverCallAndAsyncArrowHead(t, e, s, r, i) {
          ...
          return o.callee = t,
            r.maybeAsyncArrow &&
            (this.expressionScope.enter(new vl(2)), a = new Rl()),
        ...
        parseTaggedTemplateExpression(t, e, s, r) {
          ...
          return i.tag = t,
            ...
            r.optionalChainMember &&
            this.raise(e, Dc.OptionalChainingNoTemplate),
            ...
            if (
              ...
              for (const e of t.arguments) {
                "SpreadElement" === e.type &&
                  this.raise(e.start, Dc.ImportCallSpreadArgument);
              }
            }
          }
        ...
        parseCallExpressionArguments(t, e, s, r, i) {
          ...
          for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(t);) {
            if (a) a = !1;
              ...
              this.raise(
                this.state.lastTokStart,
                Dc.ImportCallArgumentTrailingComma,
              ),
        ...
        parseAsyncArrowFromCallExpression(t, e) {
          ...
          return this.resetPreviousNodeTrailingComments(e),
            ...
            e.innerComments && cc(t, e.innerComments),
            e.callee.trailingComments && cc(t, e.callee.trailingComments),
            t;
        }
        parseNoCallExpr() {
          const t = this.state.start, e = this.state.startLoc;
        ...
        parseExprAtom(t) {
          ...
          switch (s) {
            ...
            case 77:
              return e = this.startNode(),
                ...
                this.match(16)
                  ...
                  : (this.match(10) ||
                    this.raise(this.state.lastTokStart, Dc.UnsupportedImport),
            ...
            case 15: {
              ...
              throw this.raise(t.start, Dc.UnsupportedBind);
            }
            case 128:
              return this.raise(
                this.state.start,
                Dc.PrivateInExpectedIn,
                this.state.value,
              ),
                this.parsePrivateName();
            case 31:
          ...
          if (this.testTopicReferenceConfiguration(s, e, r)) {
            ...
            return r = "smart" === s
              ...
              this.topicReferenceIsAllowedInCurrentContext() || ("smart" === s
                ? this.raise(e, Dc.PrimaryTopicNotAllowed)
                : this.raise(e, Dc.PipeTopicUnbound)),
              this.registerTopicReference(),
              this.finishNode(t, r);
          }
          throw this.raise(e, Dc.PipeTopicUnconfiguredToken, Wc(r));
        }
        testTopicReferenceConfiguration(t, e, s) {
          switch (t) {
            ...
            case "smart":
              return 25 === s;
            default:
              throw this.raise(e, Dc.PipeTopicRequiresHackPipes);
          }
        }
        parseAsyncArrowUnaryFunction(t) {
          ...
          return this.prodParam.exit(),
            this.hasPrecedingLineBreak() &&
            this.raise(this.state.pos, Dc.LineTerminatorBeforeArrow),
            this.expect(19),
          ...
          return this.next(),
            !this.match(10) || this.scope.allowDirectSuper ||
              ...
              ? this.scope.allowSuper || this.options.allowSuperOutsideMethod ||
                this.raise(t.start, Dc.UnexpectedSuper)
              : this.raise(t.start, Dc.SuperNotAllowed),
            this.match(10) || this.match(0) || this.match(16) ||
            this.raise(t.start, Dc.UnsupportedSuper),
        ...
        parseMetaProperty(t, e, s) {
          ...
          return t.property = this.parseIdentifier(!0),
            (t.property.name !== s || r) &&
            this.raise(t.property.start, Dc.UnsupportedMetaProperty, e.name, s),
        ...
        parseImportMetaProperty(t) {
          ...
          return this.next(),
            ...
            (this.inModule || this.raise(e.start, mc.ImportMetaOutsideModule),
        ...
        parseNewOrNewTarget() {
          ...
          if (this.next(), this.match(16)) {
            ...
            return this.scope.inNonArrowFunction || this.scope.inClass ||
              this.raise(s.start, Dc.UnexpectedNewTarget),
              s;
          }
        ...
        parseNew(t) {
          return t.callee = this.parseNoCallExpr(),
            "Import" === t.callee.type
              ? this.raise(t.callee.start, Dc.ImportCallNotNewExpression)
              : this.isOptionalChain(t.callee)
              ? this.raise(this.state.lastTokEnd, Dc.OptionalChainingNoNew)
              : this.eat(18) &&
                this.raise(this.state.start, Dc.OptionalChainingNoNew),
        ...
        parseTemplateElement(t) {
          ...
          return null === this.state.value &&
            (t ||
              this.raise(
                this.state.start + 1,
                Dc.InvalidEscapeSequenceTemplate,
              )),
            e.value = {
        ...
        parseObjectLike(t, e, s, r) {
          ...
          for (o.properties = [], this.next(); !this.match(t);) {
            ...
            e
              ...
              this.raise(i.start, Dc.InvalidRecordProperty),
        ...
        parsePropertyDefinition(t) {
          ...
          if (this.match(24)) {
            for (
              ...
              this.raise(this.state.start, Dc.UnsupportedPropertyDecorator);
              this.match(24);
            ) {
          ...
          if (!o && !u && this.maybeAsyncOrAccessorProp(s)) {
            ...
            (n = !0,
              ...
              (a = !0,
                ...
                this.match(49) &&
                (o = !0,
                  this.raise(this.state.pos, Dc.AccessorIsGenerator, t),
                  this.next()),
                this.parsePropertyName(s));
          }
        ...
        checkGetterSetterParams(t) {
          ...
          r.length !== s &&
          ("get" === t.kind
            ? this.raise(i, Dc.BadGetterArity)
            : this.raise(i, Dc.BadSetterArity)),
            "set" === t.kind && "RestElement" === (null == (e = r[r.length - 1])
                ? void 0
                : e.type) &&
            this.raise(i, Dc.BadSetterRestParameter);
        }
        parseObjectMethod(t, e, s, r, i) {
          return i
          ...
          return t.shorthand = !1,
            this.eat(14)
              ...
              : (this.checkReservedWord(t.key.name, t.key.start, !0, !1),
                r
                  ? t.value = this.parseMaybeDefault(e, s, _l(t.key))
                  : this.match(27) && i
                  ? (-1 === i.shorthandAssign &&
        ...
        parsePropertyName(t) {
          if (this.eat(0)) {
            ...
            let r;
            if (_c(e)) r = this.parseIdentifier(!0);
            else {
              switch (e) {
                case 124:
                ...
                case 128: {
                  const t = this.state.start + 1;
                  this.raise(t, Dc.UnexpectedPrivateField),
        ...
        parseMethod(t, e, s, r, i, n) {
          ...
          const o = r;
          return this.scope.enter(18 | (a ? dl : 0) | (i ? 32 : 0)),
        ...
        parseFunctionBody(t, e) {
          ...
          if (this.expressionScope.enter(Ll()), r) {
                ...
                if (i && n) {
                  const e =
                    "method" !== t.kind && "constructor" !== t.kind || !t.key
                      ? t.start
                      : t.key.end;
                  this.raise(e, Dc.IllegalLanguageModeDirective);
                }
        ...
        parseExprListItem(t, e, s) {
          let r;
          if (this.match(12)) {
            t || this.raise(this.state.pos, Dc.UnexpectedToken, ","), r = null;
            ...
            this.expectPlugin("partialApplication"),
              s ||
              this.raise(this.state.start, Dc.UnexpectedArgumentPlaceholder);
            const t = this.startNode();
        ...
        checkReservedWord(t, e, s, r) {
          ...
          if ("yield" === t) {
            if (this.prodParam.hasYield) {
              return void this.raise(e, Dc.YieldBindingIdentifier);
            }
          } else if ("await" === t) {
            if (this.prodParam.hasAwait) {
              return void this.raise(e, Dc.AwaitBindingIdentifier);
            }
            if (this.scope.inStaticBlock) {
              return void this.raise(e, Dc.AwaitBindingIdentifierInStaticBlock);
            }
            this.expressionScope.recordAsyncArrowParametersError(
              e,
              Dc.AwaitBindingIdentifier,
            );
          } else if (
            "arguments" === t && this.scope.inClassAndNotInNonArrowFunction
          ) {
            return void this.raise(e, Dc.ArgumentsInClass);
          }
          if (
            s && function (t) {
              return nl.has(t);
            ...
            return void this.raise(e, Dc.UnexpectedKeyword, t);
          }
          (this.state.strict ? r ? cl : hl : ul)(t, this.inModule) &&
            this.raise(e, Dc.UnexpectedReservedWord, t);
        }
        isAwaitAllowed() {
        ...
        parseAwait(t, e) {
          ...
          return this.expressionScope.recordParameterInitializerError(
            s.start,
            Dc.AwaitExpressionFormalParameter,
          ),
            this.eat(49) && this.raise(s.start, Dc.ObsoleteAwaitStar),
        ...
        checkPipelineAtInfixOperator(t, e) {
          "smart" === this.getPluginOption("pipelineOperator", "proposal") &&
            ...
            this.raise(e, Dc.PipelineHeadSequenceExpression);
        }
        checkHackPipeBodyEarlyErrors(t) {
          this.topicReferenceWasUsedInCurrentContext() ||
            this.raise(t, Dc.PipeTopicUnused);
        }
        ...
        checkSmartPipeTopicBodyEarlyErrors(t) {
          ...
          this.topicReferenceWasUsedInCurrentContext() ||
            this.raise(t, Dc.PipelineTopicUnused);
        }
        ...
        return t.program = this.parseProgram(e),
          ...
          this.options.tokens && (t.tokens = function (t) {
            for (let e = 0; e < t.length; e++) {
              ...
              if (128 !== r) "number" == typeof r && (s.type = Gc(r));
              else {
                const { loc: r, start: i, value: n, end: a } = s,
                  o = i + 1,
                  u = new uc(r.start.line, r.start.column + 1);
                t.splice(
                  e,
                  1,
                  new wl({
      ...
      parseProgram(t) {
        ...
        if (
          ...
          for (const [t] of Array.from(this.scope.undefinedExports)) {
            ...
            this.raise(e, Dc.ModuleExportUndefined, t);
          }
        }
      ...
      isLetKeyword(t) {
        ...
        if (123 === s) return !0;
        if (el(s)) {
          if (Ad.lastIndex = e, Ad.test(this.input)) {
            const t = this.codePointAtPos(Ad.lastIndex);
            if (!sl(t) && 92 !== t) return !1;
          }
          return !0;
        }
        return !1;
      ...
      parseStatementContent(t, e) {
        ...
        switch (this.isLet(t) && (s = 68, i = "let"), s) {
          ...
          case 62:
            ...
            return t &&
              (this.state.strict
                ? this.raise(this.state.start, Dc.StrictFunction)
                : "if" !== t && "label" !== t &&
                  this.raise(this.state.start, Dc.SloppyFunction)),
          ...
          case 68:
            return i = i || this.state.value,
              t && "var" !== i &&
              this.raise(this.state.start, Dc.UnexpectedLexicalDeclaration),
          ...
          case 76: {
            ...
            return this.options.allowImportExportEverywhere || e ||
              this.raise(this.state.start, Dc.UnexpectedImportExport),
              this.next(),
              77 === s
        ...
        return Uc(s) && "Identifier" === a.type && this.eat(14)
      ...
      assertModuleNodeAllowed(t) {
        this.options.allowImportExportEverywhere || this.inModule ||
          this.raise(t.start, mc.ImportOutsideModule);
      }
      takeDecorators(t) {
        const e =
      ...
      parseDecorators(t) {
        ...
        if (this.match(76)) {
          t || this.unexpected(),
            ...
            this.raise(this.state.start, Dc.DecoratorExportClass);
      ...
      parseForStatement(t) {
        ...
        if (
          o && (s
            ? this.raise(a.start, Dc.ForOfLet)
            : -1 === e && i && "Identifier" === a.type &&
              this.raise(a.start, Dc.ForOfAsync)), o || this.match(52)
        ) {
      ...
      parseReturnStatement(t) {
        return this.prodParam.hasReturn ||
          ...
          this.raise(this.state.start, Dc.IllegalReturn),
          this.next(),
          this.isLineTerminator()
            ? t.argument = null
      ...
      parseSwitchStatement(t) {
        ...
        let s, r;
        for (
          this.expect(5), this.state.labels.push(yd), this.scope.enter(0);
          !this.match(8);
        ) {
      ...
      parseThrowStatement(t) {
        return this.next(),
          this.hasPrecedingLineBreak() &&
          this.raise(this.state.lastTokEnd, Dc.NewlineAfterThrow),
      ...
      parseTryStatement(t) {
        ...
        return t.finalizer = this.eat(61) ? this.parseBlock() : null,
          t.handler || t.finalizer || this.raise(t.start, Dc.NoCatchOrFinally),
      ...
      parseWithStatement(t) {
        return this.state.strict && this.raise(this.state.start, Dc.StrictWith),
          this.next(),
      ...
      parseLabeledStatement(t, e, s, r) {
        for (const t of this.state.labels) {
          t.name === e && this.raise(s.start, Dc.LabelRedeclaration, e);
        }
        ...
        return this.next(),
          ...
          "VariableDeclaration" !== e.type || null == e.declarations[0].init ||
            ...
            ? "AssignmentPattern" === e.type &&
              this.raise(e.start, Dc.InvalidLhs, "for-loop")
            : this.raise(
              e.start,
              Dc.ForInOfLoopInitializer,
              r ? "for-in" : "for-of",
            ),
          t.left = e,
              ...
              this.eat(27)
                ...
                : ("const" !== s || this.match(52) || this.isContextual(95)
                  ? "Identifier" === t.id.type ||
                    ...
                    this.raise(
                      this.state.lastTokEnd,
                      Dc.DeclarationMissingInitializer,
      ...
      parseFunction(t) {
        ...
        this.initFunction(t, s),
          this.match(49) && i &&
          this.raise(this.state.start, Dc.GeneratorInSingleStatementContext),
      ...
      parseFunctionId(t) {
        return t || Uc(this.state.type) ? this.parseIdentifier() : null;
      }
      parseFunctionParams(t, e) {
        this.expect(10),
          this.expressionScope.enter(new Il(3)),
            ...
            this.withSmartMixTopicForbiddingContext(() => {
              for (; !this.match(8);) {
                ...
                (t.decorators = r,
                  ...
                  this.raise(t.start, Dc.DecoratorConstructor);
              }
            }),
            this.state.strict = e,
            this.next(),
      ...
      parseClassMemberWithIsStatic(t, e, s, r) {
        ...
        if (
          e.static = r, this.parsePropertyNamePrefixOperator(e), this.eat(49)
        ) {
          u.kind = "method";
          ...
          return this.parseClassElementName(u),
            e
              ...
              : (this.isNonstaticConstructor(i) &&
                this.raise(i.key.start, Dc.ConstructorIsGenerator),
                void this.pushClassMethod(t, i, !0, !1, !1, !1));
        }
        const p = Uc(this.state.type) && !this.state.containsEsc,
          c = this.match(128),
        ...
        if (this.parsePostMemberNameModifiers(h), this.isClassMethod()) {
          ...
          (i.kind = "constructor",
            ...
            this.raise(l.start, Dc.DuplicateConstructor),
            r && this.hasPlugin("typescript") && e.override &&
            this.raise(l.start, Dc.OverrideOnConstructor),
            s.hadConstructor = !0,
          ...
          this.parseClassElementName(u),
            ...
            s
              ...
              : (this.isNonstaticConstructor(i) &&
                this.raise(i.key.start, Dc.ConstructorIsAsync),
          ...
          this.parseClassElementName(i),
            e
              ...
              : (this.isNonstaticConstructor(i) &&
                this.raise(i.key.start, Dc.ConstructorIsAccessor),
      ...
      parseClassElementName(t) {
        ...
        if (
          ...
          this.raise(r, Dc.StaticPrototype), 128 === e
        ) {
          "constructor" === s && this.raise(r, Dc.ConstructorClassPrivateField);
      ...
      parseClassStaticBlock(t, e) {
        ...
        this.parseBlockOrModuleBlockBody(i, void 0, !1, 8),
          ...
          this.raise(e.start, Dc.DecoratorStaticBlock);
      }
      pushClassProperty(t, e) {
        e.computed ||
        "constructor" !== e.key.name && "constructor" !== e.key.value ||
        this.raise(e.key.start, Dc.ConstructorClassField),
      ...
      parseClassId(t, e, s) {
        ...
        Uc(this.state.type)
          ...
          : s || !e
          ? t.id = null
          : this.unexpected(null, Dc.MissingClassName);
      }
      parseClassSuper(t) {
      ...
      isAsyncFunction() {
        ...
        const t = this.nextTokenStart();
        return !sc.test(this.input.slice(this.state.pos, t)) &&
      ...
      parseExportDefaultExpression() {
        ...
        if (this.match(24)) {
          return this.hasPlugin("decorators") &&
            this.getPluginOption("decorators", "decoratorsBeforeExport") &&
            this.raise(this.state.start, Dc.DecoratorBeforeExport),
      ...
      isExportDefaultSpecifier() {
        ...
        if (44 === this.input.charCodeAt(e) || Uc(this.state.type) && s) {
          return !0;
        }
        if (this.match(59) && s) {
      ...
      checkExport(t, e, s, r) {
          ...
          if (s) {
            if (
              ...
              "Identifier" !== e.type || "from" !== e.name ||
                ...
                this.raise(e.start, Dc.ExportDefaultFromAsIdentifier);
            }
            ...
            for (const e of t.specifiers) {
              ...
              if (this.checkDuplicateExports(e, s), !r && e.local) {
                const { local: t } = e;
                "Identifier" !== t.type
                  ? this.raise(e.start, Dc.ExportBindingIsString, t.value, s)
        ...
        if (
          ...
          throw this.raise(t.start, Dc.UnsupportedDecoratorExport);
        }
      }
      checkDeclaration(t) {
      ...
      checkDuplicateExports(t, e) {
        ...
        this.raise(
          t.start,
          "default" === e ? Dc.DuplicateDefaultExport : Dc.DuplicateExport,
          e,
      ...
      parseExportSpecifier(t, e, s, r) {
        return this.eatContextual(87)
          ...
          : e
          ? t.exported = zl(t.local)
          : t.exported || (t.exported = _l(t.local)),
          this.finishNode(t, "ExportSpecifier");
      }
      parseModuleExportName() {
        if (this.match(123)) {
          ...
          return e &&
            this.raise(
              t.start,
              Dc.ModuleExportNameHasLoneSurrogate,
      ...
      parseAssertEntries() {
        ...
        do {
          ...
          if (
            ...
            this.raise(
              this.state.start,
              Dc.ModuleAttributesWithDuplicateKeys,
              r,
            ),
              e.add(r),
              this.match(123)
            ...
            throw this.unexpected(
              this.state.start,
              Dc.ModuleAttributeInvalidValue,
            );
          }
        ...
        do {
          ...
          if (
            s.key = this.parseIdentifier(!0),
              ...
              this.raise(
                s.key.start,
                Dc.ModuleAttributeDifferentFromType,
                s.key.name,
              ),
              e.has(s.key.name) &&
              this.raise(
      ...
      parseImportSpecifier(t, e, s, r) {
        if (this.eatContextual(87)) t.local = this.parseIdentifier();
          ...
          const { imported: s } = t;
          if (e) throw this.raise(t.start, Dc.ImportBindingIsString, s.value);
          this.checkReservedWord(s.name, t.start, !0, !0),
            t.local || (t.local = _l(s));
        }
    ...
    constructor(t, e) {
      t = function (t) {
        const e = {};
        for (const s of Object.keys(dd)) {
          e[s] = t && null != t[s] ? t[s] : dd[s];
        }
        return e;
      }(t),
        super(t, e),
  ...
  const xd = function (t) {
    const e = {};
    for (const s of Object.keys(t)) e[s] = Gc(t[s]);
    return e;
  }(jc);
  function Fd(t, e) {
    let s = Cd;
    return null != t && t.plugins && (!function (t) {
      if (ad(t, "decorators")) {
        if (ad(t, "decorators-legacy")) {
          throw new Error(
            "Cannot use the decorators and decorators-legacy plugin together",
          );
        }
        const e = od(t, "decorators", "decoratorsBeforeExport");
        if (null == e) {
          throw new Error(
      ...
      if (ad(t, "flow") && ad(t, "typescript")) {
        throw new Error("Cannot combine flow and typescript plugins.");
      }
      if (ad(t, "placeholders") && ad(t, "v8intrinsic")) {
        throw new Error("Cannot combine placeholders and v8intrinsic plugins.");
      }
      if (ad(t, "pipelineOperator")) {
        const e = od(t, "pipelineOperator", "proposal");
        if (!ud.includes(e)) {
          const t = ud.map((t) => '"'.concat(t, '"')).join(", ");
          throw new Error(
            '"pipelineOperator" requires "proposal" option whose value must be one of: '
              .concat(t, "."),
          );
        }
        const s = ad(t, "recordAndTuple") &&
          "hash" === od(t, "recordAndTuple", "syntaxType");
        if ("hack" === e) {
          if (ad(t, "placeholders")) {
            throw new Error(
          ...
          const e = od(t, "pipelineOperator", "topicToken");
          if (!hd.includes(e)) {
            const t = hd.map((t) => '"'.concat(t, '"')).join(", ");
            throw new Error(
      ...
      if (ad(t, "moduleAttributes")) {
        if (ad(t, "importAssertions")) {
          throw new Error(
            "Cannot combine importAssertions and moduleAttributes plugins.",
          );
        }
        if ("may-2020" !== od(t, "moduleAttributes", "version")) {
          throw new Error(
      ...
      if (
        ad(t, "recordAndTuple") &&
        !pd.includes(od(t, "recordAndTuple", "syntaxType"))
      ) {
        throw new Error(
          "'recordAndTuple' requires 'syntaxType' option whose value should be one of: " +
            pd.map((t) => "'".concat(t, "'")).join(", "),
        );
      }
      if (ad(t, "asyncDoExpressions") && !ad(t, "doExpressions")) {
        const t = new Error(
      ...
      s = function (t) {
        const e = ld.filter((e) => ad(t, e)), s = e.join("/");
        let r = gd[s];
        if (!r) {
          r = Cd;
          for (const t of e) r = cd[t](r);
          gd[s] = r;
        }
        return r;
      }(t.plugins)),
  ...
  ec.parse = function (t, e) {
    ...
    try {
      e.sourceType = "module";
      const s = Fd(e, t), r = s.parse();
      if (s.sawUnambiguousESM) return r;
      if (s.ambiguousScriptDifferentAst) {
        try {
          return e.sourceType = "script", Fd(e, t).parse();
        } catch (t) {}
    ...
    ec.parseExpression = function (t, e) {
      const s = Fd(e, t);
  ...
  function wd() {
    ...
    return function (t) {
      ...
      if (!e && Pd(r.comments)) throw Bd(r.comments[0], "Comment");
      return Nd(r), r;
    };
  }
  function Bd(t, e) {
    ...
    return Td("".concat(e, " is not allowed in JSON."), { start: s, end: r });
  }
  function Nd(t) {
    switch (t.type) {
      case "ArrayExpression":
        for (const e of t.elements) null !== e && Nd(e);
        return;
      case "ObjectExpression":
        for (const e of t.properties) Nd(e);
        return;
      case "ObjectProperty":
        if (t.computed) throw Bd(t.key, "Computed key");
        if (t.shorthand) throw Bd(t.key, "Shorthand property");
        return "Identifier" !== t.key.type && Nd(t.key), void Nd(t.value);
      case "UnaryExpression": {
        const { operator: e, argument: s } = t;
        if ("+" !== e && "-" !== e) {
          throw Bd(t, "Operator '".concat(t.operator, "'"));
        }
        if (
        ...
        throw Bd(s, "Operator '".concat(e, "' before '").concat(s.type, "'"));
      }
      case "Identifier":
        if (
          "Infinity" !== t.name && "NaN" !== t.name && "undefined" !== t.name
        ) {
          throw Bd(t, "Identifier '".concat(t.name, "'"));
        }
        return;
      case "TemplateLiteral":
        if (Pd(t.expressions)) {
          throw Bd(t.expressions[0], "'TemplateLiteral' with expression");
        }
        for (const e of t.quasis) Nd(e);
        return;
      case "NullLiteral":
      case "BooleanLiteral":
      case "NumericLiteral":
      ...
      case "TemplateElement":
        return;
      default:
        throw Bd(t, "'".concat(t.type, "'"));
    }
  }
  const Id = wd();
  var vd = {
    json: bd({ parse: Id, hasPragma: () => !0 }),
    json5: bd(Id),
    "json-stringify": bd({
      parse: wd({ allowComments: !1 }),
      astFormat: "estree-json",
    }),
  };
  const kd = xi,
    {
      getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Ld,
      getShebang: Od,
    } = Oo,
    Md = vu,
    Rd = Ou,
    ...
    zd = ["recordAndTuple", { syntaxType: "hash" }],
    Hd = "v8intrinsic",
    Vd = [["pipelineOperator", { proposal: "hack", topicToken: "%" }], [
      "pipelineOperator",
      { proposal: "minimal" },
  ...
  function Kd(t, e) {
    ...
    const r = Ld(t, 0);
    return !1 !== r && (t = t.slice(0, r)), Wd.test(t);
  }
  function Gd(t, e, s) {
    const r = (0, ec[t])(e, s), i = r.errors.find((t) => !tD.has(t.reasonCode));
    if (i) throw i;
    return r;
  }
  function Xd(t) {
    ...
    return function (e, r) {
      let i = arguments.length > 2 && void 0 !== arguments[2]
        ? arguments[2]
        : {};
      if (
        ("babel" === i.parser || "__babel_estree" === i.parser) && Kd(e, i)
      ) {
        return i.parser = "babel-flow", $d(e, r, i);
      }
      let n = s;
      "script" === i.__babelSourceType &&
      (n = n.map((t) =>
        Object.assign(Object.assign({}, t), {}, { sourceType: "script" }))),
        /#[[{]/.test(e) && (n = n.map((t) => qd([zd], t)));
      const a = /%[A-Z]/.test(e);
      if (e.includes("|>")) {
        const t = a ? [...Vd, Hd] : Vd;
        n = t.flatMap((t) => n.map((e) => qd([t], e)));
      } else a && (n = n.map((t) => qd([Hd], t)));
      const { result: o, error: u } = kd(...n.map((s) => () => Gd(t, e, s)));
      if (!o) throw Rd(u);
      return i.originalText = e, jd(o, i);
    };
  }
  const Jd = Xd("parse", qd(["jsx", "flow"])),
    $d = Xd("parse", qd(["jsx", ["flow", { all: !0, enums: !0 }]])),
    Yd = Xd("parse", qd(["jsx", "typescript"]), qd(["typescript"])),
    Qd = Xd("parse", qd(["jsx", "flow", "estree"])),
    Zd = Xd("parseExpression", qd(["jsx"])),
    tD = new Set([
      "StrictNumericEscape",
      "StrictWith",
      "StrictOctalLiteral",
  ...
  return {
    parsers: Object.assign(
      Object.assign(
        { babel: eD, "babel-flow": Md($d), "babel-ts": Md(Yd) },
        Ud,
      ),
      {},
      {
