!function (e, t) {
  ...
  var i,
    n = function () {
      let e;
      for (
        var t = arguments.length, r = new Array(t), i = 0; i < t; i++
      ) {
        r[i] = arguments[i];
      }
  ...
  const X = (e) =>
    ...
    (e >= 4352 &&
      (e <= 4447 || 9001 === e || 9002 === e ||
        ...
        131072 <= e && e <= 262141));
  U.exports = X, U.exports.default = X;
  const G = (e) => "string" == typeof e ? e.replace(M(), "") : e,
    q = U.exports,
    W = function () {
  ...
  var ae,
    ...
    Ue = Ve.process,
    Xe = Ve.Deno,
    Ge = Ue && Ue.versions || Xe && Xe.version,
    qe = Ge && Ge.v8;
  ...
  var yt = be,
    ...
    It = wt(1..toString),
    Nt = function (e) {
      return "Symbol(" + (void 0 === e ? "" : e) + ")_" + It(++Tt + kt, 36);
    },
    _t = Y,
    Lt = dt.exports,
    Pt = St,
    ...
    Mt = _t.Symbol,
    Ut = Mt && Mt.for,
    Xt = jt ? Mt : Mt && Mt.withoutSetter || Ot,
    Gt = function (e) {
      if (!Pt(Vt, e) || !Rt && "string" != typeof Vt[e]) {
        var t = "Symbol." + e;
        Rt && Pt(Mt, e) ? Vt[e] = Mt[e] : Vt[e] = jt && Ut ? Ut(t) : Xt(t);
      }
      return Vt[e];
    },
    qt = re,
    ...
    Yt = $t("toPrimitive"),
    Qt = function (e, t) {
      if (!Wt(e) || zt(e)) return e;
      var r, i = Jt(e, Yt);
      if (i) {
        if (void 0 === t && (t = "default"), r = qt(i, e, t), !Wt(r) || zt(r)) {
          return r;
        }
    ...
    tr = Ne,
    rr = Y.document,
    ir = tr(rr) && tr(rr.createElement),
    nr = function (e) {
      return ir ? rr.createElement(e) : {};
    },
    ur = !ee && !Z(function () {
      return 7 != Object.defineProperty(nr("div"), "a", {
        get: function () {
          return 7;
        },
      }).a;
  ...
  Q.f = sr ? dr : function (e, t) {
    if (e = pr(e), t = Dr(t), lr) {
      try {
        return dr(e, t);
      } catch (e) {}
    }
    if (hr(e, t)) return cr(!ar(or.f, e, t), e[t]);
  };
  var fr = {},
    Er = Y,
    mr = Ne,
    ...
    Ar = function (e) {
      if (mr(e)) return e;
      throw Fr(Cr(e) + " is not an object");
    },
    gr = ee,
    yr = ur,
    xr = Ar,
  ...
  fr.f = gr ? br : function (e, t, r) {
    if (xr(e), t = Br(t), xr(r), yr) {
      try {
        return br(e, t, r);
      } catch (e) {}
    }
    if ("get" in r || "set" in r) throw vr("Accessors not supported");
  ...
  var Lr,
    ...
    Vr = Rr,
    Mr = Y.WeakMap,
    Ur = jr(Mr) && /native code/.test(Vr(Mr)),
    Xr = dt.exports,
    Gr = Nt,
    qr = Xr("keys"),
    Wr = {},
    ...
    ii = Jr.WeakMap;
  if (zr || Qr.state) {
    var ni = Qr.state || (Qr.state = new ii()),
      ui = Hr(ni.get),
      si = Hr(ni.has),
      ai = Hr(ni.set);
    Lr = function (e, t) {
      if (si(ni, e)) throw new ri(ti);
      return t.facade = e, ai(ni, e, t), t;
    },
      Pr = function (e) {
        return ui(ni, e) || {};
      },
    ...
    ei[oi] = !0,
      Lr = function (e, t) {
        if (Yr(e, oi)) throw new ri(ti);
        return t.facade = e, Kr(e, oi, t), t;
      },
      Pr = function (e) {
        return Yr(e, oi) ? e[oi] : {};
      },
  ...
  var ci = {
    ...
    li = pi && Object.getOwnPropertyDescriptor,
    di = Di(hi, "name"),
    fi = di && "something" === function () {}.name,
    Ei = di && (!pi || pi && li(hi, "name").configurable),
    mi = Y,
    Ci = ke,
    Fi = St,
    Ai = Tr,
    gi = mt,
    yi = Rr,
    xi = { EXISTS: di, PROPER: fi, CONFIGURABLE: Ei }.CONFIGURABLE,
    Bi = ci.get,
    vi = ci.enforce,
    bi = String(String).split("String");
  (kr.exports = function (e, t, r, i) {
    var n,
      u = !!i && !!i.unsafe,
      s = !!i && !!i.enumerable,
      a = !!i && !!i.noTargetGet,
    ...
    ("Symbol(" === String(o).slice(0, 7) &&
      ...
      (!Fi(r, "name") || xi && r.name !== o) && Ai(r, "name", o),
      (n = vi(r)).source || (n.source = bi.join(
        "string" == typeof o
          ? o
          : "",
      ))),
      e !== mi
        ? (u ? !a && e[t] && (s = !0) : delete e[t], s ? e[t] = r : Ai(e, t, r))
        : s
        ? e[t] = r
        : gi(t, r);
  })(Function.prototype, "toString", function () {
    return Ci(this) && Bi(this).source || yi(this);
  });
  var Si = {},
    wi = Math.ceil,
    Ti = Math.floor,
    ...
    Pi = Math.min,
    Oi = function (e) {
      return e > 0 ? Pi(Li(e), 9007199254740991) : 0;
    },
    Ri = function (e) {
      return Oi(e.length);
    },
    ...
    Vi = function (e, t) {
      var r = Ii(e);
      return r < 0 ? Ni(r + t, 0) : _i(r, t);
    },
    Mi = Ri,
    Ui = function (e) {
      return function (t, r, i) {
        var n, u = ji(t), s = Mi(u), a = Vi(i, s);
    ...
    Hi = function (e, t) {
      var r, i = qi(e), n = 0, u = [];
      for (r in i) !Gi(zi, r) && Gi(i, r) && Ji(u, r);
      for (; t.length > n;) Gi(i, r = t[n++]) && (~Wi(u, r) || Ji(u, r));
      return u;
    },
    $i = [
      "constructor",
  ...
  Si.f = Object.getOwnPropertyNames || function (e) {
    return Hi(e, $i);
  };
  var Ki = {};
  ...
  var Yi = Oe,
    ...
    en = Ar,
    tn = de([].concat),
    rn = Yi("Reflect", "ownKeys") || function (e) {
      var t = Qi.f(en(e)), r = Zi.f;
      return r ? tn(t, r(e)) : t;
    },
    nn = St,
    un = rn,
    ...
    Dn = function (e, t) {
      var r = ln[hn(e)];
      return r == fn || r != dn && (cn(t) ? on(t) : !!t);
    },
    hn = Dn.normalize = function (e) {
      return String(e).replace(pn, ".").toLowerCase();
    },
    ln = Dn.data = {},
    dn = Dn.NATIVE = "N",
    fn = Dn.POLYFILL = "P",
    ...
    gn = mt,
    yn = function (e, t) {
      for (var r = un(t), i = an.f, n = sn.f, u = 0; u < r.length; u++) {
        var s = r[u];
        nn(e, s) || i(e, s, n(t, s));
      }
    },
    ...
    Bn = function (e, t) {
      ...
      if (r = o ? mn : c ? mn[a] || gn(a, {}) : (mn[a] || {}).prototype) {
        for (i in t) {
          if (
            u = t[i],
              n = e.noTargetGet
          ...
          (e.sham || n && n.sham) && Fn(u, "sham", !0), An(r, i, u, e);
        }
      }
    },
    vn = Ce,
    ...
    Nn = Tn,
    _n = Y.TypeError,
    Ln = function (e, t, r, i, n, u, s, a) {
      for (var o, c, p = n, D = 0, h = !!s && Nn(s, a); D < i;) {
        if (D in r) {
          if (o = h ? h(r[D], D, t) : r[D], u > 0 && kn(o)) {
            c = In(o), p = Ln(e, t, o, c, p, u - 1) - 1;
          } else {
            if (p >= 9007199254740991) {
              throw _n("Exceed the acceptable array length");
            }
            e[p] = o;
          }
          p++;
  ...
  On[Gt("toStringTag")] = "z";
  var Rn = Y,
    jn = "[object z]" === String(On),
    Vn = ke,
    Mn = Ce,
    Un = Gt("toStringTag"),
    Xn = Rn.Object,
    Gn = "Arguments" == Mn(function () {
      return arguments;
    }()),
    qn = jn ? Mn : function (e) {
      var t, r, i;
    ...
    Kn = function () {},
    Yn = [],
    Qn = Oe("Reflect", "construct"),
    Zn = /^\s*(?:class|function)\b/,
    eu = Wn(Zn.exec),
    tu = !Zn.exec(Kn),
    ru = function (e) {
      if (!Jn(e)) return !1;
    ...
    pu = function (e) {
      ...
      return uu(e) &&
        (t = e.constructor,
          (su(t) && (t === cu || uu(t.prototype)) ||
            au(t) && null === (t = t[ou])) && (t = void 0)),
        void 0 === t ? cu : t;
    },
    Du = Pn,
    hu = at,
    ...
    du = Ri,
    fu = function (e, t) {
      return new (pu(e))(0 === t ? 0 : t);
    };
  Bn({ target: "Array", proto: !0 }, {
    flatMap: function (e) {
      var t, r = lu(this), i = du(r);
      return hu(e),
        (t = fu(r, 0)).length = Du(
          t,
          r,
  ...
  var Eu = qn,
    ...
    Fu = Math.floor,
    Au = function (e, t) {
      var r = e.length, i = Fu(r / 2);
      return r < 8 ? gu(e, t) : yu(e, Au(Cu(e, 0, i), t), Au(Cu(e, i), t), t);
    },
    gu = function (e, t) {
    ...
    xu = Au,
    Bu = Z,
    vu = je.match(/firefox\/(\d+)/i),
    bu = !!vu && +vu[1],
    Su = /MSIE|Trident/.test(je),
    wu = je.match(/AppleWebKit\/(\d+)\./),
    Tu = !!wu && +wu[1],
    ku = Bn,
    Iu = de,
    Nu = at,
    ...
    $u = !Ou(function () {
      ...
      if (!(Vu && Vu > 3)) {
        ...
        for (e = 65; e < 76; e++) {
          ...
          for (i = 0; i < 47; i++) Gu.push({ k: t + i, v: r });
        }
        for (
          Gu.sort(function (e, t) {
            return t.v - e.v;
          }), i = 0;
          i < Gu.length;
          i++
        ) {
          t = Gu[i].k.charAt(0), n.charAt(n.length - 1) !== t && (n += t);
        }
        return "DGBEFHACIJK" !== n;
      }
    });
  ku({ target: "Array", proto: !0, forced: zu || !Ju || !Hu || !$u }, {
    sort: function (e) {
      void 0 !== e && Nu(e);
      var t = _u(this);
      if ($u) return void 0 === e ? qu(t) : qu(t, e);
      var r, i, n = [], u = Lu(t);
      for (i = 0; i < u; i++) i in t && Wu(n, t[i]);
      for (
        Ru(
          n,
          function (e) {
  ...
  var Ku = {},
    ...
    is = Gt("iterator"),
    ns = function (e) {
      if (null != e) return ts(e, is) || ts(e, "@@iterator") || rs[es(e)];
    },
    us = re,
    ss = at,
    as = Ar,
    ...
    ms = it,
    Cs = function (e) {
      return void 0 !== e && (Yu.Array === e || Zu[Qu] === e);
    },
    Fs = Ri,
    As = Re,
    gs = function (e, t) {
      var r = arguments.length < 2 ? cs(e) : t;
      if (ss(r)) return as(us(r, e));
      throw ps(os(e) + " is not iterable");
    },
    ys = ns,
    xs = function (e, t, r) {
      var i, n;
    ...
    ks = function (e, t, r) {
      var i,
        ...
        d = ds(t, p),
        f = function (e) {
          return i && xs(i, "normal", e), new vs(!0, e);
        },
        E = function (e) {
          return D ? (Es(e), l ? d(e[0], e[1], f) : d(e[0], e[1]))
          : l ? d(e, f) : d(e);
        };
      if (h) i = e;
      else {
        if (!(n = ys(e))) throw Bs(ms(e) + " is not iterable");
        if (Cs(n)) {
          for (u = 0, s = Fs(e); s > u; u++) {
            if ((a = E(e[u])) && As(bs, a)) return a;
          }
          return new vs(!1);
        }
        i = gs(e, n);
      }
      for (o = i.next; !(c = fs(o, i)).done;) {
        try {
          a = E(c.value);
        } catch (e) {
          xs(i, "throw", e);
        }
        if ("object" == typeof a && a && As(bs, a)) return a;
      }
      return new vs(!1);
    },
    Is = function (e, t, r) {
      var i = Ss(t);
      i in e ? ws.f(e, i, Ts(0, r)) : e[i] = r;
    };
  function Ns() {
  ...
  Bn({ target: "Object", stat: !0 }, {
    fromEntries: function (e) {
      var t = {};
      return ks(e, function (e, r) {
        Is(t, e, r);
      }, { AS_ENTRIES: !0 }),
        t;
    },
  ...
  function Os(e) {
    ...
    if ((Ls === Ns || !Ls) && setTimeout) {
      return Ls = setTimeout, setTimeout(e, 0);
    }
    try {
      return Ls(e, 0);
    } catch (t) {
      try {
        return Ls.call(null, e, 0);
      } catch (t) {
        return Ls.call(this, e, 0);
      }
    }
  }
  "function" == typeof s.setTimeout && (Ls = setTimeout),
    "function" == typeof s.clearTimeout && (Ps = clearTimeout);
  var Rs, js = [], Vs = !1, Ms = -1;
  function Us() {
    Vs && Rs &&
      (Vs = !1, Rs.length ? js = Rs.concat(js) : Ms = -1, js.length && Xs());
  }
  function Xs() {
    if (!Vs) {
      var e = Os(Us);
      ...
      for (var t = js.length; t;) {
        for (Rs = js, js = []; ++Ms < t;) Rs && Rs[Ms].run();
        Ms = -1, t = js.length;
      }
      Rs = null,
        Vs = !1,
        function (e) {
          if (Ps === clearTimeout) return clearTimeout(e);
          if ((Ps === _s || !Ps) && clearTimeout) {
            return Ps = clearTimeout, clearTimeout(e);
          }
          try {
            Ps(e);
          } catch (t) {
            try {
              return Ps.call(null, e);
            } catch (t) {
              return Ps.call(this, e);
            }
          }
        }(e);
    }
  ...
  function qs() {}
  var Ws = qs, zs = qs, Js = qs, Hs = qs, $s = qs, Ks = qs, Ys = qs;
  var Qs = s.performance || {},
    Zs = Qs.now || Qs.mozNow || Qs.msNow || Qs.oNow || Qs.webkitNow ||
      function () {
  ...
  var ta = {
      nextTick: function (e) {
        ...
        js.push(new Gs(e, t)), 1 !== js.length || Vs || Os(Xs);
      },
      title: "browser",
      browser: !0,
      env: {},
      ...
      hrtime: function (e) {
        var t = .001 * Zs.call(Qs),
          r = Math.floor(t),
          i = Math.floor(t % 1 * 1e9);
      ...
      config: {},
      uptime: function () {
        return (new Date() - ea) / 1e3;
      },
    },
    ra = ta;
  const ia =
    "object" == typeof ra && ra.env && ra.env.NODE_DEBUG &&
      /\bsemver\b/i.test(ra.env.NODE_DEBUG)
      ? function () {
        for (
  ...
  var ua = {
    ...
    sa = { exports: {} };
  !function (e, t) {
    const { MAX_SAFE_COMPONENT_LENGTH: r } = ua,
      i = na,
      n = (t = e.exports = {}).re = [],
      u = t.src = [],
      s = t.t = {};
    ...
    o("NUMERICIDENTIFIER", "0|[1-9]\\d*"),
      ...
      o(
        "LOOSEPLAIN",
        "[v=\\s]*".concat(u[s.MAINVERSIONLOOSE]).concat(
          u[s.PRERELEASELOOSE],
          "?",
        ).concat(u[s.BUILD], "?"),
      ),
  ...
  const aa = ["includePrerelease", "loose", "rtl"];
  var oa = (e) =>
    e
      ? "object" != typeof e ? { loose: !0 }
      : aa.filter((t) => e[t]).reduce((e, t) => (e[t] = !0, e), {})
      : {};
  const ca = /^[0-9]+$/,
    pa = (e, t) => {
      const r = ca.test(e), i = ca.test(t);
      return r && i && (e = +e, t = +t),
        e === t ? 0 : r && !i ? -1 : i && !r ? 1 : e < t ? -1 : 1;
    };
  var Da = { compareIdentifiers: pa, rcompareIdentifiers: (e, t) => pa(t, e) };
  const ha = na,
    { MAX_LENGTH: la, MAX_SAFE_INTEGER: da } = ua,
    { re: fa, t: Ea } = sa.exports,
    ma = oa,
    { compareIdentifiers: Ca } = Da;
  class Fa {
    constructor(e, t) {
      if (t = ma(t), e instanceof Fa) {
        if (
      ...
      if (e.length > la) {
        throw new TypeError(
          "version is longer than ".concat(la, " characters"),
        );
      }
      ha("SemVer", e, t),
        this.options = t,
      ...
      const r = e.trim().match(t.loose ? fa[Ea.LOOSE] : fa[Ea.FULL]);
    ...
    compare(e) {
      if (
        ha("SemVer.compare", this.version, this.options, e), !(e instanceof Fa)
      ) {
    ...
    compareMain(e) {
      return e instanceof Fa || (e = new Fa(e, this.options)),
        Ca(this.major, e.major) || Ca(this.minor, e.minor) ||
        Ca(this.patch, e.patch);
    }
    comparePre(e) {
      if (
      ...
      do {
        ...
        if (
          ha("prerelease compare", t, r, i), void 0 === r && void 0 === i
        ) {
          return 0;
        }
        if (void 0 === i) return 1;
        if (void 0 === r) return -1;
        if (r !== i) return Ca(r, i);
      } while (++t);
    }
    compareBuild(e) {
      e instanceof Fa || (e = new Fa(e, this.options));
      ...
      do {
        ...
        if (ha("prerelease compare", t, r, i), void 0 === r && void 0 === i) {
          return 0;
        }
        if (void 0 === i) return 1;
        if (void 0 === r) return -1;
  ...
  const Aa = Fa;
  var ga = (e, t, r) => new Aa(e, r).compare(new Aa(t, r));
  const ya = ga;
  var xa = (e, t, r) => ya(e, t, r) < 0;
  const Ba = ga;
  var va,
    ba,
    Sa,
  ...
  const Ma = ["cliName", "cliCategory", "cliDescription"],
    Ua = { compare: ga, lt: xa, gte: Ia },
    Xa = (e, t) =>
  ...
  var za = {
    getSupportInfo: function () {
      ...
      function a(e) {
        return t || !("since" in e) || e.since && Ua.gte(n, e.since);
      }
      function o(e) {
        return r || !("deprecated" in e) ||
          e.deprecated && Ua.lt(n, e.deprecated);
      }
      function c(e) {
        if (i) return e;
        return H(e, Ma);
  ...
  const Za = Qa(/\s/), eo = Qa(" \t"), to = Qa(",; \t"), ro = Qa(/[^\n\r]/);
  function io(e, t) {
    if (!1 === t) return !1;
  ...
  function no(e, t) {
    return !1 !== t && ("/" === e.charAt(t) && "/" === e.charAt(t + 1)
      ? ro(e, t)
      : t);
  }
  function uo(e, t, r) {
  ...
  function so(e, t) {
    ...
    const i = eo(e, r.backwards ? t - 1 : t, r), n = uo(e, i, r);
    return i !== n;
  }
  function ao(e, t) {
    let r = null, i = t;
    for (; i !== r;) r = i, i = to(e, i), i = io(e, i), i = eo(e, i);
    return i = no(e, i), i = uo(e, i), !1 !== i && so(e, i);
  }
  function oo(e, t) {
    let r = null, i = t;
    for (; i !== r;) {
      r = i, i = eo(e, i), i = io(e, i), i = no(e, i), i = uo(e, i);
    }
    return i;
  }
  function co(e, t, r) {
  ...
  var fo = {
    inferParserByLanguage: function (e, t) {
      const { languages: r } = Ka({ plugins: t.plugins }),
        i = r.find((t) => {
          let { name: r } = t;
    ...
    getStringWidth: function (e) {
      return e ? Ya.test(e) ? Ja(e) : e.length : 0;
    },
    getMaxContinuousCount: function (e, t) {
      const r = e.match(new RegExp("(".concat(Ha(t), ")+"), "g"));
      return null === r
        ? 0
    ...
    getLast: $a,
    getNextNonSpaceNonCommentCharacterIndexWithStartIndex: oo,
    getNextNonSpaceNonCommentCharacterIndex: co,
    getNextNonSpaceNonCommentCharacter: function (e, t, r) {
      return e.charAt(co(e, t, r));
    },
    skip: Qa,
    skipWhitespace: Za,
    skipSpaces: eo,
    skipToLineEnd: to,
    skipEverythingButNewLine: ro,
    skipInlineComment: io,
    skipTrailingComment: no,
    skipNewline: uo,
    isNextLineEmptyAfterIndex: ao,
    isNextLineEmpty: function (e, t, r) {
      return ao(e, r(t));
    },
    isPreviousLineEmpty: function (e, t, r) {
      let i = r(t) - 1;
      return i = eo(e, i, { backwards: !0 }),
        i = uo(e, i, { backwards: !0 }),
        i = eo(e, i, { backwards: !0 }),
        i !== uo(e, i, { backwards: !0 });
    },
    hasNewline: so,
    ...
    hasSpaces: function (e, t) {
      let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2]
      : {};
      const i = eo(e, r.backwards ? t - 1 : t, r);
      return i !== t;
    },
    getAlignmentSize: po,
    getIndentSize: function (e, t) {
      const r = e.lastIndexOf("\n");
      return -1 === r ? 0 : po(e.slice(r + 1).match(/^[\t ]*/)[0], t);
    },
    getPreferredQuote: Do,
    ...
    addLeadingComment: function (e, t) {
      t.leading = !0, t.trailing = !1, lo(e, t);
    },
    addDanglingComment: function (e, t, r) {
      t.leading = !1, t.trailing = !1, r && (t.marker = r), lo(e, t);
    },
    addTrailingComment: function (e, t) {
      t.leading = !1, t.trailing = !0, lo(e, t);
    },
  ...
  const { parseWithComments: mo, strip: Co, extract: Fo, print: Ao } = u,
    { getShebang: go } = fo,
    { normalizeEndOfLine: yo } = Eo;
  function xo(e) {
    const t = go(e);
    t && (e = e.slice(t.length + 1));
    const r = Fo(e), { pragmas: i, comments: n } = mo(r);
    return { shebang: t, text: e, pragmas: i, comments: n };
  }
  var Bo = {
    hasPragma: function (e) {
      const t = Object.keys(xo(e).pragmas);
      return t.includes("prettier") || t.includes("format");
    },
    insertPragma: function (e) {
      const { shebang: t, text: r, pragmas: i, comments: n } = xo(e),
        u = Co(r),
        s = Ao({
  ...
  var To = {
    ...
    hasSameLoc: function (e, t) {
      return wo(e, t) && function (e, t) {
        return So(e) === So(t);
      }(e, t);
    },
  };
  const { hasPragma: ko } = Bo, { locStart: Io, locEnd: No } = To;
  var _o = function (e) {
  ...
  !function () {
    ...
    Po.ast = Oo.exports,
    Po.code = Ro.exports,
    Po.keyword = jo.exports;
  const Vo = Po.keyword.isIdentifierNameES5,
    {
      getLast: Mo,
      hasNewline: Uo,
      skipWhitespace: Xo,
      isNonEmptyArray: Go,
      isNextLineEmptyAfterIndex: qo,
      getStringWidth: Wo,
    } = fo,
    { locStart: zo, locEnd: Jo, hasSameLocStart: Ho } = To,
    $o = "(?:(?=.)\\s)",
    Ko = new RegExp("^".concat($o, "*:")),
    Yo = new RegExp("^".concat($o, "*::"));
  function Qo(e) {
  ...
  function uc(e) {
    return hc(e) && "Identifier" === e.callee.type &&
  ...
  function Sc(e) {
    return e && (e.prettierIgnore || kc(e, wc.PrettierIgnore));
  }
  const wc = {
      Leading: 2,
      Trailing: 4,
    ...
    Tc = (e, t) => {
      if ("function" == typeof e && (t = e, e = 0), e || t) {
        return (r, i, n) =>
          !(e & wc.Leading && !r.leading || e & wc.Trailing && !r.trailing ||
            e & wc.Dangling && (r.leading || r.trailing) ||
            e & wc.Block && !Qo(r) || e & wc.Line && !Zo(r) ||
            e & wc.First && 0 !== i || e & wc.Last && i !== n.length - 1 ||
            e & wc.PrettierIgnore && !bc(r) || t && !t(r));
      }
    };
  function kc(e, t, r) {
    if (!e || !Go(e.comments)) return !1;
    const i = Tc(t, r);
  ...
  function Nc(e) {
    return hc(e) || "NewExpression" === e.type || "ImportExpression" === e.type;
  }
  var _c = {
    ...
    hasRestParameter: function (e) {
      if (e.rest) return !0;
      const t = xc(e);
      return t.length > 0 && "RestElement" === Mo(t).type;
    },
    ...
    getParentExportDeclaration: function (e) {
      ...
      return "declaration" === e.getName() && tc(t) ? t : null;
    },
    getTypeScriptMappedTypeModifier: function (e, t) {
      return "+" === e ? "+" + t : "-" === e ? "-" + t : t;
    },
    hasFlowAnnotationComment: function (e) {
      return Go(e) && Qo(e[0]) && Yo.test(e[0].value);
    },
    hasFlowShorthandAnnotationComment: function (e) {
      return e.extra && e.extra.parenthesized && Go(e.trailingComments) &&
        Qo(e.trailingComments[0]) && Ko.test(e.trailingComments[0].value);
    },
    hasLeadingOwnLineComment: function (e, t) {
      return sc(t) ? Sc(t) : kc(t, wc.Leading, (t) => Uo(e, Jo(t)));
    },
    hasNakedLeftSide: function (e) {
      return "AssignmentExpression" === e.type ||
        ...
        hc(e) || lc(e) || "SequenceExpression" === e.type ||
    ...
    hasIgnoreComment: function (e) {
      return Sc(e.getValue());
    },
    hasNodeIgnoreComment: Sc,
    identity: function (e) {
      return e;
    },
    isBinaryish: function (e) {
      return cc.has(e.type);
    },
    isBlockComment: Qo,
    isCallLikeExpression: Nc,
    isEnabledHackPipeline: function (e) {
      return Boolean(e.__isUsingHackPipeline);
    },
    isLineComment: Zo,
    isPrettierIgnoreComment: bc,
    isCallExpression: hc,
    isMemberExpression: lc,
    isExportDeclaration: tc,
    isFlowAnnotationComment: function (e, t) {
      const r = zo(t), i = Xo(e, Jo(t));
      return !1 !== i && "/*" === e.slice(r, r + 2) &&
        "*/" === e.slice(i, i + 2);
    },
      ...
      return !(n && Wo(n) > 5) &&
        ("Literal" === t.type || "BigIntLiteral" === t.type ||
          ...
          "Import" === t.type || ("TemplateLiteral" === t.type
            ...
            ? t.properties.every(
              (e) => !e.computed && (e.shorthand || e.value && i(e.value)),
            )
            : "ArrayExpression" === t.type
            ? t.elements.every((e) => null === e || i(e))
            : Nc(t)
            ? ("ImportExpression" === t.type || e(t.callee, r)) &&
              vc(t).every(i)
            : lc(t)
    ...
    isMemberish: function (e) {
      return lc(e) || "BindExpression" === e.type && Boolean(e.object);
    },
    isNumericLiteral: rc,
    isSignedNumericLiteral: function (e) {
      return "UnaryExpression" === e.type &&
        ("+" === e.operator || "-" === e.operator) && rc(e.argument);
    },
    ...
    isObjectTypePropertyAFunction: function (e) {
      return !("ObjectTypeProperty" !== e.type &&
        ...
        "FunctionTypeAnnotation" !== e.value.type || e.static || oc(e));
    },
    isSimpleType: function (e) {
      return !!e &&
        (!("GenericTypeAnnotation" !== e.type && "TSTypeReference" !== e.type ||
          e.typeParameters) || !!pc.has(e.type));
    },
    isSimpleNumber: dc,
    ...
    isTestCall: function e(t, r) {
      ...
      if (1 === t.arguments.length) {
        ...
        if (
          ...
          return uc(t.arguments[0]);
        }
      } else if (
        (2 === t.arguments.length || 3 === t.arguments.length) &&
        ("Identifier" === t.callee.type && Dc.test(t.callee.name) ||
          function (e) {
            return lc(e.callee) && "Identifier" === e.callee.object.type &&
        ...
        }(t.arguments[0]) || ic(t.arguments[0]))
      ) {
        return !(t.arguments[2] && !rc(t.arguments[2])) &&
          ((2 === t.arguments.length ? nc(t.arguments[1]) : function (e) {
            return "FunctionExpression" === e.type ||
              "ArrowFunctionExpression" === e.type &&
                "BlockStatement" === e.body.type;
          }(t.arguments[1]) && xc(t.arguments[1]).length <= 1) ||
            uc(t.arguments[1]));
      }
      return !1;
    },
    isTheOnlyJsxElementInMarkdown: function (e, t) {
      ...
      const r = t.getNode();
      if (!r.expression || !sc(r.expression)) return !1;
  ...
  const {
      ...
      hasNewlineInRange: jc,
      addLeadingComment: Vc,
      addTrailingComment: Mc,
      addDanglingComment: Uc,
      getNextNonSpaceNonCommentCharacterIndex: Xc,
      isNonEmptyArray: Gc,
    } = fo,
    {
      isBlockComment: qc,
      getFunctionParameters: Wc,
      isPrettierIgnoreComment: zc,
      isJsxNode: Jc,
      hasFlowShorthandAnnotationComment: Hc,
      hasFlowAnnotationComment: $c,
      hasIgnoreComment: Kc,
  ...
  function ap(e, t) {
    "BlockStatement" === e.type ? sp(e, t) : Vc(e, t);
  }
  function op(e) {
    let { comment: t, followingNode: r } = e;
    return !(!r || !Rp(t)) && (Vc(r, t), !0);
  }
  function cp(e) {
    let {
      comment: t,
    ...
    return ")" === Rc(u, t, up)
      ...
      ? ("BlockStatement" === r.type ? Mc(r, t) : Uc(i, t), !0)
      : "BlockStatement" === n.type
      ? (sp(n, t), !0)
      : "IfStatement" === n.type
      ? (ap(n.consequent, t), !0)
      : i.consequent === n && (Vc(n, t), !0);
  }
  function pp(e) {
    let {
      comment: t,
  ...
  function Dp(e) {
    let { comment: t, precedingNode: r, enclosingNode: i, followingNode: n } =
      e;
    return !(!i || "TryStatement" !== i.type && "CatchClause" !== i.type ||
      !n) && ("CatchClause" === i.type && r
        ? (Mc(r, t), !0)
        : "BlockStatement" === n.type
        ? (sp(n, t), !0)
        : "TryStatement" === n.type
        ? (ap(n.finalizer, t), !0)
        : "CatchClause" === n.type && (ap(n.body, t), !0));
  }
  function hp(e) {
    let { comment: t, enclosingNode: r, followingNode: i } = e;
    return !(!ep(r) || !i || "Identifier" !== i.type) && (Vc(r, t), !0);
  }
  function lp(e) {
    let {
      comment: t,
  ...
  function dp(e) {
    ...
    return !(!tp(i) || !i.shorthand || i.key !== r ||
      "AssignmentPattern" !== i.value.type) && (Mc(i.value.left, t), !0);
  }
  function fp(e) {
    let { comment: t, precedingNode: r, enclosingNode: i, followingNode: n } =
      e;
    if (
      ...
      if (Gc(i.decorators) && (!n || "Decorator" !== n.type)) {
        return Mc(Lc(i.decorators), t), !0;
      }
      if (i.body && n === i.body) return sp(i.body, t), !0;
      if (n) {
  ...
  function Ep(e) {
    ...
    return (i && r &&
        ...
        "Identifier" === r.type && i.key === r && ":" !== Rc(n, r, up) ||
    ...
    return "(" === Rc(n, t, up) &&
      (!(!r || !i ||
        "FunctionDeclaration" !== i.type && "FunctionExpression" !== i.type &&
          ...
          "ObjectMethod" !== i.type) && (Mc(r, t), !0));
  }
  function Cp(e) {
    let { comment: t, enclosingNode: r, text: i } = e;
    if (!r || "ArrowFunctionExpression" !== r.type) return !1;
    const n = Xc(i, t, up);
    return !1 !== n && "=>" === i.slice(n, n + 2) && (Uc(r, t), !0);
  }
  function Fp(e) {
    let { comment: t, enclosingNode: r, text: i } = e;
    return ")" === Rc(i, t, up) &&
      (r && (Op(r) && 0 === Wc(r).length || Yc(r) && 0 === Qc(r).length)
        ? (Uc(r, t), !0)
        : !(!r ||
          "MethodDefinition" !== r.type &&
            "TSAbstractMethodDefinition" !== r.type ||
          0 !== Wc(r.value).length) && (Uc(r.value, t), !0));
  }
  function Ap(e) {
    let {
      comment: t,
    ...
    if (
      ...
      const e = (() => {
        const e = Wc(i);
        if (e.length > 0) return Oc(u, up(Lc(e)));
        const t = Oc(u, up(i.id));
        return !1 !== t && Oc(u, t + 1);
      })();
      if (np(t) > e) return sp(n, t), !0;
    }
    return !1;
  }
  function gp(e) {
    let { comment: t, enclosingNode: r } = e;
    return !(!r || "ImportSpecifier" !== r.type) && (Vc(r, t), !0);
  }
  function yp(e) {
    let { comment: t, enclosingNode: r } = e;
    return !(!r || "LabeledStatement" !== r.type) && (Vc(r, t), !0);
  }
  function xp(e) {
    let { comment: t, enclosingNode: r } = e;
    return !(!r ||
      "ContinueStatement" !== r.type && "BreakStatement" !== r.type ||
      r.label) && (Mc(r, t), !0);
  }
  function Bp(e) {
    let { comment: t, precedingNode: r, enclosingNode: i } = e;
    return !!(Zc(i) && r && i.callee === r && i.arguments.length > 0) &&
      (Vc(i.arguments[0], t), !0);
  }
  function vp(e) {
    let { comment: t, precedingNode: r, enclosingNode: i, followingNode: n } =
      e;
    return !i || "UnionTypeAnnotation" !== i.type && "TSUnionType" !== i.type
      ? (n && ("UnionTypeAnnotation" === n.type || "TSUnionType" === n.type) &&
        zc(t) && (n.types[0].prettierIgnore = !0, t.unignore = !0),
        !1)
      : (zc(t) && (n.prettierIgnore = !0, t.unignore = !0),
        !!r && (Mc(r, t), !0));
  }
  function bp(e) {
    let { comment: t, enclosingNode: r } = e;
    return !!tp(r) && (Vc(r, t), !0);
  }
  function Sp(e) {
    let {
      comment: t,
    ...
    return n && n.body && 0 === n.body.length
      ? (u ? Uc(n, t) : Vc(n, t), !0)
      : r && "Program" === r.type && 0 === r.body.length && !Gc(r.directives)
      ? (u ? Uc(r, t) : Vc(r, t), !0)
      : !(!i || "Program" !== i.type || 0 !== i.body.length || !r ||
        "ModuleExpression" !== r.type) && (Uc(i, t), !0);
  }
  function wp(e) {
    let { comment: t, enclosingNode: r } = e;
    return !(!r ||
      "ForInStatement" !== r.type && "ForOfStatement" !== r.type) &&
      (Vc(r, t), !0);
  }
  function Tp(e) {
    let { comment: t, precedingNode: r, enclosingNode: i, text: n } = e;
    return !!(r && "ImportSpecifier" === r.type && i &&
      "ImportDeclaration" === i.type && Pc(n, up(t))) && (Mc(r, t), !0);
  }
  function kp(e) {
    let { comment: t, enclosingNode: r } = e;
    return !(!r || "AssignmentPattern" !== r.type) && (Vc(r, t), !0);
  }
  function Ip(e) {
    let { comment: t, enclosingNode: r } = e;
    return !(!r || "TypeAlias" !== r.type) && (Vc(r, t), !0);
  }
  function Np(e) {
    let { comment: t, enclosingNode: r, followingNode: i } = e;
    return !(!r ||
  ...
  function Rp(e) {
    return qc(e) && "*" === e.value[0] && /@type\b/.test(e.value);
  }
  var jp = {
    handleOwnLineComment: function (e) {
      return [Lp, Ap, hp, cp, pp, Dp, fp, gp, wp, vp, Sp, Tp, kp, Ep, yp].some(
        (t) => t(e),
      );
    },
    handleEndOfLineComment: function (e) {
      return [op, Ap, lp, gp, cp, pp, Dp, fp, yp, Bp, bp, Sp, Ip, Np].some(
        (t) => t(e),
      );
    },
    handleRemainingComment: function (e) {
      return [Lp, cp, pp, dp, Fp, Ep, Sp, Cp, mp, Pp, xp, _p].some((t) => t(e));
    },
    isTypeCastComment: Rp,
    getCommentChildNodes: function (e, t) {
      if (
        ...
        "FunctionExpression" === e.value.type && 0 === Wc(e.value).length &&
    ...
    willPrintOwnComments: function (e) {
      ...
      return (t &&
          (Jc(t) || Hc(t) || Zc(r) && ((e) =>
                $c(rp(e, ip.Leading)) || $c(rp(e, ip.Trailing)))(t)) ||
        r &&
          ("JSXSpreadAttribute" === r.type || "JSXSpreadChild" === r.type ||
            ...
            ("ClassDeclaration" === r.type || "ClassExpression" === r.type) &&
              r.superClass === t)) &&
        (!Kc(e) || "UnionTypeAnnotation" === r.type ||
          "TSUnionType" === r.type);
    },
  };
      ...
      e = Up(e, (e) => {
        ...
        n === e && (function (e, t, r) {
          ...
          Array.isArray(n) && n.length === i.length && !i.some((e) => {
            ...
            Xp(t, "Leading decorators must be attached to a class declaration");
        }(t, n, i),
          function (e, t) {
            166 !== e.kind || e.modifiers && !e.modifiers.some((e) =>
                  126 === e.kind) ||
              e.initializer && null === t.value &&
                Xp(t, "Abstract property cannot have an initializer");
          }(t, n));
      });
    },
  };
  const { getLast: qp } = fo,
    { locStart: Wp, locEnd: zp } = To,
    { isTypeCastComment: Jp } = jp,
    Hp = Vp,
    { throwErrorForInvalidNodes: $p } = Gp;
  function Kp(e) {
    return "CallExpression" === e.type
      ? (e.type = "OptionalCallExpression", e.callee = Kp(e.callee))
      : "MemberExpression" === e.type
      ? (e.type = "OptionalMemberExpression", e.object = Kp(e.object))
      : "TSNonNullExpression" === e.type && (e.expression = Kp(e.expression)),
      e;
  }
  function Yp(e) {
    ...
    return Yp(e)
      ? Qp({
        ...
        left: Qp({
          ...
          left: e.left,
          right: e.right.left,
          range: [Wp(e.left), zp(e.right.left)],
        }),
        right: e.right.right,
        range: [Wp(e), zp(e)],
      })
  ...
  var Zp = function (e, t) {
      if (
        ...
        const t = new Set();
        e = Hp(e, (e) => {
          e.leadingComments && e.leadingComments.some(Jp) && t.add(Wp(e));
        }),
          e = Hp(e, (e) => {
      ...
      return e = Hp(e, (e) => {
        switch (e.type) {
          case "ChainExpression":
            return Kp(e.expression);
          case "LogicalExpression":
            if (Yp(e)) return Qp(e);
            break;
          case "VariableDeclaration": {
            const r = qp(e.declarations);
            r && r.init && function (e, r) {
              if (";" === t.originalText[zp(r)]) return;
              e.range = [Wp(e), zp(r)];
            }(e, r);
            break;
          }
          case "TSParenthesizedType":
            return e.typeAnnotation.range = [Wp(e), zp(e)], e.typeAnnotation;
          case "TSTypeParameter":
            ...
            break;
          case "SequenceExpression": {
            const t = qp(e.expressions);
            e.range = [Wp(e), Math.min(zp(t), zp(e))];
            break;
          }
          case "TopicReference":
    ...
    !function (e) {
          ...
          this.reservedWordsStrict = I(s),
            ...
            n
              ? (this.pos = n,
                ...
                this.curLine =
                  this.input.slice(0, this.lineStart).split(g).length)
            ...
            0 === this.pos && e.allowHashBang &&
            "#!" === this.input.slice(0, 2) && this.skipLineComment(2),
            this.scopeStack = [],
            this.enterScope(V),
      ...
      ae.isLet = function (e) {
        ...
        ae.isAsyncFunction = function () {
          if (
            this.options.ecmaVersion < 8 || !this.isContextual("async")
          ) {
            return !1;
          }
          v.lastIndex = this.pos;
        ...
        ae.parseStatement = function (e, t, r) {
          ...
          switch (this.isLet(e) && (n = A._var, i = "let"), n) {
            ...
            default:
              ...
              return n === A.name && "Identifier" === p.type &&
                  this.eat(A.colon)
      ...
      ae.parseFunction = function (e, t, r, i, n) {
        ...
        ae.parseClassStaticBlock = function (e) {
          ...
          var t = this.labels;
          for (
            this.labels = [], this.enterScope(J | W); this.type !== A.braceR;
          ) {
        ...
        ae.parseClassSuper = function (e) {
          e.superClass = this.eat(A._extends) ? this.parseExprSubscripts(!1)
          : null;
        },
        ...
        ae.adaptDirectivePrologue = function (e) {
          for (
            var t = 0; t < e.length && this.isDirectiveCandidate(e[t]); ++t
          ) {
      ...
      Ee.toAssignable = function (e, t, r) {
        ...
        Ee.toAssignableList = function (e, t) {
          ...
          if (r) {
            var u = e[r - 1];
            6 === this.options.ecmaVersion && t && u &&
              "RestElement" === u.type && "Identifier" !== u.argument.type &&
              this.unexpected(u.argument.start);
          }
          return e;
        },
      ...
      Fe.initialContext = function () {
          ...
          return t === Ce.f_expr || t === Ce.f_stat ||
            (e !== A.colon || t !== Ce.b_stat && t !== Ce.b_expr
              ? e === A._return || e === A.name && this.exprAllowed
                ? g.test(this.input.slice(this.lastTokEnd, this.start))
                : e === A._else || e === A.semi || e === A.eof ||
                  e === A.parenR || e === A.arrow || (e === A.braceL
                    ? t === Ce.b_stat
        ...
        A.parenL.updateContext = function (e) {
          var t = e === A._if || e === A._for || e === A._with ||
            e === A._while;
        ...
        A._function.updateContext = A._class.updateContext = function (e) {
          !e.beforeExpr || e === A._else ||
            ...
            : this.context.push(Ce.f_expr), this.exprAllowed = !1;
        },
      ...
      Ae.checkPropClash = function (e, t, r) {
        ...
        Ae.parseExpression = function (e, t) {
          ...
          if (this.type === A.comma) {
            ...
            for (u.expressions = [n]; this.eat(A.comma);) {
        ...
        Ae.parseExprAtom = function (e, t) {
          ...
          switch (this.type) {
            ...
            case A.parenL:
              var c = this.start,
                p = this.parseParenAndDistinguishExpression(i, t);
              return e &&
        ...
        Ae.parseParenAndDistinguishExpression = function (e, t) {
          ...
          if (this.options.ecmaVersion >= 6) {
            ...
            var s,
              ...
              d = this.awaitPos;
            for (
              this.yieldPos = 0, this.awaitPos = 0; this.type !== A.parenR;
            ) {
              if (
      ...
      Ae.parseNew = function () {
        ...
        return e.callee = this.parseSubscripts(
          this.parseExprAtom(),
          i,
          n,
          !0,
          ...
          for (r.properties = [], this.next(); !this.eat(A.braceR);) {
            if (i) i = !1;
              ...
              this.expect(A.comma),
                ...
                this.afterTrailingComma(A.braceR)
            ) {
              break;
            }
        ...
        Ae.parseProperty = function (e, t) {
          ...
          return this.parsePropertyName(s),
            !e && !a && this.options.ecmaVersion >= 8 && !r &&
              this.isAsyncProp(s)
              ? (i = !0,
        ...
        Ae.parsePropertyValue = function (e, t, r, i, n, u, s, a) {
          if (
            ...
            this.type === A.comma || this.type === A.braceR ||
            this.type === A.eq
          ) {
        ...
        Ae.parseExprList = function (e, t, r, i) {
          for (var n = [], u = !0; !this.eat(e);) {
            ...
            r && this.type === A.comma
              ...
              : s = this.parseMaybeAssign(!1, i), n.push(s);
          }
          return n;
        },
        ...
        Ae.parsePrivateIdent = function () {
          ...
          return this.type === A.privateId
            ...
            0 === this.privateNameStack.length
              ...
              : this.privateNameStack[this.privateNameStack.length - 1].used
                .push(e),
            e;
        },
      ...
      Be.enterScope = function (e) {
        ...
        Be.currentThisScope = function () {
          for (var e = this.scopeStack.length - 1;; e--) {
            var t = this.scopeStack[e];
            if (t.flags & H && !(t.flags & G)) return t;
          }
        };
      ...
      var Te =
        ...
        Ie = {
          ...
          10: ke,
          11: ke,
          12: ke + " EBase EComp EMod EPres ExtPict",
        },
        Ne =
      ...
      function Qe(e) {
        return e >= 65 && e <= 70 ? e - 65 + 10
        : e >= 97 && e <= 102 ? e - 97 + 10 : e - 48;
      }
      function Ze(e) {
        return e >= 48 && e <= 55;
      }
      Me.prototype.reset = function (e, t, r) {
        ...
        Me.prototype.nextIndex = function (e, t) {
          ...
          return !t && !this.switchU || u <= 55295 || u >= 57344 ||
              e + 1 >= i || (n = r.charCodeAt(e + 1)) < 56320 || n > 57343
            ? e + 1
            : e + 2;
        },
        ...
        Ve.regexp_eatSyntaxCharacter = function (e) {
          var t = e.current();
          return !!Xe(t) && (e.lastIntValue = t, e.advance(), !0);
        },
        Ve.regexp_eatPatternCharacters = function (e) {
          for (var t = e.pos, r = 0; -1 !== (r = e.current()) && !Xe(r);) {
            e.advance();
          }
          return e.pos !== t;
        },
        ...
        Ve.regexp_eatRegExpIdentifierStart = function (e) {
          ...
          return e.advance(r),
            ...
            (i = e.lastIntValue),
            Ge(i) ? (e.lastIntValue = i, !0) : (e.pos = t, !1);
        },
        ...
        Ve.regexp_eatCharacterClassEscape = function (e) {
          ...
          if (
            e.switchU && this.options.ecmaVersion >= 9 &&
            (80 === t || 112 === t)
          ) {
            if (
              e.lastIntValue = -1,
                e.advance(),
                e.eat(123) &&
                this.regexp_eatUnicodePropertyValueExpression(e) && e.eat(125)
            ) {
              return !0;
            }
        ...
        Ve.regexp_eatUnicodePropertyValueExpression = function (e) {
          ...
          if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
            ...
            if (this.regexp_eatUnicodePropertyValue(e)) {
              ...
              return this.regexp_validateUnicodePropertyNameAndValue(e, r, i),
                !0;
            }
          }
        ...
        Ve.regexp_validateUnicodePropertyNameAndValue = function (e, t, r) {
          T(e.unicodeProperties.nonBinary, t) ||
          e.raise("Invalid property name"),
      ...
      tt.next = function (e) {
        ...
        tt.readToken = function (e) {
          return h(e, this.options.ecmaVersion >= 6) || 92 === e
            ? this.readWord() : this.getTokenFromCode(e);
        },
        ...
        tt.skipBlockComment = function () {
          ...
          if (
            ...
            for (
              y.lastIndex = r; (e = y.exec(this.input)) && e.index < this.pos;
            ) {
          ...
          for (; this.pos < this.input.length;) {
            ...
            switch (e) {
              ...
              default:
                if (
                  !(e > 8 && e < 14 ||
                    e >= 5760 && B.test(String.fromCharCode(e)))
                ) {
                  break e;
                }
                ++this.pos;
        ...
        tt.readToken_lt_gt = function (e) {
          ...
          return t === e
            ? (r = 62 === e && 62 === this.input.charCodeAt(this.pos + 2)
              ? 3
              : 2,
              61 === this.input.charCodeAt(this.pos + r)
                ? this.finishOp(A.assign, r + 1) : this.finishOp(A.bitShift, r))
        ...
        tt.readRegexp = function () {
          for (var e, t, r = this.pos;;) {
            ...
            if (
              g.test(i) && this.raise(r, "Unterminated regular expression"), e
            ) {
              e = !1;
            } else {
              if ("[" === i) t = !0;
        ...
        tt.readTmplToken = function () {
          for (var e = "", t = this.pos;;) {
            ...
            if (92 === r) {e += this.input.slice(t, this.pos),
              ...
              this.options.locations &&
              (++this.curLine, this.lineStart = this.pos), t = this.pos;
            } else ++this.pos;
          }
        },
  ...
  !function (e) {
    const t = iD, r = /^[\da-fA-F]+$/, i = /^\d+$/, n = new WeakMap();
    function u(e) {
      e = e.Parser.acorn || e;
      let t = n.get(e);
      if (!t) {
    ...
    function s(e) {
      return e
        ? "JSXIdentifier" === e.type ? e.name
        : "JSXNamespacedName" === e.type ? e.namespace.name + ":" + e.name.name
          ...
          return class extends n {
            ...
            updateContext(e) {
              if (this.type == c.braceL) {
                var t = this.curContext();
                t == h ? this.context.push(D.b_expr) : t == d
                  ? this.context.push(D.b_tmpl)
                  : super.updateContext(e), this.exprAllowed = !0;
              } else {
                if (this.type !== c.slash || e !== p.jsxTagStart) {return super
                    .updateContext(e);}
  ...
  const uD = {
    ...
    sD = Object.keys(uD);
  for (const e of sD) Object.freeze(uD[e]);
  Object.freeze(uD);
  const aD = new Set(["parent", "leadingComments", "trailingComments"]);
  function oD(e) {
    return !aD.has(e) && "_" !== e[0];
  }
  nD.KEYS = uD,
    nD.getKeys = function (e) {
      return Object.keys(e).filter(oD);
    },
    nD.unionWith = function (e) {
      const t = Object.assign({}, uD);
  ...
  const mD = "Boolean",
    CD = "Identifier",
    FD = "PrivateIdentifier",
    AD = "Keyword",
    gD = "Null",
    yD = "Numeric",
    xD = "Punctuator",
    BD = "String",
    vD = "RegularExpression",
    bD = "Template",
    SD = "JSXIdentifier",
    wD = "JSXText";
  function TD(e, t) {
  ...
  TD.prototype = {
    ...
    translate(e, t) {
      ...
      if (r === i.name) {
        e.type = CD,
          "static" === e.value && (e.type = AD),
          t.ecmaVersion > 5 && ("yield" === e.value || "let" === e.value) &&
          (e.type = AD);
      } else if (r === i.privateId) e.type = FD;
      else if (
        ...
        e.type = xD, e.value = this._code.slice(e.start, e.end);
      } else if (r === i.jsxName) e.type = SD;
      else if ("jsxText" === r.label || r === i.jsxAttrValueToken) e.type = wD;
      else if (r.keyword) {
        "true" === r.keyword || "false" === r.keyword
          ? e.type = mD
          : "null" === r.keyword
          ? e.type = gD
          : e.type = AD;
      } else if (r === i.num) {
        e.type = yD, e.value = this._code.slice(e.start, e.end);
      } else if (r === i.string) {
        t.jsxAttrValueToken
          ? (t.jsxAttrValueToken = !1, e.type = wD)
          : e.type = BD, e.value = this._code.slice(e.start, e.end);
      } else if (r === i.regexp) {
        e.type = vD;
        const t = e.value;
    ...
    onToken(e, t) {
      ...
      function s() {
        n.push(function (e, t) {
          const r = e[0],
            i = e[e.length - 1],
            n = { type: bD, value: t.slice(r.start, i.end) };
  ...
  const kD = [3, 5, 6, 7, 8, 9, 10, 11, 12, 13];
  function ID() {
  ...
  function ND(e) {
    const t = function () {
        ...
        if (t >= 2015 && (t -= 2009), !kD.includes(t)) {
  ...
  const _D = Symbol("espree's internal state"),
    LD = Symbol("espree's esprimaFinishNode");
  var PD = () =>
    (e) => {
        ...
        class extends e {
          constructor(e, r) {
            ...
            super({
              ...
              onToken: (e) => {
                s && s.onToken(e, this[_D]),
                  e.type !== t.eof && (this[_D].lastToken = e);
              },
          ...
          parse() {
            ...
            return e.lastToken &&
              ...
              this[_D].templateElements.forEach((e) => {
                const t = e.tail ? 1 : 2;
                e.start += -1,
                  e.end += t,
          ...
          parseTopLevel(e) {
            return this[_D].impliedStrict && (this.strict = !0),
              super.parseTopLevel(e);
          }
          raise(t, r) {
            const i = e.acorn.getLineInfo(this.input, t),
              n = new SyntaxError(r);
            throw n.index = t,
              n.lineNumber = i.line,
              n.column = i.column + 1,
          ...
          jsx_readString(e) {
            ...
            return this.type === t.string && (this[_D].jsxAttrValueToken = !0),
              r;
          }
          [LD](e) {
            return "TemplateElement" === e.type &&
              this[_D].templateElements.push(e),
  ...
  const OD = {
    ...
    _jsx: null,
    get regular() {
      return null === this._regular && (this._regular = lD.Parser.extend(PD())),
        this._regular;
    },
    get jsx() {
      return null === this._jsx &&
        (this._jsx = lD.Parser.extend(dD.default(), PD())),
        this._jsx;
    },
    get(e) {
      return Boolean(e && e.ecmaFeatures && e.ecmaFeatures.jsx)
        ? this.jsx
        : this.regular;
    },
  };
  const RD = function () {
      let e, t = {};
      for (
        e in "function" == typeof Object.create && (t = Object.create(null)), ED
      ) {
        Object.hasOwnProperty.call(ED, e) && (t[e] = ED[e]);
      }
  ...
  eD.Syntax = RD,
    eD.VisitorKeys = jD,
    eD.latestEcmaVersion = VD,
    eD.parse = function (e, t) {
      return new (OD.get(t))(t, e).parse();
    },
    eD.supportedEcmaVersions = MD,
    eD.tokenize = function (e, t) {
      const r = OD.get(t);
  ...
  function zD(e) {
    ...
    return "number" != typeof r ? e : UD(t, { start: { line: r, column: i } });
  }
  var JD = {
    parsers: {
      espree: _o(function (e, t) {
        ...
        if (!u) throw zD(s);
        return r.originalText = e, qD(u, r);
      }),
    },
  };
  return JD;
