...
if (argv.version) version();
else if (argv.help) usage();
else {
  var inFilename = argv._[0];
  var readStream = void 0;
  if (inFilename) readStream = _fs2.default.createReadStream(inFilename);
  ...
  readStream.on("end", function () {
    var space = void 0;
    if (argv.space === "t" || argv.space === "tab") space = "\t";
    else space = Number(argv.space);
    var value = void 0;
    try {
      ...
      if (!argv.validate) {
        ...
        if (argv.convert && inFilename && !argv.o) {
          ...
          var outFilename = _path2.default.format(
            Object.assign(parsedFilename, {
              base:
        ...
        } else if (argv.o) writeStream = _fs2.default.createWriteStream(argv.o);
