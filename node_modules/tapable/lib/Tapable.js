...
Tapable.prototype.applyPlugins = function applyPlugins(name) {
  ...
  for (
    ...
    this._currentPluginApply < plugins.length;
...
Tapable.prototype.applyPluginsWaterfall = function applyPlugins(name, init) {
  ...
  for (
    ...
    current = plugins[this._currentPluginApply].apply(
      this,
      [current].concat(args),
    );
  }
...
Tapable.prototype.applyPluginsBailResult = function applyPluginsBailResult(
  name,
) {
  if (!this._plugins[name]) return;
  var args = Array.prototype.slice.call(arguments, 1);
...
Tapable.prototype.applyPluginsAsyncSeries = Tapable.prototype
  .applyPluginsAsync = function applyPluginsAsync(name) {
    var args = Array.prototype.slice.call(arguments, 1);
...
Tapable.prototype.applyPluginsParallelBailResult =
  function applyPluginsParallelBailResult(name) {
    var args = Array.prototype.slice.call(arguments, 1);
...
Tapable.prototype.restartApplyPlugins = function restartApplyPlugins() {
  if (typeof this._currentPluginApply !== "number") {
    throw new Error(
      "Tapable.prototype.restartApplyPlugins can only be used inside of any sync plugins application",
    );
  }
