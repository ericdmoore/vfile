...
- [`TypedArray`](source/basic.d.ts) - Matches any
...
- [`Mutable`](source/mutable.d.ts) - Convert an object with `readonly` keys into
  a mutable object. The inverse of `Readonly<T>`.
