...
test("isSharedArrayBuffer", function (t) {
  ...
  forEach(nonSABs, function (nonSAB) {
    t.equal(
      isSharedArrayBuffer(nonSAB),
      false,
      inspect(nonSAB) + " is not a SharedArrayBuffer",
    );
  });

  t.test("actual SharedArrayBuffer instances", {
    skip: typeof SharedArrayBuffer === "undefined",
  }, function (st) {
    var sab = new SharedArrayBuffer();

    st.equal(
      isSharedArrayBuffer(sab),
      true,
      inspect(sab) + " is a SharedArrayBuffer",
    );
