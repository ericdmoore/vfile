  ...
  */ var r = Object.getOwnPropertySymbols,
  ...
  e.exports = (function () {
      try {
        ...
        if (
          "0123456789" !== Object.getOwnPropertyNames(t).map(function (e) {
            return t[e];
          }).join("")
        ) {
          return !1;
  ...
  function T() {
    var e = y(),
      ...
      x = h[0],
      T = h[1],
      C = l(g(e && e.activeFilters || { low: !0, medium: !0, high: !0 }), 2),
      _ = C[0],
      P = C[1],
    ...
    return w(function () {
      ...
      w(function () {
        window.onpopstate = function () {
          var e = y();
          e && o.unstable_batchedUpdates(function () {
            P(e.activeFilters),
              i(e.activeSort),
              T(e.isFlat),
              F(e.expandedLines),
      ...
      a.createElement(
        ...
        a.createElement(
          ...
          a.createElement(s, { metrics: L, metricsToShow: k }),
        ),
        a.createElement(
          "div",
          { className: "layout__section" },
    ...
    return null == e ? 0 : function e(t, n, r, l) {
      ...
      if (u = 0, n = "" === n ? "." : n + ":", Array.isArray(t)) {
        ...
        null === t || "object" != typeof t
          ? s = null
          : s = "function" == typeof (s = v && t[v] || t["@@iterator"])
            ? s
            : null, "function" == typeof s
      ) {
  ...
  function G(e, t, n, r) {
    ...
    (null !== l
      ...
      : !r &&
        ...
        r || null === l
          ? function (e) {
            return !!Q.call(B, e) || !Q.call($, e) && (W.test(e)
                  ? B[e] = !0
                  : ($[e] = !0, !1));
          }(t) && (null === n
            ? e.removeAttribute(t)
    ...
    do {
      ...
      switch (e.tag) {
        ...
        case 9:
          ...
          break e;
        default:
          var r = e._debugOwner, l = e._debugSource, i = ve(e.type);
          n = null,
            r && (n = ve(r.type)),
            r = i,
            i = "",
  ...
  function we(e) {
    e._valueTracker || (e._valueTracker = function (e) {
      var t = be(e) ? "checked" : "value",
        ...
        r = "" + e[t];
      if (
        !e.hasOwnProperty(t) && void 0 !== n && "function" == typeof n.get &&
  ...
  var Me = "http://www.w3.org/1999/xhtml", Re = "http://www.w3.org/2000/svg";
  function Le(e) {
    switch (e) {
      case "svg":
  ...
  var je,
    Ae = function (e) {
      ...
      if (e.namespaceURI !== Re || "innerHTML" in e) e.innerHTML = t;
        ...
        for (
          (je = je || document.createElement("div")).innerHTML = "<svg>" +
            t.valueOf().toString() + "</svg>", t = je.firstChild;
          e.firstChild;
        ) {
  ...
  function Rt(e, t) {
    e.blockedOn === t &&
      (e.blockedOn = null,
        gt ||
        (gt = !0, i.unstable_scheduleCallback(i.unstable_NormalPriority, Mt)));
  }
  function Lt(e) {
    function t(t) {
      return Rt(t, e);
  ...
  function zn(e, t) {
    ...
    switch (t) {
      ...
      case "onMouseEnter":
        (r = !r.disabled) ||
        (r =
          !("button" === (e = e.type) || "input" === e || "select" === e ||
            "textarea" === e)), e = !r;
        break e;
      default:
        e = !1;
  ...
  function $n(e, t, n, r) {
    for (
      var l in this.dispatchConfig = e,
        this._targetInst = t,
        this.nativeEvent = n,
  ...
  var or = {
      ...
      extractEvents: function (e, t, n, r) {
        ...
        return i
          ? (er && "ko" !== n.locale && (ar || i !== nr.compositionStart
            ? i === nr.compositionEnd && ar && (l = Vn())
            : (An = "value" in (jn = r) ? jn.value : jn.textContent, ar = !0)),
  ...
  function fr(e, t, n) {
    return (e = $n.getPooled(sr.change, e, t, n)).type = "change",
      z(n),
      Dn(e),
      e;
  }
  ...
  _ &&
    (yr = ct("input") && (!document.documentMode || 9 < document.documentMode));
  var Sr = {
      eventTypes: sr,
      _isInputEventSupported: yr,
      extractEvents: function (e, t, n, r) {
        var l = t ? Nn(t) : window, i = l.nodeName && l.nodeName.toLowerCase();
        if ("select" === i || "input" === i && "file" === l.type) var a = vr;
          ...
          (i = l.nodeName) && "input" === i.toLowerCase() &&
            ("checkbox" === l.type || "radio" === l.type) && (a = kr);
        }
        if (a && (a = a(e, t))) return fr(a, n, r);
        o && o(e, l, t),
          "blur" === e && (e = l._wrapperState) && e.controlled &&
          "number" === l.type && _e(l, "number", l.value);
      },
    },
  ...
  var Nr = 0,
    ...
    Lr = {
      ...
      extractEvents: function (e, t, n, r, l) {
        ...
        if (
          i && 0 == (32 & l) && (n.relatedTarget || n.fromElement) || !a && !i
        ) {
          return null;
        }
        (i = r.window === r ? r : (i = r.ownerDocument)
          ...
          ? (a = t,
            null !== (t = (t = n.relatedTarget || n.toElement)
                ? _n(t)
                : null) &&
            (t !== Ze(t) || 5 !== t.tag && 6 !== t.tag) && (t = null))
          : a = null;
        if (a === t) return null;
        if ("mouseout" === e || "mouseover" === e) {
          var o = Ir, u = Rr.mouseLeave, c = Rr.mouseEnter, s = "mouse";
        } else {
          "pointerout" !== e && "pointerover" !== e ||
            (o = Mr, u = Rr.pointerLeave, c = Rr.pointerEnter, s = "pointer");
        }
        if (
          e = null == a
            ? i
  ...
  function Ar(e, t) {
    if (Dr(e, t)) return !0;
    if (
      "object" != typeof e || null === e || "object" != typeof t || null === t
    ) {
      return !1;
    }
    ...
    for (r = 0; r < n.length; r++) {
      if (!jr.call(t, n[r]) || !Dr(e[n[r]], t[n[r]])) return !1;
    }
    return !0;
  }
  ...
  function Hr(e, t) {
    ...
    return Br || null == Wr || Wr !== sn(n)
      ...
      : ("selectionStart" in (n = Wr) && mn(n)
        ...
        : n = {
          anchorNode:
            (n = (n.ownerDocument && n.ownerDocument.defaultView || window)
  ...
  function bl(e) {
    return e =
      (e = e.stateNode) && e.__reactInternalMemoizedMergedChildContext || sl,
      pl = fl.current,
      cl(fl, e),
      cl(dl, dl.current),
      !0;
  ...
  function $l(e) {
    return null === Rl ? (Rl = [e], Ll = kl(_l, Hl)) : Rl.push(e), zl;
  }
  function Bl() {
    if (null !== Ll) {
      var e = Ll;
          ...
          if ((o = m.expirationTime) < r) {
            ...
            e: {
              ...
              switch (o = t, h = n, y.tag) {
                ...
                case 0:
                  if (
                    null == (o = "function" == typeof (v = y.payload)
                      ? v.call(h, c, o)
                      : v)
                  ) {
                    break e;
  ...
  var di = X.ReactCurrentBatchConfig, pi = (new r.Component()).refs;
  function mi(e, t, n, r) {
  ...
  function Ei(e, t, n) {
    if (
      null !== (e = n.ref) && "function" != typeof e && "object" != typeof e
    ) {
      if (n._owner) {
        if (n = n._owner) {
  ...
  function xi(e) {
    ...
    function c(e, t, n, r) {
      return null !== t && t.elementType === n.type
        ...
        : ((r = _u(n.type, n.key, n.props, null, e.mode, r)).ref = Ei(e, t, n),
          r.return = e,
          r);
    }
    function s(e, t, n, r) {
    ...
    function d(e, t, n) {
      ...
      if ("object" == typeof t && null !== t) {
        switch (t.$$typeof) {
          case ee:
            return (n = _u(t.type, t.key, t.props, null, e.mode, n)).ref = Ei(
              e,
              null,
              t,
            ),
    ...
    function p(e, t, n, r) {
      ...
      if ("object" == typeof n && null !== n) {
        switch (n.$$typeof) {
          case ee:
            return n.key === l
              ? n.type === ne ? f(e, t, n.props.children, r, l) : c(e, t, n, r)
              : null;
          case te:
    ...
    return function (e, r, i, u) {
      var c = "object" == typeof i && null !== i && i.type === ne &&
        null === i.key;
            ...
            e: {
              ...
              i.type === ne
                ? ((r = Pu(i.props.children, e.mode, u, i.key)).return = e,
                  e = r)
                : ((u = _u(i.type, i.key, i.props, null, e.mode, u)).ref = Ei(
                  e,
                  r,
                  i,
                ),
  ...
  function Ii(e) {
    Oi(Ni.current);
    var t = Oi(_i.current), n = De(t, e.type);
    t !== n && (cl(Pi, e), cl(_i, n));
  }
  function Mi(e) {
  ...
  function Ki(e, t, n, r, l, i) {
    if (
      Ui = i,
        ...
        t.updateQueue = null,
        t.expirationTime = 0,
        ji.current = null === e || null === e.memoizedState ? va : ya,
        e = n(r, l),
        t.expirationTime === Ui
    ) {
      i = 0;
  ...
  function Gi(e) {
    ...
    var r = Wi, l = r.baseQueue, i = n.pending;
    if (null !== i) {
      if (null !== l) {
        var o = l.next;
  ...
  function ma(e, t, n) {
    ...
    if (
      ...
      if (
        0 === e.expirationTime && (null === i || 0 === i.expirationTime) &&
        null !== (i = t.lastRenderedReducer)
      ) {
        try {
          var a = t.lastRenderedState, o = i(a, n);
          if (l.eagerReducer = i, l.eagerState = o, Dr(o, a)) return;
        } catch (e) {}
      }
      qo(e, r);
    }
  ...
  function Ca(e) {
    ...
    var t = e.type;
    if (
      5 !== e.tag || "head" !== t && "body" !== t && !gn(t, e.memoizedProps)
    ) {
  ...
  var Pa = X.ReactCurrentOwner, Na = !1;
  function Oa(e, t, n, r) {
  ...
  function za(e, t, n, r, l, i) {
    if (null === e) {
      var a = n.type;
      return "function" != typeof a || Tu(a) || void 0 !== a.defaultProps ||
  ...
  function Ia(e, t, n, r, l, i) {
    return null !== e && Ar(e.memoizedProps, r) && e.ref === t.ref &&
        (Na = !1, l < i)
  ...
  function Da(e, t, n, r, l, i) {
    ...
    var o = a && "function" != typeof n.getDerivedStateFromError
      ? null
      : r.render();
  ...
  function ja(e) {
    ...
    t.pendingContext
      ...
      : t.context && yl(0, t.context, !1), Fi(e, t.containerInfo);
  }
  var Aa, Ua, Va, Wa = { dehydrated: null, retryTime: 0 };
  function Qa(e, t, n) {
    var r, l = t.mode, i = t.pendingProps, a = Ri.current, o = !1;
    if (
      (r = 0 != (64 & t.effectTag)) ||
      (r = 0 != (2 & a) && (null === e || null !== e.memoizedState)),
        r
          ? (o = !0, t.effectTag &= -65)
          : null !== e && null === e.memoizedState || void 0 === i.fallback ||
            !0 === i.unstable_avoidThisFallback || (a |= 1),
        cl(Ri, 1 & a),
        null === e
    ) {
      if (void 0 !== i.fallback && Sa(t), o) {
        ...
        return (n = Pu(o, l, n, null)).return = t,
          i.sibling = n,
          t.memoizedState = Wa,
          t.child = i,
          n;
      ...
      if (l = (e = e.child).sibling, o) {
        if (
          i = i.fallback,
            ...
            0 == (2 & t.mode) && (o = null !== t.memoizedState
                ? t.child.child
                : t.child) !== e.child
        ) {
          for (n.child = o; null !== o;) o.return = n, o = o.sibling;
        }
        return (l = Cu(l, i)).return = t,
          n.sibling = l,
              ...
              if (s.hasOwnProperty(o)) {
                ...
                "style" === o
                  ...
                  : "suppressContentEditableWarning" !== o &&
                    "suppressHydrationWarning" !== o && "autoFocus" !== o &&
                    (S.hasOwnProperty(o)
                      ? null != f && un(n, o)
                      : null != f && G(e, o, f, u));
              }
          ...
          if (!i) {
            if (null !== (e = Li(o))) {
              if (
                ...
                return null !== (t = t.lastEffect = r.lastEffect) &&
                  (t.nextEffect = null),
                  null;
              }
            } else {
              2 * Al() - r.renderingStartTime > r.tailExpiration && 1 < n &&
                (t.effectTag |= 64,
                  i = !0,
                  qa(r, !1),
      ...
      if (a !== r) {
        ...
        for (o in ln(n, r), n = null, a) {
          if (!r.hasOwnProperty(o) && a.hasOwnProperty(o) && null != a[o]) {
            if ("style" === o) {
              for (u in c = a[o]) {c.hasOwnProperty(u) &&
                  (n || (n = {}), n[u] = "");}
            } else {
              "dangerouslySetInnerHTML" !== o && "children" !== o &&
                "suppressContentEditableWarning" !== o &&
                "suppressHydrationWarning" !== o && "autoFocus" !== o &&
                (S.hasOwnProperty(o)
                  ? e || (e = [])
            ...
            if ("style" === o) {
              ...
              "dangerouslySetInnerHTML" === o
                ...
                ? c === s || "string" != typeof s && "number" != typeof s ||
                  (e = e || []).push(o, "" + s)
                : "suppressContentEditableWarning" !== o &&
                  "suppressHydrationWarning" !== o && (S.hasOwnProperty(o)
    ...
    switch (n.tag) {
      ...
      case 1:
        if (e = n.stateNode, 4 & n.effectTag) {
          if (null === t) e.componentDidMount();
            ...
            var r = n.elementType === n.type ? t.memoizedProps
      ...
      case 5:
        return e = n.stateNode,
          void (null === t && 4 & n.effectTag && yn(n.type, n.memoizedProps) &&
            e.focus());
      case 6:
      case 4:
      case 12:
        return;
      case 13:
        return void (null === n.memoizedState &&
          (n = n.alternate,
            null !== n &&
            (n = n.memoizedState,
          ...
          t = i ? t.stateNode : t.stateNode.instance,
            n
              ...
              : (8 === r.nodeType
                ...
                null !== n.onclick || (n.onclick = cn));
        } else if (4 !== l && null !== (t = t.child)) {for (
            e(t, n, r), t = t.sibling; null !== t;
          ) {
            e(t, n, r), t = t.sibling;
          }}
      }(e, n, t)
  ...
  function so(e, t) {
    switch (t.tag) {
        ...
        if (null != n) {
          ...
          if (t.updateQueue = null, null !== i) {
            for (
              ...
              var o = i[l], u = i[l + 1];
              "style" === o ? nn(n, u)
              : "dangerouslySetInnerHTML" === o ? Ae(n, u) : "children" === o
                ? Ue(n, u)
                : G(n, o, u, t);
            }
            switch (e) {
              ...
              case "select":
                t = n._wrapperState.wasMultiple,
                  ...
                  null != (e = r.value)
                    ? Ne(n, !!r.multiple, e, !1)
                    : t !== !!r.multiple && (null != r.defaultValue
      ...
      case 3:
        return void ((t = t.stateNode).hydrate &&
      ...
      case 13:
        if (
          ...
          for (e = n;;) {
            ...
            } else if (6 === e.tag) {e.stateNode.nodeValue = r ? ""
              : e.memoizedProps;} else {
              if (
                13 === e.tag && null !== e.memoizedState &&
  ...
  function ho(e, t, n) {
    ...
    return null !== i && "function" == typeof i.componentDidCatch &&
      (n.callback = function () {
        "function" != typeof r &&
          (null === jo ? jo = new Set([this]) : jo.add(this), Za(e, t));
        var n = t.stack;
  ...
  function qo(e, t) {
    ...
    if (null !== (e = Yo(e, t))) {
      var n = Ul();
      1073741823 === t
        ? 0 != (8 & xo) && 0 == (48 & xo) ? Zo(e) : (Go(e), 0 === xo && Bl())
        : Go(e),
        0 == (4 & xo) || 98 !== n && 99 !== n ||
        (null === Wo
          ? Wo = new Map([[e, t]])
  ...
  function Yo(e, t) {
    ...
    return null !== l &&
      (So === l && (au(t), _o === ko && Iu(l, Co)), Mu(l, t)),
      l;
  }
  function Xo(e) {
          ...
          if (
            ...
            do {
              ...
              if (d) {
                ...
                if (
                  null === g
                    ? (g = l.pingCache = new po(), o = new Set(), g.set(u, o))
              ...
              case 1:
                ...
                if (
                  ...
                  ("function" == typeof w.getDerivedStateFromError ||
                    null !== E && "function" == typeof E.componentDidCatch &&
                      (null === jo || !jo.has(E)))
                ) {
  ...
  function pu(e, t) {
    ...
    if (
      e.firstPendingTime = l,
        r <= e.lastSuspendedTime
          ? e.firstSuspendedTime = e.lastSuspendedTime = e
          ...
          "selectionStart" in w
            ...
            : (k = (E = w.ownerDocument || document) && E.defaultView || window)
              ...
              (k = k.getSelection(),
                ...
                f = dn(w, u),
                s && f &&
                (1 !== k.rangeCount || k.anchorNode !== s.node ||
                  k.anchorOffset !== s.offset || k.focusNode !== f.node ||
                  k.focusOffset !== f.offset) &&
                ((E = E.createRange()).setStart(s.node, s.offset),
                  k.removeAllRanges(),
                  o > u
                    ? (k.addRange(E), k.extend(f.node, f.offset))
                    : (E.setEnd(f.node, f.offset), k.addRange(E))))), E = [];
        for (k = w; k = k.parentNode;) {
          1 === k.nodeType &&
            E.push({ element: k, left: k.scrollLeft, top: k.scrollTop });
        }
        for (
          "function" == typeof w.focus && w.focus(), w = 0; w < E.length; w++
        ) {
    ...
    if (Ao) Ao = !1, Uo = e, Vo = t;
      ...
      for (Ro = l; null !== Ro;) {t = Ro.nextEffect,
          Ro.nextEffect = null,
          Ro = t;}
    }
    if (
  ...
  vo = function (e, t, n) {
    ...
    switch (t.expirationTime = 0, t.tag) {
      case 2:
        if (
          r = t.type,
            ...
            "function" == typeof l.render && void 0 === l.$$typeof
        ) {
          if (t.tag = 1, t.memoizedState = null, t.updateQueue = null, hl(r)) {
            var i = !0;
            bl(t);
          } else i = !1;
          t.memoizedState = null !== l.state && void 0 !== l.state
            ? l.state
            : null, ii(t);
      ...
      case 1:
        return r = t.type,
          l = t.pendingProps,
          La(e, t, r, l = t.elementType === r ? l : ql(r, l), n);
      case 3:
      ...
      case 5:
        return Ii(t),
          ...
          o = l.children,
          gn(r, l) ? o = null : null !== i && gn(r, i) && (t.effectTag |= 16),
          Ma(e, t),
          ...
          if (cl(Yl, u._currentValue), u._currentValue = i, null !== o) {
            if (
              u = o.value,
                0 === (i = Dr(u, i)
                  ? 0
                  : 0 | ("function" == typeof r._calculateChangedBits
                  ...
                  for (var s = c.firstContext; null !== s;) {
                    if (s.context === r && 0 != (s.observedBits & i)) {
                      1 === u.tag && ((s = oi(n, null)).tag = 2, ui(u, s)),
                        ...
                        null !== (s = u.alternate) && s.expirationTime < n &&
                        (s.expirationTime = n),
                        ti(u.return, n),
      ...
      case 9:
        return l = t.type,
          ...
          t.child;
      case 14:
        return i = ql(l = t.type, t.pendingProps),
  ...
  function _u(e, t, n, r, l, i) {
    ...
    if (r = e, "function" == typeof e) Tu(e) && (o = 1);
      ...
      switch (e) {
        ...
        case re:
          ...
          break;
        case le:
          return (e = Su(12, n, t, 8 | l)).elementType = le,
            e.type = le,
            e.expirationTime = i,
            e;
        case ce:
          return (e = Su(13, n, t, l)).type = ce,
            e.elementType = ce,
            e.expirationTime = i,
            e;
        case se:
          return (e = Su(19, n, t, l)).elementType = se,
            e.expirationTime = i,
            e;
        default:
    ...
    return (t = Su(o, n, t, l)).elementType = e,
      t.type = r,
      t.expirationTime = i,
      t;
  }
  ...
  function Ou(e, t, n) {
    return (t = Su(4, null !== e.children ? e.children : [], e.key, t))
      .expirationTime = n,
      t.stateNode = {
  ...
  function Fu(e, t, n) {
    this.tag = t,
      ...
      this.lastExpiredTime = this.lastPingedTime = this.nextKnownPendingLevel =
        this.lastSuspendedTime = this.firstSuspendedTime = this
          .firstPendingTime = 0;
  }
  function zu(e, t) {
  ...
  function Mu(e, t) {
    ...
    0 !== n &&
      (t >= n
        ? e.firstSuspendedTime = e.lastSuspendedTime = e.nextKnownPendingLevel =
          0
  ...
  function Lu(e, t, n, r) {
    var l = t.current, i = Ho(), o = di.suspense;
    i = Ko(i, l, o);
    e:
    if (n) {
      t: {
          ...
          if (
            t || (t = !(!(t = e
              ? 9 === e.nodeType
                ...
                : e.firstChild
              : null) ||
              1 !== t.nodeType || !t.hasAttribute("data-reactroot"))), !t
          ) {
  ...
  var N = [], O = [], F = 1, z = null, I = 3, M = !1, R = !1, L = !1;
  function D(e) {
  ...
  function A(e, n) {
    ...
    try {
      for (
        D(n), z = C(N); null !== z && (!(z.expirationTime > n) || e && !a());
      ) {
        var o = z.callback;
        if (null !== o) {
  ...
  t.unstable_IdlePriority = 5,
    ...
    t.unstable_scheduleCallback = function (e, n, a) {
      ...
      return e = {
        ...
        u > o
          ? (e.sortIndex = u,
            T(O, e),
            null === C(N) && e === C(O) && (L ? i() : L = !0, l(j, u - o)))
    ...
    t.unstable_shouldYield = function () {
      ...
      D(e);
      var n = C(N);
      return n !== z && null !== z && null !== n && null !== n.callback &&
          n.startTime <= e && n.expirationTime < z.expirationTime || a();
    },
  ...
  var r = n(0);
  function l(e, t) {
    var n = { sortKey: e, order: "desc" }, r = "";
    return t && t.sortKey === e && (r = "sorted",
      "desc" === t.order
        ? (r += "-desc", n.order = "asc")
  ...
  function o(e) {
    var t = e.sortKeyPrefix, n = e.onSort, l = e.activeSort;
    return r.createElement(
      r.Fragment,
      null,
      r.createElement(i, {
  ...
  e.exports = function (e) {
    var t = e.onSort, n = e.activeSort, l = e.metricsToShow;
    return r.createElement(
      "thead",
      null,
      r.createElement(
  ...
  function u(e) {
    ...
    if (o) {
      var c = r.indexOf(n + t),
        s = c >= 0,
        f = s ? [].concat(l(r.slice(0, c)), l(r.slice(c + 1)))
        : [].concat(l(r), [n + t]);
      return a.createElement(
        a.Fragment,
        null,
    ...
    return a.createElement("a", { href: "./".concat(n).concat(t, ".html") }, t);
  }
  function c(e, t) {
    var n = "none";
    for (var r in e) {
      if (e[r]) {
        ...
        if ("none" === l) continue;
        ("low" == l || "medium" === l && "low" !== n ||
          "high" === l && "low" !== n && "medium" !== n) && (n = l);
      }
    }
    return n;
  }
  e.exports = function e(t) {
    ...
    return f = f || 0,
      ...
      a.createElement(
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            Array.apply(null, { length: f }).map(function (e, t) {
              return a.createElement("span", { className: "filetab", key: t });
            }),
            a.createElement(u, {
              file: i,
              prefix: n,
        ...
        s && p.indexOf(n + i) >= 0 && s.map(function (t) {
          return a.createElement(
            e,
            r({}, t, {
              tabSize: f + 2,
  ...
  function l(e) {
    for (
      var t = e.metrics, n = e.metricsToShow, l = Object.keys(n), i = [], a = 0;
      a < l.length;
      a++
    ) {
      var o = l[a];
  ...
  e.exports = function (e) {
    var t = e.metrics, n = e.metricsToShow;
    return r.createElement(
      "div",
      { className: "toolbar" },
      n.statements &&
        r.createElement(i, { data: t.statements, name: "Statements" }),
      n.branches && r.createElement(i, { data: t.branches, name: "Branches" }),
      n.functions &&
  ...
  function s(e, t) {
    return t ? u(u({}, e), {}, { file: t + "/" + e.file }) : e;
  }
  e.exports = function (e, t, n, i, a, o) {
    var c = e.children;
    return i && (c = function e(t, n) {
      for (var r = [], i = 0; i < t.length; i++) {
        var a = t[i];
        a.children
          ? r = [].concat(l(r), l(e(a.children, (n ? n + "/" : "") + a.file)))
          : r.push(s(a, n));
      }
      return r;
    }(c.slice(0))),
      o && (c = function e(t, n, r) {
        for (var i = [], a = 0; a < t.length; a++) {
          var o = t[a],
            ...
            s = n === c || 0 === n.indexOf(c + "/"),
            f = 0 === c.indexOf(n + "/");
          if (s) i = [].concat(l(i), l(e(o.children, n, c)));
          else if (f) {
            var d = n.length - (r ? r.length : 0), p = o.file.slice(d);
            "/" === p[0] && (p = p.slice(1)),
              i.push(u(u({}, o), {}, { file: p }));
          }
        }
      ...
      a.low && (a = u(u({}, a), {}, { empty: !0 })),
      c = function e(t, n, r) {
        for (var l = [], i = 0; i < t.length; i++) {
          var a = t[i];
          if (a.children) {
            var o = e(a.children, n, r);
            o.length && (a = u(u({}, a), {}, { children: o }), l.push(a));
          } else {
            (n.statements && r[a.metrics.statements.classForPercent] ||
              ...
              n.lines && r[a.metrics.lines.classForPercent]) && l.push(a);
          }
        }
        return l;
      }(c, t, a),
      n && (c = function e(t, n) {
        var l = "asc" === n.order ? 1 : -1, i = "asc" === n.order ? -1 : 1;
        t.sort(function (e, t) {
          var a, o;
          if ("file" === n.sortKey) a = e.file, o = t.file;
          else {
            var u = r(n.sortKey.split("."), 2), c = u[0], s = u[1];
            a = e.metrics[c][s], o = t.metrics[c][s];
          }
          return a === o ? 0 : a < o ? l : i;
        });
        for (var a = 0; a < t.length; a++) {
          var o = t[a];
          o.children &&
            (t[a] = u(u({}, o), {}, { children: e(o.children, n) }));
        }
        return t;
      }(c, n)),
      c;
  ...
  var a = n(0);
  function o(e) {
    var t = e.children, n = e.filter, r = e.activeFilters, o = e.setFilters;
    return a.createElement("button", {
      className: "toggle__option " + (r[n] ? "is-toggled" : ""),
      onClick: function () {
        return o(l(l({}, r), {}, i({}, n, !r[n])));
      },
    }, t);
  }
  e.exports = function (e) {
    var t = e.activeFilters, n = e.setFilters;
    return a.createElement(
      "div",
      { className: "toggle" },
      a.createElement("div", { className: "toggle__label" }, "Filter:"),
      a.createElement(
        "div",
        { className: "toggle__options" },
        a.createElement(
  ...
  e.exports = function (e) {
    var t = e.fileFilter,
      ...
      l = e.setFileFilter,
      a = n.split("/");
    return [{ path: "", name: "all files" }].concat(r(a.map(function (e, t) {
      return { path: a.slice(0, t + 1).join("/"), name: e };
    }))).map(function (e) {
      var t = e.path, r = e.name;
      return t === n
        ? r
        : i.createElement(
          i.Fragment,
