...
export declare function __param(
  paramIndex: number,
  decorator: Function,
): Function;
export declare function __metadata(
  metadataKey: any,
  metadataValue: any,
): Function;
...
export declare function __spreadArray(
  to: any[],
  from: any[],
  pack?: boolean,
): any[];
export declare function __await(v: any): any;
export declare function __asyncGenerator(
  thisArg: any,
  _arguments: any,
  generator: Function,
): any;
...
export declare function __makeTemplateObject(
  cooked: string[],
  raw: string[],
 ...
 */
export declare function __classPrivateFieldSet<
  T extends new (...args: any[]) => unknown,
  V,
>(
  receiver: T,
