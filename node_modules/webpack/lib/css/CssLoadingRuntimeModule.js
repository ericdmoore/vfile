  ...
  generate() {
    ...
    for (const c of chunk.getAllInitialChunks()) {
      (chunkHasCss(c, chunkGraph)
        ...
        : initialChunkIdsWithoutCss).add(c.id);
    }
    ...
    return Template.asString([
        ...
        runtimeTemplate.basicFunction(
          ...
          [
            ...
            Template.indent([
              ...
              }) { token = token.replace(/^_/, ""); exports[token] = token; exportsWithId.push(token); if(cc == ${
                cc(
                  "%",
                )
              ...
              }) { token = token.replace(/^_/, ""); exportsWithId.forEach(${
              ...
              }); exportsWithDashes.forEach(${
                runtimeTemplate.expressionFunction(
                  `exports[x] = "--" + exports[x]`,
                  "x",
                )
              }); ${RuntimeGlobals.makeNamespaceObject}(exports); target[token] = (${
                runtimeTemplate.basicFunction(
                  "exports, module",
      ...
      initialChunkIdsWithCss.size > 2
        ...
        }.forEach(loadCssChunkData.bind(null, ${RuntimeGlobals.moduleFactories}, 0));`
        : initialChunkIdsWithCss.size > 0
        ? `${
          Array.from(
            initialChunkIdsWithCss,
            (id) =>
              `loadCssChunkData(${RuntimeGlobals.moduleFactories}, 0, ${
                JSON.stringify(id)
              });`,
          ).join("")
        }`
      ...
      withHmr
        ? Template.asString([
          ...
          `${RuntimeGlobals.hmrDownloadUpdateHandlers}.css = ${
            runtimeTemplate.basicFunction(
                  ...
                  runtimeTemplate.basicFunction("chunkId", [
                    ...
                    `promises.push(new Promise(${
                      runtimeTemplate.basicFunction(
                        "resolve, reject",
                        [
                          `var link = loadStylesheet(chunkId, url + (url.indexOf("?") < 0 ? "?" : "&") + "hmr=" + Date.now(), ${
                            runtimeTemplate.basicFunction(
                              "event",
                              [
                                'if(event.type !== "load") {',
