...
const ImportMetaHotAcceptDependency = require(
  "./dependencies/ImportMetaHotAcceptDependency",
);
const ImportMetaHotDeclineDependency = require(
  "./dependencies/ImportMetaHotDeclineDependency",
);
const ModuleHotAcceptDependency = require(
  "./dependencies/ModuleHotAcceptDependency",
);
const ModuleHotDeclineDependency = require(
  "./dependencies/ModuleHotDeclineDependency",
);
const HotModuleReplacementRuntimeModule = require(
  "./hmr/HotModuleReplacementRuntimeModule",
);
...
class HotModuleReplacementPlugin {
  ...
  apply(compiler) {
    ...
    const createDeclineHandler = (parser, ParamDependency) =>
      (expr) => {
        const module = parser.state.module;
        const dep = new ConstDependency(
    ...
    const createHMRExpressionHandler = (parser) =>
      (expr) => {
        const module = parser.state.module;
        const dep = new ConstDependency(
      ...
      (compilation, { normalModuleFactory }) => {
        ...
        compilation.hooks.fullHash.tap("HotModuleReplacementPlugin", (hash) => {
          ...
          for (const chunk of compilation.chunks) {
            ...
            const fullHashModulesInThisChunk = chunkGraph
        ...
        compilation.hooks.processAssets.tap(
          ...
          () => {
            ...
            forEachRuntime(allOldRuntime, (runtime) => {
              const { path: filename, info: assetInfo } = compilation
                .getPathWithInfo(
            ...
            for (const key of Object.keys(records.chunkHashes)) {
              ...
              if (currentChunk) {
                ...
                const fullHashModules = chunkGraph
                  .getChunkFullHashModulesIterable(currentChunk);
                newFullHashModules = fullHashModules &&
                  Array.from(fullHashModules).filter((module) =>
                    updatedModules.has(module, currentChunk)
                  );
                const dependentHashModules = chunkGraph
                  .getChunkDependentHashModulesIterable(currentChunk);
                newDependentHashModules = dependentHashModules &&
              ...
              if (
                ...
                for (const entry of renderManifest) {
                  ...
                  if ("filename" in entry) {
                    ...
                    ({ path: filename, info: assetInfo } = compilation
                      .getPathWithInfo(
