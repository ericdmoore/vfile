...
class ConsumeSharedRuntimeModule extends RuntimeModule {
  ...
  generate() {
    ...
    return Template.asString([
      ...
      `var findVersion = ${
        runtimeTemplate.basicFunction("scope, key", [
          "var versions = scope[key];",
          `var key = Object.keys(versions).reduce(${
      ...
      `var getInvalidVersionMessage = ${
        runtimeTemplate.basicFunction(
          ...
          [
            ...
            `\t"Available versions: " + Object.keys(versions).map(${
              runtimeTemplate.basicFunction(
                "key",
      ...
      initialConsumes.length > 0
        ? Template.asString([
          ...
          `initialConsumes.forEach(${
            runtimeTemplate.basicFunction("id", [
              `${RuntimeGlobals.moduleFactories}[id] = ${
