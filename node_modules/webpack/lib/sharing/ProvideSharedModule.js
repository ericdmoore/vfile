...
class ProvideSharedModule extends Module {
  ...
  readableIdentifier(requestShortener) {
    return `provide shared module (${this._shareScope}) ${this._name}@${this._version} = ${
  ...
  libIdent(options) {
    ...
    }webpack/sharing/provide/${this._shareScope}/${this._name}`;
  }
  ...
  codeGeneration({ runtimeTemplate, moduleGraph, chunkGraph }) {
    ...
    const code = `register(${JSON.stringify(this._name)}, ${
      JSON.stringify(
        this._version || "0",
      )
    }, ${
