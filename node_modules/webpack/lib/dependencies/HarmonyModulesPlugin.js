...
const HarmonyAcceptImportDependency = require(
  "./HarmonyAcceptImportDependency",
);
const HarmonyCompatibilityDependency = require(
  "./HarmonyCompatibilityDependency",
);
const HarmonyExportExpressionDependency = require(
  "./HarmonyExportExpressionDependency",
);
const HarmonyExportHeaderDependency = require(
  "./HarmonyExportHeaderDependency",
);
const HarmonyExportImportedSpecifierDependency = require(
  "./HarmonyExportImportedSpecifierDependency",
);
const HarmonyExportSpecifierDependency = require(
  "./HarmonyExportSpecifierDependency",
);
const HarmonyImportSideEffectDependency = require(
  "./HarmonyImportSideEffectDependency",
);
const HarmonyImportSpecifierDependency = require(
  "./HarmonyImportSpecifierDependency",
);

const HarmonyDetectionParserPlugin = require("./HarmonyDetectionParserPlugin");
const HarmonyExportDependencyParserPlugin = require(
  "./HarmonyExportDependencyParserPlugin",
);
const HarmonyImportDependencyParserPlugin = require(
  "./HarmonyImportDependencyParserPlugin",
);
const HarmonyTopLevelThisParserPlugin = require(
