...
const AwaitDependenciesInitFragment = require(
  "../async-modules/AwaitDependenciesInitFragment",
);
              ...
              new HarmonyLinkingError(
                `export ${
                  ids
                    ...
                    .map((id) => `'${id}'`)
                    .join(".")
                } ${additionalMessage} was not found in '${this.userRequest}'${moreInfo}`,
              ),
            ];
          }
          ...
          new HarmonyLinkingError(
            `export ${
              ids
                .map((id) => `'${id}'`)
                .join(".")
            } ${additionalMessage} was not found in '${this.userRequest}'`,
          ),
        ];
      }
    }
