...
module.exports = class HarmonyExportDependencyParserPlugin {
  constructor(options) {
    this.exportPresenceMode = options.reexportExportsPresence !== undefined
  ...
  apply(parser) {
        ...
        const dep = new HarmonyExportExpressionDependency(
          ...
          expr.type.endsWith("Declaration") && expr.id
            ...
            ? {
              ...
              range: [
                expr.range[0],
                expr.params.length > 0 ? expr.params[0].range[0]
                : expr.body.range[0],
              ],
    ...
    parser.hooks.exportSpecifier.tap(
      ...
      (statement, id, name, idx) => {
        ...
        let dep;
        const harmonyNamedExports =
          (parser.state.harmonyNamedExports =
