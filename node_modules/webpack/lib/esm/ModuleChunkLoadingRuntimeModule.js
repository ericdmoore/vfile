...
class ModuleChunkLoadingRuntimeModule extends RuntimeModule {
  ...
  generate() {
    ...
    return Template.asString([
      withBaseURI
        ? Template.asString([
          `${RuntimeGlobals.baseURI} = new URL(${
            JSON.stringify(
              rootOutputDir,
            )
          }, ${importMetaName}.url);`,
      ...
      withLoading || withExternalInstallChunk
        ? `var installChunk = ${
          runtimeTemplate.basicFunction("data", [
                  ...
                  Template.indent([
                    ...
                    Template.indent([
                      ...
                      Template.indent([
                        ...
                        } + ${RuntimeGlobals.getChunkScriptFilename}(chunkId)).then(installChunk, ${
                          runtimeTemplate.basicFunction(
                            "e",
                            [
                        ...
                        `var promise = Promise.race([promise, new Promise(${
