...
const ExportWebpackRequireRuntimeModule = require(
  "./ExportWebpackRequireRuntimeModule",
);
const ModuleChunkLoadingRuntimeModule = require(
    ...
    compiler.hooks.thisCompilation.tap(
      ...
      (compilation) => {
        ...
        const isEnabledForChunk = (chunk) => {
          ...
          const chunkLoading = (options && options.chunkLoading) ||
            globalChunkLoading;
