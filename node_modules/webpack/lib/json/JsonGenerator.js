...
const createObjectForExportsInfo = (data, exportsInfo, runtime) => {
  ...
  if (isArray) {
    ...
    if (arrayLengthWhenUsed !== undefined) {
      sizeObjectMinusArray += `${arrayLengthWhenUsed}`.length +
        8 -
    ...
    const generatedLength = arrayLengthWhenUsed !== undefined
...
class JsonGenerator extends Generator {
  ...
  generate(
    ...
    let finalJson = typeof data === "object" &&
        data &&
    ...
    const jsonExpr = jsonStr.length > 20 && typeof finalJson === "object"
    ...
    if (concatenationScope) {
      ...
      } ${ConcatenationScope.NAMESPACE_OBJECT_EXPORT} = ${jsonExpr};`;
