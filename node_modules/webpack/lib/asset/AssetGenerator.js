    ...
    switch (type) {
      ...
      default: {
        ...
        if (module.buildInfo.dataUrl) {
          ...
          const assetModuleFilename = this.filename ||
          ...
          let { path: filename, info: assetInfo } = runtimeTemplate.compilation
          ...
          if (this.publicPath !== undefined) {
            const { path, info } = runtimeTemplate.compilation
              .getAssetPathWithInfo(
                this.publicPath,
                {
                  module,
          ...
          if (this.outputPath) {
            const { path: outputPath, info } = runtimeTemplate.compilation
              .getAssetPathWithInfo(
                this.outputPath,
                {
                  module,
