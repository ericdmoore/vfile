...
class NormalModule extends Module {
  ...
  _doBuild(options, compilation, resolver, fs, hooks, callback) {
    ...
    runLoaders(
      ...
      (err, result) => {
        ...
        loaderContext._compilation = loaderContext._compiler = loaderContext
          ._module = loaderContext.fs = undefined;
        ...
        if (state === true) {
          if (
            ...
            moduleGraph
              ...
              .push(
                () =>
                  `Dependency (${dep.type}) with side effects at ${
                    formatLocation(dep.loc)
                  }`,
              );
          }
          this._isEvaluatingSideEffects = false;
   ...
   */
  size(type) {
    const cachedSize = this._sourceSizes === undefined
      ? undefined
      : this._sourceSizes.get(type);
