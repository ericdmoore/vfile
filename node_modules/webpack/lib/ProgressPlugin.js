  ...
  const defaultHandler = (percentage, msg, ...args) => {
    if (profile) {
      ...
      for (let i = len; i >= 0; i--) {
        ...
        const lastStateItem = i < lastStateInfo.length
          ? lastStateInfo[i]
          : undefined;
        if (lastStateItem) {
        ...
        cacheGetPromise = cache.getPromise().then(
          (data) => {
            if (data) {
              ...
              lastDependenciesCount = lastDependenciesCount ||
