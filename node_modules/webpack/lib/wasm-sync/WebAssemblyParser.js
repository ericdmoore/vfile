...
const WebAssemblyExportImportedDependency = require(
  "../dependencies/WebAssemblyExportImportedDependency",
);
const WebAssemblyImportDependency = require(
...
class WebAssemblyParser extends Parser {
  ...
  parse(source, state) {
    ...
    let jsIncompatibleExports =
      (state.module.buildMeta.jsIncompatibleExports = undefined);
    ...
    t.traverse(module, {
        ...
        if (descriptor.exportType === "Func") {
          ...
          if (incompatibleType) {
            if (jsIncompatibleExports === undefined) {
              jsIncompatibleExports = state.module.buildMeta
      ...
      ModuleImport({ node }) {
        ...
        if (t.isMemory(node.descr) === true) {
          ...
          if (incompatibleType) {
            onlyDirectImport =
              `Non-JS-compatible Func Signature (${incompatibleType})`;
          }
