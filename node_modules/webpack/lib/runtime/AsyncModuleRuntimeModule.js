...
class AsyncModuleRuntimeModule extends HelperRuntimeModule {
  ...
  generate() {
    ...
    return Template.asString([
      ...
      `var completeQueue = ${
        runtimeTemplate.basicFunction("queue", [
          "if(queue) {",
          Template.indent([
            `queue.forEach(${
      ...
      `var wrapDeps = ${
        runtimeTemplate.returningFunction(
          `deps.map(${
            runtimeTemplate.basicFunction("dep", [
              ...
              Template.indent([
                ...
                Template.indent([
                  "var queue = [];",
                  `dep.then(${
                    runtimeTemplate.basicFunction("r", [
      ...
      `${fn} = ${
        runtimeTemplate.basicFunction("module, body, hasAwait", [
          "var queue = hasAwait && [];",
          ...
          `body(${
            runtimeTemplate.basicFunction("deps", [
              "currentDeps = wrapDeps(deps);",
              "var fn;",
              `var getResult = ${
                runtimeTemplate.returningFunction(
                  `currentDeps.map(${
                    runtimeTemplate.basicFunction("d", [
