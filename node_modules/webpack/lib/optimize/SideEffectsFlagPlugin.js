          ...
          (module, data) => {
            ...
            if (
              ...
              if (sideEffects !== undefined) {
                ...
                const hasSideEffects = SideEffectsFlagPlugin
            ...
            parser.hooks.finish.tap("SideEffectsFlagPlugin", () => {
              if (sideEffectsStatement === undefined) {
                ...
                moduleGraph
                  ...
                  .push(
                    () =>
                      `Statement (${type}) with side effects in source code at ${
                        formatLocation(
                          loc,
                        )
                      }`,
          ...
          (modules) => {
            ...
            for (const module of modules) {
              if (module.getSideEffectsConnectionState(moduleGraph) === false) {
                ...
                for (
                  const connection of moduleGraph.getIncomingConnections(
                    module,
                  )
                ) {
