      ...
      (compilation) => {
        ...
        compilation.hooks.optimizeChunks.tap(
          ...
          (chunks) => {
            ...
            const makePathsRelative = identifierUtils.makePathsRelative
              .bindContextCache(
                compiler.context,
                compiler.root,
              );
            ...
            const sortedChunks = Array.from(chunks).sort((a, b) => {
              const diff1 = chunkGraph.getChunkModulesSize(b) -
                chunkGraph.getChunkModulesSize(a);
              if (diff1) return diff1;
              const diff2 = chunkGraph.getNumberOfChunkModules(a) -
        ...
        compilation.hooks.recordHash.tap(
          ...
          (records) => {
            ...
            if (invalidSplits.size > 0) {
              ...
              const recordedSplits = compilation.records &&
                compilation.records.aggressiveSplits;
              if (recordedSplits) {
