  ...
  constructor(options = {}) {
    ...
    this.options = {
      ...
      fallbackCacheGroup: {
        ...
        automaticNameDelimiter: fallbackCacheGroup.automaticNameDelimiter ||
      ...
      compilation.hooks.optimizeChunks.tap(
        ...
        (chunks) => {
          ...
          const getKey = (chunks) => {
            ...
            let key = chunkIndexMap.get(first) |
              chunkIndexMap.get(result.value);
          ...
          for (const module of compilation.modules) {
            ...
            for (const cacheGroupSource of cacheGroups) {
              ...
              for (const chunkCombination of combs) {
                // Break if minimum number of chunks is not reached
                const count = chunkCombination instanceof Chunk
                  ? 1
                  : chunkCombination.size;
            ...
            if (
              ...
              for (const module of chunkGraph.getChunkModulesIterable(chunk)) {
                if (!item.modules.has(module)) {
                  for (const type of module.getSourceTypes()) {
                    chunkSizes[type] = (chunkSizes[type] || 0) +
                      module.size(type);
                  }
                }
              }
