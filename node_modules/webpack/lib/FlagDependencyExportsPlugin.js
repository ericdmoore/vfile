            ...
            asyncLib.each(
              ...
              (err) => {
                ...
                const processExportsSpec = (dep, exportDesc) => {
                  ...
                  const globalTerminalBinding = exportDesc.terminalBinding ||
                    false;
                  ...
                  if (exports === true) {
                    ...
                    const mergeExports = (exportsInfo, exports) => {
                      for (const exportNameOrSpec of exports) {
                        ...
                        if (exports) {
                          const nestedExportsInfo = exportInfo
                        ...
                        if (target) {
                          const targetModuleExportsInfo = moduleGraph
                            .getExportsInfo(target.module);
                          targetExportsInfo = targetModuleExportsInfo
                ...
                asyncLib.each(
                  ...
                  (module, callback) => {
                    ...
                    const memCache = moduleMemCaches &&
