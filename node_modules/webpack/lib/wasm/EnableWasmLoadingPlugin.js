    ...
    if (typeof type === "string") {
      switch (type) {
        case "fetch": {
          ...
          const FetchCompileWasmPlugin = require(
            "../web/FetchCompileWasmPlugin",
          );
          const FetchCompileAsyncWasmPlugin = require(
        ...
        case "async-node": {
          ...
          const ReadFileCompileWasmPlugin = require(
            "../node/ReadFileCompileWasmPlugin",
          );
          // @ts-expect-error typescript bug for duplicate require
          const ReadFileCompileAsyncWasmPlugin = require(
