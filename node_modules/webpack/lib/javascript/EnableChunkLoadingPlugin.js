...
class EnableChunkLoadingPlugin {
  ...
  apply(compiler) {
    ...
    if (typeof type === "string") {
      switch (type) {
        case "jsonp": {
          const JsonpChunkLoadingPlugin = require(
            "../web/JsonpChunkLoadingPlugin",
          );
          new JsonpChunkLoadingPlugin().apply(compiler);
          break;
        }
        case "import-scripts": {
          const ImportScriptsChunkLoadingPlugin = require(
            "../webworker/ImportScriptsChunkLoadingPlugin",
          );
        ...
        case "require": {
          ...
          const CommonJsChunkLoadingPlugin = require(
            "../node/CommonJsChunkLoadingPlugin",
          );
        ...
        case "import": {
          const ModuleChunkLoadingPlugin = require(
            "../esm/ModuleChunkLoadingPlugin",
          );
