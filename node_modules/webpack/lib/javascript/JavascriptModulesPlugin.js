...
class JavascriptModulesPlugin {
      ...
      (compilation, { normalModuleFactory }) => {
        ...
        compilation.hooks.renderManifest.tap(
          ...
          (result, options) => {
            ...
            let render;
            const filenameTemplate = JavascriptModulesPlugin
  ...
  renderMain(renderContext, hooks, compilation) {
    ...
    const runtimeModules = renderContext.chunkGraph
      ...
      for (const m of inlinedModules) {
        ...
        if (renderedModule) {
          ...
          const webpackExports = exports &&
            m.exportsArgument === "__webpack_exports__";
  ...
  renderBootstrap(renderContext, hooks) {
    ...
    const useRequire = requireFunction || interceptModuleExecution ||
      moduleUsed;
    ...
    if (!runtimeRequirements.has(RuntimeGlobals.startupNoDefault)) {
      if (chunkGraph.getNumberOfEntryModules(chunk) > 0) {
        ...
        for (
          ...
          const entryRuntimeRequirements = chunkGraph
            .getModuleRuntimeRequirements(entryModule, chunk.runtime);
          ...
          if (chunks.length > 0) {
            buf2.push(
              ...
              }${RuntimeGlobals.onChunksLoaded}(undefined, ${
                JSON.stringify(
                  chunks.map((c) => c.id),
                )
              }, ${
