...
class ContainerEntryModule extends Module {
   ...
   */
  identifier() {
    return `container entry (${this._shareScope}) ${
      JSON.stringify(
        this._exposes,
      )
    }`;
  ...
  libIdent(options) {
    ...
    }webpack/container/entry/${this._name}`;
  }
  ...
  codeGeneration({ moduleGraph, chunkGraph, runtimeTemplate }) {
    ...
    const source = Template.asString([
      ...
      "};",
      `var get = ${
        runtimeTemplate.basicFunction("module, getScope", [
      ...
      `var init = ${
        runtimeTemplate.basicFunction("shareScope, initScope", [
