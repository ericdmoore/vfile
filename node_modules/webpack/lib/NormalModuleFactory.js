...
class NormalModuleFactory extends ModuleFactory {
  ...
  constructor({
    ...
    const cachedParseResourceWithoutFragment = parseResourceWithoutFragment
      .bindCache(associatedObjectForCache);
    ...
    this.hooks.resolve.tapAsync(
      ...
      (data, callback) => {
        ...
        const continueCallback = needCalls(2, (err) => {
          ...
          const userRequest = (matchResourceData !== undefined
            ...
            try {
              Object.assign(data.createData, {
                ...
                context: resourceData.context ||
                  getContext(resourceData.resource),
                ...
                if (!err && resolvedResource) {
                  ...
                  if (match) {
                    ...
                    if (resolver.options.extensions.has(match[1])) {
                      ...
                      hint = `Did you mean '${fixedRequest}'? Also note that '${
                        match[1]
                      }' is not in 'resolve.extensions' yet and need to be added for this to work?`;
                    }
                  } else {
                    hint =
          ...
          (err, result) => {
            ...
            const resolved = {
              ...
              options: item.options === undefined
                ? parsedResult.query ? parsedResult.query.slice(1) : undefined
                : item.options,
