...
function n(
  ...
  if (o === p) {
    if (Array.isArray(t)) {
      ...
      for (let l = 0; l < n; l++) {
        ...
        if (i === o && (a = !0, u = 0), a) {
          o = e, null !== r && (e ? r.length = e : r = null);
        } else {
  ...
  if (i = i || f, !i) {
    ...
    if (s) o = l, null !== r && (l ? r.length = l : r = null);
    else {
      const n = { params: {} };
      null === r ? r = [n] : r.push(n), o++;
    }
    ...
    if (u === t) {
      if (l && "object" == typeof l && !Array.isArray(l)) {
        ...
        if (void 0 === l.banner && (t = "banner")) {
          ...
          for (const n in l) {
            if (
              "banner" !== n && "entryOnly" !== n && "exclude" !== n &&
              "include" !== n && "raw" !== n && "test" !== n
            ) {
          ...
          if (t === u) {
            if (void 0 !== l.banner) {
              ...
              if (e) u = s, null !== o && (s ? o.length = s : o = null);
              else {
                const n = { params: {} };
                null === o ? o = [n] : o.push(n), u++;
              }
              ...
              if (m) {
                if (void 0 !== l.exclude) {
                  ...
                  if (
                    ...
                    u = e, null !== o && (e ? o.length = e : o = null);
                  } else {
