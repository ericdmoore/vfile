  ...
  if (0 === p) {
    ...
    }
    {
      ...
      }
      {
        ...
        for (const r in n) {
          if (
            "allowedUris" !== r && "cacheLocation" !== r && "frozen" !== r &&
            "lockfileLocation" !== r && "upgrade" !== r
          ) {
        ...
        if (o === p) {
            ...
            if (p == p) {
              ...
              }
              {
                ...
                for (let o = 0; o < n; o++) {
                  ...
                  if (
                    p = a, null !== i && (a ? i.length = a : i = null), s !== p
                  ) {
                    break;
                  }
                }
          ...
          if (f) {
            if (void 0 !== n.cacheLocation) {
              ...
              p = s, null !== i && (s ? i.length = s : i = null), f = o === p;
            } else f = !0;
            if (f) {
              if (void 0 !== n.frozen) {
                const r = p;
...
function n(
  ...
  if (
    ...
    const r = { params: { passingSchemas: f } };
