...
function t(
  ...
  if (!Array.isArray(r)) return t.errors = [{ params: { type: "array" } }], !1;
  {
    const e = r.length;
    for (let n = 0; n < e; n++) {
      let e = r[n];
            ...
            if (c) {
              ...
              if (c) {
                if (void 0 !== r.root) {
                  ...
                  if (s) l = n, null !== a && (n ? a.length = n : a = null);
                  else {
                    const r = { params: {} };
                    null === a ? a = [r] : a.push(r), l++;
                  }
  ...
  if (0 === f) {
    ...
    }
    {
      ...
      }
      {
        ...
        for (const r in t) {
          if (
            "exposes" !== r && "filename" !== r && "library" !== r &&
            "name" !== r && "runtime" !== r && "shareScope" !== r
          ) {
                ...
                if (u) {
                  ...
                  if (u) {
                    if (void 0 !== t.shareScope) {
                      ...
                      if (f === e) {
                        if ("string" != typeof r) {
                          return i.errors = [{ params: { type: "string" } }],
                            !1;
                        }
                        if (r.length < 1) {
                          return i.errors = [{ params: {} }], !1;
