...
function n(
  ...
  if (!Array.isArray(r)) return n.errors = [{ params: { type: "array" } }], !1;
  {
    const t = r.length;
    for (let e = 0; e < t; e++) {
      let t = r[e];
  ...
  if (p = p || c, !p) {
    ...
    if (o == o) {
      if (r && "object" == typeof r && !Array.isArray(r)) {
        ...
        for (const t in r) {
          if (
            "amd" !== t && "commonjs" !== t && "commonjs2" !== t && "root" !== t
          ) {
            ...
            if (u) {
              ...
              if (u) {
                if (void 0 !== r.root) {
                  ...
                  if (a) o = n, null !== s && (n ? s.length = n : s = null);
                  else {
                    const r = { params: {} };
                    null === s ? s = [r] : s.push(r), o++;
                  }
  ...
  if (0 === o) {
    ...
    }
    {
      ...
      }
      {
        ...
        for (const t in r) {
          if (
            "auxiliaryComment" !== t && "export" !== t && "name" !== t &&
            "type" !== t && "umdNamedDefine" !== t
          ) {
            ...
            if (f) {
              ...
              if (f) {
                if (void 0 !== r.type) {
                  ...
                  const l = o;
                  if (
                    "var" !== t && "module" !== t && "assign" !== t &&
                    "assign-properties" !== t && "this" !== t &&
                    "window" !== t && "self" !== t && "global" !== t &&
                    "commonjs" !== t && "commonjs2" !== t &&
                    "commonjs-module" !== t && "commonjs-static" !== t &&
                    "amd" !== t && "amd-require" !== t && "umd" !== t &&
                    "umd2" !== t && "jsonp" !== t && "system" !== t
                  ) {
                    const r = { params: {} };
                    null === s ? s = [r] : s.push(r), o++;
                  }
                    ...
                    if (i) {
                      if (void 0 !== r.strictVersion) {
                        ...
                        if ("boolean" != typeof r.strictVersion) {
                          return h.errors = [{ params: { type: "boolean" } }],
                            !1;
                        }
                        i = t === l;
                      } else i = !0;
            ...
            if (u) {
              ...
              if (u) {
                if (void 0 !== n.remoteType) {
                  ...
                  const o = c;
                  if (
                    "var" !== r && "module" !== r && "assign" !== r &&
                    "this" !== r && "window" !== r && "self" !== r &&
                    "global" !== r && "commonjs" !== r && "commonjs2" !== r &&
                    "commonjs-module" !== r && "commonjs-static" !== r &&
                    "amd" !== r && "amd-require" !== r && "umd" !== r &&
                    "umd2" !== r && "jsonp" !== r && "system" !== r &&
                    "promise" !== r && "import" !== r && "script" !== r &&
                    "node-commonjs" !== r
                  ) {
                    const r = { params: {} };
