...
const ModulesInHierarchicalDirectoriesPlugin = require(
...
function createOptions(options) {
  ...
  return {
    ...
    cacheWithContext: typeof options.cacheWithContext !== "undefined"
    ...
    enforceExtension: options.enforceExtension === undefined
      ? options.extensions && options.extensions.includes("") ? true : false
...
exports.createResolver = function (options) {
  ...
  // resolve
  for (
    const { source, resolveOptions } of [
...
function mergeFilteredToArray(array, filter) {
  ...
  for (const item of set) {
    if (filter(item)) {
      const lastElement = result.length > 0
