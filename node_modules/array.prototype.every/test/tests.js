...
var falseThunk = function () {
  return false;
};

var canDistinguishSparseFromUndefined = 0 in [undefined]; // IE 6 - 8 have a bug where this returns false.
var undefinedIfNoSparseBug = canDistinguishSparseFromUndefined
  ? undefined
  : {
    valueOf: function () {
      return 0;
...
module.exports = function (every, t) {
  ...
  t.test(
    "does not visit elements added to the array after it has begun",
    function (st) {
      st.plan(2);
      ...
      st.deepEqual(
        arr,
        [1, 2, 3, 4, 5, 6],
        "array has received 3 new elements",
      );
  ...
  t.test(
    "does not visit elements deleted from the array after it has begun",
    function (st) {
      var arr = [1, 2, 3];
      var actual = [];
  ...
  t.equal(
    every([1, 2, 3], trueThunk),
    true,
    "returns true if every callback does",
  );
  t.equal(
    every([1, 2, 3], falseThunk),
    false,
    "returns false if any callback does",
  );
