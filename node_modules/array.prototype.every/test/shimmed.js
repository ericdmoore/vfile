...
test("shimmed", function (t) {
  ...
  t.test(
    ...
    function (et) {
      et.equal(
        false,
        isEnumerable.call(Array.prototype, "every"),
        "Array#every is not enumerable",
      );
      et.end();
    },
  );
  ...
  t.test("bad array/this value", { skip: !supportsStrictMode }, function (st) {
    st["throws"](
      function () {
        return Array.prototype.every.call(undefined, "a");
      },
      TypeError,
    ...
    st["throws"](
      function () {
        return Array.prototype.every.call(null, "a");
      },
      TypeError,
