...
function buildYargs(withCommands = false) {
  const yargs = Yargs([])
    ...
    .options("config", {
      ...
      default: () =>
        findUp.sync([".c8rc", ".c8rc.json", ".nycrc", ".nycrc.json"]),
    })
    .option("reporter", {
      alias: "r",
    ...
    .options("all", {
      ...
      group: "Reporting options",
      describe:
        "supplying --all will cause c8 to consider all src files in the current working directory " +
    ...
    .options("src", {
      ...
      group: "Reporting options",
      describe:
        "supplying --src will override cwd as the default location where --all looks for src files. --src can be " +
    ...
    .option("exclude-after-remap", {
      ...
      group: "Reporting options",
      describe:
        "apply exclude logic to files after they are remapped by a source-map",
    })
    .options("skip-full", {
      default: false,
      type: "boolean",
    ...
    .options("allowExternal", {
      ...
      type: "boolean",
      describe:
        "supplying --allowExternal will cause c8 to allow files from outside of your cwd. This applies both to " +
