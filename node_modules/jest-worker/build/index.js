    ...
    const workerPoolOptions = {
      ...
      forkOptions:
        (_this$_options$forkOp = this._options.forkOptions) !== null &&
          ...
          ? _this$_options$forkOp
          : {},
      maxRetries: (_this$_options$maxRet = this._options.maxRetries) !== null &&
          _this$_options$maxRet !== void 0
        ? _this$_options$maxRet
        : 3,
      numWorkers: (_this$_options$numWor = this._options.numWorkers) !== null &&
      ...
      resourceLimits:
        (_this$_options$resour = this._options.resourceLimits) !== null &&
          ...
          ? _this$_options$resour
          : {},
      setupArgs: (_this$_options$setupA = this._options.setupArgs) !== null &&
