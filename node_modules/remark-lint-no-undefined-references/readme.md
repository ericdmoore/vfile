...
- `Object` with the following fields:
  - `allow` (`Array<string>`, default: `[]`) — text that you want to allowed
    between `[` and `]` even though it’s undefined

## Recommendation

Shortcut references use an implicit syntax that could also occur as plain text.
...
The second author might expect only their newly added text to form a link, but
their changes also result in a link for the first author’s text.
