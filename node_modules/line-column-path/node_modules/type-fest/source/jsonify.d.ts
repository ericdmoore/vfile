...
type Jsonify<T> =
  ...
  [Extract<T, NotJsonable>] extends [never] ? T extends JsonPrimitive ? T // Primitive is acceptable
  : T extends Array<infer U> ? Array<Jsonify<U>> // It's an array: recursive call for its children
  : T extends object
