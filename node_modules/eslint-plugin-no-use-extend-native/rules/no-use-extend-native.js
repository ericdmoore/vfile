...
var binaryExpressionProduces = function binaryExpressionProduces(o) {
  var leftType = o.left.type === "BinaryExpression"
    ? binaryExpressionProduces(o.left)
    : getType(o.left);
  var rightType = o.right.type === "BinaryExpression"
    ? binaryExpressionProduces(o.right)
    : getType(o.right);
...
var isUnkownGettSetterOrJsTypeExpressed =
  function isUnkownGettSetterOrJsTypeExpressed(
    jsType,
    propertyName,
    usageType,
  ) {
    var isExpression = usageType === "ExpressionStatement" ||
      usageType === "MemberExpression";
    return isExpression &&
      !(0, _isGetSetProp["default"])(jsType, propertyName) &&
      !(0, _isProtoProp["default"])(jsType, propertyName) &&
      !(0, _isObjProp["default"])(jsType, propertyName);
  };
/**
...
var isInvalid = function isInvalid(jsType, propertyName, usageType) {
  if (
    typeof propertyName !== "string" || typeof jsType !== "string" ||
    !(0, _isJsType["default"])(jsType)
  ) {
    return false;
  }

  var unknownGetterSetterOrjsTypeExpressed =
    isUnkownGettSetterOrJsTypeExpressed(jsType, propertyName, usageType);
  var isFunctionCall = usageType === "CallExpression";
  var getterSetterCalledAsFunction = isFunctionCall &&
    (0, _isGetSetProp["default"])(jsType, propertyName);
  var unknownjsTypeCalledAsFunction = isFunctionCall &&
    !(0, _isProtoProp["default"])(jsType, propertyName) &&
    !(0, _isObjProp["default"])(jsType, propertyName);
  return unknownGetterSetterOrjsTypeExpressed || getterSetterCalledAsFunction ||
  ...
  create: function create(context) {
    return {
      MemberExpression: function MemberExpression(node) {
        ...
        var isArgToParent = node.parent.arguments &&
