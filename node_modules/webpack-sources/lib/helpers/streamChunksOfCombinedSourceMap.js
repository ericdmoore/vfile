      ...
      if (sourceIndex === innerSourceIndex) {
        ...
        if (idx !== -1) {
          ...
          if (innerSourceIndex >= 0) {
            ...
            let sourceIndex = innerSourceIndex < innerSourceIndexMapping.length
            ...
            if (innerNameIndex >= 0) {
              ...
              finalNameIndex = innerNameIndex < innerNameIndexMapping.length
                ? innerNameIndexMapping[innerNameIndex]
                : -2;
              if (finalNameIndex === -2) {
                const name = innerNameIndex < innerNameIndexValueMapping.length
              ...
              if (originalSourceLines !== null) {
                ...
                if (name === originalName) {
                  finalNameIndex = nameIndex < nameIndexMapping.length
