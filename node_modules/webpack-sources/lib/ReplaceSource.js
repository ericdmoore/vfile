...
const hasStableSort = typeof process === "object" &&
  process.versions &&
...
class ReplaceSource extends Source {
  ...
  streamChunks(options, onChunk, onSource, onName) {
    ...
    let i = 0;
    let replacmentEnd = -1;
    let nextReplacement = i < repls.length
    ...
    const checkOriginalContent = (sourceIndex, line, column, expectedChunk) => {
      let content = sourceIndex < sourceContents.length
      ...
      (
        ...
        if (nextReplacement < endPos) {
          do {
            ...
            i++;
            nextReplacement = i < repls.length
              ? Math.floor(repls[i].start)
              : MAX_SOURCE_POSITION;
